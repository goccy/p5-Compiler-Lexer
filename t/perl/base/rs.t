...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   'name' => 'String',
                   'data' => '\\$/ preserved when set to bad value',
                   'line' => 38,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   ...
                   'line' => 42,
                   'name' => 'String',
                   'data' => 'ok $test_count # \\$/ preserved when set to bad value\\n'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'line' => 42,
                   'kind' => Compiler::Lexer::Kind::T_StmtEnd,
          ...
          bless( {
                   'data' => ' # \\$/ = []; produced expected error message\\n',
                   'name' => 'String',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'has_warnings' => 0,
          ...
          bless( {
                   ...
                   'line' => 257,
                   'name' => 'RegExp',
                   'data' => 'Setting \\$\\/ to an ARRAY reference is forbidden'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'name' => 'RegDelim',
                   'data' => '!',
          ...
          bless( {
                   ...
                   'line' => 268,
                   'name' => 'RegExp',
                   'data' => 'Setting \\$\\/ to a HASH reference is forbidden'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   'data' => ' # \\$/ = \\\\\\\\1; produced expected error message\\n',
                   'name' => 'String',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_String,
          ...
          bless( {
                   'data' => 'Setting \\$\\/ to a REF reference is forbidden',
                   'name' => 'RegExp',
                   'line' => 277,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
          ...
          bless( {
                   ...
                   'line' => 282,
                   'name' => 'String',
                   'data' => ' # \\$/ = qr/foo/; produced expected error message\\n'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'data' => ';',
                   'name' => 'SemiColon',
          ...
          bless( {
                   'name' => 'RegExp',
                   'data' => 'Setting \\$\\/ to a REGEXP reference is forbidden',
                   'line' => 286,
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   'name' => 'String',
                   'data' => ' # \\$/ = \\\\*STDOUT; produced expected error message\\n',
                   'line' => 291,
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   ...
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'line' => 295,
                   'data' => 'Setting \\$\\/ to a GLOB reference is forbidden',
                   'name' => 'RegExp'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'data' => '!',
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            'start_line' => 38,
            'indent' => 0,
            'src' => ' my $note = "\\$/ preserved when set to bad value" ;',
            'block_id' => 0,
            'token_num' => 5,
            'has_warnings' => 0,
            'end_line' => 38
          ...
          },
          {
            ...
            'token_num' => 82,
            'start_line' => 125,
            'src' => ' { local @INC = ( "../lib" , "lib" , @INC ) ; if ( not eval q/use PerlIO::scalar; 1/ ) { for $test ( $test_count .. $test_count + ( $test_count_end - $test_count_start - 1 ) ) { print "ok $test # skipped - Can\'t test in memory file with miniperl/without PerlIO::Scalar\\n" ; $test_count ++ ; } } else { open TESTFILE , "<" , \\ $teststring ; test_string ( *TESTFILE ) ; close TESTFILE ; open TESTFILE , "<" , \\ $teststring2 ; test_record ( *TESTFILE ) ; close TESTFILE ; } }',
            'indent' => 0
          },
          {
            'start_line' => 129,
          ...
          },
          {
            ...
            'start_line' => 130,
            'indent' => 1,
            'src' => ' if ( not eval q/use PerlIO::scalar; 1/ ) { for $test ( $test_count .. $test_count + ( $test_count_end - $test_count_start - 1 ) ) { print "ok $test # skipped - Can\'t test in memory file with miniperl/without PerlIO::Scalar\\n" ; $test_count ++ ; } }'
          },
          {
            'start_line' => 135,
          ...
          },
          {
            ...
            'block_id' => 0,
            'start_line' => 250,
            'src' => ' sub test_bad_setting { if ( eval { $/ = [ ] ; 1 } ) { print "not ok " , $test_count ++ , " # \\$/ = []; should die\\n" ; print "not ok " , $test_count ++ , " # \\$/ = []; produced expected error message\\n" ; } else { my $msg = $@ || "Zombie Error" ; print "ok " , $test_count ++ , " # \\$/ = []; should die\\n" ; if ( $msg !~ m!Setting \\$\\/ to an ARRAY reference is forbidden! ) { print "not " ; } print "ok " , $test_count ++ , " # \\$/ = []; produced expected error message\\n" ; } if ( eval { $/ = { } ; 1 } ) { print "not ok " , $test_count ++ , " # \\$/ = {}; should die\\n" ; print "not ok " , $test_count ++ , " # \\$/ = {}; produced expected error message\\n" ; } else { my $msg = $@ || "Zombie Error" ; print "ok " , $test_count ++ , " # \\$/ = {}; should die\\n" ; if ( $msg !~ m!Setting \\$\\/ to a HASH reference is forbidden! ) { print "not " ; } print "ok " , $test_count ++ , " # \\$/ = {}; produced expected error message\\n" ; } if ( eval { $/ = \\ \\ 1 ; 1 } ) { print "not ok " , $test_count ++ , " # \\$/ = \\\\\\\\1; should die\\n" ; print "not ok " , $test_count ++ , " # \\$/ = \\\\\\\\1; produced expected error message\\n" ; } else { my $msg = $@ || "Zombie Error" ; print "ok " , $test_count ++ , " # \\$/ = \\\\\\\\1; should die\\n" ; if ( $msg !~ m!Setting \\$\\/ to a REF reference is forbidden! ) { print "not " ; } print "ok " , $test_count ++ , " # \\$/ = \\\\\\\\1; produced expected error message\\n" ; } if ( eval { $/ = qr/foo/ ; 1 } ) { print "not ok " , $test_count ++ , " # \\$/ = qr/foo/; should die\\n" ; print "not ok " , $test_count ++ , " # \\$/ = qr/foo/; produced expected error message\\n" ; } else { my $msg = $@ || "Zombie Error" ; print "ok " , $test_count ++ , " # \\$/ = qr/foo/; should die\\n" ; if ( $msg !~ m!Setting \\$\\/ to a REGEXP reference is forbidden! ) { print "not " ; } print "ok " , $test_count ++ , " # \\$/ = qr/foo/; produced expected error message\\n" ; } if ( eval { $/ = \\ *STDOUT ; 1 } ) { print "not ok " , $test_count ++ , " # \\$/ = \\\\*STDOUT; should die\\n" ; print "not ok " , $test_count ++ , " # \\$/ = \\\\*STDOUT; produced expected error message\\n" ; } else { my $msg = $@ || "Zombie Error" ; print "ok " , $test_count ++ , " # \\$/ = \\\\*STDOUT; should die\\n" ; if ( $msg !~ m!Setting \\$\\/ to a GLOB reference is forbidden! ) { print "not " ; } print "ok " , $test_count ++ , " # \\$/ = \\\\*STDOUT; produced expected error message\\n" ; } }',
            'indent' => 0
          },
          {
            'token_num' => 30,
            ...
            'has_warnings' => 1,
            'start_line' => 251,
            'src' => ' if ( eval { $/ = [ ] ; 1 } ) { print "not ok " , $test_count ++ , " # \\$/ = []; should die\\n" ; print "not ok " , $test_count ++ , " # \\$/ = []; produced expected error message\\n" ; }',
            'indent' => 1
          },
          {
            'indent' => 1,
          ...
          },
          {
            ...
            'block_id' => 38,
            'token_num' => 8,
            'src' => ' print "not ok " , $test_count ++ , " # \\$/ = []; should die\\n" ;',
            'indent' => 2,
            'start_line' => 252
          },
          {
            ...
            'block_id' => 38,
            'token_num' => 8,
            'src' => ' print "not ok " , $test_count ++ , " # \\$/ = []; produced expected error message\\n" ;',
            'indent' => 2,
            'start_line' => 253
          },
          {
            ...
            'has_warnings' => 1,
            'indent' => 1,
            'src' => ' else { my $msg = $@ || "Zombie Error" ; print "ok " , $test_count ++ , " # \\$/ = []; should die\\n" ; if ( $msg !~ m!Setting \\$\\/ to an ARRAY reference is forbidden! ) { print "not " ; } print "ok " , $test_count ++ , " # \\$/ = []; produced expected error message\\n" ; }',
            'start_line' => 254
          },
          {
            'token_num' => 7,
          ...
          },
          {
            ...
            'block_id' => 39,
            'indent' => 2,
            'src' => ' print "ok " , $test_count ++ , " # \\$/ = []; should die\\n" ;',
            'start_line' => 256
          },
          {
            'has_warnings' => 1,
            ...
            'token_num' => 14,
            'indent' => 2,
            'src' => ' if ( $msg !~ m!Setting \\$\\/ to an ARRAY reference is forbidden! ) { print "not " ; }',
            'start_line' => 257
          },
          {
            'indent' => 3,
          ...
          },
          {
            ...
            'start_line' => 260,
            'indent' => 2,
            'src' => ' print "ok " , $test_count ++ , " # \\$/ = []; produced expected error message\\n" ;'
          },
          {
            'token_num' => 30,
            'block_id' => 37,
          ...
          },
          {
            ...
            'start_line' => 268,
            'indent' => 2,
            'src' => ' if ( $msg !~ m!Setting \\$\\/ to a HASH reference is forbidden! ) { print "not " ; }'
          },
          {
            'token_num' => 3,
            'block_id' => 43,
          ...
          {
            'start_line' => 271,
            'src' => ' if ( eval { $/ = \\ \\ 1 ; 1 } ) { print "not ok " , $test_count ++ , " # \\$/ = \\\\\\\\1; should die\\n" ; print "not ok " , $test_count ++ , " # \\$/ = \\\\\\\\1; produced expected error message\\n" ; }',
            'indent' => 1,
            'token_num' => 31,
            'block_id' => 37,
            'end_line' => 274,
          ...
          },
          {
            ...
            'block_id' => 44,
            'token_num' => 8,
            'src' => ' print "not ok " , $test_count ++ , " # \\$/ = \\\\\\\\1; should die\\n" ;',
            'indent' => 2,
            'start_line' => 272
          },
          {
            'src' => ' print "not ok " , $test_count ++ , " # \\$/ = \\\\\\\\1; produced expected error message\\n" ;',
            'indent' => 2,
            'start_line' => 273,
            'has_warnings' => 1,
            'end_line' => 273,
          ...
          },
          {
            ...
            'end_line' => 279,
            'indent' => 1,
            'src' => ' else { my $msg = $@ || "Zombie Error" ; print "ok " , $test_count ++ , " # \\$/ = \\\\\\\\1; should die\\n" ; if ( $msg !~ m!Setting \\$\\/ to a REF reference is forbidden! ) { print "not " ; } print "ok " , $test_count ++ , " # \\$/ = \\\\\\\\1; produced expected error message\\n" ; }',
            'start_line' => 274
          },
          {
            'src' => ' my $msg = $@ || "Zombie Error" ;',
          ...
          },
          {
            ...
            'token_num' => 8,
            'block_id' => 45,
            'src' => ' print "ok " , $test_count ++ , " # \\$/ = \\\\\\\\1; should die\\n" ;',
            'indent' => 2,
            'start_line' => 276
          },
          {
            ...
            'token_num' => 14,
            'start_line' => 277,
            'src' => ' if ( $msg !~ m!Setting \\$\\/ to a REF reference is forbidden! ) { print "not " ; }',
            'indent' => 2
          },
          {
            'has_warnings' => 0,
          ...
          {
            'indent' => 2,
            'src' => ' print "ok " , $test_count ++ , " # \\$/ = \\\\\\\\1; produced expected error message\\n" ;',
            'start_line' => 278,
            'end_line' => 278,
            'has_warnings' => 1,
            'block_id' => 45,
          ...
          },
          {
            ...
            'token_num' => 32,
            'indent' => 1,
            'src' => ' if ( eval { $/ = qr/foo/ ; 1 } ) { print "not ok " , $test_count ++ , " # \\$/ = qr/foo/; should die\\n" ; print "not ok " , $test_count ++ , " # \\$/ = qr/foo/; produced expected error message\\n" ; }',
            'start_line' => 280
          },
          {
            'block_id' => 46,
          ...
          {
            'src' => ' print "not ok " , $test_count ++ , " # \\$/ = qr/foo/; should die\\n" ;',
            'indent' => 2,
            'start_line' => 281,
            'token_num' => 8,
            'block_id' => 47,
          ...
          },
          {
            ...
            'start_line' => 282,
            'indent' => 2,
            'src' => ' print "not ok " , $test_count ++ , " # \\$/ = qr/foo/; produced expected error message\\n" ;'
          },
          {
            'indent' => 1,
            'src' => ' else { my $msg = $@ || "Zombie Error" ; print "ok " , $test_count ++ , " # \\$/ = qr/foo/; should die\\n" ; if ( $msg !~ m!Setting \\$\\/ to a REGEXP reference is forbidden! ) { print "not " ; } print "ok " , $test_count ++ , " # \\$/ = qr/foo/; produced expected error message\\n" ; }',
            'start_line' => 283,
            'has_warnings' => 1,
            'end_line' => 288,
            'block_id' => 37,
          ...
          },
          {
            'start_line' => 285,
            'indent' => 2,
            'src' => ' print "ok " , $test_count ++ , " # \\$/ = qr/foo/; should die\\n" ;',
            'end_line' => 285,
            'has_warnings' => 1,
            'token_num' => 8,
            'block_id' => 48
          },
          {
            ...
            'end_line' => 286,
            'start_line' => 286,
            'src' => ' if ( $msg !~ m!Setting \\$\\/ to a REGEXP reference is forbidden! ) { print "not " ; }',
            'indent' => 2
          },
          {
            'block_id' => 49,
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'indent' => 2,
            'src' => ' print "ok " , $test_count ++ , " # \\$/ = qr/foo/; produced expected error message\\n" ;',
            'start_line' => 287
          },
          {
            'src' => ' if ( eval { $/ = \\ *STDOUT ; 1 } ) { print "not ok " , $test_count ++ , " # \\$/ = \\\\*STDOUT; should die\\n" ; print "not ok " , $test_count ++ , " # \\$/ = \\\\*STDOUT; produced expected error message\\n" ; }',
            'indent' => 1,
            'start_line' => 289,
            'end_line' => 292,
            'has_warnings' => 1,
          ...
          },
          {
            ...
            'end_line' => 290,
            'has_warnings' => 1,
            'src' => ' print "not ok " , $test_count ++ , " # \\$/ = \\\\*STDOUT; should die\\n" ;',
            'indent' => 2,
            'start_line' => 290
          },
          {
            'src' => ' print "not ok " , $test_count ++ , " # \\$/ = \\\\*STDOUT; produced expected error message\\n" ;',
            'indent' => 2,
            'start_line' => 291,
            'has_warnings' => 1,
            'end_line' => 291,
          ...
          {
            'start_line' => 292,
            'src' => ' else { my $msg = $@ || "Zombie Error" ; print "ok " , $test_count ++ , " # \\$/ = \\\\*STDOUT; should die\\n" ; if ( $msg !~ m!Setting \\$\\/ to a GLOB reference is forbidden! ) { print "not " ; } print "ok " , $test_count ++ , " # \\$/ = \\\\*STDOUT; produced expected error message\\n" ; }',
            'indent' => 1,
            'end_line' => 297,
            'has_warnings' => 1,
            'token_num' => 40,
          ...
          },
          {
            ...
            'start_line' => 294,
            'indent' => 2,
            'src' => ' print "ok " , $test_count ++ , " # \\$/ = \\\\*STDOUT; should die\\n" ;'
          },
          {
            'start_line' => 295,
            'indent' => 2,
            'src' => ' if ( $msg !~ m!Setting \\$\\/ to a GLOB reference is forbidden! ) { print "not " ; }',
            'token_num' => 14,
            'block_id' => 51,
            'end_line' => 295,
            'has_warnings' => 1
          ...
          },
          {
            ...
            'end_line' => 296,
            'start_line' => 296,
            'src' => ' print "ok " , $test_count ++ , " # \\$/ = \\\\*STDOUT; produced expected error message\\n" ;',
            'indent' => 2
          }
        ]
