...
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => '$foo = 123+123.4+123e4+123.4E5+123.4e+5+.12;',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 31
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'HereDocument',
                   'data' => 'ok 12 - make sure single quotes are honored \\nnot ok
EOS
ok 13
',
                   'type' => Compiler::Lexer::TokenType::T_HereDocument,
...
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'ok 18 - was the test for the deprecated use of bare << to mean <<\\"\\"\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 72
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'Can\\\'t use global $^XYZ in "my"',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 164
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
# line 1 "plunk"
    ...
    ',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => '"fred@example.com" eq "fred.com"',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 222
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => '@nosuch = (\'a\', \'b\', \'c\'); ">@nosuch<" eq ">a b c<"',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 233
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => 'makearray(); ">@R::crackers<" eq ">fish dog carrot<"',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 244
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => 'Unrecognized character \\\\xE2; marked by <-- HERE after \\$x =<-- HERE near column 5',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 269
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
\' ;',
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 31,
            'src' => ' eval \'$foo = 123+123.4+123e4+123.4E5+123.4e+5+.12;\' ;',
            'start_line' => 31,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 34,
            'src' => ' if ( $foo eq 2591024652 ) { print "ok 7\\n" ; }',
            'start_line' => 34,
            'indent' => 0,
            'block_id' => 0
          },
...
> ;',
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 72,
            'src' => ' print "ok 18 - was the test for the deprecated use of bare << to mean <<\\"\\"\\n" ;',
            'start_line' => 72,
            'indent' => 0,
            'block_id' => 0
          },
...
E2
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 97,
            'src' => ' print "$foo{$bar}" eq "BAZ" ? "ok 21\\n" : "not ok 21\\n" ;',
            'start_line' => 97,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 99,
            'src' => ' print "${foo}{$bar}" eq "FOO{BAR}" ? "ok 22\\n" : "not ok 22\\n" ;',
            'start_line' => 99,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 100,
            'src' => ' print "${foo{$bar}}" eq "BAZ" ? "ok 23\\n" : "not ok 23\\n" ;',
            'start_line' => 100,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 115,
            'src' => ' $foo =~ s/^not /substr(<<EOF, 0, 0)/e ;',
            'start_line' => 115,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 182,
            'src' => ' { my $CX = "\\cX" ; my $CXY = "\\cXY" ; $ { $CX } = 17 ; $ { $CXY } = 23 ; if ( $ { ^ XY } != 23 ) { print "not " } print "ok 31\\n" ; if ( eval "\\$ {\\cX}" != 17 or $@ ) { print "not " } print "ok 32\\n" ; eval "\\$\\cQ = 24" ; if ( $@ or ${ "\\cQ" } != 24 ) { print "not " } print "ok 33\\n" ; if ( $^ Q != 24 ) { print "not " } print "ok 34\\n" ; if ( "$^XY" ne "17Y" ) { print "not " } print "ok 35\\n" ; sub XX (  ) { 6 } $ { "\\cQ\\cXX" } = 119 ; $^ Q = 5 ; $N = 5 ; if ( ( $^ Q ^ XX ) != 3 ) { print "not " } print "ok 36\\n" ; eval \'my $^X;\' ; print "not " unless index ( $@ , \'Can\\\'t use global $^X in "my"\' ) > -1 ; print "ok 37\\n" ; eval \'my $ {^XYZ};\' ; print "not " unless index ( $@ , \'Can\\\'t use global $^XYZ in "my"\' ) > -1 ; print "ok 38\\n" ; package Someother ; $^ Q = \'Someother\' ; $ { ^ Quixote } = \'Someother 2\' ; $ { ^ M } = \'Someother 3\' ; package main ; print "not " unless $^ Q eq \'Someother\' ; print "ok 39\\n" ; print "not " unless $ { ^ Quixote } eq \'Someother 2\' ; print "ok 40\\n" ; print "not " unless $ { ^ M } eq \'Someother 3\' ; print "ok 41\\n" ; }',
            'start_line' => 123,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 131,
            'src' => ' if ( eval "\\$ {\\cX}" != 17 or $@ ) { print "not " }',
            'start_line' => 131,
            'indent' => 1,
            'block_id' => 13
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 159,
            'src' => ' print "not " unless index ( $@ , \'Can\\\'t use global $^X in "my"\' ) > -1 ;',
            'start_line' => 159,
            'indent' => 1,
            'block_id' => 13
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 164,
            'src' => ' print "not " unless index ( $@ , \'Can\\\'t use global $^XYZ in "my"\' ) > -1 ;',
            'start_line' => 164,
            'indent' => 1,
            'block_id' => 13
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 174,
            'src' => ' print "not " unless $^ Q eq \'Someother\' ;',
            'start_line' => 174,
            'indent' => 1,
            'block_id' => 13
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 176,
            'src' => ' print "not " unless $ { ^ Quixote } eq \'Someother 2\' ;',
            'start_line' => 176,
            'indent' => 1,
            'block_id' => 13
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 178,
            'src' => ' print "not " unless $ { ^ M } eq \'Someother 3\' ;',
            'start_line' => 178,
            'indent' => 1,
            'block_id' => 13
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 191,
            'src' => ' sub T { my ( $where , $num ) = @_ ; my ( $p , $f , $l ) = caller ; print "# $p:$f:$l vs /$where/\\nnot " unless "$p:$f:$l" =~/$where/ ; print "ok $num\\n" ; }',
            'start_line' => 186,
            'indent' => 0,
            'block_id' => 0
          },
...
# line 1 "plunk"
	T(\'^main:plunk:1$\', $test++);
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 248,
            'src' => ' { my $test = 47 ; eval ( q(">@nosuch<" eq "><") ) || print "# $@" , "not " ; print "ok $test\\n" ; ++ $test ; eval ( q("fred@example.com" eq "fred.com") ) || print "# $@" , "not " ; print "ok $test\\n" ; ++ $test ; my @a = ( 1 , 2 , 3 ) ; print + ( ( ">@a<" eq ">1 2 3<" ) ? \'\' : \'not \' ) , "ok $test\\n" ; ++ $test ; eval ( q{@nosuch = (\'a\', \'b\', \'c\'); ">@nosuch<" eq ">a b c<"} ) || print "# $@" , "not " ; print "ok $test\\n" ; ++ $test ; sub makearray { my @array = ( \'fish\' , \'dog\' , \'carrot\' ) ; * R::crackers = \\ @array ; } eval ( q{makearray(); ">@R::crackers<" eq ">fish dog carrot<"} ) || print "# $@" , "not " ; print "ok $test\\n" ; ++ $test ; }',
            'start_line' => 215,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 217,
            'src' => ' eval ( q(">@nosuch<" eq "><") ) || print "# $@" , "not " ;',
            'start_line' => 217,
            'indent' => 1,
            'block_id' => 23
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 222,
            'src' => ' eval ( q("fred@example.com" eq "fred.com") ) || print "# $@" , "not " ;',
            'start_line' => 222,
            'indent' => 1,
            'block_id' => 23
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 229,
            'src' => ' print + ( ( ">@a<" eq ">1 2 3<" ) ? \'\' : \'not \' ) , "ok $test\\n" ;',
            'start_line' => 229,
            'indent' => 1,
            'block_id' => 23
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 234,
            'src' => ' eval ( q{@nosuch = (\'a\', \'b\', \'c\'); ">@nosuch<" eq ">a b c<"} ) || print "# $@" , "not " ;',
            'start_line' => 233,
            'indent' => 1,
            'block_id' => 23
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 242,
            'src' => ' sub makearray { my @array = ( \'fish\' , \'dog\' , \'carrot\' ) ; * R::crackers = \\ @array ; }',
            'start_line' => 239,
            'indent' => 1,
            'block_id' => 23
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 245,
            'src' => ' eval ( q{makearray(); ">@R::crackers<" eq ">fish dog carrot<"} ) || print "# $@" , "not " ;',
            'start_line' => 244,
            'indent' => 1,
            'block_id' => 23
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 258,
            'src' => ' my %str = ( foo => 1 , xyz::foo => 1 , xyz::bar => 1 , ) ;',
            'start_line' => 254,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 261,
            'src' => ' print ( ( exists $str { foo } ? "" : "not " ) . "ok $test\\n" ) ;',
            'start_line' => 261,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 262,
            'src' => ' print ( ( exists $str { bar } ? "" : "not " ) . "ok $test\\n" ) ;',
            'start_line' => 262,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 263,
            'src' => ' print ( ( exists $str { xyz::bar } ? "" : "not " ) . "ok $test\\n" ) ;',
            'start_line' => 263,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 269,
            'src' => ' if ( $@ =~/Unrecognized character \\\\xE2; marked by <-- HERE after \\$x =<-- HERE near column 5/ ) { print "ok $test\\n" ; }',
            'start_line' => 269,
            'indent' => 0,
            'block_id' => 0
          },
