...
# line 1 "plunk"
    ...
    ',
          ...
          bless( {
                   ...
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => 'Unrecognized character \\\\xDF; marked by <-- HERE after \\$x =<-- HERE near column 5',
                   'type' => Compiler::Lexer::TokenType::T_RegExp
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'has_warnings' => 0,
...
',
          ...
          bless( {
                   ...
                   'name' => 'String',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => 'not ok $test - s/// in s/// pattern\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0
                 }, 'Compiler::Lexer::Token' ),
...
END
          ...
          bless( {
                   'data' => 'print qq ;ok $test - eval ending with semicolon\\n;',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
          ...
          bless( {
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => 'not ok $test - eval ending with semicolon\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'line' => 316,
          ...
          bless( {
                   ...
                   'line' => 321,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => 'ok $test - here-doc in single-line re-eval\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value
                 }, 'Compiler::Lexer::Token' ),
...
END
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => 'ok $test - here-doc in quotes in multiline re-eval\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'name' => 'String',
                   'line' => 328
                 }, 'Compiler::Lexer::Token' ),
...
b"',
          ...
          bless( {
                   ...
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'data' => 'ok $test - eval \'s//<<END/\' does not leave extra newlines\\n',
                   'kind' => Compiler::Lexer::Kind::T_Term
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'type' => Compiler::Lexer::TokenType::T_SemiColon,
          ...
          bless( {
                   ...
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'data' => 'ok $test - # after null in s/// repl\\n',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'line' => 339,
                   'name' => 'String'
                 }, 'Compiler::Lexer::Token' ),
          ...
          bless( {
                   'line' => 364,
                   'name' => 'RegExp',
                   'data' => ' require goto last next redo dump ',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value
          ...
          bless( {
                   'data' => 'v23: $counter++; goto v23 unless $counter == 2',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => 'ok $test - Use v[0-9]+ as a label\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 375,
                   'name' => 'String'
                 }, 'Compiler::Lexer::Token' ),
          ...
          bless( {
                   ...
                   'name' => 'String',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => 'ok $test - Use v[0-9]+ as a label with space before colon\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value
                 }, 'Compiler::Lexer::Token' ),
          ...
          bless( {
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => 'package v10::foo; sub test2 { return \'v10::foo\' }
      package v10; sub test { return v10::foo::test2(); }
      package main; \\$output = v10::test(); ',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'has_warnings' => 0,
          ...
          bless( {
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'data' => 'ok $test - call a function in package v10::foo\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'line' => 386,
                   'name' => 'String'
          ...
          bless( {
                   'data' => 'ok $test - colon detection after vstring does not break ? vstring :\\n',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'data' => 'ok $test - print vstring prints the vstring\\n',
                   'kind' => Compiler::Lexer::Kind::T_Term
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'line' => 397,
          ...
          bless( {
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'data' => 'ok $test - q <comment> <newline> ...\\n',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 404,
                   'name' => 'String'
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'data' => 'ok $test - qq <comment> <newline> ...\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'kind' => Compiler::Lexer::Kind::T_Term
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   'line' => 412,
                   'name' => 'String',
                   'data' => 'ok $test - qw <comment> <newline> ...\\n',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value
          ...
          bless( {
                   'data' => 'ok $test - m <comment> <newline> ...\\n',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
          ...
          bless( {
                   ...
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'data' => 'ok $test - qr <comment> <newline> ...\\n',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_String
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'data' => 'ok $test - s <comment> <newline> ...\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'kind' => Compiler::Lexer::Kind::T_Term
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'line' => 434,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'data' => 'ok $test - tr <comment> <newline> ...\\n',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0
                 }, 'Compiler::Lexer::Token' ),
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'data' => 'ok $test - y <comment> <newline> ...\\n',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_String
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'data' => 'ok $test - => quotes keywords across lines\\n',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'name' => 'String',
                   'line' => 445
                 }, 'Compiler::Lexer::Token' ),
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'data' => 'ok $test - [perl #80368] qq <a\\\\U=>\\n',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_String
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   'kind' => Compiler::Lexer::Kind::T_Decl,
                   'data' => 'Function_with_side_effects',
                   'type' => Compiler::Lexer::TokenType::T_Function,
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'line' => 451,
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'data' => '${Function_with_side_effects,\\$_}',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'line' => 453,
                   'name' => 'RawString'
                 }, 'Compiler::Lexer::Token' ),
          ...
          bless( {
                   ...
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'data' => 'ok $test - \\${...} where {...} looks like hash\\n',
                   'kind' => Compiler::Lexer::Kind::T_Term
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'type' => Compiler::Lexer::TokenType::T_SemiColon,
          ...
          bless( {
                   ...
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'data' => 'ok $test - \\${...} (literal triple-dot)\\n',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'line' => 478,
                   'name' => 'String'
                 }, 'Compiler::Lexer::Token' ),
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'data' => 'ok $test - map{...} (literal triple-dot)\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'kind' => Compiler::Lexer::Kind::T_Term
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
E2
          ...
          },
          {
            ...
            'end_line' => 172,
            'token_num' => 224,
            'src' => ' { my $CX = "\\cX" ; my $CXY = "\\cXY" ; $ { $CX } = 17 ; $ { $CXY } = 23 ; if ( $ { ^ XY } != 23 ) { print "not " } print "ok $test\\n" ; $test ++ ; if ( "$^XY" ne "17Y" ) { print "not " } print "ok $test\\n" ; $test ++ ; sub XX (  ) { 6 } $ { "\\cQ\\cXX" } = 119 ; $^ Q = 5 ; $N = 5 ; if ( ( $^ Q ^ XX ) != 3 ) { print "not " } print "ok $test\\n" ; $test ++ ; eval \'my $^X;\' ; print "not " unless index ( $@ , \'Can\\\'t use global $^X in "my"\' ) > -1 ; print "ok $test\\n" ; $test ++ ; eval \'my $ {^XYZ};\' ; print "not " unless index ( $@ , \'Can\\\'t use global $^XYZ in "my"\' ) > -1 ; print "ok $test\\n" ; $test ++ ; package Someother ; $^ Q = \'Someother\' ; $ { ^ Quixote } = \'Someother 2\' ; $ { ^ M } = \'Someother 3\' ; package main ; print "not " unless $^ Q eq \'Someother\' ; print "ok $test\\n" ; $test ++ ; print "not " unless $ { ^ Quixote } eq \'Someother 2\' ; print "ok $test\\n" ; $test ++ ; print "not " unless $ { ^ M } eq \'Someother 3\' ; print "ok $test\\n" ; $test ++ ; }',
            'indent' => 0,
            'start_line' => 125,
            'block_id' => 0
          },
...
# line 1 "plunk"
	T(\'^main:plunk:1$\', $test++);
          ...
          },
          {
            ...
            'indent' => 0,
            'token_num' => 13,
            'src' => ' if ( $@ =~/Unrecognized character \\\\xDF; marked by <-- HERE after \\$x =<-- HERE near column 5/ ) { print "ok $test\\n" ; }',
            'end_line' => 257,
            'has_warnings' => 0
          },
          {
...
|e ;',
          ...
          {
            'src' => ' $_ = "not ok $test - s/// in s/// pattern\\n" ;',
            'token_num' => 4,
            'start_line' => 301,
            'indent' => 0,
            'block_id' => 0,
...
END
          ...
          {
            'src' => ' eval \'print qq ;ok $test - eval ending with semicolon\\n;\' or print "not ok $test - eval ending with semicolon\\n" ;',
            'token_num' => 6,
            'indent' => 0,
            'start_line' => 315,
            'block_id' => 0,
          ...
          },
          {
            ...
            'block_id' => 0,
            'token_num' => 10,
            'src' => ' print "not " unless qr/(?{<<END})/ eq \'(?^:(?{<<END}))\' ;',
            'end_line' => 318,
            'has_warnings' => 0
          },
          {
            ...
            'block_id' => 0,
            'indent' => 0,
            'src' => ' foo END print "ok $test - here-doc in single-line re-eval\\n" ;',
            'token_num' => 5,
            'end_line' => 321,
            'has_warnings' => 1
          },
...
END
          ...
          },
          {
            ...
            'indent' => 0,
            'block_id' => 0,
            'src' => ' print "ok $test - here-doc in quotes in multiline re-eval\\n" ;',
            'token_num' => 3
          },
          {
            'has_warnings' => 1,
...
b"\' ;'
          ...
          },
          {
            ...
            'start_line' => 334,
            'block_id' => 0,
            'src' => ' print "ok $test - eval \'s//<<END/\' does not leave extra newlines\\n" ;',
            'token_num' => 3,
            'end_line' => 334,
            'has_warnings' => 0
          },
          ...
          },
          {
            ...
            'end_line' => 338,
            'token_num' => 7,
            'src' => ' print \'not \' unless $_ eq "b\\0" ;',
            'start_line' => 338,
            'block_id' => 0,
            'indent' => 0
          },
          {
            'src' => ' print "ok $test - # after null in s/// repl\\n" ;',
            'token_num' => 3,
            'start_line' => 339,
            'block_id' => 0,
            'indent' => 0,
          ...
          },
          {
            ...
            'block_id' => 0,
            'token_num' => 5,
            'src' => ' foo END print "ok $test - s//\'#\' . <<END/e\\n" ;'
          },
          {
            'end_line' => 344,
            'has_warnings' => 1,
          ...
          },
          {
            'has_warnings' => 0,
            'end_line' => 361,
            'src' => ' print "ok $test - listop({$_ => 1} + 1)\\n" ;',
            'token_num' => 3,
            'start_line' => 361,
            'block_id' => 0,
            'indent' => 0
          ...
          },
          {
            ...
            'start_line' => 364,
            'indent' => 0,
            'src' => ' for ( qw< require goto last next redo dump > ) { eval "sub { $_ foo << 2 }" ; print "not " if $@ ; print "ok " , $test ++ , " - [perl #105924] $_ WORD << ...\\n" ; print "# $@" if $@ ; }',
            'token_num' => 30
          },
          {
            'has_warnings' => 0,
          ...
          },
          {
            ...
            'start_line' => 367,
            'indent' => 1,
            'src' => ' print "ok " , $test ++ , " - [perl #105924] $_ WORD << ...\\n" ;',
            'token_num' => 8,
            'end_line' => 367,
            'has_warnings' => 1
          },
          ...
          },
          {
            'has_warnings' => 0,
            'end_line' => 373,
            'src' => ' eval \'v23: $counter++; goto v23 unless $counter == 2\' ;',
            'token_num' => 3,
            'block_id' => 0,
            'start_line' => 373,
            'indent' => 0
          },
          {
            ...
            'indent' => 0,
            'token_num' => 7,
            'src' => ' print "not " unless $counter == 2 ;',
            'end_line' => 374,
            'has_warnings' => 1
          },
          {
            'has_warnings' => 0,
            'end_line' => 375,
            'src' => ' print "ok $test - Use v[0-9]+ as a label\\n" ;',
            'token_num' => 3,
            'start_line' => 375,
            'block_id' => 0,
            'indent' => 0
          ...
          },
          {
            'has_warnings' => 0,
            'end_line' => 379,
            'src' => ' print "ok $test - Use v[0-9]+ as a label with space before colon\\n" ;',
            'token_num' => 3,
            'indent' => 0,
            'start_line' => 379,
            'block_id' => 0
          ...
          },
          {
            ...
            'indent' => 0,
            'block_id' => 0,
            'src' => ' eval "package v10::foo; sub test2 { return \'v10::foo\' }
      package v10; sub test { return v10::foo::test2(); }
      package main; \\$output = v10::test(); " ;',
            'token_num' => 3
          },
          {
            'src' => ' print "not " unless $output eq \'v10::foo\' ;',
            'token_num' => 7,
            'start_line' => 385,
            'indent' => 0,
            'block_id' => 0,
          ...
          },
          {
            ...
            'block_id' => 0,
            'token_num' => 3,
            'src' => ' print "ok $test - call a function in package v10::foo\\n" ;',
            'end_line' => 386,
            'has_warnings' => 0
          },
          {
          ...
          },
          {
            ...
            'indent' => 0,
            'token_num' => 16,
            'src' => ' print "not " unless ( 1 ? v65 : "bar" ) eq chr ( 65 ) ;',
            'end_line' => 388,
            'has_warnings' => 1
          },
          {
            ...
            'block_id' => 0,
            'token_num' => 3,
            'src' => ' print "ok $test - colon detection after vstring does not break ? vstring :\\n" ;'
          },
          {
            'src' => ' $test ++ ;',
            'token_num' => 3,
          ...
          },
          {
            ...
            'block_id' => 0,
            'token_num' => 3,
            'src' => ' print "ok $test - print vstring prints the vstring\\n" ;',
            'end_line' => 397,
            'has_warnings' => 0
          },
          {
          ...
          },
          {
            ...
            'block_id' => 0,
            'token_num' => 3,
            'src' => ' print "ok $test - q <comment> <newline> ...\\n" ;'
          },
          {
            'token_num' => 3,
            'src' => ' $test ++ ;',
          ...
          },
          {
            ...
            'indent' => 0,
            'block_id' => 0,
            'src' => ' print "ok $test - qq <comment> <newline> ...\\n" ;',
            'token_num' => 3
          },
          {
            'has_warnings' => 1,
          ...
          },
          {
            'has_warnings' => 0,
            'end_line' => 412,
            'src' => ' print "ok $test - qw <comment> <newline> ...\\n" ;',
            'token_num' => 3,
            'block_id' => 0,
            'start_line' => 412,
            'indent' => 0
          ...
          },
          {
            ...
            'block_id' => 0,
            'token_num' => 3,
            'src' => ' print "ok $test - m <comment> <newline> ...\\n" ;'
          },
          {
            'block_id' => 0,
            'start_line' => 416,
          ...
          },
          {
            'has_warnings' => 0,
            'end_line' => 420,
            'src' => ' print "ok $test - qr <comment> <newline> ...\\n" ;',
            'token_num' => 3,
            'start_line' => 420,
            'block_id' => 0,
            'indent' => 0
          ...
          },
          {
            ...
            'block_id' => 0,
            'token_num' => 3,
            'src' => ' print "ok $test - s <comment> <newline> ...\\n" ;',
            'end_line' => 427,
            'has_warnings' => 0
          },
          {
          ...
          },
          {
            ...
            'indent' => 0,
            'token_num' => 3,
            'src' => ' print "ok $test - tr <comment> <newline> ...\\n" ;',
            'end_line' => 434,
            'has_warnings' => 0
          },
          {
          ...
          },
          {
            ...
            'indent' => 0,
            'block_id' => 0,
            'src' => ' print "ok $test - y <comment> <newline> ...\\n" ;',
            'token_num' => 3
          },
          {
            'has_warnings' => 1,
          ...
          {
            'src' => ' print "not " unless ( time => ) eq time => ;',
            'token_num' => 11,
            'block_id' => 0,
            'start_line' => 443,
            'indent' => 0,
          ...
          },
          {
            ...
            'start_line' => 445,
            'indent' => 0,
            'src' => ' print "ok $test - => quotes keywords across lines\\n" ;',
            'token_num' => 3,
            'end_line' => 445,
            'has_warnings' => 0
          },
          ...
          {
            'src' => ' print "not " unless eval \'"a\\U="\' eq "a=" ;',
            'token_num' => 8,
            'start_line' => 448,
            'block_id' => 0,
            'indent' => 0,
          ...
          },
          {
            ...
            'block_id' => 0,
            'token_num' => 3,
            'src' => ' print "ok $test - [perl #80368] qq <a\\\\U=>\\n" ;'
          },
          {
            'has_warnings' => 1,
            'end_line' => 449,
          ...
          },
          {
            ...
            'start_line' => 451,
            'indent' => 0,
            'src' => ' sub Function_with_side_effects { $_ = "sidekick function called" }',
            'token_num' => 7
          },
          {
            'token_num' => 12,
            'src' => ' print "not " unless ( eval \'${Function_with_side_effects,\\$_}\' || $@ ) eq "sidekick function called" ;',
            'block_id' => 0,
            'start_line' => 452,
            'indent' => 0,
            'has_warnings' => 0,
          ...
          },
          {
            ...
            'start_line' => 455,
            'indent' => 0,
            'src' => ' print "ok $test - \\${...} where {...} looks like hash\\n" ;',
            'token_num' => 3,
            'end_line' => 455,
            'has_warnings' => 0
          },
          ...
          {
            'src' => ' @_ = map { BEGIN { $_122782 = \'tst2\' } ; "rhu$_" } \'barb2\' ;',
            'token_num' => 15,
            'start_line' => 457,
            'indent' => 0,
            'block_id' => 0,
          ...
          },
          {
            ...
            'start_line' => 458,
            'indent' => 0,
            'src' => ' print "not " unless "@_" eq \'rhubarb2\' ;',
            'token_num' => 7,
            'end_line' => 458,
            'has_warnings' => 0
          },
          ...
          },
          {
            ...
            'end_line' => 460,
            'token_num' => 7,
            'src' => ' print "not " unless $_122782 eq \'tst2\' ;',
            'start_line' => 460,
            'block_id' => 0,
            'indent' => 0
          },
          ...
          },
          {
            ...
            'start_line' => 467,
            'block_id' => 0,
            'src' => ' print "not " unless $_ == 42 ;',
            'token_num' => 7
          },
          {
            'token_num' => 3,
            'src' => ' print "ok $test - \\${ <newline> =pod\\n" ;',
            'indent' => 0,
            'start_line' => 468,
            'block_id' => 0,
            'has_warnings' => 0,
          ...
          },
          {
            ...
            'end_line' => 475,
            'token_num' => 3,
            'src' => ' print "ok $test - map{ <newline> =pod\\n" ;',
            'start_line' => 475,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'block_id' => 0,
            'token_num' => 9,
            'src' => ' print "not " unless $@ =~/^Unimplemented at / ;'
          },
          {
            'src' => ' print "ok $test - \\${...} (literal triple-dot)\\n" ;',
            'token_num' => 3,
            'start_line' => 478,
            'block_id' => 0,
            'indent' => 0,
          ...
          },
          {
            ...
            'block_id' => 0,
            'token_num' => 3,
            'src' => ' print "ok $test - map{...} (literal triple-dot)\\n" ;'
          },
          {
            'end_line' => 481,
            'has_warnings' => 1,
