...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => '/dev/null IS NOT A CHARACTER SPECIAL FILE!!!!\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 48
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 14,
            'src' => ' elsif ( $x eq chr ( 13 ) ) { print "ok 1 # Mac OS\\n" ; }',
            'start_line' => 14,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 15,
            'src' => ' elsif ( $x eq chr ( 21 ) ) { print "ok 1 # EBCDIC\\n" ; }',
            'start_line' => 15,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 41,
            'src' => ' open ( try , "/dev/null" ) || open ( try , "nla0:" ) || ( die "Can\'t open /dev/null." ) ;',
            'start_line' => 41,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 48,
            'src' => ' die "/dev/null IS NOT A CHARACTER SPECIAL FILE!!!!\\n" unless -c \'/dev/null\' ;',
            'start_line' => 48,
            'indent' => 1,
            'block_id' => 15
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 51,
            'src' => ' open ( try , "harness" ) || ( die "Can\'t open harness." ) ;',
            'start_line' => 51,
            'indent' => 0,
            'block_id' => 0
          },
