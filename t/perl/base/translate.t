...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'block_id' => 0,
            'token_num' => 61,
            'src' => ' for my $i ( 0 .. 255 ) { my $uni = utf8::native_to_unicode ( $i ) ; if ( $uni < 0 || $uni >= 256 ) { print "not " ; } elsif ( utf8::unicode_to_native ( utf8::native_to_unicode ( $i ) ) != $i ) { print "not " ; } print "ok " ; print $i + 1 ; print "\\n" ; }',
            'end_line' => 19,
            'has_warnings' => 1
          },
          {
            ...
            'end_line' => 9,
            'token_num' => 8,
            'src' => ' my $uni = utf8::native_to_unicode ( $i ) ;',
            'start_line' => 9,
            'block_id' => 1,
            'indent' => 1
          },
          {
            ...
            'indent' => 1,
            'block_id' => 1,
            'src' => ' if ( $uni < 0 || $uni >= 256 ) { print "not " ; }',
            'token_num' => 15,
            'end_line' => 12,
            'has_warnings' => 1
          },
          ...
          {
            'src' => ' elsif ( utf8::unicode_to_native ( utf8::native_to_unicode ( $i ) ) != $i ) { print "not " ; }',
            'token_num' => 17,
            'start_line' => 13,
            'indent' => 1,
            'block_id' => 1,
          ...
          },
          {
            ...
            'block_id' => 0,
            'token_num' => 17,
            'src' => ' if ( utf8::unicode_to_native ( utf8::native_to_unicode ( 100000 ) ) != 100000 ) { print "not " ; }',
            'end_line' => 25,
            'has_warnings' => 1
          },
          {
