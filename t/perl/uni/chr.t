...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 20,
            'src' => ' for my $i ( 127 , 128 , 255 ) { ok ( chr ( $i ) eq pack ( \'C\' , $i ) ) ; }',
            'start_line' => 18,
            'indent' => 0,
            'block_id' => 0
          },
