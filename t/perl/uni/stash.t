...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'token_num' => 20,
            'indent' => 1,
            'src' => ' { use strict ; ok ( ! exists $piƓ:: { bodine } , q(referencing a non-existent stash element doesn\'t produce stricture errors) ) ; }',
            'start_line' => 49
          },
          {
            'indent' => 2,
