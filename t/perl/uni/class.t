...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'indent' => 0,
            'token_num' => 18,
            'src' => ' my $str = join "" , map { chr utf8::unicode_to_native ( $_ ) } 0x20 .. 0x6F ;'
          },
          {
            'end_line' => 13,
            'has_warnings' => 1,
          ...
          {
            'token_num' => 35,
            'src' => ' sub IsMyUniClass { my $return = "" ; for my $i ( 0x30 .. 0x4F ) { $return .= sprintf ( "%04X\\n" , utf8::unicode_to_native ( $i ) ) ; } return $return ; END }',
            'start_line' => 15,
            'block_id' => 0,
            'indent' => 0,
            'has_warnings' => 1,
          ...
          },
          {
            ...
            'block_id' => 2,
            'token_num' => 22,
            'src' => ' for my $i ( 0x30 .. 0x4F ) { $return .= sprintf ( "%04X\\n" , utf8::unicode_to_native ( $i ) ) ; }',
            'end_line' => 19,
            'has_warnings' => 1
          },
          {
          ...
          },
          {
            ...
            'block_id' => 4,
            'indent' => 1,
            'src' => ' for my $i ( 0x40 .. 0x5F ) { $return .= sprintf ( "%04X\\n" , utf8::unicode_to_native ( $i ) ) ; }',
            'token_num' => 22,
            'end_line' => 28,
            'has_warnings' => 1
          },
