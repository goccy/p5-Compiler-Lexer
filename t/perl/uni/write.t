...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'Can\'t create Uni_write.tmp',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 25
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'non-UTF8 literal / UTF8 item (1)',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 36
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'non-UTF8 literal / UTF8 item (2)',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 46
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'UTF8 literal / non-UTF8 item (1)',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 56
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'UTF8 literal / non-UTF8 item (2)',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 66
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'non-UTF8 literal / UTF8 multiline',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 76
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'UTF8 literal / non-UTF8 multiline',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 86
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'no such format, with format name in UTF-8.',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 102
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => 'Undefined top format "უデﬁᕣネḓ_ＦᚖṀŦɐȾ',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 117
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => ' Uni_write.tmp Uni_write2.tmp ',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 122
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 6,
            'src' => ' skip_all ( "EBCDIC porting needed" ) if $: : IS_EBCDIC ;',
            'start_line' => 6,
            'indent' => 1,
            'block_id' => 1
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 14,
            'src' => ' our ( $bitem1 , $uitem1 ) = ( "\\x{ff}" , "\\x{100}" ) ;',
            'start_line' => 14,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 15,
            'src' => ' our ( $bitem2 , $uitem2 ) = ( "\\x{fe}" , "\\x{101}" ) ;',
            'start_line' => 15,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 16,
            'src' => ' our ( $blite1 , $ulite1 ) = ( "\\x{fd}" , "\\x{102}" ) ;',
            'start_line' => 16,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 17,
            'src' => ' our ( $blite2 , $ulite2 ) = ( "\\x{fc}" , "\\x{103}" ) ;',
            'start_line' => 17,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 34,
            'src' => ' sub fmwrtest { no strict \'refs\' ; my ( $out , $format , $expect , $name ) = @_ ; eval "format $out =\\n$format.\\n" ; die $@ if $@ ; open $out , \'>:utf8\' , \'Uni_write.tmp\' or die "Can\'t create Uni_write.tmp" ; write $out ; close $out or die "Could not close $out: $!" ; open UIN , \'<:utf8\' , \'Uni_write.tmp\' or die "Can\'t open Uni_write.tmp" ; ; my $result = do { local $/ ; < UIN > ; } ; close UIN ; is ( $result , $expect , $name ) ; }',
            'start_line' => 21,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 23,
            'src' => ' my ( $out , $format , $expect , $name ) = @_ ;',
            'start_line' => 23,
            'indent' => 1,
            'block_id' => 2
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 25,
            'src' => ' open $out , \'>:utf8\' , \'Uni_write.tmp\' or die "Can\'t create Uni_write.tmp" ;',
            'start_line' => 25,
            'indent' => 1,
            'block_id' => 2
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 27,
            'src' => ' close $out or die "Could not close $out: $!" ;',
            'start_line' => 27,
            'indent' => 1,
            'block_id' => 2
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 29,
            'src' => ' open UIN , \'<:utf8\' , \'Uni_write.tmp\' or die "Can\'t open Uni_write.tmp" ;',
            'start_line' => 29,
            'indent' => 1,
            'block_id' => 2
          },
...
$blite1
$umulti$blite2
} , "non-UTF8 literal / UTF8 multiline" ;',
            'start_line' => 76,
            'indent' => 0,
            'block_id' => 0
          },
...
$ulite1
$bmulti$blite2
} , "UTF8 literal / non-UTF8 multiline" ;',
            'start_line' => 86,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 103,
            'src' => ' { use utf8 ; use open qw( :utf8 :std ) ; local $~ = "놋웇ʱＦᚖṀŦ" ; eval { write } ; like $@ , qr/Undefined format "놋웇ʱＦᚖṀŦ/u , \'no such format, with format name in UTF-8.\' ; }',
            'start_line' => 96,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 102,
            'src' => ' like $@ , qr/Undefined format "놋웇ʱＦᚖṀŦ/u , \'no such format, with format name in UTF-8.\' ;',
            'start_line' => 102,
            'indent' => 1,
            'block_id' => 4
          },
 ...
 . use utf8 ; use open qw( :utf8 :std ) ; open OUT , \'>\' , \'Uni_write2.tmp\' ; my $oldfh = select OUT ; local $^ = "უデﬁᕣネḓ_ＦᚖṀŦɐȾ" ; eval { write } ; like $@ , qr/Undefined top format "უデﬁᕣネḓ_ＦᚖṀŦɐȾ/u , \'no such top format\' ; select $oldfh ; close OUT ; }',
            'start_line' => 105,
            'indent' => 0,
            'block_id' => 0
          },
 ...
 . use utf8 ;',
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 117,
            'src' => ' like $@ , qr/Undefined top format "უデﬁᕣネḓ_ＦᚖṀŦɐȾ/u , \'no such top format\' ;',
            'start_line' => 117,
            'indent' => 1,
            'block_id' => 5
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 122,
            'src' => ' unlink_all qw( Uni_write.tmp Uni_write2.tmp ) ;',
            'start_line' => 122,
            'indent' => 0,
            'block_id' => 0
          }
