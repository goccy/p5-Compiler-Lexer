...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => 'ucfirst_with_appended_null_arg',
                   'name' => 'Key'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'data' => '=>',
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'block_id' => 0,
            'indent' => 0,
            'src' => ' casetest ( 0 , "Titlecase_Mapping" , ucfirst => sub { ucfirst $_ [ 0 ] } , ucfirst_with_appended_null_arg => sub { my $a = "" ; ucfirst ( $_ [ 0 ] . $a ) } ) ;',
            'start_line' => 12
          },
          {
            'end_line' => 14,
