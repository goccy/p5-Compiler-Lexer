...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'data' => 'Can\'t locate object method "n${e_with_grave}w" via package "Føø::Bær"',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'kind' => Compiler::Lexer::Kind::T_Term
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'indent' => 1,
            'token_num' => 7,
            'src' => ' @INC = qw(. ../lib ../cpan/parent/lib) ;'
          },
          {
            'end_line' => 10,
            'has_warnings' => 0,
          ...
          },
          {
            ...
            'end_line' => 114,
            'token_num' => 8,
            'src' => ' my $e_with_grave = byte_utf8a_to_utf8n ( "\\303\\250" ) ;',
            'block_id' => 0,
            'start_line' => 114,
            'indent' => 0
          },
          {
            ...
            'end_line' => 115,
            'token_num' => 5,
            'src' => ' my $new_utf8 = "n${e_with_grave}w" ;',
            'start_line' => 115,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'end_line' => 116,
            'token_num' => 5,
            'src' => ' my $newoct = "n${e_with_grave}w" ;',
            'start_line' => 116,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'block_id' => 0,
            'token_num' => 25,
            'src' => ' { local $@ ; eval { Føø::Bær-> $newoct } ; like ( $@ , qr/Can\'t locate object method "n${e_with_grave}w" via package "Føø::Bær"/u , "Can\'t access [$newoct], stored in a scalar, as a method through a UTF-8 package." ) ; }'
          },
          {
            'end_line' => 123,
            'has_warnings' => 0,
          ...
          },
          {
            ...
            'start_line' => 125,
            'block_id' => 11,
            'src' => ' like ( $@ , qr/Can\'t locate object method "n${e_with_grave}w" via package "Føø::Bær"/u , "Can\'t access [$newoct], stored in a scalar, as a method through a UTF-8 package." ) ;',
            'token_num' => 13,
            'end_line' => 125,
            'has_warnings' => 1
          },
          ...
          },
          {
            ...
            'end_line' => 143,
            'token_num' => 25,
            'src' => ' { local $@ ; eval { $pkg_latin_1-> $newoct } ; like ( $@ , qr/Can\'t locate object method "n${e_with_grave}w" via package "Føø::Bær"/u , "Can\'t access [$newoct], stored in a scalar, as a method, when the UTF-8 package name is also in a scalar." ) ; }',
            'start_line' => 139,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          {
            'src' => ' like ( $@ , qr/Can\'t locate object method "n${e_with_grave}w" via package "Føø::Bær"/u , "Can\'t access [$newoct], stored in a scalar, as a method, when the UTF-8 package name is also in a scalar." ) ;',
            'token_num' => 13,
            'start_line' => 142,
            'block_id' => 12,
            'indent' => 1,
          ...
          },
          {
            ...
            'block_id' => 20,
            'token_num' => 33,
            'src' => ' sub AUTOLOAD { if ( $: : IS_ASCII ) { :: is our $AUTOLOAD , "\\xff::\\x{100}" , \'$AUTOLOAD made from Latin1 package + UTF8 sub\' ; } else { :: is our $AUTOLOAD , "\\xdf::\\x{100}" , \'$AUTOLOAD made from Latin1 package + UTF8 sub\' ; } }',
            'end_line' => 201,
            'has_warnings' => 1
          },
          {
            ...
            'end_line' => 196,
            'token_num' => 17,
            'src' => ' if ( $: : IS_ASCII ) { :: is our $AUTOLOAD , "\\xff::\\x{100}" , \'$AUTOLOAD made from Latin1 package + UTF8 sub\' ; }',
            'indent' => 2,
            'start_line' => 193,
            'block_id' => 21
          },
          ...
          },
          {
            ...
            'start_line' => 197,
            'indent' => 2,
            'src' => ' else { :: is our $AUTOLOAD , "\\xdf::\\x{100}" , \'$AUTOLOAD made from Latin1 package + UTF8 sub\' ; }',
            'token_num' => 12,
            'end_line' => 200,
            'has_warnings' => 1
          },
          {
            'src' => ' :: is our $AUTOLOAD , "\\xdf::\\x{100}" , \'$AUTOLOAD made from Latin1 package + UTF8 sub\' ;',
            'token_num' => 9,
            'start_line' => 198,
            'block_id' => 23,
            'indent' => 3,
