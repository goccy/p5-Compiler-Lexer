...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegReplaceFrom',
                   'data' => 'bcdeghijklmnprstvwxyz$02578',
                   'type' => Compiler::Lexer::TokenType::T_RegReplaceFrom,
                   'line' => 47
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegReplaceTo',
                   'data' => 'בצדעגהיײקלמנפּרסטװשכיזשױתײחא',
                   'type' => Compiler::Lexer::TokenType::T_RegReplaceTo,
                   'line' => 47
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'aבצדעfגהיײקלמנoפqּרסuטװשכיזש1ױ34ת6ײח9',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 48
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => 'Gebääääääääääääääääääääude',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 53
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 49,
            'src' => ' { my $line = \'abcdefghijklmnopqrstuvwxyz$0123456789\' ; $line =~ tr/bcdeghijklmnprstvwxyz$02578/בצדעגהיײקלמנפּרסטװשכיזשױתײחא/ ; is ( $line , "aבצדעfגהיײקלמנoפqּרסuטװשכיזש1ױ34ת6ײח9" , "[perl #16843]" ) ; }',
            'start_line' => 44,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 46,
            'src' => ' my $line = \'abcdefghijklmnopqrstuvwxyz$0123456789\' ;',
            'start_line' => 46,
            'indent' => 1,
            'block_id' => 2
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 47,
            'src' => ' $line =~ tr/bcdeghijklmnprstvwxyz$02578/בצדעגהיײקלמנפּרסטװשכיזשױתײחא/ ;',
            'start_line' => 47,
            'indent' => 1,
            'block_id' => 2
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 48,
            'src' => ' is ( $line , "aבצדעfגהיײקלמנoפqּרסuטװשכיזש1ױ34ת6ײח9" , "[perl #16843]" ) ;',
            'start_line' => 48,
            'indent' => 1,
            'block_id' => 2
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 56,
            'src' => ' { my $str = qq/Gebääääääääääääääääääääude/ ; my $reg = qr/Gebääääääääääääääääääääude/ ; ok ( $str =~/$reg/ , "[perl #40641]" ) ; }',
            'start_line' => 51,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 53,
            'src' => ' my $str = qq/Gebääääääääääääääääääääude/ ;',
            'start_line' => 53,
            'indent' => 1,
            'block_id' => 3
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 54,
            'src' => ' my $reg = qr/Gebääääääääääääääääääääude/ ;',
            'start_line' => 54,
            'indent' => 1,
            'block_id' => 3
          },
