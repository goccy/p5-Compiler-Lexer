...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => 'בצדעגהיײקלמנפּרסטװשכיזשױתײח',
                   'type' => Compiler::Lexer::TokenType::T_RegReplaceTo
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'name' => 'RegDelim',
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'block_id' => 0,
            'indent' => 0,
            'src' => ' { my $line = \'abcdefghijklmnopqrstuvwxyz$0123456789\' ; $line =~ tr/bcdeghijklmnprstvwxyz$02578/בצדעגהיײקלמנפּרסטװשכיזשױתײח/ ; is ( $line , "aבצדעfגהיײקלמנoפqּרסuטװשכיזש1ױ34ת6ײח9" , "[perl #16843]" ) ; }',
            'token_num' => 25,
            'end_line' => 51,
            'has_warnings' => 1
          },
          ...
          },
          {
            ...
            'block_id' => 2,
            'token_num' => 9,
            'src' => ' $line =~ tr/bcdeghijklmnprstvwxyz$02578/בצדעגהיײקלמנפּרסטװשכיזשױתײח/ ;'
          },
          {
            'end_line' => 50,
            'has_warnings' => 1,
