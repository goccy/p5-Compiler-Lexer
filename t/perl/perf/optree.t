...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
      ...
      ',
          ...
          bless( {
                   'name' => 'RawString',
                   'data' => 'single scalar on RHS, no AGG',
                   'line' => 75,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
          ...
          bless( {
                   'name' => 'String',
                   'data' => 'aassign eval(\'$code\') failed: this test needs to be rewritten:\\n',
                   'line' => 81,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_String,
          ...
          bless( {
                   'data' => 'Expected aassign but found ',
                   'name' => 'String',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'has_warnings' => 0,
          ...
          bless( {
                   'data' => '; this test needs to be rewritten',
                   'name' => 'String',
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_String,
          ...
          bless( {
                   ...
                   'line' => 93,
                   'name' => 'String',
                   'data' => 'OPpASSIGN_COMMON: $desc: \'$code\''
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'data' => ';',
                   'name' => 'SemiColon',
          ...
          bless( {
                   ...
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'data' => 'join($sep, \\$scalar) optimised to stringify',
                   'name' => 'String'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'name' => 'SemiColon',
          ...
          bless( {
                   ...
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => 'list+pushmark in list context where list\'s elder sibling is a null',
                   'name' => 'String'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
          ...
          bless( {
                   ...
                   'line' => 135,
                   'name' => 'RawString',
                   'data' => 'multiple nextstates become one'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'data' => ';',
                   'name' => 'SemiColon',
          ...
          bless( {
                   'data' => 'pad[ahs]v state declarations in void context',
                   'name' => 'RawString',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   'data' => 'nextstate padrange refgen leavesub',
                   'name' => 'String',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   'name' => 'RawString',
                   'data' => 'rv2[ahs]v in void context',
                   'line' => 160,
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
          ...
          bless( {
                   'data' => '$tn = split swallows up the assignment',
                   'name' => 'String',
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_String,
          ...
          bless( {
                   'data' => 'qq"@_" optimised from stringify(join(...)) to join(...)',
                   'name' => 'RawString',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'has_warnings' => 0,
    ...
    is_deeply($stmts, [
         ...
         OPpASSIGN_COMMON_AGG
          ...
          },
          {
            ...
            'token_num' => 11,
            'start_line' => 78,
            'src' => ' my ( $exp , $code , $desc ) = @$test ;',
            'indent' => 1
          },
          {
            'start_line' => 79,
            'indent' => 1,
            'src' => ' my $sub = eval "sub { $code }" or die "aassign eval(\'$code\') failed: this test needs to be rewritten:\\n" . $@ ;',
            'token_num' => 11,
            'block_id' => 2,
            'has_warnings' => 0,
            'end_line' => 82
          },
          {
            ...
            'start_line' => 84,
            'indent' => 1,
            'src' => ' my $last_expr = svref_2object ( $sub )-> ROOT-> first-> last ;'
          },
          {
            'start_line' => 85,
            'src' => ' if ( $last_expr-> name ne \'aassign\' ) { die "Expected aassign but found " , $last_expr-> name , "; this test needs to be rewritten" }',
            'indent' => 1,
            'has_warnings' => 1,
            'end_line' => 88,
            'token_num' => 18,
          ...
          {
            'src' => ' my $got = ( ( $last_expr-> private & OPpASSIGN_COMMON_SCALAR ) ? \'S\' : \'-\' ) . ( ( $last_expr-> private & OPpASSIGN_COMMON_RC1 ) ? \'R\' : \'-\' ) . ( ( $last_expr-> private & OPpASSIGN_COMMON_AGG ) ? \'A\' : \'-\' ) ;',
            'indent' => 1,
            'start_line' => 89,
            'end_line' => 92,
            'has_warnings' => 1,
          ...
          },
          {
            ...
            'end_line' => 93,
            'indent' => 1,
            'src' => ' is $got , $exp , "OPpASSIGN_COMMON: $desc: \'$code\'" ;',
            'start_line' => 93
          },
          {
            'token_num' => 76,
            ...
            'end_line' => 107,
            'has_warnings' => 1,
            'src' => ' for ( [ \'CONSTANT\' , sub { join "foo" , $_ } ] , [ \'$var\' , sub { join $_ , $_ } ] , [ \'$myvar\' , sub { my $var ; join $var , $_ } ] , ) { my ( $sep , $sub ) = @$_ ; my $last_expr = svref_2object ( $sub )-> ROOT-> first-> last ; is $last_expr-> name , \'stringify\' , "join($sep, \\$scalar) optimised to stringify" ; }',
            'indent' => 0,
            'start_line' => 99
          },
          {
          ...
          },
          {
            ...
            'end_line' => 106,
            'indent' => 1,
            'src' => ' is $last_expr-> name , \'stringify\' , "join($sep, \\$scalar) optimised to stringify" ;',
            'start_line' => 105
          },
          {
            'end_line' => 119,
            ...
            'start_line' => 109,
            'indent' => 0,
            'src' => ' for ( [ \'CONSTANT\' , sub { join "foo" , "bar" } , 0 , "bar" ] , [ \'CONSTANT\' , sub { join "foo" , "bar" , 3 } , 1 , "barfoo3" ] , [ \'$var\' , sub { join $_ , "bar" } , 0 , "bar" ] , [ \'$myvar\' , sub { my $var ; join $var , "bar" } , 0 , "bar" ] , ) { my ( $sep , $sub , $is_list , $expect ) = @$_ ; my $last_expr = svref_2object ( $sub )-> ROOT-> first-> last ; my $tn = "join($sep, " . ( $is_list ? \'list of constants\' : \'const\' ) . ")" ; is $last_expr-> name , \'const\' , "$tn optimised to constant" ; is $sub-> ( ) , $expect , "$tn folded correctly" ; }'
          },
          {
            'end_line' => 112,
            'has_warnings' => 0,
          ...
          {
            'src' => ' my ( $sep , $sub , $is_list , $expect ) = @$_ ;',
            'indent' => 1,
            'start_line' => 114,
            'has_warnings' => 1,
            'end_line' => 114,
          ...
          {
            'start_line' => 116,
            'src' => ' my $tn = "join($sep, " . ( $is_list ? \'list of constants\' : \'const\' ) . ")" ;',
            'indent' => 1,
            'has_warnings' => 1,
            'end_line' => 116,
            'block_id' => 12,
          ...
          },
          {
            ...
            'start_line' => 117,
            'indent' => 1,
            'src' => ' is $last_expr-> name , \'const\' , "$tn optimised to constant" ;'
          },
          {
            'start_line' => 118,
            'src' => ' is $sub-> ( ) , $expect , "$tn folded correctly" ;',
            'indent' => 1,
            'token_num' => 10,
            'block_id' => 12,
            'end_line' => 118,
          ...
          },
          {
            'start_line' => 123,
            'indent' => 0,
            'src' => ' is svref_2object ( sub { ( ) = ( $_ , ( $_ , $_ ) ) } )-> START-> next-> next-> next-> name , \'gvsv\' , "list+pushmark in list context where list\'s elder sibling is a null" ;',
            'end_line' => 129,
            'has_warnings' => 1,
            'token_num' => 34,
            'block_id' => 0
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'indent' => 0,
            'src' => ' is svref_2object ( sub { 0 ; 0 ; 0 ; 0 ; 0 ; 0 ; time } )-> START-> next-> name , \'time\' , \'multiple nextstates become one\' ;',
            'start_line' => 134
          },
          {
            'start_line' => 134,
            'src' => ' sub { 0 ; 0 ; 0 ; 0 ; 0 ; 0 ; time }',
            'indent' => 0,
            'has_warnings' => 0,
            'end_line' => 134,
            'token_num' => 16,
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 142,
            'src' => ' is svref_2object ( sub { state ( $foo , @fit , %far ) ; state $bar ; state ( $a , $b ) ; time } )-> START-> next-> name , \'time\' , \'pad[ahs]v state declarations in void context\' ;',
            'indent' => 0,
            'start_line' => 140
          },
          {
            'start_line' => 140,
            'src' => ' sub { state ( $foo , @fit , %far ) ; state $bar ; state ( $a , $b ) ; time }',
            'indent' => 0,
            'token_num' => 23,
            'block_id' => 14,
            'has_warnings' => 1,
          ...
          },
          {
            ...
            'token_num' => 54,
            'start_line' => 147,
            'src' => ' { my @ops ; my $sub = sub { \\ my ( $f , @f , %f ) } ; my $op = svref_2object ( $sub )-> START ; push ( @ops , $op-> name ) , $op = $op-> next while $$op ; is "@ops" , "nextstate padrange refgen leavesub" , \'multi-type padrange\' }',
            'indent' => 0
          },
          {
            'end_line' => 148,
          ...
          },
          {
            'start_line' => 150,
            'indent' => 1,
            'src' => ' my $op = svref_2object ( $sub )-> START ;',
            'block_id' => 16,
            'token_num' => 10,
            'has_warnings' => 1,
            'end_line' => 150
          ...
          {
            'start_line' => 151,
            'src' => ' push ( @ops , $op-> name ) , $op = $op-> next while $$op ;',
            'indent' => 1,
            'token_num' => 17,
            'block_id' => 16,
            'end_line' => 151,
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'start_line' => 158,
            'src' => ' is svref_2object ( sub { our ( $foo , @fit , %far ) ; our $bar ; our ( $a , $b ) ; time } )-> START-> next-> name , \'time\' , \'rv2[ahs]v in void context\' ;',
            'indent' => 0
          },
          {
            'src' => ' sub { our ( $foo , @fit , %far ) ; our $bar ; our ( $a , $b ) ; time }',
            'indent' => 0,
            'start_line' => 158,
            'end_line' => 158,
            'has_warnings' => 1,
          ...
          {
            'start_line' => 165,
            'src' => ' for ( [ \'@pkgary\' , \'@_\' ] , [ \'@lexary\' , \'my @a; @a\' ] , [ \'my(@array)\' , \'my(@a)\' ] , [ \'local(@array)\' , \'local(@_)\' ] , [ \'@{...}\' , \'@{\\@_}\' ] , ) { my ( $tn , $code ) = @$_ ; my $sub = eval "sub { $code = split }" ; my $split = svref_2object ( $sub )-> ROOT-> first-> last ; is $split-> name , \'split\' , "$tn = split swallows up the assignment" ; }',
            'indent' => 0,
            'has_warnings' => 1,
            'end_line' => 175,
            'block_id' => 0,
          ...
          {
            'src' => ' my $sub = eval "sub { $code = split }" ;',
            'indent' => 1,
            'start_line' => 172,
            'block_id' => 19,
            'token_num' => 6,
          ...
          },
          {
            ...
            'block_id' => 19,
            'start_line' => 173,
            'src' => ' my $split = svref_2object ( $sub )-> ROOT-> first-> last ;',
            'indent' => 1
          },
          {
            'block_id' => 19,
            ...
            'end_line' => 174,
            'has_warnings' => 1,
            'src' => ' is $split-> name , \'split\' , "$tn = split swallows up the assignment" ;',
            'indent' => 1,
            'start_line' => 174
          },
          {
            'start_line' => 179,
            'src' => ' is svref_2object ( sub { "@_" } )-> ROOT-> first-> last-> name , \'join\' , \'qq"@_" optimised from stringify(join(...)) to join(...)\' ;',
            'indent' => 0,
            'token_num' => 21,
            'block_id' => 0,
            'end_line' => 180,
