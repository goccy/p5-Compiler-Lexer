...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   'data' => 'No Scalar::Util under miniperl',
                   'name' => 'String',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
          ...
          bless( {
                   'data' => 'performance issue only when tainted',
                   'name' => 'String',
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'kind' => Compiler::Lexer::Kind::T_Term,
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'token_num' => 5,
            'block_id' => 1,
            'src' => ' skip_all_if_miniperl ( "No Scalar::Util under miniperl" ) ;',
            'indent' => 1,
            'start_line' => 22
          },
          {
          ...
          },
          {
            ...
            'token_num' => 7,
            'start_line' => 27,
            'src' => ' use Scalar::Util qw(tainted) ;',
            'indent' => 0
          },
          {
            'token_num' => 4,
          ...
          },
          {
            ...
            'start_line' => 35,
            'indent' => 0,
            'src' => ' { my $in = substr ( $ENV { PATH } , 0 , 0 ) . ( "ab" x 200_000 ) ; utf8::upgrade ( $in ) ; ok ( tainted ( $in ) , "performance issue only when tainted" ) ; while ( $in =~/\\Ga+b/g ) { } pass ( "\\\\G on tainted string" ) ; }'
          },
          {
            'start_line' => 36,
            'indent' => 1,
            'src' => ' my $in = substr ( $ENV { PATH } , 0 , 0 ) . ( "ab" x 200_000 ) ;',
            'end_line' => 36,
            'has_warnings' => 1,
            'token_num' => 21,
            'block_id' => 2
          ...
          {
            'src' => ' ok ( tainted ( $in ) , "performance issue only when tainted" ) ;',
            'indent' => 1,
            'start_line' => 38,
            'end_line' => 38,
            'has_warnings' => 1,
          ...
          },
          {
            'start_line' => 39,
            'indent' => 1,
            'src' => ' while ( $in =~/\\Ga+b/g ) { } pass ( "\\\\G on tainted string" ) ;',
            'block_id' => 2,
            'token_num' => 16,
            'end_line' => 40,
            'has_warnings' => 1
