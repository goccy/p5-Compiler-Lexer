...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   'data' => 'didn\'t block on waitpid(0, ...)',
                   'name' => 'String',
                   'line' => 36,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'end_line' => 11,
            'start_line' => 10,
            'src' => ' skip_all ( \'no Errno\' ) unless eval \'use Errno qw(EINVAL); 1\' ;',
            'indent' => 1
          },
          {
            'start_line' => 12,
            'indent' => 1,
            'src' => ' skip_all ( \'no POSIX\' ) unless eval \'use POSIX qw(WNOHANG); 1\' ;',
            'end_line' => 13,
            'has_warnings' => 1,
            'block_id' => 1,
            'token_num' => 8
          ...
          {
            'src' => ' { $! = EINVAL ; my $pid = waitpid ( 0 , WNOHANG ) ; pass ( "didn\'t block on waitpid(0, ...)" ) ; }',
            'indent' => 0,
            'start_line' => 19,
            'has_warnings' => 1,
            'end_line' => 37,
          ...
          },
          {
            ...
            'start_line' => 23,
            'indent' => 1,
            'src' => ' my $pid = waitpid ( 0 , WNOHANG ) ;'
          },
          {
            'src' => ' pass ( "didn\'t block on waitpid(0, ...)" ) ;',
            'indent' => 1,
            'start_line' => 36,
            'block_id' => 2,
            'token_num' => 5,
