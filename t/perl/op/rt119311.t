...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'data' => 'die triggering DESTROY that calls outer sub',
                   'name' => 'RawString'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'line' => 44,
          ...
          bless( {
                   'name' => 'RawString',
                   'data' => 'last triggering DESTROY that calls outer sub',
                   'line' => 48,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   'data' => 'next triggering DESTROY that calls outer sub',
                   'name' => 'RawString',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'has_warnings' => 0,
          ...
          bless( {
                   ...
                   'line' => 56,
                   'name' => 'RawString',
                   'data' => 'redo triggering DESTROY that calls outer sub'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'data' => ';',
                   'name' => 'SemiColon',
          ...
          bless( {
                   'name' => 'RawString',
                   'data' => 'goto triggering DESTROY that calls outer sub',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
          ...
          bless( {
                   ...
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => 'exit triggering DESTROY that calls outer sub',
                   'name' => 'RawString'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'line' => 64,
          ...
          bless( {
                   'data' => 'die triggering DESTROY that calls current sub',
                   'name' => 'RawString',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
          ...
          bless( {
                   'data' => 'last triggering DESTROY that calls current sub',
                   'name' => 'RawString',
                   'line' => 92,
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
          ...
          bless( {
                   'name' => 'RawString',
                   'data' => 'next triggering DESTROY that calls current sub',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   ...
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'name' => 'RawString',
                   'data' => 'redo triggering DESTROY that calls current sub'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'name' => 'SemiColon',
                   'data' => ';',
          ...
          bless( {
                   'data' => 'goto triggering DESTROY that calls current sub',
                   'name' => 'RawString',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   'name' => 'RawString',
                   'data' => 'exit triggering DESTROY that calls current sub',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
...
',
          ...
          bless( {
                   ...
                   'line' => 143,
                   'name' => 'RawString',
                   'data' => 'die triggering DESTROY that calls outer format'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'data' => ';',
                   'name' => 'SemiColon',
...
',
          ...
          bless( {
                   ...
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'line' => 151,
                   'data' => 'last triggering DESTROY that calls outer format',
                   'name' => 'RawString'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'line' => 151,
...
'
          ...
          bless( {
                   ...
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'line' => 159,
                   'data' => 'next triggering DESTROY that calls outer format',
                   'name' => 'RawString'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'has_warnings' => 0,
...
',
          ...
          bless( {
                   'data' => 'redo triggering DESTROY that calls outer format',
                   'name' => 'RawString',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
...
'
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'line' => 186,
                   'data' => 'exit triggering DESTROY that calls outer format',
                   'name' => 'RawString'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'data' => '}',
...
'
          ...
          bless( {
                   'name' => 'RawString',
                   'data' => 'die triggering DESTROY directly inside format',
                   'line' => 216,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
          ...
          bless( {
                   'name' => 'RawString',
                   'data' => 'last triggering DESTROY directly inside format',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   ...
                   'line' => 224,
                   'name' => 'RawString',
                   'data' => 'next triggering DESTROY directly inside format'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'data' => ';',
                   'name' => 'SemiColon',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'redo triggering DESTROY directly inside format'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'line' => 229,
                   'kind' => Compiler::Lexer::Kind::T_StmtEnd,
          ...
          bless( {
                   ...
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'name' => 'RawString',
                   'data' => 'exit triggering DESTROY directly inside format'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'line' => 236,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            'start_line' => 28,
            'indent' => 0,
            'src' => ' sub foo { my ( $block ) = @_ ; my $got ; $_ = $got ? "this is clearly a bug" : "ok" ; $got = 1 ; $block-> ( ) ; }',
            'token_num' => 31,
            'block_id' => 0,
            'has_warnings' => 1,
            'end_line' => 37
          ...
          {
            'indent' => 1,
            'src' => ' $_ = $got ? "this is clearly a bug" : "ok" ;',
            'start_line' => 32,
            'end_line' => 32,
            'has_warnings' => 1,
            'block_id' => 2,
          ...
          },
          {
            ...
            'end_line' => 43,
            'has_warnings' => 0,
            'src' => ' eval { foo ( sub { my $o = bless { } , \'Foo\' ; die } ) } ;',
            'indent' => 0,
            'start_line' => 43
          },
          {
            'indent' => 0,
            'src' => ' sub { my $o = bless { } , \'Foo\' ; die }',
            'start_line' => 43,
            'end_line' => 43,
            'has_warnings' => 0,
            'block_id' => 3,
          ...
          },
          {
            ...
            'block_id' => 0,
            'token_num' => 7,
            'src' => ' is $_ , "ok" , \'die triggering DESTROY that calls outer sub\' ;',
            'indent' => 0,
            'start_line' => 44
          },
          {
          ...
          {
            'indent' => 0,
            'src' => ' { foo ( sub { my $o = bless { } , \'Foo\' ; last } ) }',
            'start_line' => 47,
            'has_warnings' => 0,
            'end_line' => 47,
            'token_num' => 18,
          ...
          },
          {
            ...
            'token_num' => 7,
            'indent' => 0,
            'src' => ' is $_ , "ok" , \'last triggering DESTROY that calls outer sub\' ;',
            'start_line' => 48
          },
          {
            'end_line' => 50,
          ...
          },
          {
            ...
            'block_id' => 0,
            'indent' => 0,
            'src' => ' { foo ( sub { my $o = bless { } , \'Foo\' ; next } ) }',
            'start_line' => 51
          },
          {
            'token_num' => 13,
          ...
          },
          {
            ...
            'end_line' => 52,
            'has_warnings' => 1,
            'src' => ' is $_ , "ok" , \'next triggering DESTROY that calls outer sub\' ;',
            'indent' => 0,
            'start_line' => 52
          },
          {
          ...
          {
            'indent' => 0,
            'src' => ' { if ( ! $count ++ ) { foo ( sub { my $o = bless { } , \'Foo\' ; redo } ) } }',
            'start_line' => 55,
            'end_line' => 55,
            'has_warnings' => 1,
            'token_num' => 26,
          ...
          {
            'indent' => 0,
            'src' => ' is $_ , "ok" , \'redo triggering DESTROY that calls outer sub\' ;',
            'start_line' => 56,
            'block_id' => 0,
            'token_num' => 7,
            'end_line' => 56,
          ...
          },
          {
            ...
            'end_line' => 59,
            'has_warnings' => 1,
            'src' => ' foo ( sub { my $o = bless { } , \'Foo\' ; goto test } ) ;',
            'indent' => 0,
            'start_line' => 59
          },
          {
            ...
            'end_line' => 59,
            'start_line' => 59,
            'src' => ' sub { my $o = bless { } , \'Foo\' ; goto test }',
            'indent' => 0
          },
          {
            'start_line' => 59,
          ...
          },
          {
            ...
            'token_num' => 9,
            'block_id' => 0,
            'src' => ' test : is $_ , "ok" , \'goto triggering DESTROY that calls outer sub\' ;',
            'indent' => 0,
            'start_line' => 60
          },
          {
            ...
            'end_line' => 64,
            'indent' => 0,
            'src' => ' sub END { is $_ , "ok" , \'exit triggering DESTROY that calls outer sub\' }',
            'start_line' => 64
          },
          {
            'block_id' => 0,
            ...
            'end_line' => 65,
            'has_warnings' => 0,
            'src' => ' sub END { undef $_ ; foo ( sub { my $o = bless { } , \'Foo\' ; exit } ) ; }',
            'indent' => 0,
            'start_line' => 65
          },
          {
          ...
          },
          {
            ...
            'end_line' => 65,
            'start_line' => 65,
            'src' => ' foo ( sub { my $o = bless { } , \'Foo\' ; exit } ) ;',
            'indent' => 1
          },
          {
            'block_id' => 14,
          ...
          {
            'src' => ' sub bar { my ( $block ) = @_ ; my $got ; $_ = $got ? "this is clearly a bug" : "ok" ; $got = 1 ; my $o ; if ( $block ) { $o = bless { } , "Bar" ; $block-> ( ) ; } }',
            'indent' => 0,
            'start_line' => 68,
            'block_id' => 0,
            'token_num' => 48,
          ...
          },
          {
            ...
            'end_line' => 80,
            'start_line' => 77,
            'src' => ' if ( $block ) { $o = bless { } , "Bar" ; $block-> ( ) ; }',
            'indent' => 1
          },
          {
            'start_line' => 78,
          ...
          },
          {
            ...
            'block_id' => 0,
            'indent' => 0,
            'src' => ' is $_ , "ok" , \'die triggering DESTROY that calls current sub\' ;',
            'start_line' => 88
          },
          {
            'start_line' => 90,
          ...
          },
          {
            ...
            'block_id' => 0,
            'token_num' => 7,
            'src' => ' is $_ , "ok" , \'last triggering DESTROY that calls current sub\' ;',
            'indent' => 0,
            'start_line' => 92
          },
          {
          ...
          {
            'src' => ' is $_ , "ok" , \'next triggering DESTROY that calls current sub\' ;',
            'indent' => 0,
            'start_line' => 96,
            'token_num' => 7,
            'block_id' => 0,
          ...
          {
            'src' => ' is $_ , "ok" , \'redo triggering DESTROY that calls current sub\' ;',
            'indent' => 0,
            'start_line' => 101,
            'token_num' => 7,
            'block_id' => 0,
          ...
          },
          {
            ...
            'end_line' => 106,
            'indent' => 0,
            'src' => ' test2 : is $_ , "ok" , \'goto triggering DESTROY that calls current sub\' ;',
            'start_line' => 105
          },
          {
            'start_line' => 108,
            'src' => ' sub END { is $_ , "ok" , \'exit triggering DESTROY that calls current sub\' }',
            'indent' => 0,
            'block_id' => 0,
            'token_num' => 10,
            'end_line' => 108,
          ...
          },
          {
            ...
            'block_id' => 0,
            'start_line' => 109,
            'src' => ' sub END { undef $_ ; bar ( sub { exit } ) }',
            'indent' => 0
          },
          {
            'block_id' => 29,
...
{ my $o = bless {}, \'Foomat\'; die }
 . undef $_ ;',
          ...
          },
          {
            ...
            'block_id' => 0,
            'indent' => 0,
            'src' => ' eval { local $inner_format = \'inner_die\' ; write } ;',
            'start_line' => 142
          },
          {
            'start_line' => 142,
            'src' => ' local $inner_format = \'inner_die\' ;',
            'indent' => 0,
            'token_num' => 5,
            'block_id' => 31,
            'has_warnings' => 1,
          ...
          },
          {
            'start_line' => 143,
            'indent' => 0,
            'src' => ' is $_ , "ok" , \'die triggering DESTROY that calls outer format\' ;',
            'block_id' => 0,
            'token_num' => 7,
            'end_line' => 143,
            'has_warnings' => 1
...
{ my $o = bless {}, \'Foomat\'; last LAST }
 . undef $_ ;',
          ...
          },
          {
            ...
            'block_id' => 32,
            'indent' => 1,
            'src' => ' local $inner_format = \'inner_last\' ;',
            'start_line' => 150
          },
          {
            'start_line' => 151,
            'indent' => 0,
            'src' => ' is $_ , "ok" , \'last triggering DESTROY that calls outer format\' ;',
            'end_line' => 151,
            'has_warnings' => 1,
            'token_num' => 7,
            'block_id' => 0
...
{ my $o = bless {}, \'Foomat\'; next NEXT }
 . undef $_ ;',
          ...
          },
          {
            ...
            'end_line' => 158,
            'start_line' => 158,
            'src' => ' local $inner_format = \'inner_next\' ;',
            'indent' => 1
          },
          {
            'start_line' => 159,
            'indent' => 0,
            'src' => ' is $_ , "ok" , \'next triggering DESTROY that calls outer format\' ;',
            'block_id' => 0,
            'token_num' => 7,
            'has_warnings' => 1,
            'end_line' => 159
...
{ my $o = bless {}, \'Foomat\'; redo REDO }
 . undef $_ ;',
          ...
          },
          {
            ...
            'end_line' => 168,
            'start_line' => 168,
            'src' => ' if ( ! $count ++ ) { local $inner_format = \'inner_redo\' ; write }',
            'indent' => 1
          },
          {
            'src' => ' local $inner_format = \'inner_redo\' ;',
            'indent' => 2,
            'start_line' => 168,
            'has_warnings' => 1,
            'end_line' => 168,
          ...
          {
            'start_line' => 169,
            'src' => ' is $_ , "ok" , \'redo triggering DESTROY that calls outer format\' ;',
            'indent' => 0,
            'has_warnings' => 1,
            'end_line' => 169,
            'token_num' => 7,
          ...
          },
          {
            ...
            'start_line' => 187,
            'indent' => 1,
            'src' => ' local $inner_format = \'inner_exit\' ;'
          },
          {
            'end_line' => 207,
            'has_warnings' => 1,
          ...
          {
            'src' => ' eval { local $block = sub { die } ; write } ;',
            'indent' => 0,
            'start_line' => 215,
            'block_id' => 0,
            'token_num' => 13,
          ...
          },
          {
            ...
            'block_id' => 0,
            'start_line' => 216,
            'src' => ' is $_ , "ok" , \'die triggering DESTROY directly inside format\' ;',
            'indent' => 0
          },
          {
            'block_id' => 0,
          ...
          },
          {
            'start_line' => 220,
            'indent' => 0,
            'src' => ' is $_ , "ok" , \'last triggering DESTROY directly inside format\' ;',
            'token_num' => 7,
            'block_id' => 0,
            'end_line' => 220,
            'has_warnings' => 1
          ...
          },
          {
            'start_line' => 224,
            'indent' => 0,
            'src' => ' is $_ , "ok" , \'next triggering DESTROY directly inside format\' ;',
            'token_num' => 7,
            'block_id' => 0,
            'end_line' => 224,
            'has_warnings' => 1
          ...
          },
          {
            ...
            'start_line' => 228,
            'indent' => 1,
            'src' => ' if ( ! $count ++ ) { local $block = sub { redo REDO } ; write }'
          },
          {
            'block_id' => 45,
            'token_num' => 9,
          ...
          },
          {
            ...
            'block_id' => 0,
            'token_num' => 7,
            'src' => ' is $_ , "ok" , \'redo triggering DESTROY directly inside format\' ;',
            'indent' => 0,
            'start_line' => 229
          },
          {
            'src' => ' sub END { is $_ , "ok" , \'exit triggering DESTROY directly inside format\' }',
            'indent' => 0,
            'start_line' => 236,
            'token_num' => 10,
            'block_id' => 0,
          ...
          {
            'indent' => 0,
            'src' => ' sub END { undef $_ ; local $block = sub { exit } ; write }',
            'start_line' => 237,
            'has_warnings' => 1,
            'end_line' => 237,
            'token_num' => 16,
