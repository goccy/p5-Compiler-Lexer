...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'name' => 'DivEqual',
                   'data' => '/=',
                   'type' => Compiler::Lexer::TokenType::T_DivEqual,
                   'line' => 16
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'ok $test # skipping failed NaN test under -ffast-math\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 68
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'not ok $test # ($left $threeway $right) gives: $result \\$i=$i \\$j=$j, $boolean disagrees\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 71
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'data' => 'le',
                   'type' => Compiler::Lexer::TokenType::T_StringLessEqual,
                   'line' => 204
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => '%sok %d # cmp vs octects, chr %d\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 301
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 14,
            'src' => ' my ( $iv0 , $iv1 , $ivm1 , $iv_min , $iv_max , $iv_big , $iv_small ) ;',
            'start_line' => 14,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 27,
            'src' => ' { use integer ; $iv0 = 2 - 2 ; $iv1 = 3 - 2 ; $ivm1 = 2 - 3 ; $iv_max -= 1 ; $iv_min += 0 ; $iv_big = $iv_max - 3 ; $iv_small = $iv_min + 2 ; }',
            'start_line' => 18,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 43,
            'src' => ' foreach ( "\\x{1F4A9}" , chr ( 163 ) , \'N\' ) { push @raw , $_ ; my $temp = $_ . chr 256 ; chop $temp ; push @upgraded , $temp ; my $utf8 = $_ ; next if utf8::upgrade ( $utf8 ) == length $_ ; utf8::encode ( $utf8 ) ; push @utf8 , $utf8 ; }',
            'start_line' => 34,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 40,
            'src' => ' next if utf8::upgrade ( $utf8 ) == length $_ ;',
            'start_line' => 40,
            'indent' => 1,
            'block_id' => 3
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 50,
            'src' => ' @FOO = ( \'s\' , \'N/A\' , \'a\' , \'NaN\' , -1 , undef , 0 , 1 , 3.14 , 1e37 , 0.632120558 , - .5 , \'Inf\' + 1 , \'-Inf\' -1 , 0x0 , 0x1 , 0x5 , 0xFFFFFFFF , $uv_max , $uv_maxm1 , $uv_big , $uv_bigi , $iv0 , $iv1 , $ivm1 , $iv_min , $iv_max , $iv_big , $iv_small , \\ $array [ 0 ] , \\ $array [ 0 ] , \\ $array [ 1 ] , \\ $^X , @raw , @upgraded , @utf8 ) ;',
            'start_line' => 46,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 52,
            'src' => ' $expect = 7 * ( $#FOO + 2 ) * ( $#FOO + 1 ) + 6 * @raw + 6 * @utf8 ;',
            'start_line' => 52,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 62,
            'src' => ' { use Config ; my $ccflags = $Config { ccflags } // \'\' ; $bad_NaN = 1 if $ccflags =~/-ffast-math\\b/ ; }',
            'start_line' => 57,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 61,
            'src' => ' $bad_NaN = 1 if $ccflags =~/-ffast-math\\b/ ;',
            'start_line' => 61,
            'indent' => 1,
            'block_id' => 4
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 73,
            'src' => ' sub nok ( $$$$$$$$ ) { my ( $test , $left , $threeway , $right , $result , $i , $j , $boolean ) = @_ ; $result = defined $result ? "\'$result\'" : \'undef\' ; if ( $bad_NaN && ( $left eq \'NaN\' || $right eq \'NaN\' ) ) { print "ok $test # skipping failed NaN test under -ffast-math\\n" ; } else { print "not ok $test # ($left $threeway $right) gives: $result \\$i=$i \\$j=$j, $boolean disagrees\\n" ; } }',
            'start_line' => 64,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 65,
            'src' => ' my ( $test , $left , $threeway , $right , $result , $i , $j , $boolean ) = @_ ;',
            'start_line' => 65,
            'indent' => 1,
            'block_id' => 5
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 66,
            'src' => ' $result = defined $result ? "\'$result\'" : \'undef\' ;',
            'start_line' => 66,
            'indent' => 1,
            'block_id' => 5
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 69,
            'src' => ' if ( $bad_NaN && ( $left eq \'NaN\' || $right eq \'NaN\' ) ) { print "ok $test # skipping failed NaN test under -ffast-math\\n" ; }',
            'start_line' => 67,
            'indent' => 1,
            'block_id' => 5
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 68,
            'src' => ' print "ok $test # skipping failed NaN test under -ffast-math\\n" ;',
            'start_line' => 68,
            'indent' => 2,
            'block_id' => 6
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 72,
            'src' => ' else { print "not ok $test # ($left $threeway $right) gives: $result \\$i=$i \\$j=$j, $boolean disagrees\\n" ; }',
            'start_line' => 70,
            'indent' => 1,
            'block_id' => 5
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 71,
            'src' => ' print "not ok $test # ($left $threeway $right) gives: $result \\$i=$i \\$j=$j, $boolean disagrees\\n" ;',
            'start_line' => 71,
            'indent' => 2,
            'block_id' => 7
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 85,
            'src' => ' my ( $i1 , $i2 , $i3 , $i4 , $i5 , $i6 , $i7 , $i8 , $i9 , $i10 , $i11 , $i12 , $i13 , $i14 , $i15 , $i16 , $i17 ) = ( $FOO [ $i ] , $FOO [ $i ] , $FOO [ $i ] , $FOO [ $i ] , $FOO [ $i ] , $FOO [ $i ] , $FOO [ $i ] , $FOO [ $i ] , $FOO [ $i ] , $FOO [ $i ] , $FOO [ $i ] , $FOO [ $i ] , $FOO [ $i ] , $FOO [ $i ] , $FOO [ $i ] , $FOO [ $i ] , $FOO [ $i ] ) ;',
            'start_line' => 81,
            'indent' => 2,
            'block_id' => 9
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 90,
            'src' => ' my ( $j1 , $j2 , $j3 , $j4 , $j5 , $j6 , $j7 , $j8 , $j9 , $j10 , $j11 , $j12 , $j13 , $j14 , $j15 , $j16 , $j17 ) = ( $FOO [ $j ] , $FOO [ $j ] , $FOO [ $j ] , $FOO [ $j ] , $FOO [ $j ] , $FOO [ $j ] , $FOO [ $j ] , $FOO [ $j ] , $FOO [ $j ] , $FOO [ $j ] , $FOO [ $j ] , $FOO [ $j ] , $FOO [ $j ] , $FOO [ $j ] , $FOO [ $j ] , $FOO [ $j ] , $FOO [ $j ] ) ;',
            'start_line' => 86,
            'indent' => 2,
            'block_id' => 9
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 98,
            'src' => ' if ( ! defined ( $cmp ) ? ! ( $i2 < $j2 ) : ( $cmp == -1 && $i2 < $j2 || $cmp == 0 && ! ( $i2 < $j2 ) || $cmp == 1 && ! ( $i2 < $j2 ) ) ) { print "ok $ok\\n" ; }',
            'start_line' => 92,
            'indent' => 2,
            'block_id' => 9
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 109,
            'src' => ' if ( ! defined ( $cmp ) ? ! ( $i4 == $j4 ) : ( $cmp == -1 && ! ( $i4 == $j4 ) || $cmp == 0 && $i4 == $j4 || $cmp == 1 && ! ( $i4 == $j4 ) ) ) { print "ok $ok\\n" ; }',
            'start_line' => 103,
            'indent' => 2,
            'block_id' => 9
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 120,
            'src' => ' if ( ! defined ( $cmp ) ? ! ( $i5 > $j5 ) : ( $cmp == -1 && ! ( $i5 > $j5 ) || $cmp == 0 && ! ( $i5 > $j5 ) || $cmp == 1 && ( $i5 > $j5 ) ) ) { print "ok $ok\\n" ; }',
            'start_line' => 114,
            'indent' => 2,
            'block_id' => 9
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 131,
            'src' => ' if ( ! defined ( $cmp ) ? ! ( $i6 >= $j6 ) : ( $cmp == -1 && ! ( $i6 >= $j6 ) || $cmp == 0 && $i6 >= $j6 || $cmp == 1 && $i6 >= $j6 ) ) { print "ok $ok\\n" ; }',
            'start_line' => 125,
            'indent' => 2,
            'block_id' => 9
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 143,
            'src' => ' if ( ! defined ( $cmp ) ? ( $i7 != $j7 ) : ( $cmp == -1 && $i7 != $j7 || $cmp == 0 && ! ( $i7 != $j7 ) || $cmp == 1 && $i7 != $j7 ) ) { print "ok $ok\\n" ; }',
            'start_line' => 137,
            'indent' => 2,
            'block_id' => 9
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 154,
            'src' => ' if ( ! defined ( $cmp ) ? ! ( $i8 <= $j8 ) : ( $cmp == -1 && $i8 <= $j8 || $cmp == 0 && $i8 <= $j8 || $cmp == 1 && ! ( $i8 <= $j8 ) ) ) { print "ok $ok\\n" ; }',
            'start_line' => 148,
            'indent' => 2,
            'block_id' => 9
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 165,
            'src' => ' if ( defined ( $cmp ) ? ! ( $cmp + $pmc ) : ! defined $pmc ) { print "ok $ok\\n" ; }',
            'start_line' => 162,
            'indent' => 2,
            'block_id' => 9
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 168,
            'src' => ' else { nok ( $ok , $i3 , \'<=>\' , $j3 , $cmp , $i , $j , \'<=> transposed\' ) ; }',
            'start_line' => 166,
            'indent' => 2,
            'block_id' => 9
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 167,
            'src' => ' nok ( $ok , $i3 , \'<=>\' , $j3 , $cmp , $i , $j , \'<=> transposed\' ) ;',
            'start_line' => 167,
            'indent' => 3,
            'block_id' => 23
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 179,
            'src' => ' if ( $cmp == -1 && $i10 lt $j10 || $cmp == 0 && ! ( $i10 lt $j10 ) || $cmp == 1 && ! ( $i10 lt $j10 ) ) { print "ok $ok\\n" ; }',
            'start_line' => 174,
            'indent' => 2,
            'block_id' => 9
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 182,
            'src' => ' else { nok ( $ok , $i3 , \'cmp\' , $j3 , $cmp , $i , $j , \'lt\' ) ; }',
            'start_line' => 180,
            'indent' => 2,
            'block_id' => 9
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 181,
            'src' => ' nok ( $ok , $i3 , \'cmp\' , $j3 , $cmp , $i , $j , \'lt\' ) ;',
            'start_line' => 181,
            'indent' => 3,
            'block_id' => 25
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 189,
            'src' => ' if ( $cmp == -1 && ! ( $i11 eq $j11 ) || $cmp == 0 && ( $i11 eq $j11 ) || $cmp == 1 && ! ( $i11 eq $j11 ) ) { print "ok $ok\\n" ; }',
            'start_line' => 184,
            'indent' => 2,
            'block_id' => 9
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 192,
            'src' => ' else { nok ( $ok , $i3 , \'cmp\' , $j3 , $cmp , $i , $j , \'eq\' ) ; }',
            'start_line' => 190,
            'indent' => 2,
            'block_id' => 9
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 191,
            'src' => ' nok ( $ok , $i3 , \'cmp\' , $j3 , $cmp , $i , $j , \'eq\' ) ;',
            'start_line' => 191,
            'indent' => 3,
            'block_id' => 27
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 199,
            'src' => ' if ( $cmp == -1 && ! ( $i12 gt $j12 ) || $cmp == 0 && ! ( $i12 gt $j12 ) || $cmp == 1 && ( $i12 gt $j12 ) ) { print "ok $ok\\n" ; }',
            'start_line' => 194,
            'indent' => 2,
            'block_id' => 9
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 202,
            'src' => ' else { nok ( $ok , $i3 , \'cmp\' , $j3 , $cmp , $i , $j , \'gt\' ) ; }',
            'start_line' => 200,
            'indent' => 2,
            'block_id' => 9
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 201,
            'src' => ' nok ( $ok , $i3 , \'cmp\' , $j3 , $cmp , $i , $j , \'gt\' ) ;',
            'start_line' => 201,
            'indent' => 3,
            'block_id' => 29
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 209,
            'src' => ' if ( $cmp == -1 && $i13 le $j13 || $cmp == 0 && ( $i13 le $j13 ) || $cmp == 1 && ! ( $i13 le $j13 ) ) { print "ok $ok\\n" ; }',
            'start_line' => 204,
            'indent' => 2,
            'block_id' => 9
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 212,
            'src' => ' else { nok ( $ok , $i3 , \'cmp\' , $j3 , $cmp , $i , $j , \'le\' ) ; }',
            'start_line' => 210,
            'indent' => 2,
            'block_id' => 9
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 211,
            'src' => ' nok ( $ok , $i3 , \'cmp\' , $j3 , $cmp , $i , $j , \'le\' ) ;',
            'start_line' => 211,
            'indent' => 3,
            'block_id' => 31
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 219,
            'src' => ' if ( $cmp == -1 && ( $i14 ne $j14 ) || $cmp == 0 && ! ( $i14 ne $j14 ) || $cmp == 1 && ( $i14 ne $j14 ) ) { print "ok $ok\\n" ; }',
            'start_line' => 214,
            'indent' => 2,
            'block_id' => 9
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 222,
            'src' => ' else { nok ( $ok , $i3 , \'cmp\' , $j3 , $cmp , $i , $j , \'ne\' ) ; }',
            'start_line' => 220,
            'indent' => 2,
            'block_id' => 9
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 221,
            'src' => ' nok ( $ok , $i3 , \'cmp\' , $j3 , $cmp , $i , $j , \'ne\' ) ;',
            'start_line' => 221,
            'indent' => 3,
            'block_id' => 33
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 229,
            'src' => ' if ( $cmp == -1 && ! ( $i15 ge $j15 ) || $cmp == 0 && ( $i15 ge $j15 ) || $cmp == 1 && ( $i15 ge $j15 ) ) { print "ok $ok\\n" ; }',
            'start_line' => 224,
            'indent' => 2,
            'block_id' => 9
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 232,
            'src' => ' else { nok ( $ok , $i3 , \'cmp\' , $j3 , $cmp , $i , $j , \'ge\' ) ; }',
            'start_line' => 230,
            'indent' => 2,
            'block_id' => 9
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 231,
            'src' => ' nok ( $ok , $i3 , \'cmp\' , $j3 , $cmp , $i , $j , \'ge\' ) ;',
            'start_line' => 231,
            'indent' => 3,
            'block_id' => 35
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 243,
            'src' => ' else { nok ( $ok , $i3 , \'cmp\' , $j3 , $cmp , $i , $j , \'cmp transposed\' ) ; }',
            'start_line' => 241,
            'indent' => 2,
            'block_id' => 9
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 242,
            'src' => ' nok ( $ok , $i3 , \'cmp\' , $j3 , $cmp , $i , $j , \'cmp transposed\' ) ;',
            'start_line' => 242,
            'indent' => 3,
            'block_id' => 37
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 291,
            'src' => ' printf "%sok %d # eq vs octets, chr %d\\n" , $not , ++ $ok , ord $raw ;',
            'start_line' => 291,
            'indent' => 1,
            'block_id' => 39
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 296,
            'src' => ' printf "%sok %d # ne vs octets, chr %d\\n" , $not , ++ $ok , ord $raw ;',
            'start_line' => 296,
            'indent' => 1,
            'block_id' => 39
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 301,
            'src' => ' printf "%sok %d # cmp vs octects, chr %d\\n" , $not , ++ $ok , ord $raw ;',
            'start_line' => 301,
            'indent' => 1,
            'block_id' => 39
          },
