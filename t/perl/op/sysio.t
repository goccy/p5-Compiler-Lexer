...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'sysio.t: cannot find myself: $!',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'sysio.t: cannot write $outfile: $!',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 58
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'sysio.t: cannot read $outfile: $!',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 186
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => '^IO layers \\(like \':utf8\'\\) unavailable',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 218
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 11,
            'src' => ' open ( I , \'op/sysio.t\' ) || die "sysio.t: cannot find myself: $!" ;',
            'start_line' => 11,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 18,
            'src' => ' $reopen = ( $^O eq \'VMS\' || $^O eq \'os2\' || $^O eq \'MSWin32\' || $^O eq \'NetWare\' || $^O eq \'dos\' || $^O eq \'mpeix\' ) ;',
            'start_line' => 13,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 31,
            'src' => ' like ( $@ , qr/^Offset outside string / ) ;',
            'start_line' => 31,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 58,
            'src' => ' open ( O , ">$outfile" ) || die "sysio.t: cannot write $outfile: $!" ;',
            'start_line' => 58,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 86,
            'src' => ' if ( $reopen ) { close O ; open ( O , ">>$outfile" ) || die "sysio.t: cannot write $outfile: $!" ; }',
            'start_line' => 84,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 104,
            'src' => ' eval { my $buf = \'\' ; syswrite ( O , $buf , 1 , 1 ) } ;',
            'start_line' => 104,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 116,
            'src' => ' eval { my $buf = \'x\' ; syswrite ( O , $buf , 1 , 2 ) } ;',
            'start_line' => 116,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 186,
            'src' => ' open ( I , $outfile ) || die "sysio.t: cannot read $outfile: $!" ;',
            'start_line' => 186,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 206,
            'src' => ' ok ( sysseek ( I , 0 , 0 ) eq \'0 but true\' ) ;',
            'start_line' => 206,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 208,
            'src' => ' ok ( not defined sysseek ( I , -1 , 1 ) ) ;',
            'start_line' => 208,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 215,
            'src' => ' open ( I , ">$outfile" ) || die "sysio.t: cannot write $outfile: $!" ;',
            'start_line' => 215,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 218,
            'src' => ' die $@ if $@ and $@ !~/^IO layers \\(like \':utf8\'\\) unavailable/ ;',
            'start_line' => 218,
            'indent' => 0,
            'block_id' => 0
          },
