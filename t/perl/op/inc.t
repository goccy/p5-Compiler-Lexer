...
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'Could not find a value which overflows the mantissa',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 239
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 105,
            'src' => ' foreach ( keys %inc ) { my $ans = $up { $_ } ; my $up ; eval { $up = ++ $_ } ; is ( $up , $ans ) ; is ( $@ , \'\' ) ; }',
            'start_line' => 99,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 115,
            'src' => ' foreach ( keys %dec ) { my $ans = $down { $_ } ; my $down ; eval { $down = -- $_ } ; is ( $down , $ans ) ; is ( $@ , \'\' ) ; }',
            'start_line' => 109,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 125,
            'src' => ' foreach ( keys %postinc ) { my $ans = $postinc { $_ } ; my $up ; eval { $up = $_ ++ } ; is ( $up , $ans ) ; is ( $@ , \'\' ) ; }',
            'start_line' => 119,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 135,
            'src' => ' foreach ( keys %postdec ) { my $ans = $postdec { $_ } ; my $down ; eval { $down = $_ -- } ; is ( $down , $ans ) ; is ( $@ , \'\' ) ; }',
            'start_line' => 129,
            'indent' => 0,
            'block_id' => 0
          },
    ...
    for(0 .. 3) {
        my \\$a = $action;
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 239,
            'src' => ' die "Could not find a value which overflows the mantissa" unless $found ;',
            'start_line' => 239,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 246,
            'src' => ' isnt ( scalar eval { my $pvbm = PVBM ; $pvbm ++ } , undef ) ;',
            'start_line' => 246,
            'indent' => 0,
            'block_id' => 0
          },
