...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'line' => 113,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'data' => '"23" can can when the pack exists',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0
                 }, 'Compiler::Lexer::Token' ),
          ...
          bless( {
                   'name' => 'RegExp',
                   'line' => 266,
                   'data' => '^UNIVERSAL does not export anything\\b',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value
          ...
          bless( {
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'data' => 'error for UNIVERSAL->import(\'can\')',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 267,
                   'name' => 'String'
          ...
          bless( {
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'data' => 'no deprecation warning for UNIVERSAL->import(\'can\')',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'line' => 269,
          ...
          bless( {
                   'data' => 'no error for UNIVERSAL->import',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'start_line' => 9,
            'block_id' => 1,
            'src' => ' set_up_inc ( qw \'../lib ../dist/base/lib\' ) ;',
            'token_num' => 6
          },
          {
            'block_id' => 1,
          ...
          },
          {
            ...
            'end_line' => 113,
            'token_num' => 10,
            'src' => ' ok UNIVERSAL::can ( "23" , "can" ) , \'"23" can can when the pack exists\' ;',
            'block_id' => 0,
            'start_line' => 113,
            'indent' => 0
          },
          ...
          },
          {
            ...
            'start_line' => 115,
            'block_id' => 0,
            'src' => ' sub IO::Handle::turn { } ok UNIVERSAL::can ( *STDOUT , \'turn\' ) , \'globs with IOs can\' ;',
            'token_num' => 14
          },
          {
            'end_line' => 117,
            ...
            'indent' => 0,
            'token_num' => 11,
            'src' => ' ok UNIVERSAL::can ( \\ *STDOUT , \'turn\' ) , \'globrefs with IOs can\' ;'
          },
          {
            'end_line' => 118,
            'has_warnings' => 1,
            ...
            'indent' => 0,
            'token_num' => 10,
            'src' => ' ok UNIVERSAL::can ( "STDOUT" , \'turn\' ) , \'IO barewords can\' ;'
          },
          {
