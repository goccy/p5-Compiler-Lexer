...
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => 'Not an unblessed ARRAY reference',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 66
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => ' got: \\$first = [ @$first ]; \\$second = [ @$second ];\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 80
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => ' got (arrayref): @got2 == @get left: @$y == @leave\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 120
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
-4,			4 5 6 7,	0 1 2 3
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 22,
            'src' => ' if ( join ( \':\' , @x ) eq \'1:2:3:1:2:3\' ) { print "ok 1\\n" ; }',
            'start_line' => 22,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 24,
            'src' => ' if ( join ( \':\' , @x ) eq \'1:2:3:1:2:3:4\' ) { print "ok 2\\n" ; }',
            'start_line' => 24,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 30,
            'src' => ' { no warnings \'deprecated\' ; push ( x , 3 ) ; }',
            'start_line' => 27,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 31,
            'src' => ' if ( join ( \':\' , @x ) eq \'1:2:3:1:2:3:4:3\' ) { print "ok 3\\n" ; }',
            'start_line' => 31,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 35,
            'src' => ' { no warnings \'deprecated\' ; pop ( x ) ; }',
            'start_line' => 32,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 36,
            'src' => ' if ( join ( \':\' , @x ) eq \'1:2:3:1:2:3:4\' ) { print "ok 4\\n" ; }',
            'start_line' => 36,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 40,
            'src' => ' if ( join ( \':\' , @x ) eq \'1:2:3:1:2:3:4:5\' ) { print "ok 5\\n" ; }',
            'start_line' => 40,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 42,
            'src' => ' if ( join ( \':\' , @x ) eq \'1:2:3:1:2:3:4\' ) { print "ok 6\\n" ; }',
            'start_line' => 42,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 46,
            'src' => ' if ( join ( \':\' , @$undef1 ) eq \'1:2:3\' ) { print "ok 7\\n" ; }',
            'start_line' => 46,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 50,
            'src' => ' if ( $@ =~/Not an ARRAY/ ) { print "ok 8\\n" ; }',
            'start_line' => 50,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 53,
            'src' => ' use constant CONST_ARRAYREF => [ qw/a b c/ ] ;',
            'start_line' => 53,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 54,
            'src' => ' push CONST_ARRAYREF ( ) , qw/d e f/ ;',
            'start_line' => 54,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 55,
            'src' => ' if ( join ( \':\' , @{ CONST_ARRAYREF ( ) } ) eq \'a:b:c:d:e:f\' ) { print "ok 9\\n" ; }',
            'start_line' => 55,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 59,
            'src' => ' if ( $@ && $@ =~/must be array/ ) { print "ok 10\\n" }',
            'start_line' => 59,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 63,
            'src' => ' if ( $@ && $@ =~/Not an ARRAY reference/ ) { print "ok 11\\n" }',
            'start_line' => 63,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 66,
            'src' => ' if ( $@ && $@ =~/Not an unblessed ARRAY reference/ ) { print "ok 12\\n" }',
            'start_line' => 66,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 91,
            'src' => ' { my ( $first , $second ) = ( [ 1 ] , [ 2 ] ) ; sub two_things { return + ( $first , $second ) } push two_things ( ) , 3 ; if ( join ( \':\' , @$first ) eq \'1\' && join ( \':\' , @$second ) eq \'2:3\' ) { print "ok " , $test ++ , "\\n" ; } else { print "not ok " , $test ++ , " got: \\$first = [ @$first ]; \\$second = [ @$second ];\\n" ; } push @{ two_things ( ) } , 4 ; if ( join ( \':\' , @$first ) eq \'1\' && join ( \':\' , @$second ) eq \'2:3:4\' ) { print "ok " , $test ++ , "\\n" ; } else { print "not ok " , $test ++ , " got: \\$first = [ @$first ]; \\$second = [ @$second ];\\n" ; } }',
            'start_line' => 71,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 73,
            'src' => ' sub two_things { return + ( $first , $second ) }',
            'start_line' => 73,
            'indent' => 1,
            'block_id' => 28
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 78,
            'src' => ' if ( join ( \':\' , @$first ) eq \'1\' && join ( \':\' , @$second ) eq \'2:3\' ) { print "ok " , $test ++ , "\\n" ; }',
            'start_line' => 75,
            'indent' => 1,
            'block_id' => 28
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 81,
            'src' => ' else { print "not ok " , $test ++ , " got: \\$first = [ @$first ]; \\$second = [ @$second ];\\n" ; }',
            'start_line' => 79,
            'indent' => 1,
            'block_id' => 28
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 80,
            'src' => ' print "not ok " , $test ++ , " got: \\$first = [ @$first ]; \\$second = [ @$second ];\\n" ;',
            'start_line' => 80,
            'indent' => 2,
            'block_id' => 31
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 87,
            'src' => ' if ( join ( \':\' , @$first ) eq \'1\' && join ( \':\' , @$second ) eq \'2:3:4\' ) { print "ok " , $test ++ , "\\n" ; }',
            'start_line' => 84,
            'indent' => 1,
            'block_id' => 28
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 103,
            'src' => ' if ( defined $len ) { @got = splice ( @x , $pos , $len , @list ) ; @got2 = splice ( $y , $pos , $len , @list ) ; }',
            'start_line' => 100,
            'indent' => 1,
            'block_id' => 34
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 102,
            'src' => ' @got2 = splice ( $y , $pos , $len , @list ) ;',
            'start_line' => 102,
            'indent' => 2,
            'block_id' => 35
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 107,
            'src' => ' else { @got = splice ( @x , $pos ) ; @got2 = splice ( $y , $pos ) ; }',
            'start_line' => 104,
            'indent' => 1,
            'block_id' => 34
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 111,
            'src' => ' if ( join ( \':\' , @got ) eq join ( \':\' , @get ) && join ( \':\' , @x ) eq join ( \':\' , @leave ) ) { print "ok " , $test ++ , "\\n" ; }',
            'start_line' => 108,
            'indent' => 1,
            'block_id' => 34
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 114,
            'src' => ' else { print "not ok " , $test ++ , " got: @got == @get left: @x == @leave\\n" ; }',
            'start_line' => 112,
            'indent' => 1,
            'block_id' => 34
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 113,
            'src' => ' print "not ok " , $test ++ , " got: @got == @get left: @x == @leave\\n" ;',
            'start_line' => 113,
            'indent' => 2,
            'block_id' => 38
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 118,
            'src' => ' if ( join ( \':\' , @got2 ) eq join ( \':\' , @get ) && join ( \':\' , @$y ) eq join ( \':\' , @leave ) ) { print "ok " , $test ++ , "\\n" ; }',
            'start_line' => 115,
            'indent' => 1,
            'block_id' => 34
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 121,
            'src' => ' else { print "not ok " , $test ++ , " got (arrayref): @got2 == @get left: @$y == @leave\\n" ; }',
            'start_line' => 119,
            'indent' => 1,
            'block_id' => 34
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 120,
            'src' => ' print "not ok " , $test ++ , " got (arrayref): @got2 == @get left: @$y == @leave\\n" ;',
            'start_line' => 120,
            'indent' => 2,
            'block_id' => 40
          },
