...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'package withversion $v$suffix',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 62
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'package withversion $v$suffix -> syntax error ($match)',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 63
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => '... and "$v" should also fail STRICT regex',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 64
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'package withversion $v$suffix $v eq \\$withversion::VERSION',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 67
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'and \\$VERSION = $withversion::VERSION',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 69
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => '... and "$v" should pass STRICT regex',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 70
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => 'version->new("$v") -> invalid format ($match)',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 78
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => '... and "$v" should fail LAX regex',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 80
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => '... and "$v" should pass LAX regex',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 84
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => '... and unquoted version->new($v) has same error',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 95
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'New line between package name and version',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 112
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 16,
            'src' => ' my @syntax_cases = ( \'package Foo\' , \'package Bar 1.23\' , \'package Baz v1.2.3\' , ) ;',
            'start_line' => 12,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 21,
            'src' => ' plan tests => 7 * @syntax_cases + 7 * ( grep { $_ !~/^#/ } @version_cases ) + 2 * 3 ;',
            'start_line' => 20,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 41,
            'src' => ' for my $string ( @syntax_cases ) { eval "$string" ; is ( $@ , \'\' , qq/eval "$string"/ ) ; eval "$string;" ; is ( $@ , \'\' , qq/eval "$string;"/ ) ; eval "$string ;" ; is ( $@ , \'\' , qq/eval "$string ;"/ ) ; eval "{$string}" ; is ( $@ , \'\' , qq/eval "{$string}"/ ) ; eval "{ $string }" ; is ( $@ , \'\' , qq/eval "{ $string }"/ ) ; eval "${string}{}" ; is ( $@ , \'\' , qq/eval "${string}{}"/ ) ; eval "$string {}" ; is ( $@ , \'\' , qq/eval "$string {}"/ ) ; }',
            'start_line' => 26,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 101,
            'src' => ' for my $line ( @version_cases ) { chomp $line ; if ( $line =~/^#/ ) { diag $line ; next LINE ; } my ( $v , $package , $quoted , $bare , $match ) = split/\\t+/ , $line ; my $warning = "" ; local $SIG { __WARN__ } = sub { $warning .= $_ [ 0 ] . "\\n" } ; $match = defined $match ? $match : "" ; $match =~ s/\\s*\\z// ; foreach my $suffix ( ";" , "{}" ) { $withversion::VERSION = undef ; if ( $package eq \'fail\' ) { eval "package withversion $v$suffix" ; like ( $@ , qr/$match/ , "package withversion $v$suffix -> syntax error ($match)" ) ; ok ( ! version::is_strict ( $v ) , qq{... and "$v" should also fail STRICT regex} ) ; } else { my $ok = eval "package withversion $v$suffix $v eq \\$withversion::VERSION" ; ok ( $ok , "package withversion $v$suffix" ) or diag ( $@ ? $@ : "and \\$VERSION = $withversion::VERSION" ) ; ok ( version::is_strict ( $v ) , qq{... and "$v" should pass STRICT regex} ) ; } } my $ver = undef ; eval qq/\\$ver = version->new("$v")/ ; if ( $quoted eq \'fail\' ) { like ( $@ , qr/$match/ , qq{version->new("$v") -> invalid format ($match)} ) or diag ( $@ ? $@ : "and \\$ver = $ver" ) ; ok ( ! version::is_lax ( $v ) , qq{... and "$v" should fail LAX regex} ) ; } else { is ( $@ , "" , qq{version->new("$v")} ) ; ok ( version::is_lax ( $v ) , qq{... and "$v" should pass LAX regex} ) ; } if ( $bare eq \'na\' ) { pass ( "... skipping version->new($v)" ) ; next LINE ; } $ver = undef ; eval qq/\\$ver = version->new($v)/ ; if ( $bare eq \'fail\' ) { like ( $@ , qr/$match/m , qq{... and unquoted version->new($v) has same error} ) or diag ( $@ ? $@ : "and \\$ver = $ver" ) ; } else { is ( $@ , "" , qq{... and version->new($v) is ok} ) ; } }',
            'start_line' => 44,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 50,
            'src' => ' if ( $line =~/^#/ ) { diag $line ; next LINE ; }',
            'start_line' => 47,
            'indent' => 1,
            'block_id' => 3
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 52,
            'src' => ' my ( $v , $package , $quoted , $bare , $match ) = split/\\t+/ , $line ;',
            'start_line' => 52,
            'indent' => 1,
            'block_id' => 3
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 54,
            'src' => ' local $SIG { __WARN__ } = sub { $warning .= $_ [ 0 ] . "\\n" } ;',
            'start_line' => 54,
            'indent' => 1,
            'block_id' => 3
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 72,
            'src' => ' foreach my $suffix ( ";" , "{}" ) { $withversion::VERSION = undef ; if ( $package eq \'fail\' ) { eval "package withversion $v$suffix" ; like ( $@ , qr/$match/ , "package withversion $v$suffix -> syntax error ($match)" ) ; ok ( ! version::is_strict ( $v ) , qq{... and "$v" should also fail STRICT regex} ) ; } else { my $ok = eval "package withversion $v$suffix $v eq \\$withversion::VERSION" ; ok ( $ok , "package withversion $v$suffix" ) or diag ( $@ ? $@ : "and \\$VERSION = $withversion::VERSION" ) ; ok ( version::is_strict ( $v ) , qq{... and "$v" should pass STRICT regex} ) ; } }',
            'start_line' => 59,
            'indent' => 1,
            'block_id' => 3
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 65,
            'src' => ' if ( $package eq \'fail\' ) { eval "package withversion $v$suffix" ; like ( $@ , qr/$match/ , "package withversion $v$suffix -> syntax error ($match)" ) ; ok ( ! version::is_strict ( $v ) , qq{... and "$v" should also fail STRICT regex} ) ; }',
            'start_line' => 61,
            'indent' => 2,
            'block_id' => 6
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 62,
            'src' => ' eval "package withversion $v$suffix" ;',
            'start_line' => 62,
            'indent' => 3,
            'block_id' => 7
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 63,
            'src' => ' like ( $@ , qr/$match/ , "package withversion $v$suffix -> syntax error ($match)" ) ;',
            'start_line' => 63,
            'indent' => 3,
            'block_id' => 7
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 64,
            'src' => ' ok ( ! version::is_strict ( $v ) , qq{... and "$v" should also fail STRICT regex} ) ;',
            'start_line' => 64,
            'indent' => 3,
            'block_id' => 7
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 71,
            'src' => ' else { my $ok = eval "package withversion $v$suffix $v eq \\$withversion::VERSION" ; ok ( $ok , "package withversion $v$suffix" ) or diag ( $@ ? $@ : "and \\$VERSION = $withversion::VERSION" ) ; ok ( version::is_strict ( $v ) , qq{... and "$v" should pass STRICT regex} ) ; }',
            'start_line' => 66,
            'indent' => 2,
            'block_id' => 6
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 67,
            'src' => ' my $ok = eval "package withversion $v$suffix $v eq \\$withversion::VERSION" ;',
            'start_line' => 67,
            'indent' => 3,
            'block_id' => 8
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 69,
            'src' => ' ok ( $ok , "package withversion $v$suffix" ) or diag ( $@ ? $@ : "and \\$VERSION = $withversion::VERSION" ) ;',
            'start_line' => 68,
            'indent' => 3,
            'block_id' => 8
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 70,
            'src' => ' ok ( version::is_strict ( $v ) , qq{... and "$v" should pass STRICT regex} ) ;',
            'start_line' => 70,
            'indent' => 3,
            'block_id' => 8
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 81,
            'src' => ' if ( $quoted eq \'fail\' ) { like ( $@ , qr/$match/ , qq{version->new("$v") -> invalid format ($match)} ) or diag ( $@ ? $@ : "and \\$ver = $ver" ) ; ok ( ! version::is_lax ( $v ) , qq{... and "$v" should fail LAX regex} ) ; }',
            'start_line' => 77,
            'indent' => 1,
            'block_id' => 3
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 79,
            'src' => ' like ( $@ , qr/$match/ , qq{version->new("$v") -> invalid format ($match)} ) or diag ( $@ ? $@ : "and \\$ver = $ver" ) ;',
            'start_line' => 78,
            'indent' => 2,
            'block_id' => 9
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 80,
            'src' => ' ok ( ! version::is_lax ( $v ) , qq{... and "$v" should fail LAX regex} ) ;',
            'start_line' => 80,
            'indent' => 2,
            'block_id' => 9
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 85,
            'src' => ' else { is ( $@ , "" , qq{version->new("$v")} ) ; ok ( version::is_lax ( $v ) , qq{... and "$v" should pass LAX regex} ) ; }',
            'start_line' => 82,
            'indent' => 1,
            'block_id' => 3
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 84,
            'src' => ' ok ( version::is_lax ( $v ) , qq{... and "$v" should pass LAX regex} ) ;',
            'start_line' => 84,
            'indent' => 2,
            'block_id' => 10
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 91,
            'src' => ' if ( $bare eq \'na\' ) { pass ( "... skipping version->new($v)" ) ; next LINE ; }',
            'start_line' => 88,
            'indent' => 1,
            'block_id' => 3
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 89,
            'src' => ' pass ( "... skipping version->new($v)" ) ;',
            'start_line' => 89,
            'indent' => 2,
            'block_id' => 11
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 97,
            'src' => ' if ( $bare eq \'fail\' ) { like ( $@ , qr/$match/m , qq{... and unquoted version->new($v) has same error} ) or diag ( $@ ? $@ : "and \\$ver = $ver" ) ; }',
            'start_line' => 94,
            'indent' => 1,
            'block_id' => 3
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 96,
            'src' => ' like ( $@ , qr/$match/m , qq{... and unquoted version->new($v) has same error} ) or diag ( $@ ? $@ : "and \\$ver = $ver" ) ;',
            'start_line' => 95,
            'indent' => 2,
            'block_id' => 12
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 100,
            'src' => ' else { is ( $@ , "" , qq{... and version->new($v) is ok} ) ; }',
            'start_line' => 98,
            'indent' => 1,
            'block_id' => 3
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 99,
            'src' => ' is ( $@ , "" , qq{... and version->new($v) is ok} ) ;',
            'start_line' => 99,
            'indent' => 2,
            'block_id' => 13
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 115,
            'src' => ' for my $v ( "1" , "1.23" , "v1.2.3" ) { ok ( run_perl ( prog => "package Foo\\n$v; print 1;" ) , "New line between package name and version" ) ; ok ( run_perl ( prog => "package Foo\\n$v { print 1; }" ) , "New line between package name and version" ) ; }',
            'start_line' => 110,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 112,
            'src' => ' ok ( run_perl ( prog => "package Foo\\n$v; print 1;" ) , "New line between package name and version" ) ;',
            'start_line' => 111,
            'indent' => 1,
            'block_id' => 14
          },
