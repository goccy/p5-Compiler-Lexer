...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'select undef  $blank $blank 0',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 16
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'select $blank undef  $blank 0',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 18
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'select $blank $blank undef  0',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 20
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'select(u,u,u,\\$sleep):  at least $sleep seconds have passed',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 56
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'select(\\$e,u,u,\\$sleep): at least $sleep seconds have passed',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 65
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 7,
            'src' => ' $hires = eval \'use Time::HiResx "time"; 1\' ;',
            'start_line' => 7,
            'indent' => 1,
            'block_id' => 1
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 15,
            'src' => ' eval { select undef , $blank , $blank , 0 } ;',
            'start_line' => 15,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 16,
            'src' => ' is ( $@ , "" , \'select undef  $blank $blank 0\' ) ;',
            'start_line' => 16,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 17,
            'src' => ' eval { select $blank , undef , $blank , 0 } ;',
            'start_line' => 17,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 18,
            'src' => ' is ( $@ , "" , \'select $blank undef  $blank 0\' ) ;',
            'start_line' => 18,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 19,
            'src' => ' eval { select $blank , $blank , undef , 0 } ;',
            'start_line' => 19,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 20,
            'src' => ' is ( $@ , "" , \'select $blank $blank undef  0\' ) ;',
            'start_line' => 20,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 29,
            'src' => ' eval { select "a" , $blank , $blank , 0 } ;',
            'start_line' => 29,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 31,
            'src' => ' like ( $@ , qr/^Modification of a read-only value attempted/ , \'select "a"    $blank $blank 0\' ) ;',
            'start_line' => 30,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 32,
            'src' => ' eval { select $blank , "a" , $blank , 0 } ;',
            'start_line' => 32,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 34,
            'src' => ' like ( $@ , qr/^Modification of a read-only value attempted/ , \'select $blank "a"    $blank 0\' ) ;',
            'start_line' => 33,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 35,
            'src' => ' eval { select $blank , $blank , "a" , 0 } ;',
            'start_line' => 35,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 37,
            'src' => ' like ( $@ , qr/^Modification of a read-only value attempted/ , \'select $blank $blank "a"    0\' ) ;',
            'start_line' => 36,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 53,
            'src' => ' select ( undef , undef , undef , $sleep ) ;',
            'start_line' => 53,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 56,
            'src' => ' ok ( $diff >= $sleep - $under , "select(u,u,u,\\$sleep):  at least $sleep seconds have passed" ) ;',
            'start_line' => 56,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 57,
            'src' => ' note ( "diff=$diff under=$under" ) ;',
            'start_line' => 57,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 62,
            'src' => ' select ( $empty , undef , undef , $sleep ) ;',
            'start_line' => 62,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 65,
            'src' => ' ok ( $diff >= $sleep - $under , "select(\\$e,u,u,\\$sleep): at least $sleep seconds have passed" ) ;',
            'start_line' => 65,
            'indent' => 0,
            'block_id' => 0
          },
