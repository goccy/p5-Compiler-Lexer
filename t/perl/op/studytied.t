...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 20,
            'src' => ' { package J ; my $c = 0 ; sub reset { $c = 0 } sub TIESCALAR { bless [ ] } sub FETCH { $c ++ ? "next" : "first" } }',
            'start_line' => 14,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 51,
            'src' => ' for my $do_study ( 0 , 1 ) { J::reset ( ) ; my $x ; tie $x , "J" ; if ( $do_study ) { study $x ; pass ( "Studying..." ) ; } else { my $first_fetch = $x ; pass ( "Not studying..." ) ; } ok ( $x !~/f/ , qq{"next" doesn\'t match /f/} ) ; is ( index ( $x , \'f\' ) , -1 , qq{"next" doesn\'t contain "f"} ) ; ok ( $x =~/n/ , qq{"next" matches /n/} ) ; is ( index ( $x , \'n\' ) , 0 , qq{"next" contains "n" at pos 0} ) ; ok ( $x =~/t/ , qq{"next" matches /t/} ) ; is ( index ( $x , \'t\' ) , 3 , qq{"next" contains "t" at pos 3} ) ; }',
            'start_line' => 26,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 34,
            'src' => ' if ( $do_study ) { study $x ; pass ( "Studying..." ) ; }',
            'start_line' => 31,
            'indent' => 1,
            'block_id' => 6
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 37,
            'src' => ' else { my $first_fetch = $x ; pass ( "Not studying..." ) ; }',
            'start_line' => 34,
            'indent' => 1,
            'block_id' => 6
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 41,
            'src' => ' ok ( $x !~/f/ , qq{"next" doesn\'t match /f/} ) ;',
            'start_line' => 41,
            'indent' => 1,
            'block_id' => 6
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 42,
            'src' => ' is ( index ( $x , \'f\' ) , -1 , qq{"next" doesn\'t contain "f"} ) ;',
            'start_line' => 42,
            'indent' => 1,
            'block_id' => 6
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 46,
            'src' => ' is ( index ( $x , \'n\' ) , 0 , qq{"next" contains "n" at pos 0} ) ;',
            'start_line' => 46,
            'indent' => 1,
            'block_id' => 6
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 50,
            'src' => ' is ( index ( $x , \'t\' ) , 3 , qq{"next" contains "t" at pos 3} ) ;',
            'start_line' => 50,
            'indent' => 1,
            'block_id' => 6
          }
