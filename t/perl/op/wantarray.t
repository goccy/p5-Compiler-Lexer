...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          {
            'indent' => 0,
            'src' => ' sub context { local $: : Level = $: : Level + 1 ; my ( $cona , $name ) = @_ ; my $conb = ( defined wantarray ) ? ( wantarray ? \'A\' : \'S\' ) : \'V\' ; is $conb , $cona , $name ; }',
            'start_line' => 13,
            'end_line' => 18,
            'has_warnings' => 1,
            'token_num' => 49,
          ...
          {
            'src' => ' my $conb = ( defined wantarray ) ? ( wantarray ? \'A\' : \'S\' ) : \'V\' ;',
            'indent' => 1,
            'start_line' => 16,
            'end_line' => 16,
            'has_warnings' => 0,
          ...
          {
            'indent' => 0,
            'src' => ' { sub simple { wantarray ? 1 : 2 } sub inline { my $a = wantarray ? simple ( ) : simple ( ) ; $a ; } my @b = inline ( ) ; my $c = inline ( ) ; is @b , 1 ; is "@b" , "2" ; is $c , 2 ; }',
            'start_line' => 28,
            'block_id' => 0,
            'token_num' => 59,
            'has_warnings' => 1,
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'indent' => 1,
            'src' => ' sub inline { my $a = wantarray ? simple ( ) : simple ( ) ; $a ; }',
            'start_line' => 31
          },
          {
            'indent' => 2,
            'src' => ' my $a = wantarray ? simple ( ) : simple ( ) ;',
            'start_line' => 32,
            'end_line' => 32,
            'has_warnings' => 0,
            'block_id' => 5,
  ...
  $q = (defined wantarray) ? ( wantarray ? \'A\' : \'S\' ) : \'V\';
          ...
          },
          {
            ...
            'start_line' => 60,
            'indent' => 0,
            'src' => ' sub or_context { $: : f || context ( shift , "rhs of || at sub exit" ) }'
          },
          {
            'start_line' => 61,
            'indent' => 0,
          ...
          },
          {
            ...
            'end_line' => 64,
            'has_warnings' => 1,
            'src' => ' sub and_context { $: : t && context ( shift , "rhs of && at sub exit" ) }',
            'indent' => 0,
            'start_line' => 64
          },
          {
          ...
          {
            'start_line' => 68,
            'src' => ' sub dor_context { $: : u // context ( shift , "rhs of // at sub exit" ) }',
            'indent' => 0,
            'token_num' => 14,
            'block_id' => 0,
            'end_line' => 68,
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'start_line' => 72,
            'src' => ' sub cond_middle_cx { $: : t ? context ( shift , "mid of ?: at sub exit" ) : 0 }',
            'indent' => 0
          },
          {
            'start_line' => 73,
            'indent' => 0,
            'src' => ' cond_middle_cx ( \'V\' ) ;',
            'end_line' => 73,
            'has_warnings' => 0,
            'token_num' => 5,
            'block_id' => 0
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'start_line' => 76,
            'src' => ' sub cond_rhs_cx { $: : f ? 0 : context ( shift , "rhs of ?: at sub exit" ) }',
            'indent' => 0
          },
          {
            'start_line' => 77,
