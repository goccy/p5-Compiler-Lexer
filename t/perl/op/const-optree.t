...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'sub with null+kids (if-block), then constant'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'name' => 'Comma',
                   'data' => ',',
          ...
          bless( {
                   ...
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => 'sub with simple lexical modified elsewhere',
                   'name' => 'RawString'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'has_warnings' => 0,
          ...
          bless( {
                   'data' => 'sub with simple lexical unmodified elsewhere',
                   'name' => 'RawString',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'has_warnings' => 0,
          ...
          bless( {
                   'name' => 'RawString',
                   'data' => 'return $variable modified elsewhere',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   ...
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'data' => 'return $variable unmodified elsewhere',
                   'name' => 'RawString'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'data' => ',',
          ...
          bless( {
                   'name' => 'RawString',
                   'data' => 'sub () { 0; $x } with $x modified elsewhere',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   ...
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'data' => 'sub () { 0; $x } with $x unmodified elsewhere',
                   'name' => 'RawString'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'name' => 'Comma',
          ...
          bless( {
                   'data' => 'simple lexical after another closure and no lvalue',
                   'name' => 'RawString',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   'name' => 'RawString',
                   'data' => 'simple lexical before another closure and no lvalue',
                   'line' => 148,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'simple lexical after an lvalue closure'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'line' => 177,
                   'data' => 'simple lexical before an lvalue closure',
                   'name' => 'RawString'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'data' => ',',
          ...
          bless( {
                   ...
                   'line' => 194,
                   'name' => 'RawString',
                   'data' => 'complex lexical op tree before an lvalue closure'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'type' => Compiler::Lexer::TokenType::T_Comma,
          ...
          bless( {
                   'name' => 'RawString',
                   'data' => 'complex lexical op tree before a nested lvalue closure',
                   'line' => 209,
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   ...
                   'line' => 238,
                   'name' => 'RawString',
                   'data' => 'sub with constant and return'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'name' => 'Comma',
                   'data' => ',',
          ...
          bless( {
                   'data' => 'sub with optimised statement and constant',
                   'name' => 'RawString',
                   'line' => 247,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'has_warnings' => 0,
          ...
          bless( {
                   'data' => 'sub with optimised statement, constant and return',
                   'name' => 'RawString',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'has_warnings' => 0,
          ...
          bless( {
                   'name' => 'RawString',
                   'data' => 'my sub with constant and return',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   ...
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'name' => 'RawString',
                   'data' => 'my sub with optimised statement and constant'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'line' => 283,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
          ...
          bless( {
                   ...
                   'line' => 292,
                   'name' => 'RawString',
                   'data' => 'my sub with optimised statement, constant and return'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'line' => 292,
                   'has_warnings' => 0,
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'sub () { $x } with eval not in scope'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'line' => 332,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
          ...
          bless( {
                   'data' => 'sub () { my $x; state sub z { $x } $outer }',
                   'name' => 'RawString',
                   'line' => 350,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
          ...
          bless( {
                   'name' => 'RawString',
                   'data' => 'sub:method with simple lexical',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   'data' => 'my sub:method with constant',
                   'name' => 'RawString',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'has_warnings' => 0,
          ...
          bless( {
                   ...
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => 'sub closing over state var',
                   'name' => 'RawString'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'name' => 'Comma',
          ...
          bless( {
                   ...
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'line' => 435,
                   'data' => '^Constants from lexical variables potentially (?x:
                       )modified elsewhere are deprecated at ',
                   'name' => 'RegExp'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   'name' => 'String',
                   'data' => '$nickname is not deprecated',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   ...
                   'line' => 449,
                   'name' => 'String',
                   'data' => '$nickname gives $same retval each call'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'line' => 450,
                   'type' => Compiler::Lexer::TokenType::T_RightParenthesis,
          ...
          bless( {
                   ...
                   'line' => 460,
                   'name' => 'String',
                   'data' => '$nickname is$not inlinable'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'data' => ';',
                   'name' => 'SemiColon',
          ...
          bless( {
                   'name' => 'String',
                   'data' => '$nickname has :method attribute',
                   'line' => 468,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_String,
          ...
          bless( {
                   ...
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'data' => '^Ambiguous call resolved as CORE::time\\(\\), (?x:
                        )qualify as such or use & at ',
                   'name' => 'RegExp'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   'name' => 'String',
                   'data' => '$nickname has no :method attribute',
                   'line' => 473,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_String,
          ...
          bless( {
                   ...
                   'line' => 483,
                   'name' => 'String',
                   'data' => 'No assertion failure when turning on PADSTALE on lexical shared by'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'line' => 484,
                   'kind' => Compiler::Lexer::Kind::T_Operator,
          ...
          bless( {
                   ...
                   'line' => 492,
                   'name' => 'RawString',
                   'data' => 'inlinable sub ret vals are not swipable'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'data' => ';',
                   'name' => 'SemiColon',
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          {
            'indent' => 0,
            'src' => ' sub blonk { ++ $blonk_was_called }',
            'start_line' => 30,
            'token_num' => 6,
            'block_id' => 0,
            'has_warnings' => 1,
          ...
          {
            'indent' => 0,
            'src' => ' sub { ok ( $blonk_was_called , \'RT #63540\' ) ; }',
            'start_line' => 43,
            'block_id' => 0,
            'token_num' => 10,
            'end_line' => 43,
          ...
          {
            'src' => ' ok ( $blonk_was_called , \'RT #63540\' ) ;',
            'indent' => 1,
            'start_line' => 43,
            'block_id' => 6,
            'token_num' => 7,
