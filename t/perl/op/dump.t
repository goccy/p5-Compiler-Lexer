...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => 'only tested on devel builds',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'data' => 'avoid coredump under ASan',
                   'kind' => Compiler::Lexer::Kind::T_Term
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'name' => 'RightParenthesis',
          ...
          bless( {
                   ...
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => 'Cannot chdir to work directory',
                   'type' => Compiler::Lexer::TokenType::T_String
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'line' => 43,
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'end_line' => 19,
            'token_num' => 10,
            'src' => ' skip_all ( "only tested on devel builds" ) unless $Config { usedevel } ;',
            'start_line' => 18,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'block_id' => 0,
            'indent' => 0,
            'src' => ' skip_all ( "no point in dumping on $^O" ) unless $^O =~/^(linux|.*bsd|solaris)$/ ;',
            'token_num' => 11
          },
          {
            'indent' => 0,
            ...
            'block_id' => 0,
            'token_num' => 14,
            'src' => ' skip_all ( "avoid coredump under ASan" ) if $Config { ccflags } =~/-fsanitize=/ ;',
            'end_line' => 30,
            'has_warnings' => 1
          },
          {
          ...
          },
          {
            'has_warnings' => 1,
            'end_line' => 43,
            'src' => ' chdir $tmp or skip_all ( "Cannot chdir to work directory" ) ;',
            'token_num' => 8,
            'indent' => 0,
            'start_line' => 42,
            'block_id' => 0
...
if ($pid) {
    ...
    print qq(B);
...
} , qr/A(?!B\\z)/ , { } , "dump with label quits" ) ;',
            'token_num' => 15,
            'start_line' => 83,
            'block_id' => 0,
            'indent' => 0
          ...
          {
            'token_num' => 6,
            'src' => ' chdir $start if defined $start ;',
            'indent' => 1,
            'start_line' => 100,
            'block_id' => 2,
            'has_warnings' => 1,
