...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => 'dist/Cwd/lib dist/Cwd ../dist/Cwd/lib ../dist/Cwd',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 12
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => ':DEFAULT splitdir rel2abs splitpath',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 40
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => '^The dirfd function is unimplemented at',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 82
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'verify that we are in \'base\'',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 123
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => '^The fchdir function is unimplemented at',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 131
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'chdir() on $^O ignores only \\$ENV{$key} set',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 142
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => '  no need to test SYS\\$LOGIN on $^O',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 144
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'chdir(undef) w/ only \\$ENV{$key} set',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 158
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => '  got uninit & deprecation warning',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 160
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'HereDocument',
                   'data' => 'Use of uninitialized value in chdir at $0 line 64.
Use of chdir(\'\') or chdir(undef) as chdir() is deprecated at $0 line 64.
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'HereDocument',
                   'data' => 'Use of chdir(\'\') or chdir(undef) as chdir() is deprecated at $0 line 76.
',
                   'type' => Compiler::Lexer::TokenType::T_HereDocument,
                   'line' => 174
                 }, 'Compiler::Lexer::Token' ),
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'Can\'t reset HOME, so chdir() test meaningless',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 224
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 13,
            'src' => ' if ( is_miniperl ( ) && ! eval { require File::Spec::Functions ; 1 } ) { push @INC , qw(dist/Cwd/lib dist/Cwd ../dist/Cwd/lib ../dist/Cwd) ; }',
            'start_line' => 11,
            'indent' => 1,
            'block_id' => 1
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 12,
            'src' => ' push @INC , qw(dist/Cwd/lib dist/Cwd ../dist/Cwd/lib ../dist/Cwd) ;',
            'start_line' => 12,
            'indent' => 2,
            'block_id' => 2
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 33,
            'src' => ' if ( $IsVMS ) { if ( eval \'require VMS::Feature\' ) { $vms_unix_rpt = VMS::Feature::current ( "filename_unix_report" ) ; $vms_efs = VMS::Feature::current ( "efs_charset" ) ; } else { my $unix_rpt = $ENV { \'DECC$FILENAME_UNIX_REPORT\' } || \'\' ; my $efs_charset = $ENV { \'DECC$EFS_CHARSET\' } || \'\' ; $vms_unix_rpt = $unix_rpt =~/^[ET1]/i ; $vms_efs = $efs_charset =~/^[ET1]/i ; } }',
            'start_line' => 23,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 27,
            'src' => ' if ( eval \'require VMS::Feature\' ) { $vms_unix_rpt = VMS::Feature::current ( "filename_unix_report" ) ; $vms_efs = VMS::Feature::current ( "efs_charset" ) ; }',
            'start_line' => 24,
            'indent' => 1,
            'block_id' => 3
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 25,
            'src' => ' $vms_unix_rpt = VMS::Feature::current ( "filename_unix_report" ) ;',
            'start_line' => 25,
            'indent' => 2,
            'block_id' => 4
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 26,
            'src' => ' $vms_efs = VMS::Feature::current ( "efs_charset" ) ;',
            'start_line' => 26,
            'indent' => 2,
            'block_id' => 4
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 32,
            'src' => ' else { my $unix_rpt = $ENV { \'DECC$FILENAME_UNIX_REPORT\' } || \'\' ; my $efs_charset = $ENV { \'DECC$EFS_CHARSET\' } || \'\' ; $vms_unix_rpt = $unix_rpt =~/^[ET1]/i ; $vms_efs = $efs_charset =~/^[ET1]/i ; }',
            'start_line' => 27,
            'indent' => 1,
            'block_id' => 3
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 28,
            'src' => ' my $unix_rpt = $ENV { \'DECC$FILENAME_UNIX_REPORT\' } || \'\' ;',
            'start_line' => 28,
            'indent' => 2,
            'block_id' => 5
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 29,
            'src' => ' my $efs_charset = $ENV { \'DECC$EFS_CHARSET\' } || \'\' ;',
            'start_line' => 29,
            'indent' => 2,
            'block_id' => 5
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 30,
            'src' => ' $vms_unix_rpt = $unix_rpt =~/^[ET1]/i ;',
            'start_line' => 30,
            'indent' => 2,
            'block_id' => 5
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 36,
            'src' => ' my $has_fchdir = ( $Config { d_fchdir } || "" ) eq "define" ;',
            'start_line' => 36,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 40,
            'src' => ' use File::Spec::Functions qw(:DEFAULT splitdir rel2abs splitpath) ;',
            'start_line' => 40,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 48,
            'src' => ' sub abs_path { my $d = rel2abs ( curdir ) ; $d = lc ( $d ) if $^O =~/^uwin/ ; $d ; }',
            'start_line' => 44,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 54,
            'src' => ' my ( $vol , $dir ) = splitpath ( abs_path , 1 ) ;',
            'start_line' => 54,
            'indent' => 1,
            'block_id' => 7
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 56,
            'src' => ' my $compare_dir = ( splitdir ( $dir ) ) [ -1 ] ;',
            'start_line' => 56,
            'indent' => 1,
            'block_id' => 7
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 61,
            'src' => ' $compare_dir = lc ( $compare_dir ) if $IsVMS ;',
            'start_line' => 61,
            'indent' => 1,
            'block_id' => 7
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 62,
            'src' => ' skip ( "Already in t/" , 2 ) if $compare_dir eq $test_dir ;',
            'start_line' => 62,
            'indent' => 1,
            'block_id' => 7
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 64,
            'src' => ' ok ( chdir ( $test_dir ) , \'chdir($test_dir)\' ) ;',
            'start_line' => 64,
            'indent' => 1,
            'block_id' => 7
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 65,
            'src' => ' is ( abs_path , catdir ( $Cwd , $test_dir ) , \'  abs_path() agrees\' ) ;',
            'start_line' => 65,
            'indent' => 1,
            'block_id' => 7
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 71,
            'src' => ' skip ( "no fchdir" , 16 ) unless $has_fchdir ;',
            'start_line' => 71,
            'indent' => 1,
            'block_id' => 8
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 72,
            'src' => ' my $has_dirfd = ( $Config { d_dirfd } || $Config { d_dir_dd_fd } || "" ) eq "define" ;',
            'start_line' => 72,
            'indent' => 1,
            'block_id' => 8
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 76,
            'src' => ' ok ( -f "chdir.t" , "verify that we are in op" ) ;',
            'start_line' => 76,
            'indent' => 1,
            'block_id' => 8
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 79,
            'src' => ' if ( $has_dirfd ) { ok ( chdir ( $dh ) , "fchdir back" ) ; }',
            'start_line' => 77,
            'indent' => 1,
            'block_id' => 8
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 84,
            'src' => ' else { eval { chdir ( $dh ) ; } ; like ( $@ , qr/^The dirfd function is unimplemented at/ , "dirfd is unimplemented" ) ; chdir ".." or die $! ; }',
            'start_line' => 80,
            'indent' => 1,
            'block_id' => 8
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 82,
            'src' => ' like ( $@ , qr/^The dirfd function is unimplemented at/ , "dirfd is unimplemented" ) ;',
            'start_line' => 82,
            'indent' => 2,
            'block_id' => 10
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 90,
            'src' => ' ok ( chdir FH , "fchdir op bareword" ) ;',
            'start_line' => 90,
            'indent' => 1,
            'block_id' => 8
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 94,
            'src' => ' if ( $has_dirfd ) { ok ( chdir DH , "fchdir back bareword" ) ; }',
            'start_line' => 92,
            'indent' => 1,
            'block_id' => 8
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 93,
            'src' => ' ok ( chdir DH , "fchdir back bareword" ) ;',
            'start_line' => 93,
            'indent' => 2,
            'block_id' => 11
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 100,
            'src' => ' ok ( -d "op" , "verify that we are back" ) ;',
            'start_line' => 100,
            'indent' => 1,
            'block_id' => 8
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 107,
            'src' => ' { no warnings qw<io deprecated> ; ok ( opendir ( H , "op" ) , "opendir op" ) or diag $! ; ok ( open ( H , "<" , "base" ) , "open base" ) or diag $! ; }',
            'start_line' => 103,
            'indent' => 1,
            'block_id' => 8
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 104,
            'src' => ' no warnings qw<io deprecated> ;',
            'start_line' => 104,
            'indent' => 2,
            'block_id' => 13
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 105,
            'src' => ' ok ( opendir ( H , "op" ) , "opendir op" ) or diag $! ;',
            'start_line' => 105,
            'indent' => 2,
            'block_id' => 13
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 106,
            'src' => ' ok ( open ( H , "<" , "base" ) , "open base" ) or diag $! ;',
            'start_line' => 106,
            'indent' => 2,
            'block_id' => 13
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 112,
            'src' => ' if ( $has_dirfd ) { ok ( chdir ( H ) , "fchdir to op" ) ; ok ( -f "chdir.t" , "verify that we are in \'op\'" ) ; chdir ".." or die $! ; }',
            'start_line' => 108,
            'indent' => 1,
            'block_id' => 8
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 120,
            'src' => ' else { eval { chdir ( H ) ; } ; like ( $@ , qr/^The dirfd function is unimplemented at/ , "dirfd is unimplemented" ) ; SKIP : { skip ( "dirfd is unimplemented" ) ; } }',
            'start_line' => 113,
            'indent' => 1,
            'block_id' => 8
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 118,
            'src' => ' skip ( "dirfd is unimplemented" ) ;',
            'start_line' => 118,
            'indent' => 3,
            'block_id' => 16
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 123,
            'src' => ' ok ( -f "cond.t" , "verify that we are in \'base\'" ) ;',
            'start_line' => 123,
            'indent' => 1,
            'block_id' => 8
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 128,
            'src' => ' skip ( "has fchdir" , 1 ) if $has_fchdir ;',
            'start_line' => 128,
            'indent' => 1,
            'block_id' => 17
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 131,
            'src' => ' like ( $@ , qr/^The fchdir function is unimplemented at/ , "fchdir is unimplemented" ) ;',
            'start_line' => 131,
            'indent' => 1,
            'block_id' => 17
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 135,
            'src' => ' my @magic_envs = qw(HOME LOGDIR SYS$LOGIN) ;',
            'start_line' => 135,
            'indent' => 0,
            'block_id' => 0
          },
...
Use of chdir(\'\') or chdir(undef) as chdir() is deprecated at $0 line 64.
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 145,
            'src' => ' if ( $key eq \'SYS$LOGIN\' && ! $IsVMS ) { ok ( ! chdir ( ) , "chdir() on $^O ignores only \\$ENV{$key} set" ) ; is ( abs_path , $Cwd , \'  abs_path() did not change\' ) ; pass ( "  no need to test SYS\\$LOGIN on $^O" ) for 1 .. 7 ; }',
            'start_line' => 141,
            'indent' => 1,
            'block_id' => 18
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 142,
            'src' => ' ok ( ! chdir ( ) , "chdir() on $^O ignores only \\$ENV{$key} set" ) ;',
            'start_line' => 142,
            'indent' => 2,
            'block_id' => 19
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 143,
            'src' => ' is ( abs_path , $Cwd , \'  abs_path() did not change\' ) ;',
            'start_line' => 143,
            'indent' => 2,
            'block_id' => 19
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 144,
            'src' => ' pass ( "  no need to test SYS\\$LOGIN on $^O" ) for 1 .. 7 ;',
            'start_line' => 144,
            'indent' => 2,
            'block_id' => 19
          },
...
Use of chdir(\'\') or chdir(undef) as chdir() is deprecated at $0 line 64.
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 147,
            'src' => ' ok ( chdir ( ) , "chdir() w/ only \\$ENV{$key} set" ) ;',
            'start_line' => 147,
            'indent' => 2,
            'block_id' => 20
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 148,
            'src' => ' is ( abs_path , $ENV { $key } , \'  abs_path() agrees\' ) ;',
            'start_line' => 148,
            'indent' => 2,
            'block_id' => 20
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 150,
            'src' => ' is ( abs_path , $Cwd , \'  and back again\' ) ;',
            'start_line' => 150,
            'indent' => 2,
            'block_id' => 20
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 153,
            'src' => ' local $SIG { __WARN__ } = sub { $warning .= join \'\' , @_ } ;',
            'start_line' => 153,
            'indent' => 2,
            'block_id' => 20
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 158,
            'src' => ' ok ( chdir ( undef ) , "chdir(undef) w/ only \\$ENV{$key} set" ) ;',
            'start_line' => 158,
            'indent' => 2,
            'block_id' => 20
          },
...
Use of chdir(\'\') or chdir(undef) as chdir() is deprecated at $0 line 64.
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 197,
            'src' => ' sub clean_env { foreach my $env ( @magic_envs ) { $Saved_Env { $env } = $ENV { $env } ; next if $IsVMS && $env eq \'SYS$LOGIN\' ; next if $IsVMS && $env eq \'HOME\' && ! $Config { \'d_setenv\' } ; delete $ENV { $env } while exists $ENV { $env } ; } $ENV { \'SYS$LOGIN\' } = \'\' if $IsVMS ; }',
            'start_line' => 181,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 191,
            'src' => ' foreach my $env ( @magic_envs ) { $Saved_Env { $env } = $ENV { $env } ; next if $IsVMS && $env eq \'SYS$LOGIN\' ; next if $IsVMS && $env eq \'HOME\' && ! $Config { \'d_setenv\' } ; delete $ENV { $env } while exists $ENV { $env } ; }',
            'start_line' => 182,
            'indent' => 1,
            'block_id' => 22
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 186,
            'src' => ' next if $IsVMS && $env eq \'SYS$LOGIN\' ;',
            'start_line' => 186,
            'indent' => 2,
            'block_id' => 23
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 187,
            'src' => ' next if $IsVMS && $env eq \'HOME\' && ! $Config { \'d_setenv\' } ;',
            'start_line' => 187,
            'indent' => 2,
            'block_id' => 23
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 190,
            'src' => ' delete $ENV { $env } while exists $ENV { $env } ;',
            'start_line' => 190,
            'indent' => 2,
            'block_id' => 23
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 203,
            'src' => ' @ENV { @magic_envs } = @Saved_Env { @magic_envs } ;',
            'start_line' => 203,
            'indent' => 1,
            'block_id' => 24
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 207,
            'src' => ' delete $ENV { \'SYS$LOGIN\' } if $IsVMS ;',
            'start_line' => 207,
            'indent' => 1,
            'block_id' => 24
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 219,
            'src' => ' foreach my $key ( @magic_envs ) { no warnings \'uninitialized\' ; clean_env ; $ENV { $key } = catdir $Cwd , ( $IsVMS ? \'OP\' : \'op\' ) ; check_env ( $key ) ; }',
            'start_line' => 211,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 216,
            'src' => ' $ENV { $key } = catdir $Cwd , ( $IsVMS ? \'OP\' : \'op\' ) ;',
            'start_line' => 216,
            'indent' => 1,
            'block_id' => 25
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 229,
            'src' => ' { clean_env ; if ( $IsVMS && ! $Config { \'d_setenv\' } ) { pass ( "Can\'t reset HOME, so chdir() test meaningless" ) ; } else { ok ( ! chdir ( ) , \'chdir() w/o any ENV set\' ) ; } is ( abs_path , $Cwd , \'  abs_path() agrees\' ) ; }',
            'start_line' => 221,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 225,
            'src' => ' if ( $IsVMS && ! $Config { \'d_setenv\' } ) { pass ( "Can\'t reset HOME, so chdir() test meaningless" ) ; }',
            'start_line' => 223,
            'indent' => 1,
            'block_id' => 26
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 224,
            'src' => ' pass ( "Can\'t reset HOME, so chdir() test meaningless" ) ;',
            'start_line' => 224,
            'indent' => 2,
            'block_id' => 27
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 227,
            'src' => ' else { ok ( ! chdir ( ) , \'chdir() w/o any ENV set\' ) ; }',
            'start_line' => 225,
            'indent' => 1,
            'block_id' => 26
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 226,
            'src' => ' ok ( ! chdir ( ) , \'chdir() w/o any ENV set\' ) ;',
            'start_line' => 226,
            'indent' => 2,
            'block_id' => 28
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 228,
            'src' => ' is ( abs_path , $Cwd , \'  abs_path() agrees\' ) ;',
            'start_line' => 228,
            'indent' => 1,
            'block_id' => 26
          }
...
subtest 'get_used_modules' => sub {
    ...
    is_deeply($modules, [
          ...
          {
            'args' => '  qw ( :DEFAULT splitdir rel2abs splitpath )',
