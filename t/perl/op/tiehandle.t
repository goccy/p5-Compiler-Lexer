...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'line' => 206,
                   'data' => '  and it\'s localized, even for undef \\$\\\\',
                   'name' => 'String'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'line' => 206,
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          {
            'start_line' => 206,
            'src' => ' :: is ( $\\ , undef , "  and it\'s localized, even for undef \\$\\\\" ) ;',
            'indent' => 1,
            'has_warnings' => 1,
            'end_line' => 206,
            'token_num' => 10,
