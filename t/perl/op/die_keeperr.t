...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          {
            'indent' => 0,
            'src' => ' { no warnings "misc" ; my $warn = "" ; local $SIG { __WARN__ } = sub { $warn .= $_ [ 0 ] } ; { my $e = end { no warnings "misc" ; die "aa\\n" ; } ; } is $warn , "" ; }',
            'start_line' => 30,
            'block_id' => 0,
            'token_num' => 48,
            'has_warnings' => 1,
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 44,
            'src' => ' { no warnings "misc" ; my $warn = "" ; local $SIG { __WARN__ } = sub { $warn .= $_ [ 0 ] } ; { my $e = end { use warnings "misc" ; die "aa\\n" ; } ; } is $warn , "\\t(in cleanup) aa\\n" ; }',
            'indent' => 0,
            'start_line' => 38
          },
          {
          ...
          },
          {
            ...
            'start_line' => 42,
            'indent' => 1,
            'src' => ' { my $e = end { use warnings "misc" ; die "aa\\n" ; } ; }'
          },
          {
            'start_line' => 42,
            'src' => ' my $e = end { use warnings "misc" ; die "aa\\n" ; } ;',
          ...
          {
            'indent' => 0,
            'src' => ' { my $warn = "" ; local $SIG { __WARN__ } = sub { $warn .= $_ [ 0 ] } ; { my $e = end { use warnings "misc" ; die "aa\\n" ; } ; } is $warn , "\\t(in cleanup) aa\\n" ; }',
            'start_line' => 53,
            'has_warnings' => 1,
            'end_line' => 58,
            'token_num' => 44,
          ...
          },
          {
            ...
            'token_num' => 48,
            'start_line' => 60,
            'src' => ' { use warnings "misc" ; my $warn = "" ; local $SIG { __WARN__ } = sub { $warn .= $_ [ 0 ] } ; { my $e = end { no warnings "misc" ; die "aa\\n" ; } ; } is $warn , "" ; }',
            'indent' => 0
          },
          {
            'start_line' => 61,
          ...
          },
          {
            ...
            'block_id' => 0,
            'start_line' => 68,
            'src' => ' { use warnings "misc" ; my $warn = "" ; local $SIG { __WARN__ } = sub { $warn .= $_ [ 0 ] } ; { my $e = end { use warnings "misc" ; die "aa\\n" ; } ; } is $warn , "\\t(in cleanup) aa\\n" ; }',
            'indent' => 0
          },
          {
            'indent' => 1,
