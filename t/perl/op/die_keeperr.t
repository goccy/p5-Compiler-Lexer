...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 14,
            'src' => ' sub end ( & ) { my ( $c ) = @_ ; return bless ( sub { $c-> ( ) } , "End" ) ; }',
            'start_line' => 11,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 23,
            'src' => ' { $@ = $outx ; my $e = end { die $inx if $inx } ; }',
            'start_line' => 20,
            'indent' => 2,
            'block_id' => 6
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 24,
            'src' => ' ok ref ( $@ ) eq ref ( $outx ) && $@ eq $outx ;',
            'start_line' => 24,
            'indent' => 2,
            'block_id' => 6
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 26,
            'src' => ' is $warn , $inx ? "\\t(in cleanup) $inx" : "" ;',
            'start_line' => 26,
            'indent' => 2,
            'block_id' => 6
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 36,
            'src' => ' { no warnings "misc" ; my $warn = "" ; local $SIG { __WARN__ } = sub { $warn .= $_ [ 0 ] } ; { my $e = end { die "aa\\n" ; } ; } is $warn , "" ; }',
            'start_line' => 30,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 43,
            'src' => ' { my $warn = "" ; local $SIG { __WARN__ } = sub { $warn .= $_ [ 0 ] } ; { my $e = end { no warnings "misc" ; die "aa\\n" ; } ; } is $warn , "\\t(in cleanup) aa\\n" ; }',
            'start_line' => 38,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 41,
            'src' => ' { my $e = end { no warnings "misc" ; die "aa\\n" ; } ; }',
            'start_line' => 41,
            'indent' => 1,
            'block_id' => 12
          },
