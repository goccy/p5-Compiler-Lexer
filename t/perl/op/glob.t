...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'ExecString',
                   'data' => 'dir /b /l op & dir /b /l /ah op 2>nul',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'ExecString',
                   'data' => 'directory/noheading/notrailing/versions=1 [.op]',
                   'type' => Compiler::Lexer::TokenType::T_ExecString,
                   'line' => 19
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'sane input record separator',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 27
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'input record separator still sane',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 36
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'remove File::Glob stash *and* CORE::GLOBAL::glob',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 61
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'undefined *CORE::GLOBAL::glob{CODE} at run time',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 67
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'undefined *CORE::GLOBAL::glob{CODE} at compile time',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 74
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'no File::Glob to emulate Unix-ism',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 80
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'test definedness with LOGOP',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 93
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => '~ globbing returns nothing on VMS',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 99
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'CORE::glob bypasses overrides',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 111
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 16,
            'src' => ' if ( $^O eq \'MSWin32\' ) { map { $files { lc ( $_ ) } ++ } < op / * > ; map { delete $files { "op/$_" } } split/[\\s\\n]/ , `dir /b /l op & dir /b /l /ah op 2>nul` , }',
            'start_line' => 13,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 20,
            'src' => ' elsif ( $^O eq \'VMS\' ) { map { $files { lc ( $_ ) } ++ } < [ . op ] * > ; map { s/;.*$// ; delete $files { lc ( $_ ) } ; } split/[\\n]/ , `directory/noheading/notrailing/versions=1 [.op]` , }',
            'start_line' => 17,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 24,
            'src' => ' else { map { $files { $_ } ++ } < op / * > ; map { delete $files { $_ } } split/[\\s\\n]/ , `echo op/*` ; }',
            'start_line' => 21,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 23,
            'src' => ' map { delete $files { $_ } } split/[\\s\\n]/ , `echo op/*` ;',
            'start_line' => 23,
            'indent' => 1,
            'block_id' => 4
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 25,
            'src' => ' ok ( ! ( keys ( %files ) ) , \'leftover op/* files\' ) or diag ( join ( \' \' , sort keys %files ) ) ;',
            'start_line' => 25,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 33,
            'src' => ' while ( < jskdfjskdfj * op / * jskdjfjkosvk * > ) { $not = "not " unless $_ eq shift @ops ; $not = "not at all " if $/ eq "\\0" ; }',
            'start_line' => 30,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 31,
            'src' => ' $not = "not " unless $_ eq shift @ops ;',
            'start_line' => 31,
            'indent' => 1,
            'block_id' => 5
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 34,
            'src' => ' ok ( ! $not , "glob amid garbage [$not]" ) ;',
            'start_line' => 34,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 40,
            'src' => ' cmp_ok ( "@glops" , \'eq\' , "@oops" , \'glob operator 1\' ) ;',
            'start_line' => 40,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 43,
            'src' => ' cmp_ok ( "@glops" , \'eq\' , "@oops" , \'glob operator 2\' ) ;',
            'start_line' => 43,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 53,
            'src' => ' for ( 1 .. 2 ) { eval "<.>" ; ok ( ! length ( $@ ) , "eval\'ed a glob $_" ) ; local %File::Glob::; ++ $i ; }',
            'start_line' => 48,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 50,
            'src' => ' ok ( ! length ( $@ ) , "eval\'ed a glob $_" ) ;',
            'start_line' => 50,
            'indent' => 1,
            'block_id' => 6
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 54,
            'src' => ' cmp_ok ( $i , \'==\' , 2 , \'remove File::Glob stash\' ) ;',
            'start_line' => 54,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 61,
            'src' => ' ok ( ! length ( $@ ) , "remove File::Glob stash *and* CORE::GLOBAL::glob" ) ;',
            'start_line' => 61,
            'indent' => 1,
            'block_id' => 7
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 68,
            'src' => ' { local * CORE::GLOBAL::glob ; ok eval { glob ( "0" ) ; 1 } , \'undefined *CORE::GLOBAL::glob{CODE} at run time\' ; }',
            'start_line' => 64,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 67,
            'src' => ' ok eval { glob ( "0" ) ; 1 } , \'undefined *CORE::GLOBAL::glob{CODE} at run time\' ;',
            'start_line' => 66,
            'indent' => 1,
            'block_id' => 8
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 81,
            'src' => ' skip ( \'no File::Glob to emulate Unix-ism\' , 1 ) unless $INC { \'File/Glob.pm\' } ;',
            'start_line' => 80,
            'indent' => 1,
            'block_id' => 10
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 94,
            'src' => ' { my $f = 0 ; my $ok = 1 ; $ok = 0 , undef $f while $x = $f || $f ; ok ( $ok , \'test definedness with LOGOP\' ) ; }',
            'start_line' => 89,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 93,
            'src' => ' ok ( $ok , \'test definedness with LOGOP\' ) ;',
            'start_line' => 93,
            'indent' => 1,
            'block_id' => 11
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 96,
            'src' => ' cmp_ok ( scalar ( @oops ) , \'>\' , 0 , \'glob globbed something\' ) ;',
            'start_line' => 96,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 99,
            'src' => ' skip "~ globbing returns nothing on VMS" , 1 if $^O eq \'VMS\' ;',
            'start_line' => 99,
            'indent' => 1,
            'block_id' => 12
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 112,
            'src' => ' { my $called ; local * CORE::GLOBAL::glob = sub { ++ $called } ; eval \'CORE::glob("0")\' ; ok ! $called , \'CORE::glob bypasses overrides\' ; }',
            'start_line' => 107,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 109,
            'src' => ' local * CORE::GLOBAL::glob = sub { ++ $called } ;',
            'start_line' => 109,
            'indent' => 1,
            'block_id' => 13
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 111,
            'src' => ' ok ! $called , \'CORE::glob bypasses overrides\' ;',
            'start_line' => 111,
            'indent' => 1,
            'block_id' => 13
          }
