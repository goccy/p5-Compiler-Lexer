...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   'name' => 'RawString',
                   'data' => '$2b$12$FPWWO2RJ3CK4FINTw0Hi',
                   'line' => 42,
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
          ...
          bless( {
                   ...
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'name' => 'RawString',
                   'data' => 'crypt writing to utf8 target'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'data' => ';',
                   'name' => 'SemiColon',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'line' => 70,
                   'data' => 'crypt turns off utf8 on its target',
                   'name' => 'RawString'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'data' => ';',
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'block_id' => 0,
            'start_line' => 38,
            'src' => ' if ( ! defined ( crypt ( "ab" , $alg . "cd" ) ) ) { $alg = \'$5$\' ; }',
            'indent' => 0
          },
          {
            'indent' => 1,
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 43,
            'src' => ' if ( ! defined ( crypt ( "ab" , $alg . "cd" ) ) ) { $alg = \'$2b$12$FPWWO2RJ3CK4FINTw0Hi\' ; }',
            'indent' => 0,
            'start_line' => 41
          },
          {
            'src' => ' $alg = \'$2b$12$FPWWO2RJ3CK4FINTw0Hi\' ;',
            'indent' => 1,
            'start_line' => 42,
            'block_id' => 6,
            'token_num' => 4,
          ...
          {
            'start_line' => 44,
            'src' => ' if ( ! defined ( crypt ( "ab" , $alg . "cd" ) ) ) { $alg = \'\' ; }',
            'indent' => 0,
            'block_id' => 0,
            'token_num' => 21,
            'has_warnings' => 1,
          ...
          {
            'src' => ' ok ( substr ( crypt ( "ab" , $alg . "cd" ) , length ( $alg ) + 2 ) ne substr ( crypt ( "ab" , $alg . "ce" ) , length ( $alg ) + 2 ) , "salt makes a difference" ) ;',
            'indent' => 1,
            'start_line' => 50,
            'has_warnings' => 1,
            'end_line' => 52,
          ...
          },
          {
            ...
            'start_line' => 64,
            'indent' => 0,
            'src' => ' is ( $b , crypt ( "a\\xFF" , $alg . "cd" ) , "downgrade results agree" ) ;'
          },
          {
            'indent' => 0,
            'src' => ' my $x = chr 256 ;',
          ...
          {
            'indent' => 0,
            'src' => ' is $x , crypt ( "foo" , "bar" ) , \'crypt writing to utf8 target\' ;',
            'start_line' => 69,
            'block_id' => 0,
            'token_num' => 12,
            'has_warnings' => 1,
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'start_line' => 70,
            'src' => ' ok ! utf8::is_utf8 ( $x ) , \'crypt turns off utf8 on its target\' ;',
            'indent' => 0
          }
        ]
