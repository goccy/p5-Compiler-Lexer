...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'downgrade to eight bit characters',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 44
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 15,
            'src' => ' if ( ! $Config { d_crypt } ) { skip_all ( "crypt unimplemented" ) ; }',
            'start_line' => 13,
            'indent' => 1,
            'block_id' => 2
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 14,
            'src' => ' skip_all ( "crypt unimplemented" ) ;',
            'start_line' => 14,
            'indent' => 2,
            'block_id' => 3
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 32,
            'src' => ' skip ( "VOS crypt ignores salt." , 1 ) if ( $^O eq \'vos\' ) ;',
            'start_line' => 32,
            'indent' => 1,
            'block_id' => 5
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 33,
            'src' => ' ok ( substr ( crypt ( "ab" , "cd" ) , 2 ) ne substr ( crypt ( "ab" , "ce" ) , 2 ) , "salt makes a difference" ) ;',
            'start_line' => 33,
            'indent' => 1,
            'block_id' => 5
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 39,
            'src' => ' like ( $@ , qr/Wide character in crypt/ , "wide characters ungood" ) ;',
            'start_line' => 39,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 44,
            'src' => ' is ( $@ , \'\' , "downgrade to eight bit characters" ) ;',
            'start_line' => 44,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 45,
            'src' => ' is ( $b , crypt ( "a\\xFF" , "cd" ) , "downgrade results agree" ) ;',
            'start_line' => 45,
            'indent' => 0,
            'block_id' => 0
          }
