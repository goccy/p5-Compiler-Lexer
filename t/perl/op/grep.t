...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'name' => 'RawString',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => '[perl #78194] \\$_ == \\$_ inside grep ..., "$x"',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0
                 }, 'Compiler::Lexer::Token' ),
          ...
          bless( {
                   ...
                   'name' => 'RawString',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => '[perl #78194] \\$_ == \\$_ inside map ..., "$x"',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value
                 }, 'Compiler::Lexer::Token' ),
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'start_line' => 219,
            'indent' => 0,
            'src' => ' grep is ( \\ $_ , \\ $_ , \'[perl #78194] \\$_ == \\$_ inside grep ..., "$x"\' ) , "${\\\'\'}" , "${\\\'\'}" ;',
            'token_num' => 16
          },
          {
            'has_warnings' => 1,
            'end_line' => 222,
            'src' => ' map is ( \\ $_ , \\ $_ , \'[perl #78194] \\$_ == \\$_ inside map ..., "$x"\' ) , "${\\\'\'}" , "${\\\'\'}" ;',
            'token_num' => 16,
            'block_id' => 0,
            'start_line' => 221,
            'indent' => 0
          ...
          {
            'src' => ' { my @a = map { 1 ; "$_" } 1 , 2 ; is ( "@a" , "1 2" , "PADTMP" ) ; }',
            'token_num' => 24,
            'start_line' => 237,
            'indent' => 0,
            'block_id' => 0,
