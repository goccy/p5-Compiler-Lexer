...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'line' => 18,
                   'name' => 'RawString',
                   'data' => 'compile time sqrt(-1) fails'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'line' => 18,
                   'has_warnings' => 0,
          ...
          bless( {
                   'name' => 'RawString',
                   'data' => 'compile time sqrt(2) == 1.414',
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
          ...
          bless( {
                   'data' => '1.4142135623730950488016887242097',
                   'name' => 'RawString',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'has_warnings' => 0,
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            'start_line' => 18,
            'indent' => 0,
            'src' => ' like ( $@ , qr/sqrt of -1/ , \'compile time sqrt(-1) fails\' ) ;',
            'token_num' => 12,
            'block_id' => 0,
            'end_line' => 18,
            'has_warnings' => 1
          ...
          {
            'src' => ' is ( $s , 0 , \'compile time sqrt(0)\' ) ;',
            'indent' => 0,
            'start_line' => 21,
            'block_id' => 0,
            'token_num' => 9,
          ...
          {
            'src' => ' is ( $s , 1 , \'compile time sqrt(1)\' ) ;',
            'indent' => 0,
            'start_line' => 24,
            'end_line' => 24,
            'has_warnings' => 1,
          ...
          {
            'src' => ' is ( substr ( $s , 0 , 5 ) , \'1.414\' , \'compile time sqrt(2) == 1.414\' ) ;',
            'indent' => 0,
            'start_line' => 27,
            'block_id' => 0,
            'token_num' => 16,
          ...
          },
          {
            ...
            'end_line' => 30,
            'start_line' => 30,
            'src' => ' is ( $s , 1 , \'compile time exp(0) == 1\' ) ;',
            'indent' => 0
          },
          {
            'block_id' => 0,
          ...
          },
          {
            ...
            'start_line' => 33,
            'indent' => 0,
            'src' => ' is ( substr ( $s , 0 , 7 ) , \'2.71828\' , \'compile time exp(1) == e\' ) ;'
          },
          {
            'block_id' => 0,
            'token_num' => 10,
          ...
          },
          {
            ...
            'start_line' => 36,
            'indent' => 0,
            'src' => ' like ( $@ , qr/log of 0/ , \'compile time log(0) fails\' ) ;'
          },
          {
            'indent' => 0,
            'src' => ' $s = log ( 1 ) ;',
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'start_line' => 39,
            'src' => ' is ( $s , 0 , \'compile time log(1) == 0\' ) ;',
            'indent' => 0
          },
          {
            'block_id' => 0,
          ...
          {
            'start_line' => 42,
            'src' => ' is ( substr ( $s , 0 , 5 ) , \'0.693\' , \'compile time log(2)\' ) ;',
            'indent' => 0,
            'token_num' => 16,
            'block_id' => 0,
            'has_warnings' => 1,
          ...
          {
            'indent' => 0,
            'src' => ' cmp_ok ( exp ( log ( 1 ) ) , \'==\' , 1 , \'compile time exp(log(1)) == 1\' ) ;',
            'start_line' => 44,
            'has_warnings' => 1,
            'end_line' => 44,
            'block_id' => 0,
          ...
          },
          {
            ...
            'start_line' => 46,
            'indent' => 0,
            'src' => ' cmp_ok ( round ( atan2 ( 1 , 2 ) ) , \'==\' , \'0.463647609\' , "atan2(1, 2)" ) ;'
          },
          {
            'src' => ' $x0 = 0 ;',
            'indent' => 0,
          ...
          {
            'start_line' => 55,
            'src' => ' like ( $@ , qr/sqrt of -1/ , \'run time sqrt(-1) fails\' ) ;',
            'indent' => 0,
            'token_num' => 12,
            'block_id' => 0,
            'has_warnings' => 1,
          ...
          },
          {
            ...
            'start_line' => 64,
            'indent' => 0,
            'src' => ' is ( substr ( $s , 0 , 5 ) , \'1.414\' , \'run time sqrt(2) == 1.414\' ) ;'
          },
          {
            'token_num' => 7,
            'block_id' => 0,
          ...
          },
          {
            ...
            'block_id' => 0,
            'token_num' => 16,
            'src' => ' is ( substr ( $s , 0 , 7 ) , \'2.71828\' , \'run time exp(1) = e\' ) ;',
            'indent' => 0,
            'start_line' => 70
          },
          {
          ...
          },
          {
            ...
            'end_line' => 73,
            'has_warnings' => 1,
            'src' => ' like ( $@ , qr/log of 0/ , \'run time log(0) fails\' ) ;',
            'indent' => 0,
            'start_line' => 73
          },
          {
          ...
          },
          {
            ...
            'end_line' => 79,
            'indent' => 0,
            'src' => ' is ( substr ( $s , 0 , 5 ) , \'0.693\' , \'run time log(2)\' ) ;',
            'start_line' => 79
          },
          {
            'token_num' => 17,
            ...
            'has_warnings' => 1,
            'indent' => 0,
            'src' => ' cmp_ok ( exp ( log ( $x1 ) ) , \'==\' , 1 , \'run time exp(log(1)) == 1\' ) ;',
            'start_line' => 81
          },
          {
            'token_num' => 5,
            ...
            'has_warnings' => 0,
            'start_line' => 88,
            'src' => ' my $pi_2 = 1.5707963267949 ;',
            'indent' => 0
          },
          {
            'start_line' => 90,
            'src' => ' sub round { my $result = shift ; return sprintf ( "%.9f" , $result ) ; }',
            'indent' => 0,
            'has_warnings' => 1,
            'end_line' => 93,
            'block_id' => 0,
          ...
          },
          {
            ...
            'token_num' => 20,
            'indent' => 0,
            'src' => ' cmp_ok ( abs ( sin ( $pi_2 ) - 1 ) , \'<\' , 1e -9 , \'sin(pi/2) == 1\' ) ;',
            'start_line' => 97
          },
          {
            'start_line' => 98,
            'src' => ' cmp_ok ( abs ( sin ( -1 * $pi_2 ) - -1 ) , \'<\' , 1e -9 , \'sin(-pi/2) == -1\' ) ;',
            'indent' => 0,
            'token_num' => 22,
            'block_id' => 0,
            'end_line' => 98,
          ...
          {
            'indent' => 0,
            'src' => ' cmp_ok ( round ( sin ( $x1 ) ) , \'==\' , \'0.841470985\' , "sin(1)" ) ;',
            'start_line' => 100,
            'block_id' => 0,
            'token_num' => 17,
            'end_line' => 100,
          ...
          },
          {
            ...
            'block_id' => 0,
            'token_num' => 18,
            'src' => ' cmp_ok ( abs ( cos ( $pi_2 ) ) , \'<\' , 1e -9 , \'cos(pi/2) == 0\' ) ;',
            'indent' => 0,
            'start_line' => 104
          },
          {
            ...
            'block_id' => 0,
            'token_num' => 20,
            'src' => ' cmp_ok ( abs ( cos ( -1 * $pi_2 ) ) , \'<\' , 1e -9 , \'cos(-pi/2) == 0\' ) ;',
            'indent' => 0,
            'start_line' => 105
          },
          {
            'start_line' => 107,
            'indent' => 0,
            'src' => ' cmp_ok ( round ( cos ( $x1 ) ) , \'==\' , \'0.540302306\' , "cos(1)" ) ;',
            'token_num' => 17,
            'block_id' => 0,
            'has_warnings' => 1,
            'end_line' => 107
          },
          {
            ...
            'has_warnings' => 1,
            'indent' => 0,
            'src' => ' cmp_ok ( round ( atan2 ( $x1 , $x2 ) ) , \'==\' , \'0.463647609\' , "atan2($x1, $x2)" ) ;',
            'start_line' => 109
          },
          {
            'start_line' => 116,
            'indent' => 1,
            'src' => ' unless ( $Config { usequadmath } ) { skip "need usequadmath" , 1 ; }',
            'has_warnings' => 1,
            'end_line' => 118,
            'token_num' => 14,
            'block_id' => 3
          ...
          },
          {
            'start_line' => 120,
            'indent' => 1,
            'src' => ' is ( sqrt ( 2 ) , \'1.4142135623730950488016887242097\' , "quadmath sqrt" ) ;',
            'token_num' => 12,
            'block_id' => 3,
            'end_line' => 120,
            'has_warnings' => 1
