...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 28,
            'src' => ' unless ( $pid ) { open STDERR , ">&STDOUT" ; $a = "hello \\x{1234}" ; for ( 1 .. 2 ) { bar ( substr ( $a , $_ , 1 ) ) ; } sub bar { $_ [ 0 ] = "\\x{4321}" ; Devel::Peek::Dump ( $_ [ 0 ] ) ; } exit ; }',
            'start_line' => 17,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 26,
            'src' => ' sub bar { $_ [ 0 ] = "\\x{4321}" ; Devel::Peek::Dump ( $_ [ 0 ] ) ; }',
            'start_line' => 23,
            'indent' => 1,
            'block_id' => 2
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 37,
            'src' => ' unlike ( $_ , qr{ $utf8magic $utf8magic }x ) ;',
            'start_line' => 37,
            'indent' => 0,
            'block_id' => 0
          }
