...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    sub bar {
        ...
        Devel::Peek::Dump($_[0]);
          ...
          {
            'start_line' => 48,
            'src' => ' { local ${ ^UTF8CACHE } = 1 ; my $x = "\\x{100}" x 1000000 ; while ( $x =~/./g ) { my $p = pos ( $x ) ; } pass ( "quadratic pos" ) ; }',
            'indent' => 0,
            'block_id' => 0,
            'token_num' => 40,
            'end_line' => 55,
          ...
          },
          {
            ...
            'start_line' => 75,
            'indent' => 0,
            'src' => ' sub { $_ [ 0 ] = "a\\x{100}" ; ( ) = ord substr $_ [ 0 ] , 1 , 1 ; $h { k } = "\\x{100}" x2 ; is ord substr ( $_ [ 0 ] , 1 , 1 ) , 0x100 , \'get-magic resets uf8cache on defelems\' ; }'
          },
          {
            'src' => ' $_ [ 0 ] = "a\\x{100}" ;',
            'indent' => 1,
