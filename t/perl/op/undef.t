...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   'data' => 'undef constants preserve identity',
                   'name' => 'RawString',
                   'line' => 129,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'undef $scalar frees refs immediately'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'name' => 'SemiColon',
                   'data' => ';',
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'token_num' => 13,
            'block_id' => 0,
            'src' => ' is $_ [ 0 ] , $_ [ 1 ] , \'undef constants preserve identity\' ;',
            'indent' => 0,
            'start_line' => 129
          },
          {
          ...
          },
          {
            ...
            'end_line' => 143,
            'has_warnings' => 1,
            'src' => ' sub body { sub { my $t = bless [ ] , \'Thingie\' ; undef $t ; }-> ( ) , $messages .= \'after \' ; return ; }',
            'indent' => 0,
            'start_line' => 136
          },
          {
            'src' => ' sub { my $t = bless [ ] , \'Thingie\' ; undef $t ; }-> ( ) , $messages .= \'after \' ;',
            'indent' => 1,
            'start_line' => 137,
            'token_num' => 23,
            'block_id' => 12,
          ...
          {
            'src' => ' sub { my $t = bless [ ] , \'Thingie\' ; undef $t ; }',
            'indent' => 1,
            'start_line' => 137,
            'end_line' => 140,
            'has_warnings' => 1,
          ...
          {
            'start_line' => 145,
            'src' => ' is $messages , \'destroyed after \' , \'undef $scalar frees refs immediately\' ;',
            'indent' => 0,
            'has_warnings' => 1,
            'end_line' => 145,
            'token_num' => 7,
