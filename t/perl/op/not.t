...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 34,
            'src' => ' { my $not0 = ! 0 ; my $not1 = ! 1 ; no warnings ; ok ( $not1 == undef ) ; ok ( $not1 == ( ) ) ; use warnings ; ok ( $not1 eq \'\' ) ; ok ( $not1 == 0 ) ; ok ( $not0 == 1 ) ; }',
            'start_line' => 22,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 49,
            'src' => ' { my $not0 = not 0 ; my $not1 = not 1 ; no warnings ; ok ( $not1 == undef ) ; ok ( $not1 == ( ) ) ; use warnings ; ok ( $not1 eq \'\' ) ; ok ( $not1 == 0 ) ; ok ( $not0 == 1 ) ; }',
            'start_line' => 37,
            'indent' => 0,
            'block_id' => 0
          },
