...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 23,
            'src' => ' { package End ; sub DESTROY { $_ [ 0 ]-> ( ) } sub main::end ( & ) { my ( $cleanup ) = @_ ; return bless ( sub { $cleanup-> ( ) } , "End" ) ; } }',
            'start_line' => 16,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 21,
            'src' => ' return bless ( sub { $cleanup-> ( ) } , "End" ) ;',
            'start_line' => 21,
            'indent' => 2,
            'block_id' => 3
          },
