...
',
          ...
          bless( {
                   'data' => 'overridden `` interpolates [perl #115330]',
                   'name' => 'RawString',
                   'line' => 135,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
...
'
          ...
          bless( {
                   'name' => 'RawString',
                   'data' => '<<`` respects overrides and interpolates [perl #119827]',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'token_num' => 19,
            'indent' => 0,
            'src' => ' { local $_ = qq($Perl -le "print \'ok\'") ; is ( readpipe , "ok\\n" , \'readpipe default argument\' ) ; }',
            'start_line' => 126
          },
          {
            'start_line' => 127,
            'src' => ' local $_ = qq($Perl -le "print \'ok\'") ;',
            'indent' => 1,
            'has_warnings' => 0,
            'end_line' => 127,
            'token_num' => 8,
          ...
          },
          {
            ...
            'token_num' => 5,
            'block_id' => 13,
            'src' => ' sub readpipe { pop }',
            'indent' => 1,
            'start_line' => 133
          },
          {
            'start_line' => 134,
            'src' => ' :: is `${\\"hello"}` , \'hello\' , \'overridden `` interpolates [perl #115330]\' ;',
            'indent' => 1,
            'token_num' => 8,
            'block_id' => 13,
            'end_line' => 135,
