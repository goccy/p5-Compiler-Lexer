...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 9,
            'src' => ' print "not " unless j ( splice ( @a , @a , 0 , 11 , 12 ) ) eq "" && j ( @a ) eq j ( 1 .. 12 ) ;',
            'start_line' => 9,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 12,
            'src' => ' print "not " unless j ( splice ( @a , -1 ) ) eq "12" && j ( @a ) eq j ( 1 .. 11 ) ;',
            'start_line' => 12,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 15,
            'src' => ' print "not " unless j ( splice ( @a , 0 , 1 ) ) eq "1" && j ( @a ) eq j ( 2 .. 11 ) ;',
            'start_line' => 15,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 18,
            'src' => ' print "not " unless j ( splice ( @a , 0 , 0 , 0 , 1 ) ) eq "" && j ( @a ) eq j ( 0 .. 11 ) ;',
            'start_line' => 18,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 21,
            'src' => ' print "not " unless j ( splice ( @a , 5 , 1 , 5 ) ) eq "5" && j ( @a ) eq j ( 0 .. 11 ) ;',
            'start_line' => 21,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 24,
            'src' => ' print "not " unless j ( splice ( @a , @a , 0 , 12 , 13 ) ) eq "" && j ( @a ) eq j ( 0 .. 13 ) ;',
            'start_line' => 24,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 27,
            'src' => ' print "not " unless j ( splice ( @a , - @a , @a , 1 , 2 , 3 ) ) eq j ( 0 .. 13 ) && j ( @a ) eq j ( 1 .. 3 ) ;',
            'start_line' => 27,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 30,
            'src' => ' print "not " unless j ( splice ( @a , 1 , -1 , 7 , 7 ) ) eq "2" && j ( @a ) eq j ( 1 , 7 , 7 , 3 ) ;',
            'start_line' => 30,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 33,
            'src' => ' print "not " unless j ( splice ( @a , -3 , -2 , 2 ) ) eq j ( 7 ) && j ( @a ) eq j ( 1 , 2 , 7 , 3 ) ;',
            'start_line' => 33,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 37,
            'src' => ' print "not " unless j ( splice ( @a ) ) eq j ( 1 , 2 , 7 , 3 ) && j ( @a ) eq \'\' ;',
            'start_line' => 37,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 47,
            'src' => ' print "not " unless $foo eq \'blue\' ;',
            'start_line' => 47,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 52,
            'src' => ' print "not " unless $foo eq \'red\' ;',
            'start_line' => 52,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 58,
            'src' => ' print "not " unless j ( @a ) eq j ( 2 , 1 ) ;',
            'start_line' => 58,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 63,
            'src' => ' print "not " unless j ( @a ) eq j ( 1 , 2 ) ;',
            'start_line' => 63,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 68,
            'src' => ' print "not " unless j ( @a ) eq j ( 3 , 2 , 1 ) ;',
            'start_line' => 68,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 72,
            'src' => ' splice ( @a , 0 , 3 , $a [ 0 ] , $a [ 1 ] , $a [ 2 ] , $a [ 0 ] , $a [ 1 ] , $a [ 2 ] ) ;',
            'start_line' => 72,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 73,
            'src' => ' print "not " unless j ( @a ) eq j ( 1 , 2 , 3 , 1 , 2 , 3 ) ;',
            'start_line' => 73,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 78,
            'src' => ' print "not " unless j ( @a ) eq j ( 1 , 3 , 2 ) ;',
            'start_line' => 78,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 83,
            'src' => ' print "not " unless j ( @a ) eq j ( 1 , 2 , 2 ) ;',
            'start_line' => 83,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 97,
            'src' => ' eval { splice ( $new_arrayref , 0 , 0 , 1 , 2 , 3 ) } ;',
            'start_line' => 97,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 98,
            'src' => ' print "not " unless $@ && $@ =~/Not an ARRAY/ ;',
            'start_line' => 98,
            'indent' => 0,
            'block_id' => 0
          },
