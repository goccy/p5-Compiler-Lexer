...
',
          ...
          bless( {
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'data' => '^(?:chom?p|exec|keys|each|not
                           |(?:prototyp|read(?:lin|pip))e
          ...
          bless( {
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'data' => '^Too many arguments for $desc',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'line' => 112,
                   'name' => 'RegExp'
        ...
        sub { () = (CORE::$word$full_args) }',
          ...
          bless( {
                   'data' => 'inlinability of CORE::$word $preposition parens $desc_suffix',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
          ...
          bless( {
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'data' => 'RT #117607: \\\\&CORE::foo doesn\'t crash in error context',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
 ...
 __DATA__ __END__ AUTOLOAD BEGIN UNITCHECK CORE DESTROY END INIT CHECK and
  ...
  when while x xor y
          ...
          },
          {
            ...
            'block_id' => 0,
            'indent' => 0,
            'src' => ' my %args_for = ( dbmopen => \'%1,$2,$3\' , ( dbmclose => \'%1\' , keys => values => each => ) [ 0 , 1 , 2 , 1 , 3 , 1 , 4 , 1 ] , delete => \'$1[2]\' , exists => \'$1[2]\' , ( push => \'@1\' , pop => shift => unshift => splice => ) [ 0 , 1 , 2 , 1 , 3 , 1 , 4 , 1 , 5 , 1 ] , ) ;',
            'token_num' => 84
          },
          {
            'has_warnings' => 0,
            'end_line' => 41,
            'src' => ' my %desc = ( pos => \'match position\' , ) ;',
            'token_num' => 10,
            'start_line' => 39,
            'indent' => 0,
            'block_id' => 0
          ...
          },
          {
            ...
            'indent' => 0,
            'token_num' => 83,
            'src' => ' while ( < $kh > ) { if ( m?__END__? .. ${ \\ 0 } and/^[+-]/ ) { chomp ( my $word = $\' ) ; if ( $unsupported { $word } ) { $tests ++ ; ok ! defined &{ "CORE::$word" } , "no CORE::$word" ; } else { $tests += 2 ; ok defined &{ "CORE::$word" } , "defined &{\'CORE::$word\'}" ; my $proto = prototype "CORE::$word" ; * { "my$word" } = \\ &{ "CORE::$word" } ;',
            'end_line' => 60,
            'has_warnings' => 1
          },
          {
          ...
          },
          {
            ...
            'indent' => 1,
            'block_id' => 2,
            'src' => ' if ( m?__END__? .. ${ \\ 0 } and/^[+-]/ ) { chomp ( my $word = $\' ) ; if ( $unsupported { $word } ) { $tests ++ ; ok ! defined &{ "CORE::$word" } , "no CORE::$word" ; }',
            'token_num' => 46,
            'end_line' => 53,
            'has_warnings' => 1
          },
          ...
          },
          {
            ...
            'block_id' => 3,
            'indent' => 2,
            'src' => ' if ( $unsupported { $word } ) { $tests ++ ; ok ! defined &{ "CORE::$word" }',
            'token_num' => 17
          },
          {
            'indent' => 3,
          ...
          },
          {
            ...
            'end_line' => 57,
            'token_num' => 11,
            'src' => ' else { $tests += 2 ; ok defined &{ "CORE::$word" }',
            'start_line' => 54,
            'block_id' => 2,
            'indent' => 1
          },
