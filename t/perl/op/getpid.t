...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   'data' => 'We\'re running under $^O with linuxthreads <$thread_version>',
                   'name' => 'String',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'has_warnings' => 0,
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'end_line' => 39,
            'indent' => 0,
            'src' => ' my $thread_version = qx[getconf GNU_LIBPTHREAD_VERSION 2>&1] // \'\' ;',
            'start_line' => 39
          },
          {
            'token_num' => 3,
          ...
          },
          {
            ...
            'token_num' => 3,
            'block_id' => 6,
            'src' => ' diag "We\'re running under $^O with linuxthreads <$thread_version>" ;',
            'indent' => 1,
            'start_line' => 44
          },
          {
