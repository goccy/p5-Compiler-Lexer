...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'use threads; use threads::shared',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 17
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'unable to load thread modules',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 20
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => 'getconf GNU_LIBPTHREAD_VERSION 2>&1',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 37
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'We\'re running under $^O with linuxthreads <$linuxthreads>',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 39
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'getpid() in a thread is different from the parent on this non-POSIX system',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 40
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'getppid() in a thread is different from the parent on this non-POSIX system',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 41
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'getpid() in a thread is the same as in the parent',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 43
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'getppid() in a thread is the same as in the parent',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 44
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 15,
            'src' => ' skip_all_without_config ( qw(useithreads d_getppid) ) ;',
            'start_line' => 15,
            'indent' => 1,
            'block_id' => 2
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 17,
            'src' => ' eval \'use threads; use threads::shared\' ;',
            'start_line' => 17,
            'indent' => 1,
            'block_id' => 2
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 21,
            'src' => ' if ( $@ ) { fail ( "unable to load thread modules" ) ; }',
            'start_line' => 19,
            'indent' => 1,
            'block_id' => 2
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 20,
            'src' => ' fail ( "unable to load thread modules" ) ;',
            'start_line' => 20,
            'indent' => 2,
            'block_id' => 3
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 24,
            'src' => ' else { pass ( "thread modules loaded" ) ; }',
            'start_line' => 22,
            'indent' => 1,
            'block_id' => 2
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 23,
            'src' => ' pass ( "thread modules loaded" ) ;',
            'start_line' => 23,
            'indent' => 2,
            'block_id' => 4
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 39,
            'src' => ' diag "We\'re running under $^O with linuxthreads <$linuxthreads>" ;',
            'start_line' => 39,
            'indent' => 1,
            'block_id' => 6
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 40,
            'src' => ' isnt ( $pid , $pid2 , "getpid() in a thread is different from the parent on this non-POSIX system" ) ;',
            'start_line' => 40,
            'indent' => 1,
            'block_id' => 6
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 41,
            'src' => ' isnt ( $ppid , $ppid2 , "getppid() in a thread is different from the parent on this non-POSIX system" ) ;',
            'start_line' => 41,
            'indent' => 1,
            'block_id' => 6
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 45,
            'src' => ' else { is ( $pid , $pid2 , \'getpid() in a thread is the same as in the parent\' ) ; is ( $ppid , $ppid2 , \'getppid() in a thread is the same as in the parent\' ) ; }',
            'start_line' => 42,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 43,
            'src' => ' is ( $pid , $pid2 , \'getpid() in a thread is the same as in the parent\' ) ;',
            'start_line' => 43,
            'indent' => 1,
            'block_id' => 7
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 44,
            'src' => ' is ( $ppid , $ppid2 , \'getppid() in a thread is the same as in the parent\' ) ;',
            'start_line' => 44,
            'indent' => 1,
            'block_id' => 7
          }
