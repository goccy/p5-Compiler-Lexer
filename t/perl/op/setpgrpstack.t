...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'setpgrp() should extend the stack before modifying it',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 13
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 7,
            'src' => ' skip_all_without_config ( \'d_setpgrp\' ) ;',
            'start_line' => 7,
            'indent' => 1,
            'block_id' => 1
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 12,
            'src' => ' ok ( ! eval { package A ; sub foo { die ( "got here" ) } ; package main ; A-> foo ( setpgrp ( ) ) } ) ;',
            'start_line' => 12,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 13,
            'src' => ' ok ( $@ =~/got here/ , "setpgrp() should extend the stack before modifying it" ) ;',
            'start_line' => 13,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 15,
            'src' => ' is join ( "_" , setpgrp ( 0 ) ) , 1 , \'setpgrp with one argument\' ;',
            'start_line' => 15,
            'indent' => 0,
            'block_id' => 0
          }
