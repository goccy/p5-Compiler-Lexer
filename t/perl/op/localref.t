...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => 'Can\'t localize through a reference',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 60
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'old value not visible during restore',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 98
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 16,
            'src' => ' { local ${ $x } ; $aa = 5 ; is ( $aa , 5 ) ; undef $x ; is ( $aa , 5 ) ; }',
            'start_line' => 16,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 19,
            'src' => ' { local ${ $x x2 } ; $aa = 6 ; is ( $aa , 6 ) ; undef $x ; is ( $aa , 6 ) ; }',
            'start_line' => 19,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 22,
            'src' => ' { local $$x ; $aa = 7 ; is ( $aa , 7 ) ; undef $x ; is ( $aa , 7 ) ; }',
            'start_line' => 22,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 26,
            'src' => ' { local @aa ; @aa = qw/c d/ ; is ( "@aa" , "c d" ) ; }',
            'start_line' => 26,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 28,
            'src' => ' { local @{ aa } ; @aa = qw/e f/ ; is ( "@aa" , "e f" ) ; }',
            'start_line' => 28,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 30,
            'src' => ' { local @{ "aa" } ; @aa = qw/g h/ ; is ( "@aa" , "g h" ) ; }',
            'start_line' => 30,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 33,
            'src' => ' { local @{ $x } ; @aa = qw/i j/ ; is ( "@aa" , "i j" ) ; undef $x ; is ( "@aa" , "i j" ) ; }',
            'start_line' => 33,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 36,
            'src' => ' { local @{ $x x2 } ; @aa = qw/k l/ ; is ( "@aa" , "k l" ) ; undef $x ; is ( "@aa" , "k l" ) ; }',
            'start_line' => 36,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 39,
            'src' => ' { local @$x ; @aa = qw/m n/ ; is ( "@aa" , "m n" ) ; undef $x ; is ( "@aa" , "m n" ) ; }',
            'start_line' => 39,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 99,
            'src' => ' { local %$x ; %aa = qw/m n/ ; is ( $aa { m},"n"); undef $x; is($aa{m} , "n" ) ; } is ( $aa { a } , "b" ) ; sub test_err_localref (  ) { like ( $@ , qr/Can\'t localize through a reference/ , \'error\' ) ; } $x = \\ $aa ; my $y = \\ $aa ; eval { local $$x ; } ; test_err_localref ; eval { local ${ $x } ; } ; test_err_localref ; eval { local $$y ; } ; test_err_localref ; eval { local ${ $y } ; } ; test_err_localref ; eval { local ${ \\ $aa } ; } ; test_err_localref ; eval { local ${ \\ \'aa\' } ; } ; test_err_localref ; $x = \\ @aa ; $y = \\ @aa ; eval { local @$x ; } ; test_err_localref ; eval { local @{ $x } ; } ; test_err_localref ; eval { local @$y ; } ; test_err_localref ; eval { local @{ $y } ; } ; test_err_localref ; eval { local @{ \\ @aa } ; } ; test_err_localref ; eval { local @{ [ ] } ; } ; test_err_localref ; $x = \\ %aa ; $y = \\ %aa ; eval { local %$x ; } ; test_err_localref ; eval { local %{ $x } ; } ; test_err_localref ; eval { local %$y ; } ; test_err_localref ; eval { local %{ $y } ; } ; test_err_localref ; eval { local %{ \\ %aa } ; } ; test_err_localref ; eval { local %{ { a => 1 } } ; } ; test_err_localref ; { my $ok ; $x = 0 ; sub X::DESTROY { $ok = ! ref ( $x ) ; } { local $x = \\ bless { } , \'X\' ; 1 ; } ok ( $ok , \'old value not visible during restore\' ) ; }',
            'start_line' => 56,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 57,
            'src' => ' is ( $aa { m},"n"); undef $x; is($aa{m} , "n" ) ; } is ( $aa { a } , "b" ) ;',
            'start_line' => 56,
            'indent' => 1,
            'block_id' => 18
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 61,
            'src' => ' sub test_err_localref (  ) { like ( $@ , qr/Can\'t localize through a reference/ , \'error\' ) ; }',
            'start_line' => 59,
            'indent' => 1,
            'block_id' => 18
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 60,
            'src' => ' like ( $@ , qr/Can\'t localize through a reference/ , \'error\' ) ;',
            'start_line' => 60,
            'indent' => 2,
            'block_id' => 19
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 99,
            'src' => ' { my $ok ; $x = 0 ; sub X::DESTROY { $ok = ! ref ( $x ) ; } { local $x = \\ bless { } , \'X\' ; 1 ; } ok ( $ok , \'old value not visible during restore\' ) ; }',
            'start_line' => 88,
            'indent' => 1,
            'block_id' => 18
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 98,
            'src' => ' ok ( $ok , \'old value not visible during restore\' ) ;',
            'start_line' => 98,
            'indent' => 2,
            'block_id' => 20
          }
