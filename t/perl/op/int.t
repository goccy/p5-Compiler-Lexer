...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 36,
            'src' => ' { my $fail ; use integer ; $x = length ( "abc" ) % -10 ; $y = ( 3 / -10 ) * -10 ; ok ( $x + $y == 3 ) or ++ $fail ; ok ( abs ( $x ) < 10 ) or ++ $fail ; if ( $fail ) { diag ( "\\$x == $x" , "\\$y == $y" ) ; } }',
            'start_line' => 26,
            'indent' => 0,
            'block_id' => 0
          },
