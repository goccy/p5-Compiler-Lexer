...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   'data' => 'Unicode tables not built yet',
                   'name' => 'String',
                   'line' => 145,
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            'start_line' => 21,
            'indent' => 0,
            'src' => ' plan ( tests => 3 * 10 + 3 * 8 + 2 * 16 + 3 ) ;',
            'block_id' => 0,
            'token_num' => 19,
            'has_warnings' => 1,
            'end_line' => 21
          ...
          },
          {
            ...
            'token_num' => 18,
            'start_line' => 144,
            'src' => ' if ( is_miniperl ( ) ) { skip_if_miniperl ( "Unicode tables not built yet" , 2 ) unless eval \'require "unicore/Heavy.pl"\' ; }',
            'indent' => 1
          },
          {
            'indent' => 2,
            'src' => ' skip_if_miniperl ( "Unicode tables not built yet" , 2 ) unless eval \'require "unicore/Heavy.pl"\' ;',
            'start_line' => 145,
            'has_warnings' => 1,
            'end_line' => 146,
            'token_num' => 10,
          ...
          },
          {
            ...
            'block_id' => 0,
            'start_line' => 157,
            'src' => ' { my @p ; my $s = "\\x{100}\\x{100}\\x{100}\\x{100}" . $^X ; $s =~ s/\\x{100}/push @p, pos($s); "xxxx";/eg ; is ( "@p" , "0 1 2 3" , "RT #122148" ) ; }',
            'indent' => 0
          },
          {
            'indent' => 1,
          ...
          },
          {
            ...
            'block_id' => 9,
            'token_num' => 7,
            'src' => ' my $s = "\\x{100}\\x{100}\\x{100}\\x{100}" . $^X ;',
            'indent' => 1,
            'start_line' => 161
          },
          {
            ...
            'end_line' => 162,
            'indent' => 1,
            'src' => ' $s =~ s/\\x{100}/push @p, pos($s); "xxxx";/eg ;',
            'start_line' => 162
          },
          {
            'has_warnings' => 1,
