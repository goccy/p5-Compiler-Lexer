...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'chmod 0555, \'$ro_file\' failed: $!',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 29
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 27,
            'src' => ' { open my $fh , \'>\' , $ro_file or die "open $fh: $!" ; close $fh or die "close $fh: $!" ; }',
            'start_line' => 24,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 25,
            'src' => ' open my $fh , \'>\' , $ro_file or die "open $fh: $!" ;',
            'start_line' => 25,
            'indent' => 1,
            'block_id' => 2
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 29,
            'src' => ' chmod 0555 , $ro_file or die "chmod 0555, \'$ro_file\' failed: $!" ;',
            'start_line' => 29,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 34,
            'src' => ' print "# oldeuid = $oldeuid, euid = $>\\n" ;',
            'start_line' => 34,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 39,
            'src' => ' if ( ! $Config { d_seteuid } ) { skip ( \'no seteuid\' ) ; }',
            'start_line' => 37,
            'indent' => 1,
            'block_id' => 3
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 58,
            'src' => ' if ( $Config { d_seteuid } ) { ok ( -w \'op\' ) ; }',
            'start_line' => 56,
            'indent' => 1,
            'block_id' => 6
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 65,
            'src' => ' is ( "@{[grep -r, qw(foo io noo op zoo)]}" , "io op" ) ;',
            'start_line' => 65,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 79,
            'src' => ' ok ( ( -s -f \'TEST\' > 1 ) , "-s returns real size" ) ;',
            'start_line' => 79,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 106,
            'src' => ' if ( os_type ne \'Unix\' ) { skip "Not Unix" , 2 }',
            'start_line' => 106,
            'indent' => 1,
            'block_id' => 10
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 107,
            'src' => ' if ( -l "TEST" ) { skip "TEST is a symlink" , 2 }',
            'start_line' => 107,
            'indent' => 1,
            'block_id' => 10
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 112,
            'src' => ' ok ! -l -e _ , \'stacked -l uses previous stat, not previous retval\' ;',
            'start_line' => 112,
            'indent' => 1,
            'block_id' => 10
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 120,
            'src' => ' ok -l \\ * foo , \'-l \\*foo is a file name\' ;',
            'start_line' => 120,
            'indent' => 1,
            'block_id' => 10
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 185,
            'src' => ' ok ( my $rv = eval "-$op \\$ft" , "overloaded -$op succeeds" ) or diag ( $@ ) ;',
            'start_line' => 184,
            'indent' => 1,
            'block_id' => 24
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 199,
            'src' => ' if ( ! $fcntl_not_available and ( $op eq "u" and not eval { Fcntl::S_ISUID ( ) } or $op eq "g" and not eval { Fcntl::S_ISGID ( ) } or $op eq "k" and not eval { Fcntl::S_ISVTX ( ) } ) ) { ( $exp , $is ) = ( 0 , "not" ) ; }',
            'start_line' => 191,
            'indent' => 1,
            'block_id' => 24
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 204,
            'src' => ' ok ( ! $@ , "-$op succeeds with string overloading" ) or diag ( $@ ) ;',
            'start_line' => 203,
            'indent' => 1,
            'block_id' => 24
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 227,
            'src' => ' ok ( ! $@ , "-$op succeeds with random overloading" ) or diag ( $@ ) ;',
            'start_line' => 226,
            'indent' => 1,
            'block_id' => 24
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 244,
            'src' => ' ok ! stat _ , \'fatal warnings do not prevent -l HANDLE from setting stat status\' ;',
            'start_line' => 243,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 291,
            'src' => ' ok -T _ , \'-T _ works after stat $ioref\' ;',
            'start_line' => 291,
            'indent' => 1,
            'block_id' => 30
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 295,
            'src' => ' ok -T _ , \'-T _ works after -r $ioref\' ;',
            'start_line' => 295,
            'indent' => 1,
            'block_id' => 30
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 301,
            'src' => ' ok ! stat _ , \'-T _ on closed filehandle resets stat info\' ;',
            'start_line' => 301,
            'indent' => 1,
            'block_id' => 30
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 328,
            'src' => ' ok ! stat _ , \'-T "nonexistent" resets stat success status\' ;',
            'start_line' => 328,
            'indent' => 1,
            'block_id' => 31
          },
