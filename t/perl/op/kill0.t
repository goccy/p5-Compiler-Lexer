...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   'data' => 'custom process group kill() only on Win32',
                   'name' => 'RawString',
                   'line' => 59,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'process group kill, named signal'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'data' => ')',
                   'name' => 'RightParenthesis',
          ...
          bless( {
                   'name' => 'RawString',
                   'data' => '$Config{sig_name} parsed correctly',
                   'line' => 94,
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   'data' => 'a child proc wasn\'t killed and did cleanup on its own',
                   'name' => 'String',
                   'line' => 95,
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   'name' => 'RawString',
                   'data' => 'process group kill, numeric signal',
                   'line' => 107,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'end_line' => 59,
            'indent' => 1,
            'src' => ' skip \'custom process group kill() only on Win32\' , 3 if ( $^O ne \'MSWin32\' ) ;',
            'start_line' => 59
          },
          {
            'src' => ' my $killfile = \'tmp-killchildstarted\' ;',
            'indent' => 1,
            'start_line' => 69,
            'has_warnings' => 0,
            'end_line' => 69,
          ...
          {
            'src' => ' die "can\'t unlink $killfile: $!" if -e $killfile ;',
            'indent' => 1,
            'start_line' => 71,
            'end_line' => 71,
            'has_warnings' => 1,
          ...
          },
          {
            ...
            'start_line' => 72,
            'indent' => 1,
            'src' => ' eval q{END {unlink($killfile);}} ;'
          },
          {
            'start_line' => 74,
            'src' => ' my $pid = system ( 1 , $^X , \'op/kill0_child\' , $killfile ) ;',
            'indent' => 1,
            'block_id' => 7,
            'token_num' => 14,
            'has_warnings' => 1,
          ...
          },
          {
            ...
            'token_num' => 6,
            'indent' => 1,
            'src' => ' die \'PID is 0\' if ! $pid ;',
            'start_line' => 75
          },
          {
            'src' => ' while ( ! -e $killfile ) { sleep 1 ; }',
            'indent' => 1,
            'start_line' => 76,
            'has_warnings' => 1,
            'end_line' => 78,
          ...
          },
          {
            ...
            'start_line' => 82,
            'indent' => 1,
            'src' => ' is ( kill ( \'-KILL\' , $pid ) , 1 , \'process group kill, named signal\' ) ;'
          },
          {
            'start_line' => 86,
            'src' => ' my ( $i , %signo , @signame , $sig_name ) = 0 ;',
            'indent' => 1,
            'end_line' => 86,
            'has_warnings' => 1,
            'token_num' => 13,
          ...
          {
            'src' => ' ( $sig_name = $Config { sig_name } ) || die "No signals?" ;',
            'indent' => 1,
            'start_line' => 87,
            'token_num' => 12,
            'block_id' => 7,
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'indent' => 1,
            'src' => ' foreach my $name ( split ( \' \' , $sig_name ) ) { $signo { $name } = $i ; $signame [ $i ] = $name ; $i ++ ; }',
            'start_line' => 88
          },
          {
            'indent' => 2,
          ...
          },
          {
            ...
            'block_id' => 7,
            'indent' => 1,
            'src' => ' ok ( scalar keys %signo > 1 && exists $signo { KILL } , \'$Config{sig_name} parsed correctly\' ) ;',
            'start_line' => 93
          },
          {
            'block_id' => 7,
            ...
            'has_warnings' => 1,
            'indent' => 1,
            'src' => ' die "a child proc wasn\'t killed and did cleanup on its own" if ! -e $killfile ;',
            'start_line' => 95
          },
          {
            'token_num' => 3,
          ...
          },
          {
            'start_line' => 100,
            'indent' => 1,
            'src' => ' die "can\'t unlink" if -e $killfile ;',
            'token_num' => 6,
            'block_id' => 7,
            'has_warnings' => 1,
            'end_line' => 100
          },
          {
            'start_line' => 102,
            'indent' => 1,
            'src' => ' $pid = system ( 1 , $^X , \'op/kill0_child\' , $killfile ) ;',
            'block_id' => 7,
            'token_num' => 13,
            'end_line' => 102,
            'has_warnings' => 1
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 107,
            'src' => ' is ( kill ( - $signo { KILL } , $pid ) , 1 , \'process group kill, numeric signal\' ) ;',
            'indent' => 1,
            'start_line' => 107
          }
        ]
