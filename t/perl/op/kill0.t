...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'kill() not implemented on this platform',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'kill(0, $pid) returns true if $pid exists',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 19
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'kill(0, $pid) returns false if $pid does not exist',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 31
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => '^Can\'t kill a non-numeric process ID',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'can kill a number string in a magic variable',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 51
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 12,
            'src' => ' if ( $^O eq \'riscos\' ) { skip_all ( "kill() not implemented on this platform" ) ; }',
            'start_line' => 10,
            'indent' => 1,
            'block_id' => 2
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 11,
            'src' => ' skip_all ( "kill() not implemented on this platform" ) ;',
            'start_line' => 11,
            'indent' => 2,
            'block_id' => 3
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 19,
            'src' => ' ok ( kill ( 0 , $$ ) , \'kill(0, $pid) returns true if $pid exists\' ) ;',
            'start_line' => 19,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 28,
            'src' => ' for my $pid ( 1 .. $total ) { ++ $count if kill ( 0 , $pid ) ; }',
            'start_line' => 26,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 31,
            'src' => ' ok ( $count < $total , \'kill(0, $pid) returns false if $pid does not exist\' ) ;',
            'start_line' => 31,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 38,
            'src' => ' my @bad_pids = ( [ undef , \'undef\' ] , [ \'\' , \'empty string\' ] , [ \'abcd\' , \'alphabetic\' ] , ) ;',
            'start_line' => 34,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 44,
            'src' => ' for my $case ( @bad_pids ) { my ( $pid , $name ) = @$case ; eval { kill 0 , $pid } ; like ( $@ , qr/^Can\'t kill a non-numeric process ID/ , "dies killing $name pid" ) ; }',
            'start_line' => 40,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 43,
            'src' => ' like ( $@ , qr/^Can\'t kill a non-numeric process ID/ , "dies killing $name pid" ) ;',
            'start_line' => 43,
            'indent' => 1,
            'block_id' => 5
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 52,
            'src' => ' { my $x = $$ . " " ; $x =~/(\\d+)/ ; ok ( eval { kill 0 , $1 } , "can kill a number string in a magic variable" ) ; }',
            'start_line' => 48,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 51,
            'src' => ' ok ( eval { kill 0 , $1 } , "can kill a number string in a magic variable" ) ;',
            'start_line' => 51,
            'indent' => 1,
            'block_id' => 6
          }
