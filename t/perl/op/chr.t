...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'data' => 'chr $tied when $tied is -1.1',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'line' => 41,
                   'name' => 'RawString'
                 }, 'Compiler::Lexer::Token' ),
          ...
          bless( {
                   ...
                   'line' => 42,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => 'chr $tied when $tied is -2.2',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value
                 }, 'Compiler::Lexer::Token' ),
          ...
          bless( {
                   'data' => 'UTF-8 ASCII centric tests',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
          ...
          bless( {
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'data' => 'chr does not call string overloading',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'line' => 91,
          ...
          bless( {
                   'name' => 'RawString',
                   'line' => 92,
                   'data' => 'chr does call num overloading',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'indent' => 0,
            'token_num' => 10,
            'src' => ' is ( chr ( -3.0 ) , "\\x{FFFD}" ) ;'
          },
          {
            'token_num' => 45,
            'src' => ' { use bytes ; is ( chr ( -0.1 ) , "\\x00" ) ; is ( chr ( -1 ) , "\\xFF" ) ; is ( chr ( -2 ) , "\\xFE" ) ; is ( chr ( -3.0 ) , "\\xFD" ) ; }',
            'block_id' => 0,
            'start_line' => 26,
            'indent' => 0,
            'has_warnings' => 1,
          ...
          },
          {
            ...
            'end_line' => 39,
            'token_num' => 9,
            'src' => ' is chr $t , chr -1 , \'chr $tied when $tied is -1\' ;',
            'block_id' => 0,
            'start_line' => 39,
            'indent' => 0
          },
          ...
          },
          {
            ...
            'block_id' => 0,
            'indent' => 0,
            'src' => ' is chr $t , chr -2 , \'chr $tied when $tied is -2\' ;',
            'token_num' => 9,
            'end_line' => 40,
            'has_warnings' => 1
          },
          ...
          {
            'src' => ' is chr $t , chr -1.1 , \'chr $tied when $tied is -1.1\' ;',
            'token_num' => 9,
            'block_id' => 0,
            'start_line' => 41,
            'indent' => 0,
          ...
          },
          {
            ...
            'indent' => 0,
            'block_id' => 0,
            'src' => ' is chr $t , chr -2.2 , \'chr $tied when $tied is -2.2\' ;',
            'token_num' => 9,
            'end_line' => 42,
            'has_warnings' => 1
          },
          {
            ...
            'start_line' => 45,
            'indent' => 0,
            'src' => ' is chr "-1" , chr -1 , \'chr "-1" eq chr -1\' ;',
            'token_num' => 9
          },
          {
            'token_num' => 9,
            'src' => ' is chr "-2" , chr -2 , \'chr "-2" eq chr -2\' ;',
            'start_line' => 46,
            'indent' => 0,
            'block_id' => 0,
            'has_warnings' => 1,
          ...
          },
          {
            ...
            'block_id' => 0,
            'indent' => 0,
            'src' => ' is chr "-1.1" , chr -1.1 , \'chr "-1.1" eq chr -1.1\' ;',
            'token_num' => 9
          },
          {
            'token_num' => 9,
            'src' => ' is chr "-2.2" , chr -2.2 , \'chr "-2.2" eq chr -2.2\' ;',
            'start_line' => 48,
            'block_id' => 0,
            'indent' => 0,
            'has_warnings' => 1,
          ...
          },
          {
            'has_warnings' => 1,
            'end_line' => 52,
            'src' => ' skip "UTF-8 ASCII centric tests" , 21 if $: : IS_EBCDIC ;',
            'token_num' => 9,
            'start_line' => 52,
            'block_id' => 6,
            'indent' => 1
          },
          {
            ...
            'indent' => 1,
            'token_num' => 22,
            'src' => ' sub hexes { no warnings \'utf8\' ; join ( " " , unpack "U0 (H2)*" , chr $_ [ 0 ] ) ; }'
          },
          {
            'end_line' => 57,
            'has_warnings' => 1,
          ...
          },
          {
            ...
            'start_line' => 65,
            'indent' => 1,
            'src' => ' is ( hexes ( 0xFFF ) , "e0 bf bf" ) ;',
            'token_num' => 10
          },
          {
            'src' => ' is ( hexes ( 0x1000 ) , "e1 80 80" ) ;',
            'token_num' => 10,
            'start_line' => 66,
            'block_id' => 6,
            'indent' => 1,
          ...
          },
          {
            ...
            'start_line' => 74,
            'block_id' => 6,
            'src' => ' is ( hexes ( 0x10000 ) , "f0 90 80 80" ) ;',
            'token_num' => 10
          },
          {
            'end_line' => 75,
            ...
            'block_id' => 6,
            'token_num' => 10,
            'src' => ' is ( hexes ( 0x3FFFF ) , "f0 bf bf bf" ) ;'
          },
          {
            'has_warnings' => 1,
            'end_line' => 76,
            'src' => ' is ( hexes ( 0x40000 ) , "f1 80 80 80" ) ;',
            'token_num' => 10,
            'block_id' => 6,
            'start_line' => 76,
            'indent' => 1
          },
          {
            ...
            'block_id' => 6,
            'token_num' => 10,
            'src' => ' is ( hexes ( 0xFFFFF ) , "f3 bf bf bf" ) ;',
            'end_line' => 77,
            'has_warnings' => 1
          },
          {
            'token_num' => 10,
            'src' => ' is ( hexes ( 0x100000 ) , "f4 80 80 80" ) ;',
            'start_line' => 78,
            'block_id' => 6,
            'indent' => 1,
            'has_warnings' => 1,
          ...
          },
          {
            ...
            'end_line' => 79,
            'token_num' => 10,
            'src' => ' is ( hexes ( 0x10FFFF ) , "f4 8f bf bf" ) ;',
            'start_line' => 79,
            'indent' => 1,
            'block_id' => 6
          },
          {
            ...
            'indent' => 1,
            'token_num' => 10,
            'src' => ' is ( hexes ( 0x110000 ) , "f4 90 80 80" ) ;',
            'end_line' => 80,
            'has_warnings' => 1
          },
          {
            'src' => ' is ( hexes ( 0x1FFFFF ) , "f7 bf bf bf" ) ;',
            'token_num' => 10,
            'block_id' => 6,
            'start_line' => 81,
            'indent' => 1,
          ...
          },
          {
            ...
            'end_line' => 82,
            'token_num' => 10,
            'src' => ' is ( hexes ( 0x200000 ) , "f8 88 80 80 80" ) ;',
            'start_line' => 82,
            'block_id' => 6,
            'indent' => 1
          },
          {
            ...
            'block_id' => 8,
            'token_num' => 22,
            'src' => ' use overload \'""\' => sub { ++ $o::str ; "42" } , \'0+\' => sub { ++ $o::num ; 42 } ;'
          },
          {
            'block_id' => 9,
            'start_line' => 87,
          ...
          },
          {
            ...
            'block_id' => 0,
            'token_num' => 17,
            'src' => ' is chr ( bless [ ] , "o" ) , chr ( 42 ) , \'overloading called\' ;',
            'end_line' => 90,
            'has_warnings' => 1
          },
          {
            'src' => ' is $o::str , undef , \'chr does not call string overloading\' ;',
            'token_num' => 7,
            'start_line' => 91,
            'indent' => 0,
            'block_id' => 0,
          ...
          },
          {
            ...
            'block_id' => 0,
            'token_num' => 7,
            'src' => ' is $o::num , 1 , \'chr does call num overloading\' ;'
          }
        ]
...
subtest 'get_used_modules' => sub {
    ...
    is_deeply($modules, [
          ...
          {
            'args' => '  \'""\'  =>  sub  { ++ $o::str ; "42" }  ,  \'0+\'  =>  sub  { ++ $o::num ; 42 }',
            'name' => 'overload'
          }
        ]
