...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 5,
            'src' => ' $SIG { __DIE__ } = sub { print ref ( $_ [ 0 ] ) ? ( "ok " , $_ [ 0 ]-> [ 0 ] ++ , "\\n" ) : @_ } ;',
            'start_line' => 5,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 33,
            'src' => ' eval { eval { die bless [ 7 ] , "Error" ; } ; die if $@ ; } ;',
            'start_line' => 28,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 35,
            'src' => ' print "not " unless ref ( $@ ) eq "Out" ;',
            'start_line' => 35,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 45,
            'src' => ' { package Error ; sub PROPAGATE { print "ok " , $_ [ 0 ]-> [ 0 ] ++ , "\\n" ; bless [ $_ [ 0 ]-> [ 0 ] ] , "Out" ; } }',
            'start_line' => 38,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 44,
            'src' => ' sub PROPAGATE { print "ok " , $_ [ 0 ]-> [ 0 ] ++ , "\\n" ; bless [ $_ [ 0 ]-> [ 0 ] ] , "Out" ; }',
            'start_line' => 41,
            'indent' => 1,
            'block_id' => 2
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 55,
            'src' => ' local $SIG { __WARN__ } = $SIG { __DIE__ } = sub { $err = shift } ;',
            'start_line' => 55,
            'indent' => 1,
            'block_id' => 4
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 56,
            'src' => ' print "not " unless $err eq $msg ;',
            'start_line' => 56,
            'indent' => 1,
            'block_id' => 4
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 61,
            'src' => ' print "not " unless $@ =~/Global symbol "\\$\\x{3b1}"/ ;',
            'start_line' => 61,
            'indent' => 1,
            'block_id' => 4
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 74,
            'src' => ' { my $ok = 1 ; local $SIG { __DIE__ } ; local $SIG { __WARN__ } = sub { $ok = 0 } ; eval { undef $@ ; die } ; print "not " unless $ok ; print "ok 15\\n" ; }',
            'start_line' => 67,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 70,
            'src' => ' local $SIG { __WARN__ } = sub { $ok = 0 } ;',
            'start_line' => 70,
            'indent' => 1,
            'block_id' => 6
          },
