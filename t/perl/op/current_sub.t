...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => '__SUB__ is a bareword outside of use feature',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 11
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => '__SUB__ returns undef outside of a subroutine',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 20
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => '__SUB__ returns undef in list context',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 21
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => '__SUB__ inside a named subroutine',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 24
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => '__SUB__ is a code reference',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 26
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => '__SUB__ inside anonymous non-closure',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 29
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 11,
            'src' => ' is __SUB__ , "__SUB__" , \'__SUB__ is a bareword outside of use feature\' ;',
            'start_line' => 11,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 16,
            'src' => ' { use v5.15 ; is __SUB__ , undef , \'__SUB__ under use v5.16\' ; }',
            'start_line' => 13,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 15,
            'src' => ' is __SUB__ , undef , \'__SUB__ under use v5.16\' ;',
            'start_line' => 15,
            'indent' => 1,
            'block_id' => 2
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 20,
            'src' => ' is __SUB__ , undef , \'__SUB__ returns undef outside of a subroutine\' ;',
            'start_line' => 20,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 21,
            'src' => ' is + ( ) = __SUB__ , 1 , \'__SUB__ returns undef in list context\' ;',
            'start_line' => 21,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 24,
            'src' => ' is foo , \\ & foo , \'__SUB__ inside a named subroutine\' ;',
            'start_line' => 24,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 25,
            'src' => ' is foo-> ( ) , \\ & foo , \'__SUB__ is callable\' ;',
            'start_line' => 25,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 26,
            'src' => ' is ref foo , \'CODE\' , \'__SUB__ is a code reference\' ;',
            'start_line' => 26,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 29,
            'src' => ' is &$subsub , $subsub , \'__SUB__ inside anonymous non-closure\' ;',
            'start_line' => 29,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 34,
            'src' => ' for my $x ( 1 .. 3 ) { push @subsubs , sub { return $x if @_ ; __SUB__ } ; }',
            'start_line' => 32,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 33,
            'src' => ' push @subsubs , sub { return $x if @_ ; __SUB__ } ;',
            'start_line' => 33,
            'indent' => 1,
            'block_id' => 5
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 37,
            'src' => ' is $subsubs [ 0 ] ( ) ( 0 ) , 1 , \'__SUB__ inside closure (1)\' ;',
            'start_line' => 37,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 38,
            'src' => ' is $subsubs [ 1 ] ( ) ( 0 ) , 2 , \'__SUB__ inside closure (2)\' ;',
            'start_line' => 38,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 39,
            'src' => ' is $subsubs [ 2 ] ( ) ( 0 ) , 3 , \'__SUB__ inside closure (3)\' ;',
            'start_line' => 39,
            'indent' => 0,
            'block_id' => 0
          }
