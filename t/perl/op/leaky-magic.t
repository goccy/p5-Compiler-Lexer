...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            'start_line' => 36,
            'indent' => 0,
            'src' => ' for ( qw< CHILD_ERROR_NATIVE ENCODING UTF8CACHE WARNING_BITS > ) { no warnings \'deprecated\' ; my $name = s/./"qq|\\\\c$&|"/ere ; local $$name = \'swit\' ; ${ "foo::$name" } ; ok ! defined ( ${ "foo::$name" } ) , "\\$foo::^$_" ; }',
            'has_warnings' => 1,
            'end_line' => 45,
            'token_num' => 44,
            'block_id' => 0
