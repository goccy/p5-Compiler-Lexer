...
die "Failed to fail!";
          ...
          {
            'start_line' => 62,
            'src' => ' { local $^W = 1 ; local $SIG { __WARN__ } = sub { ++ $w } ; my $leaf = \'pleaseletthisfilenotexist\' ; dbmopen ( %truffe , $leaf , undef ) ; is $w , 1 , \'1 warning from dbmopen with undef third arg\' ; unlink $leaf if -e $leaf ; 1 while unlink glob "$leaf.*" ; }',
            'indent' => 0,
            'end_line' => 72,
            'has_warnings' => 1,
            'block_id' => 0,
          ...
          },
          {
            ...
            'start_line' => 66,
            'indent' => 1,
            'src' => ' my $leaf = \'pleaseletthisfilenotexist\' ;'
          },
          {
            'has_warnings' => 1,
            'end_line' => 67,
