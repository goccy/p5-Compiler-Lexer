...
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'implicit require and no stash fails',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 60
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'pleaseletthisfilenotexist',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 65
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => '1 warning from dbmopen with undef third arg',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 66
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 9,
            'src' => ' skip_all ( "No dbm functions" ) if $@ ;',
            'start_line' => 9,
            'indent' => 1,
            'block_id' => 1
          },
...
$test = Foo->new(); # must be package var
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 45,
            'src' => ' fresh_perl_is ( "require AnyDBM_File;\\n$prog" , \'ok\' , { } , \'explicit require\' ) ;',
            'start_line' => 45,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 46,
            'src' => ' fresh_perl_is ( $prog , \'ok\' , { } , \'implicit require\' ) ;',
            'start_line' => 46,
            'indent' => 0,
            'block_id' => 0
          },
...
die "Failed to fail!";
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 57,
            'src' => ' fresh_perl_like ( $prog , qr/No dbm on this machine/ , { } , \'implicit require fails\' ) ;',
            'start_line' => 56,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 60,
            'src' => ' fresh_perl_like ( \'delete $::{"AnyDBM_File::"}; \' . $prog , qr/No dbm on this machine/ , { } , \'implicit require and no stash fails\' ) ;',
            'start_line' => 58,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 67,
            'src' => ' { local $^W = 1 ; local $SIG { __WARN__ } = sub { ++ $w } ; dbmopen ( %truffe , \'pleaseletthisfilenotexist\' , undef ) ; is $w , 1 , \'1 warning from dbmopen with undef third arg\' ; }',
            'start_line' => 62,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 65,
            'src' => ' dbmopen ( %truffe , \'pleaseletthisfilenotexist\' , undef ) ;',
            'start_line' => 65,
            'indent' => 1,
            'block_id' => 6
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 66,
            'src' => ' is $w , 1 , \'1 warning from dbmopen with undef third arg\' ;',
            'start_line' => 66,
            'indent' => 1,
            'block_id' => 6
          }
