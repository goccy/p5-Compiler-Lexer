...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => '/bin:/usr/bin:/usr/xpg4/bin:/usr/ucb',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'no dynamic loading on miniperl, no POSIX',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 16
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'Can\'t parse \'${groups_command}\'',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 41
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => '# pwgid=$pwgid pwgnam=$pwgnam \\$(=$(\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 46
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'LocalArrayVar',
                   'data' => '@extracted_supplementary_groups',
                   'type' => Compiler::Lexer::TokenType::T_LocalArrayVar,
                   'line' => 51
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'ok 1 # SKIP Your platform\'s `$groups_command\' is broken\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 71
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'ok 1 # SKIP darwin\'s `${groups_command}\' can\'t be trusted\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 86
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'ok 1 # This Cygwin behaves like Unix (Win2k?)\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 113
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'not ok 2 (groupstype should be type short, not long)\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 129
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'id -a 2>/dev/null || id 2>/dev/null',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 191
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'HereDocument',
                   'data' => '# These test results *may* be bogus, as you appear to have AFS,
# and I can\'t find a working \'id\' in your PATH (which I have set
# to \'$ENV{PATH}\').
#
# If these tests fail, report the particular incantation you use
    ...
    is_deeply($stmts, [
          {
            ...
            'has_warnings' => 1,
            'end_line' => 9,
            'src' => ' if ( $^O eq \'VMS\' ) { my $p = "/bin:/usr/bin:/usr/xpg4/bin:/usr/ucb" ; if ( $ENV { PATH } ) { $p .= ":$ENV{PATH}" ; } $ENV { PATH } = $p ; }',
            'start_line' => 3,
            'indent' => 1,
            'block_id' => 1
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 4,
            'src' => ' my $p = "/bin:/usr/bin:/usr/xpg4/bin:/usr/ucb" ;',
            'start_line' => 4,
            'indent' => 2,
            'block_id' => 2
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 16,
            'src' => ' skip_all_if_miniperl ( "no dynamic loading on miniperl, no POSIX" ) ;',
            'start_line' => 16,
            'indent' => 1,
            'block_id' => 1
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 24,
            'src' => ' skip_all ( \'getgrgid() not implemented\' ) unless eval { my ( $foo ) = getgrgid ( 0 ) ; 1 } ;',
            'start_line' => 23,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 27,
            'src' => ' skip_all ( "No \'id\' or \'groups\'" ) if $^O eq \'MSWin32\' || $^O eq \'NetWare\' || $^O eq \'VMS\' || $^O =~/lynxos/i ;',
            'start_line' => 26,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 133,
            'src' => ' sub Test { my ( $groups_command , $groups_string ) = system_groups ( ) or skip_all ( "No \'id\' or \'groups\'" ) ; my @extracted_groups = extract_system_groups ( $groups_string ) or skip_all ( "Can\'t parse \'${groups_command}\'" ) ; my $pwgid = $( + 0 ; my ( $pwgnam ) = getgrgid ( $pwgid ) ; $pwgnam //= \'\' ; print "# pwgid=$pwgid pwgnam=$pwgnam \\$(=$(\\n" ; my ( $gid_count , $all_perl_groups ) = perl_groups ( ) ; my %basegroup = basegroups ( $pwgid , $pwgnam ) ; my @extracted_supplementary_groups = remove_basegroup ( \\ %basegroup , \\ @extracted_groups ) ; print "1..2\\n" ; my $ngroups_max = posix_ngroups_max ( ) ; if ( defined $ngroups_max && $ngroups_max < @extracted_groups ) { print "ok 1 # SKIP Your platform\'s `$groups_command\' is broken\\n" ; } elsif ( darwin ( ) ) { print "ok 1 # SKIP darwin\'s `${groups_command}\' can\'t be trusted\\n" ; } else { my @perl_groups = remove_unparsed_entries ( \\ @extracted_groups , \\ @$all_perl_groups ) ; my @supplementary_groups = remove_basegroup ( \\ %basegroup , \\ @perl_groups ) ; my $ok1 = 0 ; if ( match_groups ( \\ @supplementary_groups , \\ @extracted_supplementary_groups , $pwgid ) ) { print "ok 1\\n" ; $ok1 = 1 ; } elsif ( cygwin_nt ( ) ) { %basegroup = unixy_cygwin_basegroups ( ) ; @extracted_supplementary_groups = remove_basegroup ( \\ %basegroup , \\ @extracted_groups ) ; if ( match_groups ( \\ @supplementary_groups , \\ @extracted_supplementary_groups , $pwgid ) ) { print "ok 1 # This Cygwin behaves like Unix (Win2k?)\\n" ; $ok1 = 1 ; } } unless ( $ok1 ) { } } $gid_count-> { 0 } //= 0 ; if ( 0 == $pwgid || $gid_count-> { 0 } < 2 ) { print "ok 2\\n" ; } else { print "not ok 2 (groupstype should be type short, not long)\\n" ; } return ; }',
            'start_line' => 34,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 39,
            'src' => ' my ( $groups_command , $groups_string ) = system_groups ( ) or skip_all ( "No \'id\' or \'groups\'" ) ;',
            'start_line' => 38,
            'indent' => 1,
            'block_id' => 4
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 41,
            'src' => ' my @extracted_groups = extract_system_groups ( $groups_string ) or skip_all ( "Can\'t parse \'${groups_command}\'" ) ;',
            'start_line' => 40,
            'indent' => 1,
            'block_id' => 4
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 46,
            'src' => ' print "# pwgid=$pwgid pwgnam=$pwgnam \\$(=$(\\n" ;',
            'start_line' => 46,
            'indent' => 1,
            'block_id' => 4
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 49,
            'src' => ' my ( $gid_count , $all_perl_groups ) = perl_groups ( ) ;',
            'start_line' => 49,
            'indent' => 1,
            'block_id' => 4
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 50,
            'src' => ' my %basegroup = basegroups ( $pwgid , $pwgnam ) ;',
            'start_line' => 50,
            'indent' => 1,
            'block_id' => 4
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 51,
            'src' => ' my @extracted_supplementary_groups = remove_basegroup ( \\ %basegroup , \\ @extracted_groups ) ;',
            'start_line' => 51,
            'indent' => 1,
            'block_id' => 4
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 59,
            'src' => ' my $ngroups_max = posix_ngroups_max ( ) ;',
            'start_line' => 59,
            'indent' => 1,
            'block_id' => 4
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 72,
            'src' => ' if ( defined $ngroups_max && $ngroups_max < @extracted_groups ) { print "ok 1 # SKIP Your platform\'s `$groups_command\' is broken\\n" ; }',
            'start_line' => 60,
            'indent' => 1,
            'block_id' => 4
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 71,
            'src' => ' print "ok 1 # SKIP Your platform\'s `$groups_command\' is broken\\n" ;',
            'start_line' => 71,
            'indent' => 2,
            'block_id' => 5
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 87,
            'src' => ' elsif ( darwin ( ) ) { print "ok 1 # SKIP darwin\'s `${groups_command}\' can\'t be trusted\\n" ; }',
            'start_line' => 74,
            'indent' => 1,
            'block_id' => 4
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 86,
            'src' => ' print "ok 1 # SKIP darwin\'s `${groups_command}\' can\'t be trusted\\n" ;',
            'start_line' => 86,
            'indent' => 2,
            'block_id' => 6
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 121,
            'src' => ' else { my @perl_groups = remove_unparsed_entries ( \\ @extracted_groups , \\ @$all_perl_groups ) ; my @supplementary_groups = remove_basegroup ( \\ %basegroup , \\ @perl_groups ) ; my $ok1 = 0 ; if ( match_groups ( \\ @supplementary_groups , \\ @extracted_supplementary_groups , $pwgid ) ) { print "ok 1\\n" ; $ok1 = 1 ; } elsif ( cygwin_nt ( ) ) { %basegroup = unixy_cygwin_basegroups ( ) ; @extracted_supplementary_groups = remove_basegroup ( \\ %basegroup , \\ @extracted_groups ) ; if ( match_groups ( \\ @supplementary_groups , \\ @extracted_supplementary_groups , $pwgid ) ) { print "ok 1 # This Cygwin behaves like Unix (Win2k?)\\n" ; $ok1 = 1 ; } } unless ( $ok1 ) { } }',
            'start_line' => 89,
            'indent' => 1,
            'block_id' => 4
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 95,
            'src' => ' my @perl_groups = remove_unparsed_entries ( \\ @extracted_groups , \\ @$all_perl_groups ) ;',
            'start_line' => 94,
            'indent' => 2,
            'block_id' => 7
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 97,
            'src' => ' my @supplementary_groups = remove_basegroup ( \\ %basegroup , \\ @perl_groups ) ;',
            'start_line' => 96,
            'indent' => 2,
            'block_id' => 7
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 105,
            'src' => ' if ( match_groups ( \\ @supplementary_groups , \\ @extracted_supplementary_groups , $pwgid ) ) { print "ok 1\\n" ; $ok1 = 1 ; }',
            'start_line' => 100,
            'indent' => 2,
            'block_id' => 7
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 116,
            'src' => ' elsif ( cygwin_nt ( ) ) { %basegroup = unixy_cygwin_basegroups ( ) ; @extracted_supplementary_groups = remove_basegroup ( \\ %basegroup , \\ @extracted_groups ) ; if ( match_groups ( \\ @supplementary_groups , \\ @extracted_supplementary_groups , $pwgid ) ) { print "ok 1 # This Cygwin behaves like Unix (Win2k?)\\n" ; $ok1 = 1 ; } }',
            'start_line' => 106,
            'indent' => 2,
            'block_id' => 7
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 107,
            'src' => ' %basegroup = unixy_cygwin_basegroups ( ) ;',
            'start_line' => 107,
            'indent' => 3,
            'block_id' => 9
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 108,
            'src' => ' @extracted_supplementary_groups = remove_basegroup ( \\ %basegroup , \\ @extracted_groups ) ;',
            'start_line' => 108,
            'indent' => 3,
            'block_id' => 9
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 115,
            'src' => ' if ( match_groups ( \\ @supplementary_groups , \\ @extracted_supplementary_groups , $pwgid ) ) { print "ok 1 # This Cygwin behaves like Unix (Win2k?)\\n" ; $ok1 = 1 ; }',
            'start_line' => 110,
            'indent' => 3,
            'block_id' => 9
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 113,
            'src' => ' print "ok 1 # This Cygwin behaves like Unix (Win2k?)\\n" ;',
            'start_line' => 113,
            'indent' => 4,
            'block_id' => 10
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 127,
            'src' => ' if ( 0 == $pwgid || $gid_count-> { 0 } < 2 ) { print "ok 2\\n" ; }',
            'start_line' => 125,
            'indent' => 1,
            'block_id' => 4
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 130,
            'src' => ' else { print "not ok 2 (groupstype should be type short, not long)\\n" ; }',
            'start_line' => 128,
            'indent' => 1,
            'block_id' => 4
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 129,
            'src' => ' print "not ok 2 (groupstype should be type short, not long)\\n" ;',
            'start_line' => 129,
            'indent' => 2,
            'block_id' => 13
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 146,
            'src' => ' sub system_groups { my ( $cmd , $groups_string ) = _system_groups ( ) ; if ( $groups_string ) { chomp $groups_string ; diag_variable ( groups => $groups_string ) ; } return ( $cmd , $groups_string ) ; }',
            'start_line' => 137,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 138,
            'src' => ' my ( $cmd , $groups_string ) = _system_groups ( ) ;',
            'start_line' => 138,
            'indent' => 1,
            'block_id' => 14
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 143,
            'src' => ' if ( $groups_string ) { chomp $groups_string ; diag_variable ( groups => $groups_string ) ; }',
            'start_line' => 140,
            'indent' => 1,
            'block_id' => 14
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 142,
            'src' => ' diag_variable ( groups => $groups_string ) ;',
            'start_line' => 142,
            'indent' => 2,
            'block_id' => 15
          },
...
# user may belong to, using the \'perlbug\' program.
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 191,
            'src' => ' $cmd = \'id -a 2>/dev/null || id 2>/dev/null\' ;',
            'start_line' => 191,
            'indent' => 1,
            'block_id' => 16
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 203,
            'src' => ' if ( $str && $str =~/groups=/ ) { return ( $cmd , $str ) ; }',
            'start_line' => 193,
            'indent' => 1,
            'block_id' => 16
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 211,
            'src' => ' if ( $str && $str !~/^[\\d\\s]$/ ) { return ( $cmd , $str ) ; }',
            'start_line' => 207,
            'indent' => 1,
            'block_id' => 16
          },
...
# user may belong to, using the \'perlbug\' program.
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 243,
            'src' => ' my @fields = split/\\b(\\w+=)/ , $groups_string ;',
            'start_line' => 243,
            'indent' => 1,
            'block_id' => 21
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 250,
            'src' => ' if ( $fields [ $i ] eq \'groups=\' ) { $gr = $fields [ $i + 1 ] ; $gr =~ s/ $// ; last ; }',
            'start_line' => 246,
            'indent' => 2,
            'block_id' => 22
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 267,
            'src' => ' if ( defined $gr ) { my @g = split m{, ?} , $gr ; for ( @g ) { if ( $_ =~ GROUP_RX1 ( ) || $_ =~ GROUP_RX2 ( ) ) { push @extracted , $+ { gr_name } || $+ { gid } ; } else { print "# ignoring group entry [$_]\\n" ; } } diag_variable ( gr => $gr ) ; diag_variable ( g => join \',\' , @g ) ; diag_variable ( ex_gr => join \',\' , @extracted ) ; }',
            'start_line' => 252,
            'indent' => 1,
            'block_id' => 21
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 262,
            'src' => ' for ( @g ) { if ( $_ =~ GROUP_RX1 ( ) || $_ =~ GROUP_RX2 ( ) ) { push @extracted , $+ { gr_name } || $+ { gid } ; } else { print "# ignoring group entry [$_]\\n" ; } }',
            'start_line' => 255,
            'indent' => 2,
            'block_id' => 24
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 258,
            'src' => ' if ( $_ =~ GROUP_RX1 ( ) || $_ =~ GROUP_RX2 ( ) ) { push @extracted , $+ { gr_name } || $+ { gid } ; }',
            'start_line' => 256,
            'indent' => 3,
            'block_id' => 25
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 257,
            'src' => ' push @extracted , $+ { gr_name } || $+ { gid } ;',
            'start_line' => 257,
            'indent' => 4,
            'block_id' => 26
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 261,
            'src' => ' else { print "# ignoring group entry [$_]\\n" ; }',
            'start_line' => 259,
            'indent' => 3,
            'block_id' => 25
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 260,
            'src' => ' print "# ignoring group entry [$_]\\n" ;',
            'start_line' => 260,
            'indent' => 4,
            'block_id' => 27
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 266,
            'src' => ' diag_variable ( ex_gr => join \',\' , @extracted ) ;',
            'start_line' => 266,
            'indent' => 2,
            'block_id' => 24
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 277,
            'src' => ' sub posix_ngroups_max { return eval { POSIX::NGROUPS_MAX ( ) ; } ; }',
            'start_line' => 273,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 276,
            'src' => ' return eval { POSIX::NGROUPS_MAX ( ) ; } ;',
            'start_line' => 274,
            'indent' => 1,
            'block_id' => 28
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 283,
            'src' => ' sub darwin { return $Config::Config { myuname } =~/^darwin/ ; }',
            'start_line' => 280,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 288,
            'src' => ' sub cygwin_nt { return $Config::Config { myuname } =~/^cygwin_nt/i ; }',
            'start_line' => 286,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 315,
            'src' => ' sub perl_groups { my @gids = split \' \' , $( ; my %gid_count ; my @gr_name ; for my $gid ( @gids ) { ++ $gid_count { $gid } ; my ( $group ) = getgrgid $gid ; next if ! defined $group ; push @gr_name , $group ; } diag_variable ( gr_name => join \',\' , @gr_name ) ; return ( \\ %gid_count , \\ @gr_name ) ; }',
            'start_line' => 292,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 329,
            'src' => ' sub remove_unparsed_entries { my ( $extracted_groups , $perl_groups ) = @_ ; my %was_extracted = map { $_ => 1 } @$extracted_groups ; return grep { $was_extracted { $_ } } @$perl_groups ; }',
            'start_line' => 319,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 345,
            'src' => ' sub basegroups { my ( $pwgid , $pwgnam ) = @_ ; if ( cygwin_nt ( ) ) { return ; } else { return ( $pwgid => 1 , $pwgnam => 1 , ) ; } }',
            'start_line' => 333,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 354,
            'src' => ' sub unixy_cygwin_basegroups { my ( $pwgid , $pwgnam ) = @_ ; return ( $pwgid => 1 , $pwgnam => 1 , ) ; }',
            'start_line' => 348,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 364,
            'src' => ' sub remove_basegroup { my ( $basegroups , $groups ) = @_ ; return grep { ! $basegroups-> { $_ } } @$groups ; }',
            'start_line' => 358,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 387,
            'src' => ' sub match_groups { my ( $supplementary_groups , $extracted_supplementary_groups , $pwgid ) = @_ ; my %g ; $g { $_ } [ 0 ] = 1 for @$supplementary_groups ; $g { $_ } [ 1 ] = 1 for @$extracted_supplementary_groups ; my @misses = grep { ! ( $g { $_ } [ 0 ] && $g { $_ } [ 1 ] ) } sort keys %g ; return ! @misses || ( ! @$supplementary_groups && 1 == @$extracted_supplementary_groups && $pwgid == $extracted_supplementary_groups-> [ 0 ] ) ; }',
            'start_line' => 369,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 395,
            'src' => ' sub diag_variable { my ( $label , $content ) = @_ ; printf "# %-11s=%s\\n" , $label , $content ; return ; }',
            'start_line' => 390,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 403,
            'src' => ' sub uniq { my %seen ; return grep { ! $seen { $_ } ++ } @_ ; }',
            'start_line' => 398,
            'indent' => 0,
            'block_id' => 0
          },
