...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'name' => 'AlphabetXOr',
                   'data' => 'xor',
                   'type' => Compiler::Lexer::TokenType::T_AlphabetXOr,
                   'line' => 108
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'rwxoRWXOezsfdpSbctugkTBMAC',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 135
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => '*988 already exists. Please adjust this test',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 197
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => '*973 already exists. Please adjust this test',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 203
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => '$op $args\\$tied_glob$postargs',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 231
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'retval of $int \\$var2 $op= \\$var2',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 277
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 23,
            'src' => ' sub TIESCALAR { my $pack = shift ; bless [ @_ ] , $pack ; }',
            'start_line' => 23,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 24,
            'src' => ' sub FETCH { $count ++ ; @{ $_ [ 0 ] } == 1 ? ${ $_ [ 0 ] } [ 0 ] : shift @{ $_ [ 0 ] } }',
            'start_line' => 24,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 39,
            'src' => ' sub check_count { my $op = shift ; my $expected = shift ( ) // 1 ; local $: : Level = $: : Level + 1 ; is $count , $expected , "FETCH called " . ( $expected == 1 ? "just once" : $expected == 2 ? "twice" : "$count times" ) . " using \'$op\'" ; $count = 0 ; }',
            'start_line' => 28,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 37,
            'src' => ' is $count , $expected , "FETCH called " . ( $expected == 1 ? "just once" : $expected == 2 ? "twice" : "$count times" ) . " using \'$op\'" ;',
            'start_line' => 32,
            'indent' => 1,
            'block_id' => 5
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 125,
            'src' => ' check_count \'$tiedref .= <rcatline>\' ;',
            'start_line' => 125,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 127,
            'src' => ' check_count \'$tiedstr .= <rcatline>\' ;',
            'start_line' => 127,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 129,
            'src' => ' check_count \'$tiedglob .= <rcatline>\' ;',
            'start_line' => 129,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 132,
            'src' => ' { no warnings "glob" ; $dummy = < ${ var } > ; check_count \'<glob>\' ; }',
            'start_line' => 130,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 145,
            'src' => ' for ( split // , \'rwxoRWXOezsfdpSbctugkTBMAC\' ) { no warnings \'unopened\' ; $dummy = eval "-$_ \\$var" ; check_count "-$_" ; $var = * dummy ; $dummy = $var ; $count = 0 ; $dummy = eval "-$_ \\$var" ; check_count "-$_ \\$tied_glob" ; next if/[guk]/ ; $var = * dummy ; $dummy = $var ; $count = 0 ; eval "\\$dummy = -$_ \\\\\\$var" ; check_count "-$_ \\\\\\$tied_glob" ; }',
            'start_line' => 135,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 169,
            'src' => ' check_count \'shift arrayref\' ;',
            'start_line' => 169,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 177,
            'src' => ' { no strict \'refs\' ; tie my $var4 => \'main\' , ** ; $dummy = * $var4 ; check_count \'*{}\' ; }',
            'start_line' => 173,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 207,
            'src' => ' { no strict \'refs\' ; tie my $var1 => \'main\' , 1 ; $dummy = $$var1 ; check_count \'symbolic ${}\' ; $dummy = @$var1 ; check_count \'symbolic @{}\' ; $dummy = %$var1 ; check_count \'symbolic %{}\' ; $dummy = * $var1 ; check_count \'symbolic *{}\' ; local * 1 = sub { } ; $dummy = &$var1 ; check_count \'symbolic &{}\' ; if ( exists $: : { 988 } ) { die "*988 already exists. Please adjust this test" } tie my $var6 => main => 988 ; no warnings ; readdir $var6 ; check_count \'symbolic readdir\' ; if ( exists $: : { 973 } ) { die "*973 already exists. Please adjust this test" } tie my $var7 => main => 973 ; defined $$var7 ; check_count \'symbolic defined ${}\' ; }',
            'start_line' => 182,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 198,
            'src' => ' if ( exists $: : { 988 } ) { die "*988 already exists. Please adjust this test" }',
            'start_line' => 196,
            'indent' => 1,
            'block_id' => 11
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 201,
            'src' => ' check_count \'symbolic readdir\' ;',
            'start_line' => 201,
            'indent' => 1,
            'block_id' => 11
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 204,
            'src' => ' if ( exists $: : { 973 } ) { die "*973 already exists. Please adjust this test" }',
            'start_line' => 202,
            'indent' => 1,
            'block_id' => 11
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 206,
            'src' => ' check_count \'symbolic defined ${}\' ;',
            'start_line' => 206,
            'indent' => 1,
            'block_id' => 11
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 221,
            'src' => ' { no warnings \'once\' ; ( ) = * swibble ; tie my $var9 => \'main\' , \'swibble\' ; no strict \'refs\' ; use constant glumscrin => \'shreggleboughet\' ; * $var9 = \\ & { "glumscrin" } ; check_count \'*$tied = \\&{"name of const"}\' ; }',
            'start_line' => 212,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 219,
            'src' => ' use constant glumscrin => \'shreggleboughet\' ;',
            'start_line' => 219,
            'indent' => 1,
            'block_id' => 18
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 220,
            'src' => ' check_count \'*$tied = \\&{"name of const"}\' ;',
            'start_line' => 220,
            'indent' => 1,
            'block_id' => 18
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 236,
            'src' => ' for ( [ chdir => \'\' ] , [ chmod => \'0,\' ] , [ chown => \'0,0,\' ] , [ utime => \'0,0,\' ] , [ truncate => \'\' , \',0\' ] , [ stat => \'\' ] , [ lstat => \'\' ] , [ open => \'my $fh,"<&",\' ] , [ \'()=sort\' => \'\' , \' 1,2,3\' ] ) { my ( $op , $args , $postargs ) = @$_ ; $postargs //= \'\' ; $var8 = * dummy ; $dummy = $var8 ; $count = 0 ; eval "$op $args \\$var8 $postargs" ; check_count "$op $args\\$tied_glob$postargs" ; $var8 = * dummy ; $dummy = $var8 ; $count = 0 ; my $ref = \\ $var8 ; eval "$op $args \\$ref $postargs" ; check_count "$op $args\\\\\\$tied_glob$postargs" ; }',
            'start_line' => 224,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 230,
            'src' => ' eval "$op $args \\$var8 $postargs" ;',
            'start_line' => 230,
            'indent' => 1,
            'block_id' => 20
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 231,
            'src' => ' check_count "$op $args\\$tied_glob$postargs" ;',
            'start_line' => 231,
            'indent' => 1,
            'block_id' => 20
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 249,
            'src' => ' { no warnings ; $var = * foo ; $dummy = select $var , undef , undef , 0 ; check_count \'select $tied_glob, ...\' ; $var = \\ 1 ; $dummy = select $var , undef , undef , 0 ; check_count \'select $tied_ref, ...\' ; $var = undef ; $dummy = select $var , undef , undef , 0 ; check_count \'select $tied_undef, ...\' ; }',
            'start_line' => 238,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 242,
            'src' => ' $dummy = select $var , undef , undef , 0 ;',
            'start_line' => 241,
            'indent' => 1,
            'block_id' => 21
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 242,
            'src' => ' check_count \'select $tied_glob, ...\' ;',
            'start_line' => 242,
            'indent' => 1,
            'block_id' => 21
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 245,
            'src' => ' check_count \'select $tied_ref, ...\' ;',
            'start_line' => 245,
            'indent' => 1,
            'block_id' => 21
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 248,
            'src' => ' check_count \'select $tied_undef, ...\' ;',
            'start_line' => 248,
            'indent' => 1,
            'block_id' => 21
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 279,
            'src' => ' sub _bin_test { my $int = shift ; my $op = shift ; my $exp = pop ; my @fetches = @_ ; $int = $int ? \'use integer; \' : \'\' ; tie my $var , "main" , @fetches ; is ( eval "$int\\$var $op \\$var" , $exp , "retval of $int\\$var $op \\$var" ) ; check_count "$int$op" , 2 ; return unless $mutators { $op } ; tie my $var2 , "main" , @fetches ; is ( eval "$int \\$var2 $op= \\$var2" , $exp , "retval of $int \\$var2 $op= \\$var2" ) ; check_count "$int$op=" , 3 ; }',
            'start_line' => 262,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 271,
            'src' => ' is ( eval "$int\\$var $op \\$var" , $exp , "retval of $int\\$var $op \\$var" ) ;',
            'start_line' => 271,
            'indent' => 1,
            'block_id' => 22
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 277,
            'src' => ' is ( eval "$int \\$var2 $op= \\$var2" , $exp , "retval of $int \\$var2 $op= \\$var2" ) ;',
            'start_line' => 277,
            'indent' => 1,
            'block_id' => 22
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 283,
            'src' => ' sub bin_test { _bin_test ( 0 , @_ ) ; }',
            'start_line' => 281,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 287,
            'src' => ' sub bin_int_test { _bin_test ( 1 , @_ ) ; }',
            'start_line' => 285,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 329,
            'src' => ' cmp_ok ( atan2 ( $var , $var ) , \'<\' , .3 , \'retval of atan2 $var, $var\' ) ;',
            'start_line' => 329,
            'indent' => 0,
            'block_id' => 0
          },
...
subtest 'get_used_modules' => sub {
    ...
    is_deeply($modules, [
          ...
          {
            'args' => '  glumscrin  =>  \'shreggleboughet\'',
            'name' => 'constant'
          }
        ]
