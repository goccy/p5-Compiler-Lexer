...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => 'sub redefinition sets CvGV',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 76,
                   'name' => 'RawString'
                 }, 'Compiler::Lexer::Token' ),
...
',
          ...
          bless( {
                   'name' => 'RawString',
                   'line' => 84,
                   'data' => 'no double free redefining anon stub',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value
...
',
          ...
          bless( {
                   'data' => 'recursive calls do not share shared-hash-key TARGs',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
          ...
          bless( {
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'data' => 'recursive calls do not share shared-hash-key TARGs (2)',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'line' => 129,
                   'name' => 'RawString'
          ...
          bless( {
                   ...
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => '[perl #78194] \\$_[0] == \\$_[0] when @_ aliases "$x"',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 133,
                   'name' => 'RawString'
                 }, 'Compiler::Lexer::Token' ),
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'data' => 'sub (){42} returns a mutable value',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_RawString
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => 'sub (){ return 42 } returns a mutable value',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'line' => 145,
          ...
          bless( {
                   ...
                   'line' => 147,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'data' => 'my sub (){42} returns a mutable value',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value
                 }, 'Compiler::Lexer::Token' ),
          ...
          bless( {
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => 'my sub (){ return 42 } returns a mutable value',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'data' => 'freeing ops does not make sub(){42} immutable',
                   'kind' => Compiler::Lexer::Kind::T_Term
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'kind' => Compiler::Lexer::Kind::T_StmtEnd,
          ...
          bless( {
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => 'num of elems in @_ after &xsub with nonexistent $_[0]',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
          ...
          bless( {
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'data' => 'content of nonexistent $_[0] is modified by &xsub',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'line' => 164,
                   'name' => 'RawString'
          ...
          bless( {
                   ...
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => 'goto &xsub when @_ does not exist',
                   'type' => Compiler::Lexer::TokenType::T_RawString
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'line' => 172,
          ...
          bless( {
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => 'XSUB clobbering sub whose DESTROY assigns to the glob',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'line' => 190,
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'data' => 'Pure-Perl sub clobbering sub whose DESTROY assigns to the glob',
                   'kind' => Compiler::Lexer::Kind::T_Term
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'type' => Compiler::Lexer::TokenType::T_SemiColon,
          ...
          bless( {
                   ...
                   'name' => 'HereDocument',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => 'use strict; use warnings; eval q/use File::{Spec}/; eval q/use File::Spec/;
',
                   'type' => Compiler::Lexer::TokenType::T_HereDocument,
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value
          ...
          bless( {
                   'name' => 'String',
                   'line' => 213,
                   'data' => 'check special blocks are cleared on error',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0
          ...
          bless( {
                   ...
                   'name' => 'RawString',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => 'sub constant1; sub constant2($)',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value
                 }, 'Compiler::Lexer::Token' ),
          ...
          bless( {
                   'data' => 'stub re-declaration of constant with no prototype',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => 'stub re-declaration of constant with wrong prototype',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 223,
                   'name' => 'RawString'
                 }, 'Compiler::Lexer::Token' ),
          ...
          bless( {
                   ...
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'data' => 'two warnings from the above',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'kind' => Compiler::Lexer::Kind::T_Term
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'data' => '[perl #122845] no crash in closure recursion with our-vars',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'name' => 'RawString',
                   'line' => 242
          ...
          bless( {
                   ...
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'data' => 'eval q/$var/ in named sub in predeclared sub',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_RawString
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'name' => 'RawString',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => 'sub rt126845_1 (); sub rt126845_1 () :lvalue',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0
                 }, 'Compiler::Lexer::Token' ),
          ...
          bless( {
                   'line' => 258,
                   'name' => 'String',
                   'data' => 'RT #126845: stub with prototype, then with attribute',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0
          ...
          bless( {
                   'data' => 'sub rt126845_2 (); sub rt126845_2 () :lvalue {}',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
          ...
          bless( {
                   'data' => 'RT #126845: stub with prototype, then definition with attribute',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
          ...
          bless( {
                   ...
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'data' => 'check_ret(5,6,7,8,9) scalar',
                   'kind' => Compiler::Lexer::Kind::T_Term
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'line' => 360,
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'indent' => 0,
            'block_id' => 0,
            'src' => ' sub empty_sub { } is ( empty_sub , undef , "Is empty" ) ;',
            'token_num' => 13
          },
          {
            'indent' => 0,
