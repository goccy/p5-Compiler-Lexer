...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => '^Illegal number of bits in vec',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 46
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => '^Negative offset to vec in lvalue context',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 55
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'Timely scalar destruction with lvalue vec',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 109
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 27,
            'src' => ' is ( ( unpack ( \'C\' , substr ( $foo , 1 , 1 ) ) & 255 ) , 0xf1 ) ;',
            'start_line' => 27,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 32,
            'src' => ' is ( vec ( $Vec , 0 , 32 ) , 3135089835 ) ;',
            'start_line' => 32,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 46,
            'src' => ' like ( $@ , qr/^Illegal number of bits in vec/ ) ;',
            'start_line' => 46,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 55,
            'src' => ' like ( $@ , qr/^Negative offset to vec in lvalue context/ ) ;',
            'start_line' => 55,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 73,
            'src' => ' if ( $Is_EBCDIC ) { is ( $foo , "\\x8c\\x0d\\xff\\x8a\\x69" ) ; }',
            'start_line' => 71,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 72,
            'src' => ' is ( $foo , "\\x8c\\x0d\\xff\\x8a\\x69" ) ;',
            'start_line' => 72,
            'indent' => 1,
            'block_id' => 2
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 76,
            'src' => ' else { is ( $foo , "\\xc4\\x0d\\xc3\\xbf\\xc3\\xbe" ) ; }',
            'start_line' => 74,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 75,
            'src' => ' is ( $foo , "\\xc4\\x0d\\xc3\\xbf\\xc3\\xbe" ) ;',
            'start_line' => 75,
            'indent' => 1,
            'block_id' => 3
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 84,
            'src' => ' $foo = "\\x61\\x62\\x63\\x64\\x65\\x66" ;',
            'start_line' => 84,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 85,
            'src' => ' is ( vec ( substr ( $foo , 2 , 2 ) , 0 , 16 ) , 25444 ) ;',
            'start_line' => 85,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 87,
            'src' => ' is ( $foo , "\\x61\\x62\\x63\\x34\\x65\\x66" ) ;',
            'start_line' => 87,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 97,
            'src' => ' { my $s = "" ; vec ( $s , 0 , 1 ) = 0 ; vec ( $s , 1 , 1 ) = 1 ; my @r ; $r [ $_ ] = \\ vec $s , $_ , 1 for ( 0 , 1 ) ; ok ( ! ( ${ $r [ 0 ] } != 0 || ${ $r [ 1 ] } != 1 ) ) ; }',
            'start_line' => 90,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 108,
            'src' => ' { my $x = \'\' ; vec ( $x , 0 , 1 ) = 0 ; $x = bless ( { } , \'Class\' ) ; }',
            'start_line' => 104,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 109,
            'src' => ' is ( $destroyed , 1 , \'Timely scalar destruction with lvalue vec\' ) ;',
            'start_line' => 109,
            'indent' => 0,
            'block_id' => 0
          }
