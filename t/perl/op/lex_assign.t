...
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => '# skipping $comment: unimplemented:\\nok $ord\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 138
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => '# skipping $comment: syntax not good for selfassign:\\nok $ord\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 166
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 27,
            'src' => ' print "1.." , ( 11 + @INPUT + @simple_input ) , "\\n" ;',
            'start_line' => 27,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 59,
            'src' => ' print "not " unless $xxx eq \'cb\' ;',
            'start_line' => 59,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 97,
            'src' => ' { my $sc = 0 ; sub B::TIESCALAR { bless [ 11 ] , \'B\' } sub B::FETCH { - ( shift-> [ 0 ] ) } sub B::STORE { $sc ++ ; my $o = shift ; $o-> [ 0 ] = 17 + shift } my $m ; tie $m , \'B\' ; $m = 100 ; $ord ++ ; print "not " unless $sc == 1 ; print "ok $ord\\n" ; my $t = 11 ; $m = $t + 89 ; $ord ++ ; print "not " unless $sc == 2 ; print "ok $ord\\n" ; $ord ++ ; print "# $m\\nnot " unless $m == -117 ; print "ok $ord\\n" ; $m += $t ; $ord ++ ; print "not " unless $sc == 3 ; print "ok $ord\\n" ; $ord ++ ; print "# $m\\nnot " unless $m == 89 ; print "ok $ord\\n" ; }',
            'start_line' => 62,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 108,
            'src' => ' print "# $zzz1 = $l1 = $l2 = $zzz2 = $l3 = $l4 = 13\\nnot " unless $zzz1 == 13 and $zzz2 == 13 and $l1 == 13 and $l2 == 13 and $l3 == 13 and $l4 == 13 ;',
            'start_line' => 106,
            'indent' => 0,
            'block_id' => 0
          },
  ...
  print "ok \\$ord\\\\n";
} ; if ( $@ ) { if ( $@ =~/is unimplemented/ ) { print "# skipping $comment: unimplemented:\\nok $ord\\n" ; } else { warn $@ ; print "# \'$_\'\\nnot ok $ord\\n" ; } } }',
            'start_line' => 111,
            'indent' => 0,
            'block_id' => 0
          },
  ...
  print "ok \\$ord\\\\n";
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 143,
            'src' => ' if ( $@ ) { if ( $@ =~/is unimplemented/ ) { print "# skipping $comment: unimplemented:\\nok $ord\\n" ; } else { warn $@ ; print "# \'$_\'\\nnot ok $ord\\n" ; } }',
            'start_line' => 136,
            'indent' => 1,
            'block_id' => 10
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 139,
            'src' => ' if ( $@ =~/is unimplemented/ ) { print "# skipping $comment: unimplemented:\\nok $ord\\n" ; }',
            'start_line' => 137,
            'indent' => 2,
            'block_id' => 11
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 138,
            'src' => ' print "# skipping $comment: unimplemented:\\nok $ord\\n" ;',
            'start_line' => 138,
            'indent' => 3,
            'block_id' => 12
          },
  ...
  print "ok \\$ord\\\\n";
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 167,
            'src' => ' elsif ( $@ =~/Can\'t (modify|take log of 0)/ ) { print "# skipping $comment: syntax not good for selfassign:\\nok $ord\\n" ; }',
            'start_line' => 165,
            'indent' => 2,
            'block_id' => 15
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 166,
            'src' => ' print "# skipping $comment: syntax not good for selfassign:\\nok $ord\\n" ;',
            'start_line' => 166,
            'indent' => 3,
            'block_id' => 17
          },
