...
',
          ...
          bless( {
                   'name' => 'String',
                   'data' => 'concat does not lose its stack pointer after utf8 upgrade [perl #78674]',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   ...
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'line' => 36,
                   'data' => '.= is not confused by changing utf8ness',
                   'name' => 'RawString'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'data' => ';',
...
',
          ...
          bless( {
                   ...
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'line' => 58,
                   'data' => 'recursive concat does not share TARGs',
                   'name' => 'String'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'line' => 58,
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          {
            'src' => ' skip ( "no encoding pragma in EBCDIC" , 1 ) if $: : IS_EBCDIC ;',
            'indent' => 1,
            'start_line' => 18,
            'has_warnings' => 1,
            'end_line' => 18,
          ...
          },
          {
            ...
            'start_line' => 19,
            'indent' => 1,
            'src' => ' skip_if_miniperl ( "no dynamic loading on miniperl, no Encode" , 1 ) ;'
          },
          {
            'start_line' => 20,
            'indent' => 1,
            'src' => ' fresh_perl_is q{    no warnings \'deprecated\';
    use encoding \'utf8\';
    map { "a" . $a } ((1)x5000);
    print "ok\\n";
} , "ok\\n" , { } , "concat does not lose its stack pointer after utf8 upgrade [perl #78674]" ;',
          ...
          {
            'indent' => 0,
            'src' => ' { package o ; use overload \'""\' => sub { $_ [ 0 ] [ 0 ] } }',
            'start_line' => 30,
            'token_num' => 19,
            'block_id' => 0,
            'has_warnings' => 1,
          ...
          },
          {
            ...
            'start_line' => 36,
            'indent' => 0,
            'src' => ' is $x , "\\xff\\x{101}\\x{101}" , \'.= is not confused by changing utf8ness\' ;'
          },
          {
            'token_num' => 10,
            'block_id' => 0,
            'has_warnings' => 1,
            'end_line' => 58,
            'src' => ' fresh_perl_is q{ sub canonpath {
     my ($path) = @_;
     my $node = \'\';
     $path =~ s|/\\z||;
     return "$node$path";
