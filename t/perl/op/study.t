...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'split with studied string passed to the regep engine',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 93
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'studied scalar passed to pp_substconst',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 99
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'studied scalar passed to pp_substconst with RX_MATCH_COPIED() true',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 107
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => '#92696 study $b inside (?{}), nothing studied',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 138
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => '#92696 study $b inside (?{}), $c studied',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 146
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => '#92696 study $b inside (?{}), $a studied',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 153
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 15,
            'src' => ' my $have_alarm = $Config { d_alarm } ;',
            'start_line' => 15,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 79,
            'src' => ' todo_skip ( \'busy loop - compiler bug?\' , 2 ) if $^O eq \'os390\' or $^O eq \'posix-bc\' ;',
            'start_line' => 78,
            'indent' => 1,
            'block_id' => 2
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 94,
            'src' => ' { my $a = \'QaaQaabQaabbQ\' ; study $a ; my @a = split/aab*/ , $a ; is ( "@a" , \'Q Q Q Q\' , \'split with studied string passed to the regep engine\' ) ; }',
            'start_line' => 89,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 93,
            'src' => ' is ( "@a" , \'Q Q Q Q\' , \'split with studied string passed to the regep engine\' ) ;',
            'start_line' => 93,
            'indent' => 1,
            'block_id' => 3
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 101,
            'src' => ' { $_ = "AABBAABB" ; study ; is ( s/AB+/1/ge , 2 , \'studied scalar passed to pp_substconst\' ) ; is ( $_ , \'A1A1\' ) ; }',
            'start_line' => 96,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 99,
            'src' => ' is ( s/AB+/1/ge , 2 , \'studied scalar passed to pp_substconst\' ) ;',
            'start_line' => 99,
            'indent' => 1,
            'block_id' => 4
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 111,
            'src' => ' { $_ = "AABBAABB" ; study ; is ( s/(A)B+/1/ge , 2 , \'studied scalar passed to pp_substconst with RX_MATCH_COPIED() true\' ) ; is ( $1 , \'A\' ) ; is ( $2 , undef ) ; is ( $_ , \'A1A1\' ) ; }',
            'start_line' => 103,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 107,
            'src' => ' is ( s/(A)B+/1/ge , 2 , \'studied scalar passed to pp_substconst with RX_MATCH_COPIED() true\' ) ;',
            'start_line' => 106,
            'indent' => 1,
            'block_id' => 5
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 117,
            'src' => ' push @got , $_ foreach $a =~/[^x]d(?{})[^x]d/g ;',
            'start_line' => 117,
            'indent' => 1,
            'block_id' => 6
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 118,
            'src' => ' is ( "@got" , \'ydyd ydyd\' , \'#92696 control\' ) ;',
            'start_line' => 118,
            'indent' => 1,
            'block_id' => 6
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 125,
            'src' => ' is ( "@got" , \'ydyd ydyd\' , \'#92696 study $a\' ) ;',
            'start_line' => 125,
            'indent' => 1,
            'block_id' => 6
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 132,
            'src' => ' is ( "@got" , \'ydyd ydyd\' , \'#92696 study $b\' ) ;',
            'start_line' => 132,
            'indent' => 1,
            'block_id' => 6
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 137,
            'src' => ' push @got , $_ foreach $a =~/[^x]d(?{study $b})[^x]d/g ;',
            'start_line' => 137,
            'indent' => 1,
            'block_id' => 6
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 138,
            'src' => ' is ( "@got" , \'ydyd ydyd\' , \'#92696 study $b inside (?{}), nothing studied\' ) ;',
            'start_line' => 138,
            'indent' => 1,
            'block_id' => 6
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 146,
            'src' => ' is ( "@got" , \'ydyd ydyd\' , \'#92696 study $b inside (?{}), $c studied\' ) ;',
            'start_line' => 146,
            'indent' => 1,
            'block_id' => 6
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 153,
            'src' => ' is ( "@got" , \'ydyd ydyd\' , \'#92696 study $b inside (?{}), $a studied\' ) ;',
            'start_line' => 153,
            'indent' => 1,
            'block_id' => 6
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 159,
            'src' => ' push @got , $_ foreach $a =~/[^x]d(?{$a .= \'\'})[^x]d/g ;',
            'start_line' => 159,
            'indent' => 1,
            'block_id' => 6
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 160,
            'src' => ' is ( "@got" , \'ydyd ydyd\' , \'#92696 $a .= \\\'\\\' inside (?{}), $a studied\' ) ;',
            'start_line' => 160,
            'indent' => 1,
            'block_id' => 6
          }
