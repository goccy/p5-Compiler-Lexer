...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => '{ local *F; open F, q[TEST]; close F; $!=0 } die;',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 38
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'Can\'t open temp error file $tempfile:  $!',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 63
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'exit = 0x%04x bang = 0x%04x query = 0x%04x',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 81
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 16,
            'src' => ' skip_all ( \'broken on MPE/iX\' ) if $^O eq \'mpeix\' ;',
            'start_line' => 16,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 39,
            'src' => ' my @tests = ( [ 0 , 0 ] , [ 0 , 1 ] , [ 0 , 127 ] , [ 0 , 128 ] , [ 0 , 255 ] , [ 0 , 256 ] , [ 0 , 512 ] , [ 1 , 0 ] , [ 1 , 1 ] , [ 1 , 256 ] , [ 128 , 0 ] , [ 128 , 1 ] , [ 128 , 256 ] , [ 255 , 0 ] , [ 255 , 1 ] , [ 255 , 256 ] , [ 0 , 512 , \'{ local *F; open F, q[TEST]; close F; $!=0 } die;\' ] , ) ;',
            'start_line' => 20,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 63,
            'src' => ' open STDERR , \'>\' , $tempfile or die "Can\'t open temp error file $tempfile:  $!" ;',
            'start_line' => 63,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 82,
            'src' => ' foreach my $test ( @tests ) { my ( $bang , $query , $code ) = @$test ; $code ||= \'die;\' ; if ( $^O eq \'MSWin32\' || $^O eq \'NetWare\' || $^O eq \'VMS\' ) { system ( qq{$^X -e "\\$! = $bang; \\$? = $query; $code"} ) ; } else { system ( qq{$^X -e \'\\$! = $bang; \\$? = $query; $code\'} ) ; } my $exit = $? ; $bang = 4 if $vms_exit_mode ; is ( $exit , ( ( $bang || ( $query >> 8 ) || 255 ) << 8 ) , sprintf "exit = 0x%04x bang = 0x%04x query = 0x%04x" , $exit , $bang , $query ) ; }',
            'start_line' => 65,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 70,
            'src' => ' if ( $^O eq \'MSWin32\' || $^O eq \'NetWare\' || $^O eq \'VMS\' ) { system ( qq{$^X -e "\\$! = $bang; \\$? = $query; $code"} ) ; }',
            'start_line' => 68,
            'indent' => 1,
            'block_id' => 7
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 69,
            'src' => ' system ( qq{$^X -e "\\$! = $bang; \\$? = $query; $code"} ) ;',
            'start_line' => 69,
            'indent' => 2,
            'block_id' => 8
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 73,
            'src' => ' else { system ( qq{$^X -e \'\\$! = $bang; \\$? = $query; $code\'} ) ; }',
            'start_line' => 71,
            'indent' => 1,
            'block_id' => 7
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 81,
            'src' => ' is ( $exit , ( ( $bang || ( $query >> 8 ) || 255 ) << 8 ) , sprintf "exit = 0x%04x bang = 0x%04x query = 0x%04x" , $exit , $bang , $query ) ;',
            'start_line' => 80,
            'indent' => 1,
            'block_id' => 7
          },
