...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'opendir(NOSUCH, "no/such/directory");',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 13
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'readdir results all accounted for',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 48
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'glob results all accounted for',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 49
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 13,
            'src' => ' eval \'opendir(NOSUCH, "no/such/directory");\' ;',
            'start_line' => 13,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 20,
            'src' => ' for my $i ( 1 .. 2000 ) { local * OP ; opendir ( OP , "op" ) or die "can\'t opendir: $!" ; }',
            'start_line' => 16,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 18,
            'src' => ' opendir ( OP , "op" ) or die "can\'t opendir: $!" ;',
            'start_line' => 18,
            'indent' => 1,
            'block_id' => 2
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 32,
            'src' => ' { open my $man , \'<\' , \'../MANIFEST\' or die "Can\'t open ../MANIFEST: $!" ; while ( < $man > ) { ++ $expect if m!^t/op/[^/]+\\t! ; } }',
            'start_line' => 27,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 28,
            'src' => ' open my $man , \'<\' , \'../MANIFEST\' or die "Can\'t open ../MANIFEST: $!" ;',
            'start_line' => 28,
            'indent' => 1,
            'block_id' => 3
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 31,
            'src' => ' while ( < $man > ) { ++ $expect if m!^t/op/[^/]+\\t! ; }',
            'start_line' => 29,
            'indent' => 1,
            'block_id' => 3
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 34,
            'src' => ' my ( $min , $max ) = ( $expect - 10 , $expect + 10 ) ;',
            'start_line' => 34,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 35,
            'src' => ' within ( scalar @D , $expect , 10 , \'counting op/*.t\' ) ;',
            'start_line' => 35,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 43,
            'src' => ' if ( $G [ 0 ] =~ m#.*\\](\\w+\\.t)#i ) { @G = grep ( s#.*\\](\\w+\\.t).*#op/$1#i , < op / * . t > ) ; }',
            'start_line' => 39,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 47,
            'src' => ' while ( @R && @G && $G [ 0 ] eq \'op/\' . $R [ 0 ] ) { shift ( @R ) ; shift ( @G ) ; }',
            'start_line' => 44,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 48,
            'src' => ' is ( scalar @R , 0 , \'readdir results all accounted for\' ) ;',
            'start_line' => 48,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 49,
            'src' => ' is ( scalar @G , 0 , \'glob results all accounted for\' ) ;',
            'start_line' => 49,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 62,
            'src' => ' fresh_perl_like ( q{  eval {
    my $x = ".";
    my @files = readdir($x);
  };
  print "no crash";
} , qr/^no crash/ , { } , \'RT #68182\' ) ;',
            'start_line' => 62,
            'indent' => 0,
            'block_id' => 0
          },
