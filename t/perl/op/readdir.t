...
',
          ...
          bless( {
                   ...
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'data' => 'should be the same number of files, scalar or list',
                   'name' => 'String'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'name' => 'RightParenthesis',
          ...
          bless( {
                   'name' => 'String',
                   'data' => 'mismatch on file count - presumably a readdir error',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_String,
...
subtest 'get_groups_by_syntax_level' => sub {
  ...
  print "no crash";
          ...
          {
            'indent' => 1,
            'src' => ' ok ( opendir ( OP , "op" ) , "opendir op" ) ;',
            'start_line' => 75,
            'block_id' => 7,
            'token_num' => 12,
            'has_warnings' => 1,
          ...
          {
            'indent' => 1,
            'src' => ' while ( defined ( my $f = readdir OP ) ) { push @s , $f if $f =~/^[^\\.].*\\.t$/i ; }',
            'start_line' => 77,
            'has_warnings' => 1,
            'end_line' => 80,
            'block_id' => 7,
          ...
          },
          {
            'start_line' => 83,
            'indent' => 1,
            'src' => ' is ( @s , @D , "should be the same number of files, scalar or list" ) or skip "mismatch on file count - presumably a readdir error" , 1 ;',
            'end_line' => 84,
            'has_warnings' => 1,
            'token_num' => 14,
            'block_id' => 7
          ...
          {
            'start_line' => 85,
            'src' => ' is ( $errno , 0 , "errno preserved" ) ;',
            'indent' => 1,
            'block_id' => 7,
            'token_num' => 9,
            'has_warnings' => 1,
