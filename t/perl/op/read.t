...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'Needs :utf8 layer but no perlio',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 54
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => '%d into %d l $length o $offset',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 82
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 12,
            'src' => ' open ( FOO , \'op/read.t\' ) || open ( FOO , \'t/op/read.t\' ) || open ( FOO , \':op:read.t\' ) || die "Can\'t open op.read" ;',
            'start_line' => 12,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 13,
            'src' => ' seek ( FOO , 4 , 0 ) or die "Seek failed: $!" ;',
            'start_line' => 13,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 20,
            'src' => ' seek ( FOO , 0 , 2 ) || seek ( FOO , 20000 , 0 ) ;',
            'start_line' => 20,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 32,
            'src' => ' my $has_perlio = ! eval { no warnings ; require Config ; ! $Config::Config { useperlio } } ;',
            'start_line' => 28,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 41,
            'src' => ' foreach ( 65 , 161 , 253 , 9786 ) { push @values , join "" , map { chr $_ } $_ .. $_ + 4 ; push @buffers , join "" , map { chr $_ } $_ + 5 .. $_ + 20 ; }',
            'start_line' => 38,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 42,
            'src' => ' my @offsets = ( 0 , 3 , 7 , 22 , -1 , -3 , -5 , -7 ) ;',
            'start_line' => 42,
            'indent' => 0,
            'block_id' => 0
          },
