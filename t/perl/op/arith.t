...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'ok $_[0] # $_[1] is close to $_[2], \\$^O eq $^O\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 26
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => ' # TODO VOS raises SIGFPE instead of producing infinity.\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 300
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => ' # SKIP -- the IEEE infinity model is unavailable in this configuration.\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 303
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => ' # TODO Ultrix enters deep nirvana instead of producing infinity.\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 306
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 12,
            'src' => ' sub try ( $$ ) { print + ( $_ [ 1 ] ? "ok" : "not ok" ) , " $_[0]\\n" ; }',
            'start_line' => 10,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 19,
            'src' => ' sub tryeq ( $$$ ) { if ( $_ [ 1 ] == $_ [ 2 ] ) { print "ok $_[0]\\n" ; } else { print "not ok $_[0] # $_[1] != $_[2]\\n" ; } }',
            'start_line' => 13,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 18,
            'src' => ' else { print "not ok $_[0] # $_[1] != $_[2]\\n" ; }',
            'start_line' => 16,
            'indent' => 1,
            'block_id' => 3
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 30,
            'src' => ' else { my $error = abs ( $_ [ 1 ] - $_ [ 2 ] ) / $_ [ 1 ] ; if ( $error < 1e -9 ) { print "ok $_[0] # $_[1] is close to $_[2], \\$^O eq $^O\\n" ; } else { print "not ok $_[0] # $_[1] != $_[2]\\n" ; } }',
            'start_line' => 23,
            'indent' => 1,
            'block_id' => 6
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 27,
            'src' => ' if ( $error < 1e -9 ) { print "ok $_[0] # $_[1] is close to $_[2], \\$^O eq $^O\\n" ; }',
            'start_line' => 25,
            'indent' => 2,
            'block_id' => 8
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 26,
            'src' => ' print "ok $_[0] # $_[1] is close to $_[2], \\$^O eq $^O\\n" ;',
            'start_line' => 26,
            'indent' => 3,
            'block_id' => 9
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 43,
            'src' => ' tryeq $T ++ , abs ( 2147483647 ) , 2147483647 ;',
            'start_line' => 43,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 45,
            'src' => ' tryeq $T ++ , abs ( 4294967295 ) , 4294967295 ;',
            'start_line' => 45,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 47,
            'src' => ' tryeq $T ++ , abs ( 9223372036854775807 ) , 9223372036854775807 ;',
            'start_line' => 47,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 58,
            'src' => ' try $T ++ , abs ( 13e21 % 4e21 - 1e21 ) < $limit ;',
            'start_line' => 58,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 59,
            'src' => ' try $T ++ , abs ( -13e21 % 4e21 - 3e21 ) < $limit ;',
            'start_line' => 59,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 65,
            'src' => ' tryeq $T ++ , 4063328477 % 65535 , 27407 ;',
            'start_line' => 65,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 66,
            'src' => ' tryeq $T ++ , 4063328477 % 4063328476 , 1 ;',
            'start_line' => 66,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 67,
            'src' => ' tryeq $T ++ , 4063328477 % 2031664238 , 1 ;',
            'start_line' => 67,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 68,
            'src' => ' tryeq $T ++ , 2031664238 % 4063328477 , 2031664238 ;',
            'start_line' => 68,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 72,
            'src' => ' tryeq $T ++ , 2147483647 + 0 , 2147483647 ;',
            'start_line' => 72,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 75,
            'src' => ' tryeq $T ++ , 2147483647 + 1 , 2147483648 ;',
            'start_line' => 75,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 76,
            'src' => ' tryeq $T ++ , 2147483640 + 10 , 2147483650 ;',
            'start_line' => 76,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 77,
            'src' => ' tryeq $T ++ , 2147483647 + 2147483647 , 4294967294 ;',
            'start_line' => 77,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 79,
            'src' => ' tryeq $T ++ , 2147483647 + 2147483649 , 4294967296 ;',
            'start_line' => 79,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 81,
            'src' => ' tryeq $T ++ , 4294967294 + 2 , 4294967296 ;',
            'start_line' => 81,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 83,
            'src' => ' tryeq $T ++ , 4294967295 + 4294967295 , 8589934590 ;',
            'start_line' => 83,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 86,
            'src' => ' tryeq $T ++ , 2147483648 + -1 , 2147483647 ;',
            'start_line' => 86,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 87,
            'src' => ' tryeq $T ++ , 2147483650 + -10 , 2147483640 ;',
            'start_line' => 87,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 89,
            'src' => ' tryeq $T ++ , -1 + 2147483648 , 2147483647 ;',
            'start_line' => 89,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 90,
            'src' => ' tryeq $T ++ , -10 + 4294967294 , 4294967284 ;',
            'start_line' => 90,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 92,
            'src' => ' tryeq $T ++ , -2147483648 + -2147483648 , -4294967296 ;',
            'start_line' => 92,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 118,
            'src' => ' tryeq $T ++ , 2147483648 - 0 , 2147483648 ;',
            'start_line' => 118,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 121,
            'src' => ' tryeq $T ++ , 0 - -2147483647 , 2147483647 ;',
            'start_line' => 121,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 123,
            'src' => ' tryeq $T ++ , 2 - -2147483648 , 2147483650 ;',
            'start_line' => 123,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 125,
            'src' => ' tryeq $T ++ , 4294967294 - 3 , 4294967291 ;',
            'start_line' => 125,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 130,
            'src' => ' tryeq $T ++ , 2147483647 - -2147483648 , 4294967295 ;',
            'start_line' => 130,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 132,
            'src' => ' tryeq $T ++ , 4294967294 - -3 , 4294967297 ;',
            'start_line' => 132,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 134,
            'src' => ' tryeq $T ++ , -2147483648 - + 1 , -2147483649 ;',
            'start_line' => 134,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 136,
            'src' => ' tryeq $T ++ , 2147483648 - 2147483650 , -2 ;',
            'start_line' => 136,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 138,
            'src' => ' tryeq $T ++ , 2000000000 - 4000000000 , -2000000000 ;',
            'start_line' => 138,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 187,
            'src' => ' tryeq $T ++ , 65535 * 65535 , 4294836225 ;',
            'start_line' => 187,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 193,
            'src' => ' tryeq $T ++ , 65535 * 65537 , 4294967295 ;',
            'start_line' => 193,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 199,
            'src' => ' tryeq $T ++ , 65537 * 65535 , 4294967295 ;',
            'start_line' => 199,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 205,
            'src' => ' tryeq $T ++ , 65537 * 65537 , 4295098369 ;',
            'start_line' => 205,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 211,
            'src' => ' tryeq $T ++ , 46340 * 46342 , 0x80001218 ;',
            'start_line' => 211,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 216,
            'src' => ' tryeq $T ++ , 46342 * 46340 , 0x80001218 ;',
            'start_line' => 216,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 222,
            'src' => ' tryeq $T ++ , 65536 * 32768 , 0x80000000 ;',
            'start_line' => 222,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 227,
            'src' => ' tryeq $T ++ , 32768 * 65536 , 0x80000000 ;',
            'start_line' => 227,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 234,
            'src' => ' tryeq $T ++ , 46339 * 46341 , 0x7ffea80f ;',
            'start_line' => 234,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 253,
            'src' => ' tryeq $T ++ , 0x80000000 / 1 , 0x80000000 ;',
            'start_line' => 253,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 268,
            'src' => ' tryeq_sloppy $T ++ , 18446744073709551616 / 1 , 18446744073709551616 ;',
            'start_line' => 268,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 269,
            'src' => ' tryeq_sloppy $T ++ , 18446744073709551616 / 2 , 9223372036854775808 ;',
            'start_line' => 269,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 270,
            'src' => ' tryeq_sloppy $T ++ , 18446744073709551616 / 4294967296 , 4294967296 ;',
            'start_line' => 270,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 271,
            'src' => ' tryeq_sloppy $T ++ , 18446744073709551616 / 9223372036854775808 , 2 ;',
            'start_line' => 271,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 290,
            'src' => ' { my $n = 1127 ; my $float = ( $n % 1000 ) * 167772160.0 ; tryeq_sloppy $T ++ , $float , 21307064320 ; my $int = ( $n % 1000 ) * 167772160 ; tryeq $T ++ , $int , 21307064320 ; my $t = time ; my $t1000 = time ( ) * 1000 ; try $T ++ , abs ( $t1000 -1000 * $t ) <= 2000 ; }',
            'start_line' => 273,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 279,
            'src' => ' my $float = ( $n % 1000 ) * 167772160.0 ;',
            'start_line' => 279,
            'indent' => 1,
            'block_id' => 11
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 280,
            'src' => ' tryeq_sloppy $T ++ , $float , 21307064320 ;',
            'start_line' => 280,
            'indent' => 1,
            'block_id' => 11
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 289,
            'src' => ' try $T ++ , abs ( $t1000 -1000 * $t ) <= 2000 ;',
            'start_line' => 289,
            'indent' => 1,
            'block_id' => 11
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 297,
            'src' => ' if ( $^O eq \'VMS\' ) { use vars \'%Config\' ; eval { require Config ; import Config } ; $vms_no_ieee = 1 unless defined ( $Config { useieee } ) ; }',
            'start_line' => 293,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 296,
            'src' => ' $vms_no_ieee = 1 unless defined ( $Config { useieee } ) ;',
            'start_line' => 296,
            'indent' => 1,
            'block_id' => 12
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 301,
            'src' => ' if ( $^O eq \'vos\' ) { print "not ok " , $T ++ , " # TODO VOS raises SIGFPE instead of producing infinity.\\n" ; }',
            'start_line' => 299,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 300,
            'src' => ' print "not ok " , $T ++ , " # TODO VOS raises SIGFPE instead of producing infinity.\\n" ;',
            'start_line' => 300,
            'indent' => 1,
            'block_id' => 13
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 304,
            'src' => ' elsif ( $vms_no_ieee ) { print $T ++ , " # SKIP -- the IEEE infinity model is unavailable in this configuration.\\n" }',
            'start_line' => 302,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 307,
            'src' => ' elsif ( $^O eq \'ultrix\' ) { print "not ok " , $T ++ , " # TODO Ultrix enters deep nirvana instead of producing infinity.\\n" ; }',
            'start_line' => 305,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 306,
            'src' => ' print "not ok " , $T ++ , " # TODO Ultrix enters deep nirvana instead of producing infinity.\\n" ;',
            'start_line' => 306,
            'indent' => 1,
            'block_id' => 15
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 326,
            'src' => ' else { my $n = 5000 ; my $v = 2 ; while ( -- $n ) { $v *= 2 ; } print "ok " , $T ++ , "\\n" ; }',
            'start_line' => 308,
            'indent' => 0,
            'block_id' => 0
          },
