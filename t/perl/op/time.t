...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'line' => 229,
                   'name' => 'RegExp',
                   'data' => '^localtime\\($big_time_f\\) failed'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'name' => 'RegDelim',
                   'data' => '/',
          ...
          bless( {
                   'name' => 'RegExp',
                   'data' => '^gmtime\\($small_time_f\\) failed',
                   'line' => 234,
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   'name' => 'RegExp',
                   'data' => '^localtime\\($small_time_f\\) failed',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'token_num' => 67,
            'indent' => 0,
            'src' => ' for ( $i = 0 ; $i < 1_000_000 ; $i ++ ) { for my $j ( 1 .. 1000 ) { ++ $x ; } ; ( $nowuser , $nowsys ) = times ; $i = 2_000_000 if $nowuser > $beguser && ( $nowsys >= $begsys || ( ! $nowsys && ! $begsys ) ) ; last if time - $beg > 20 ; }',
            'start_line' => 25
          },
          {
            'token_num' => 4,
          ...
          },
          {
            'start_line' => 143,
            'indent' => 1,
            'src' => ' sub { is ( ( localtime ( 1296000.23 ) ) [ 5 ] + 1900 , 1970 ) }',
            'token_num' => 19,
            'block_id' => 11,
            'end_line' => 143,
            'has_warnings' => 1
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'indent' => 1,
            'src' => ' sub { is ( ( gmtime ( 1.23 ) ) [ 5 ] + 1900 , 1970 ) }',
            'start_line' => 145
          },
          {
            'block_id' => 0,
          ...
          },
          {
            'start_line' => 209,
            'indent' => 1,
            'src' => ' if ( $small_time + 200 != $smallest || $small_time == $smallest || $big_time - 200 != $biggest || $big_time == $biggest ) { skip "Can\'t represent test values" , 8 ; }',
            'token_num' => 29,
            'block_id' => 18,
            'end_line' => 214,
            'has_warnings' => 1
          },
          {
            ...
            'block_id' => 19,
            'start_line' => 213,
            'src' => ' skip "Can\'t represent test values" , 8 ;',
            'indent' => 2
          },
          {
            'block_id' => 18,
          ...
          {
            'src' => ' like $warning , qr/^gmtime\\($big_time_f\\) failed/m ;',
            'indent' => 1,
            'start_line' => 224,
            'token_num' => 9,
            'block_id' => 18,
          ...
          {
            'indent' => 1,
            'src' => ' like $warning , qr/^localtime\\($big_time_f\\) failed/m ;',
            'start_line' => 229,
            'token_num' => 9,
            'block_id' => 18,
            'has_warnings' => 1,
          ...
          },
          {
            ...
            'block_id' => 18,
            'token_num' => 9,
            'src' => ' like $warning , qr/^gmtime\\($small_time_f\\) failed/m ;',
            'indent' => 1,
            'start_line' => 234
          },
          {
          ...
          },
          {
            ...
            'start_line' => 239,
            'indent' => 1,
            'src' => ' like $warning , qr/^localtime\\($small_time_f\\) failed/m ;'
          },
          {
            'end_line' => 246,
            'has_warnings' => 1,
            ...
            'start_line' => 242,
            'indent' => 0,
            'src' => ' { local $^W ; is scalar gmtime ( "NaN" ) , undef , \'[perl #123495] gmtime(NaN)\' ; is scalar localtime ( "NaN" ) , undef , \'localtime(NaN)\' ; }'
          },
          {
            'block_id' => 21,
            'token_num' => 3,
          ...
          },
          {
            ...
            'block_id' => 21,
            'start_line' => 244,
            'src' => ' is scalar gmtime ( "NaN" ) , undef , \'[perl #123495] gmtime(NaN)\' ;',
            'indent' => 1
          },
          {
            'has_warnings' => 1,
            ...
            'token_num' => 11,
            'indent' => 1,
            'src' => ' is scalar localtime ( "NaN" ) , undef , \'localtime(NaN)\' ;',
            'start_line' => 245
          }
        ]
