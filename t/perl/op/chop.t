...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 186,
            'src' => ' my @chars = ( "N" , latin1_to_native ( "\\xd3" ) , substr ( "\\xd4\\x{100}" , 0 , 1 ) , chr 1296 ) ;',
            'start_line' => 186,
            'indent' => 0,
            'block_id' => 0
          },
