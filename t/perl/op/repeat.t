...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   'data' => '(undef)xCONST on lhs of list assignment',
                   'name' => 'RawString',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'has_warnings' => 0,
          ...
          bless( {
                   'name' => 'RawString',
                   'data' => '($x)xCONST on lhs of list assignment',
                   'line' => 70,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
          ...
          bless( {
                   ...
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'data' => '(undef)x$foo on lhs of list assignment',
                   'name' => 'RawString'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'name' => 'RightParenthesis',
          ...
          bless( {
                   'data' => '(...)x... in void context in list (via scalar comma)',
                   'name' => 'RawString',
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'line' => 167,
                   'data' => '[perl #78194] \\$_[0] == \\$_[1] when @_ aliases elems repeated by x',
                   'name' => 'RawString'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'name' => 'RightParenthesis',
          ...
          bless( {
                   ...
                   'line' => 175,
                   'name' => 'RawString',
                   'data' => 'list repetition propagates lvalue cx to its lhs'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'data' => ')',
                   'name' => 'RightParenthesis',
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'end_line' => 68,
            'start_line' => 68,
            'src' => ' is ( "$a $b" , "1 7" , \'(undef)xCONST on lhs of list assignment\' ) ;',
            'indent' => 0
          },
          {
            'start_line' => 69,
          ...
          {
            'src' => ' is ( "$a, $b" , "3, 4" , \'($x)xCONST on lhs of list assignment\' ) ;',
            'indent' => 0,
            'start_line' => 70,
            'has_warnings' => 1,
            'end_line' => 70,
          ...
          },
          {
            ...
            'end_line' => 71,
            'indent' => 0,
            'src' => ' ( $a , ( undef ) x ${ \\ 6 } , $b ) = "a" .. "z" ;',
            'start_line' => 71
          },
          {
            'start_line' => 72,
            'indent' => 0,
            'src' => ' is ( "$a$b" , "ah" , \'(undef)x$foo on lhs of list assignment\' ) ;',
            'end_line' => 72,
            'has_warnings' => 1,
            'block_id' => 0,
            'token_num' => 9
          ...
          {
            'src' => ' sub FETCH { our $Tiecount ++ ; study ; 3 }',
            'indent' => 1,
            'start_line' => 146,
            'token_num' => 11,
            'block_id' => 2,
          ...
          },
          {
            ...
            'start_line' => 150,
            'indent' => 0,
            'src' => ' { push my @temp , $t , scalar ( ( nil ) x 3 , 1 ) }'
          },
          {
            'src' => ' is ( $Tiecount::Tiecount , 1 , \'(...)x... in void context in list (via scalar comma)\' ) ;',
            'indent' => 0,
            'start_line' => 151,
            'end_line' => 152,
            'has_warnings' => 1,
          ...
          },
          {
            ...
            'start_line' => 165,
            'indent' => 0,
            'src' => ' sub { is ( \\ $_ [ 0 ] , \\ $_ [ 1 ] , \'[perl #78194] \\$_[0] == \\$_[1] when @_ aliases elems repeated by x\' ) }-> ( ( "${\\\'\'}" ) x2 ) ;'
          },
          {
            'start_line' => 165,
            'indent' => 0,
            'src' => ' sub { is ( \\ $_ [ 0 ] , \\ $_ [ 1 ] , \'[perl #78194] \\$_[0] == \\$_[1] when @_ aliases elems repeated by x\' ) }',
            'token_num' => 19,
            'block_id' => 6,
            'has_warnings' => 1,
            'end_line' => 168
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 175,
            'src' => ' is ( $#that_array , 28 , \'list repetition propagates lvalue cx to its lhs\' ) ;',
            'indent' => 0,
            'start_line' => 175
          },
          {
            'start_line' => 180,
            'src' => ' fresh_perl_like ( \'@a = (1) x ~1\' , qr/Out of memory/ , { } , \'(1) x ~1\' , ) ;',
            'indent' => 0,
            'block_id' => 0,
            'token_num' => 16,
            'end_line' => 185,
