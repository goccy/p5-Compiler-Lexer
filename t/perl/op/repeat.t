...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => '\\xdd\\xdd\\xdd\\xdd\\xdd\\xdd\\xdd\\xdd\\xdd\\xdd\\xdd\\xdd\\xdd\\xdd\\xdd\\xdd\\xdd\\xdd\\xdd\\xdd\\xdd\\xdd\\xdd\\xdd',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 121
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'list repeat in scalar context',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 130
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'list repeat in anon array ref broken [ID 20011113.110]',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 141
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'x operator not copying elements in \'for\' list? [ID 20010809.028]',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 146
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 23,
            'src' => ' is ( \'ab\' x 3 , \'ababab\' , \'  more than one char\' ) ;',
            'start_line' => 23,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 39,
            'src' => ' is ( $a x 3 , \'ababab\' , \'  more than one char\' ) ;',
            'start_line' => 39,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 41,
            'src' => ' is ( $a x 0 , \'\' , \'  more than one char\' ) ;',
            'start_line' => 41,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 43,
            'src' => ' is ( $a x -12 , \'\' , \'  more than one char\' ) ;',
            'start_line' => 43,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 56,
            'src' => ' is ( join ( \'\' , ( @x ) x 4 ) , \'123123123123\' , \'(@x) x Y\' ) ;',
            'start_line' => 56,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 58,
            'src' => ' is ( join ( \'\' , ( @x , 1 ) x 4 ) , \'1231123112311231\' , \'(@x,1) x Y\' ) ;',
            'start_line' => 58,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 60,
            'src' => ' is ( join ( \':\' , ( 9 ) x 4 ) , \'9:9:9:9\' , \'(X) x Y\' ) ;',
            'start_line' => 60,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 61,
            'src' => ' is ( join ( \':\' , ( 9 , 9 ) x 4 ) , \'9:9:9:9:9:9:9:9\' , \'(X,X) x Y\' ) ;',
            'start_line' => 61,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 62,
            'src' => ' is ( join ( \'\' , ( split ( // , "123" ) ) x 2 ) , \'123123\' , \'split and x\' ) ;',
            'start_line' => 62,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 121,
            'src' => ' is ( "\\xdd" x 24 , "\\xdd\\xdd\\xdd\\xdd\\xdd\\xdd\\xdd\\xdd\\xdd\\xdd\\xdd\\xdd\\xdd\\xdd\\xdd\\xdd\\xdd\\xdd\\xdd\\xdd\\xdd\\xdd\\xdd\\xdd" , \'Dec C bug\' ) ;',
            'start_line' => 121,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 130,
            'src' => ' is ( $x , "22" , \'list repeat in scalar context\' ) ;',
            'start_line' => 130,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 131,
            'src' => ' is ( $y , undef , \'  no extra values on stack\' ) ;',
            'start_line' => 131,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 135,
            'src' => ' is ( 77 , scalar ( ( 1 , 7 ) x2 ) , \'stack truncation\' ) ;',
            'start_line' => 135,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 142,
            'src' => ' { my $x = [ ( "foo" ) x 2 ] ; is ( join ( \'\' , @$x ) , \'foofoo\' , \'list repeat in anon array ref broken [ID 20011113.110]\' ) ; }',
            'start_line' => 139,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 141,
            'src' => ' is ( join ( \'\' , @$x ) , \'foofoo\' , \'list repeat in anon array ref broken [ID 20011113.110]\' ) ;',
            'start_line' => 141,
            'indent' => 1,
            'block_id' => 2
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 153,
            'src' => ' { local $TODO = "x operator not copying elements in \'for\' list? [ID 20010809.028]" ; my $x = \'abcd\' ; my $y = \'\' ; for ( ( $x =~/./g ) x 2 ) { $y .= chop ; } is ( $y , \'abcdabcd\' ) ; }',
            'start_line' => 145,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 146,
            'src' => ' local $TODO = "x operator not copying elements in \'for\' list? [ID 20010809.028]" ;',
            'start_line' => 146,
            'indent' => 1,
            'block_id' => 3
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 156,
            'src' => ' is ( ( join \',\' , ( qw(a b c)x 3 ) ) , \'a,b,c,a,b,c,a,b,c\' , \'x on qw produces list\' ) ;',
            'start_line' => 156,
            'indent' => 0,
            'block_id' => 0
          }
