...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'no dynamic loading on miniperl, no Fcntl',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 16
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'Sanity check broke, remaining tests will fail',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 36
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'goto &$function_package_and_name',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 49
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'goto &$function_package_and_name; again, with dirtier stack',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 52
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'goto &$function_name; from local package',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 63
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'goto &function_constant; from a sub called without arglist',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 76
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'goto &$function_package_and_name; from a sub called without arglist',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 83
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'goto &$function_ref; from a sub called without arglist',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 88
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => 'use XS::APItest qw(mycroak); 1',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 94
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => '[perl #35878] croak in XS after goto segfaulted',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 111
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 14,
            'src' => ' $SIG { __WARN__ } = sub { die "WARNING: @_" } ;',
            'start_line' => 14,
            'indent' => 1,
            'block_id' => 1
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 16,
            'src' => ' skip_all_if_miniperl ( "no dynamic loading on miniperl, no Fcntl" ) ;',
            'start_line' => 16,
            'indent' => 1,
            'block_id' => 1
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 35,
            'src' => ' my $value = Fcntl::S_IMODE ( $VALID ) ;',
            'start_line' => 35,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 36,
            'src' => ' isnt ( $value , undef , \'Sanity check broke, remaining tests will fail\' ) ;',
            'start_line' => 36,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 40,
            'src' => ' sub goto_const { goto & Fcntl::S_IMODE ; }',
            'start_line' => 40,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 43,
            'src' => ' is ( $ret , $value , \'goto &function_constant\' ) ;',
            'start_line' => 43,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 46,
            'src' => ' sub goto_name1 { goto &$FNAME1 ; }',
            'start_line' => 46,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 49,
            'src' => ' is ( $ret , $value , \'goto &$function_package_and_name\' ) ;',
            'start_line' => 49,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 52,
            'src' => ' is ( $ret , $value , \'goto &$function_package_and_name; again, with dirtier stack\' ) ;',
            'start_line' => 52,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 59,
            'src' => ' sub goto_name2 { goto &$FNAME2 ; }',
            'start_line' => 59,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 62,
            'src' => ' $ret = Fcntl::goto_name2 ( $VALID ) ;',
            'start_line' => 62,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 63,
            'src' => ' is ( $ret , $value , \'goto &$function_name; from local package\' ) ;',
            'start_line' => 63,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 69,
            'src' => ' is ( $ret , $value , \'goto &$function_ref\' ) ;',
            'start_line' => 69,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 73,
            'src' => ' sub call_goto_const { & goto_const ; }',
            'start_line' => 73,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 76,
            'src' => ' is ( $ret , $value , \'goto &function_constant; from a sub called without arglist\' ) ;',
            'start_line' => 76,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 79,
            'src' => ' sub call_goto_name1 { & goto_name1 ; }',
            'start_line' => 79,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 83,
            'src' => ' is ( $ret , $value , \'goto &$function_package_and_name; from a sub called without arglist\' ) ;',
            'start_line' => 82,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 85,
            'src' => ' sub call_goto_ref { & goto_ref ; }',
            'start_line' => 85,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 88,
            'src' => ' is ( $ret , $value , \'goto &$function_ref; from a sub called without arglist\' ) ;',
            'start_line' => 88,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 102,
            'src' => ' sub goto_croak { goto & mycroak }',
            'start_line' => 102,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 112,
            'src' => ' { my $e ; for ( 1 .. 4 ) { eval { goto_croak ( "boo$_\\n" ) } ; $e .= $@ ; } is ( $e , "boo1\\nboo2\\nboo3\\nboo4\\n" , \'[perl #35878] croak in XS after goto segfaulted\' ) }',
            'start_line' => 104,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 109,
            'src' => ' for ( 1 .. 4 ) { eval { goto_croak ( "boo$_\\n" ) } ; $e .= $@ ; }',
            'start_line' => 106,
            'indent' => 1,
            'block_id' => 15
          },
