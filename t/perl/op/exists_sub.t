...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($$stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 22,
            'src' => ' print "not " unless exists & t1 && not defined & t1 ;',
            'start_line' => 22,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 24,
            'src' => ' print "not " unless exists & t2 && not defined & t2 ;',
            'start_line' => 24,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 26,
            'src' => ' print "not " unless exists & t3 && not defined & t3 ;',
            'start_line' => 26,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 28,
            'src' => ' print "not " unless exists & t4 && not defined & t4 ;',
            'start_line' => 28,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 30,
            'src' => ' print "not " unless exists & t5 && defined & t5 ;',
            'start_line' => 30,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 33,
            'src' => ' print "not " unless not exists & P2::tmc && not defined & P2::tmc ;',
            'start_line' => 33,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 40,
            'src' => ' print "not " unless exists & P1::tmc && not defined & P1::tmc ;',
            'start_line' => 40,
            'indent' => 0,
            'block_id' => 0
          },
