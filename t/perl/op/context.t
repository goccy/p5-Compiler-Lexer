...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            'start_line' => 29,
            'indent' => 0,
            'src' => ' sub context { $cx = qw[void scalar list] [ wantarray + defined wantarray ] ; }',
            'block_id' => 0,
            'token_num' => 17,
            'end_line' => 31,
            'has_warnings' => 1
          ...
          {
            'start_line' => 30,
            'src' => ' $cx = qw[void scalar list] [ wantarray + defined wantarray ] ;',
            'indent' => 1,
            'end_line' => 30,
            'has_warnings' => 1,
            'block_id' => 3,
          ...
          },
          {
            'start_line' => 33,
            'indent' => 0,
            'src' => ' is ( $cx , \'scalar\' , \'context of { foo(); BEGIN {} }\' ) ;',
            'end_line' => 33,
            'has_warnings' => 1,
            'block_id' => 0,
            'token_num' => 9
