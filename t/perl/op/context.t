...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'nr tests: before=$before, after=$after',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 27
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 15,
            'src' => ' sub foo { $a = \'abcd\' ; $a =~/(.)/g ; cmp_ok ( $1 , \'eq\' , \'a\' , \'context \' . curr_test ( ) ) ; }',
            'start_line' => 11,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 14,
            'src' => ' cmp_ok ( $1 , \'eq\' , \'a\' , \'context \' . curr_test ( ) ) ;',
            'start_line' => 14,
            'indent' => 1,
            'block_id' => 2
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 27,
            'src' => ' cmp_ok ( $after - $before , \'==\' , 1 , \'foo called once\' ) or diag ( "nr tests: before=$before, after=$after" ) ;',
            'start_line' => 26,
            'indent' => 0,
            'block_id' => 0
          }
