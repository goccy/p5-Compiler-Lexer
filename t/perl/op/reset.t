...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => 'reset "" leaves patterns alone [perl #97958]',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'line' => 69,
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => 'cow, qr, vstring, glob, ro test',
                   'type' => Compiler::Lexer::TokenType::T_RawString
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'type' => Compiler::Lexer::TokenType::T_SemiColon,
          ...
          bless( {
                   'name' => 'RawString',
                   'line' => 126,
                   'data' => 'resetting array in the same gv as a ro scalar',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value
          ...
          bless( {
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'data' => 'resetting a hash in the same gv as a ro scalar',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'line' => 127,
          ...
          bless( {
                   ...
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'data' => 'reset skips ro scalars in the same gv as av/hv',
                   'kind' => Compiler::Lexer::Kind::T_Term
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'has_warnings' => 0,
          ...
          bless( {
                   'data' => 'reset leaves real-globs-as-scalars as GLOBs',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
          ...
          bless( {
                   ...
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'data' => 'And the glob still has the right value',
                   'kind' => Compiler::Lexer::Kind::T_Term
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'has_warnings' => 0,
   ...
   print "ok\\n";',
          ...
          bless( {
                   ...
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => 'no crash if package is effectively renamed before op is freed',
                   'type' => Compiler::Lexer::TokenType::T_String
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'name' => 'RightParenthesis',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => 'no crash when current package is freed',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 163,
                   'name' => 'String'
                 }, 'Compiler::Lexer::Token' ),
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'end_line' => 69,
            'token_num' => 8,
            'src' => ' ok ! match_foo ( ) , \'reset "" leaves patterns alone [perl #97958]\' ;',
            'start_line' => 69,
            'block_id' => 0,
            'indent' => 0
          },
          ...
          },
          {
            ...
            'indent' => 0,
            'token_num' => 22,
            'src' => ' is join ( "-" , $scratch::a // \'u\' , $scratch::a2 // \'u\' , $scratch::b // \'u\' ) , "u-u-baz" , \'reset "char"\' ;',
            'end_line' => 77,
            'has_warnings' => 1
          },
          {
          ...
          },
          {
            ...
            'start_line' => 84,
            'block_id' => 0,
            'src' => ' is join ( "-" , $scratch::a // \'u\' , $scratch::a2 // \'u\' , $scratch::b // \'u\' , $scratch::c // \'u\' ) , "foo-bar-u-u" , \'reset "chars"\' ;',
            'token_num' => 26,
            'end_line' => 87,
            'has_warnings' => 1
          },
          ...
          {
            'src' => ' is join ( "-" , $scratch::a // \'u\' , $scratch::a2 // \'u\' , $scratch::b // \'u\' , $scratch::c // \'u\' ) , "u-u-u-sea" , \'reset "range"\' ;',
            'token_num' => 26,
            'indent' => 0,
            'start_line' => 94,
            'block_id' => 0,
          ...
          {
            'token_num' => 10,
            'src' => ' { no strict ; ${ "scratch::\\0foo" } = "bar" }',
            'block_id' => 0,
            'start_line' => 99,
            'indent' => 0,
            'has_warnings' => 1,
          ...
          },
          {
            ...
            'indent' => 0,
            'block_id' => 0,
            'src' => ' is join ( "-" , $scratch::a // \'u\' , do { no strict ; ${ "scratch::\\0foo" } } // \'u\' ) , "u-u" , \'reset "\\0char"\' ;',
            'token_num' => 26,
            'end_line' => 104,
            'has_warnings' => 1
          },
          ...
          {
            'src' => ' is join ( "-" , map $_ // \'u\' , $scratch::cow , $scratch::qr , $scratch::v , $scratch::glob , $scratch::ro ) , \'u-u-u-u-1\' , \'cow, qr, vstring, glob, ro test\' ;',
            'token_num' => 25,
            'indent' => 0,
            'start_line' => 112,
            'block_id' => 0,
          ...
          },
          {
            ...
            'indent' => 0,
            'token_num' => 6,
            'src' => ' %scratch::a_hash = 1 .. 4 ;'
          },
          {
            'src' => ' is @scratch :: an_array , 0 , \'resetting an array\' ;',
            'token_num' => 9,
            'start_line' => 119,
            'indent' => 0,
            'block_id' => 0,
          ...
          },
          {
            ...
            'start_line' => 120,
            'block_id' => 0,
            'src' => ' is %scratch :: a_hash , 0 , \'resetting a hash\' ;',
            'token_num' => 9,
            'end_line' => 120,
            'has_warnings' => 1
          },
          ...
          },
          {
            ...
            'block_id' => 0,
            'token_num' => 7,
            'src' => ' *scratch :: an_array = \\ 1 ;'
          },
          {
            'has_warnings' => 1,
            'end_line' => 126,
            'token_num' => 9,
            'src' => ' is @scratch :: an_array , 0 , \'resetting array in the same gv as a ro scalar\' ;',
            'block_id' => 0,
            'start_line' => 126,
            'indent' => 0
          },
          {
            ...
            'start_line' => 127,
            'block_id' => 0,
            'src' => ' is @scratch :: an_array , 0 , \'resetting a hash in the same gv as a ro scalar\' ;',
            'token_num' => 9,
            'end_line' => 127,
            'has_warnings' => 1
          },
          {
            'src' => ' is $scratch::an_array , 1 , \'reset skips ro scalars in the same gv as av/hv\' ;',
            'token_num' => 7,
            'start_line' => 128,
            'block_id' => 0,
            'indent' => 0,
          ...
          },
          {
            ...
            'start_line' => 130,
            'block_id' => 0,
            'src' => ' for our $z ( *_ ) { { local *_ ; reset "z" ; $z = 3 ; ( ) = *_ { SCALAR } ; no warnings ; ( ) = "$_" ; } is ref \\ $z , "GLOB" , \'reset leaves real-globs-as-scalars as GLOBs\' ; is $z , "*main::_" , \'And the glob still has the right value\' ; }',
            'token_num' => 52
          },
          {
            'end_line' => 132,
          ...
          },
          {
            ...
            'indent' => 1,
            'block_id' => 16,
            'src' => ' is ref \\ $z , "GLOB" , \'reset leaves real-globs-as-scalars as GLOBs\' ;',
            'token_num' => 9,
            'end_line' => 139,
            'has_warnings' => 1
          },
          {
            'src' => ' is $z , "*main::_" , \'And the glob still has the right value\' ;',
            'token_num' => 7,
            'indent' => 1,
            'start_line' => 140,
            'block_id' => 16,
   ...
   print "ok\\n";\' , "ok\\n" , { } , "no crash if package is effectively renamed before op is freed" ) ;',
          ...
          },
          {
            ...
            'block_id' => 0,
            'token_num' => 8,
            'src' => ' sub _117941 { package _117941 ; reset }'
          },
          {
            'src' => ' package _117941 ;',
            'token_num' => 3,
          ...
          },
          {
            ...
            'block_id' => 0,
            'token_num' => 5,
            'src' => ' pass ( "no crash when current package is freed" ) ;'
          },
          {
            'end_line' => 165,
            'has_warnings' => 0,
