...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'match doesn\'t match second time',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 38
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'match matches after reset',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 40
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'match doesn\'t match third time',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 59
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'first pattern $eight$eight, second $nine$nine',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 79
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 17,
            'src' => ' sub zlopp { ( shift =~ m?zlopp? ) ? 1 : 0 ; }',
            'start_line' => 15,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 35,
            'src' => ' is ( aiieee::zlopp ( "" ) , 0 , "mismatch doesn\'t match" ) ;',
            'start_line' => 35,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 36,
            'src' => ' is ( aiieee::zlopp ( "zlopp" ) , 1 , "match matches first time" ) ;',
            'start_line' => 36,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 38,
            'src' => ' is ( aiieee::zlopp ( "zlopp" ) , 0 , "match doesn\'t match second time" ) ;',
            'start_line' => 38,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 40,
            'src' => ' is ( aiieee::zlopp ( "zlopp" ) , 1 , "match matches after reset" ) ;',
            'start_line' => 40,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 47,
            'src' => ' is ( CLINK::ZZIP ( "" ) , 0 , "mismatch doesn\'t match" ) ;',
            'start_line' => 47,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 48,
            'src' => ' is ( CLINK::ZZIP ( "ZZIP" ) , 1 , "match matches first time" ) ;',
            'start_line' => 48,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 50,
            'src' => ' is ( CLINK::ZZIP ( "ZZIP" ) , 0 , "match doesn\'t match second time" ) ;',
            'start_line' => 50,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 59,
            'src' => ' is ( CLINK::ZZIP ( "ZZIP" ) , 0 , "match doesn\'t match third time" ) ;',
            'start_line' => 59,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 62,
            'src' => ' is ( CLINK::ZZIP ( "ZZIP" ) , 1 , "match matches after reset" ) ;',
            'start_line' => 62,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 72,
            'src' => ' eval { require threads ; 1 } or skip "No threads" , 4 ;',
            'start_line' => 71,
            'indent' => 1,
            'block_id' => 6
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 81,
            'src' => ' foreach my $eight ( \'/\' , \'?\' ) { foreach my $nine ( \'/\' , \'?\' ) { my $copy = $prog ; $copy =~ s/8/$eight/gm ; $copy =~ s/9/$nine/gm ; fresh_perl_is ( $copy , "pass" , "" , "first pattern $eight$eight, second $nine$nine" ) ; } }',
            'start_line' => 73,
            'indent' => 1,
            'block_id' => 6
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 80,
            'src' => ' foreach my $nine ( \'/\' , \'?\' ) { my $copy = $prog ; $copy =~ s/8/$eight/gm ; $copy =~ s/9/$nine/gm ; fresh_perl_is ( $copy , "pass" , "" , "first pattern $eight$eight, second $nine$nine" ) ; }',
            'start_line' => 74,
            'indent' => 2,
            'block_id' => 7
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 79,
            'src' => ' fresh_perl_is ( $copy , "pass" , "" , "first pattern $eight$eight, second $nine$nine" ) ;',
            'start_line' => 78,
            'indent' => 3,
            'block_id' => 8
          }
