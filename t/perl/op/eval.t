...
$foo =;',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'eval syntax error in scalar context',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 28
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'eval run-time error in scalar context',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 29
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'eval syntax error in list context',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 30
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'eval run-time error in list context',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 31
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'if ($foo <= 1) {1;} else {push(@x,$foo--); (eval $fact) * pop(@x);}',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 36
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'calculate a factorial with recursive evals',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 38
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'local($foo)=$foo; $foo <= 1 ? 1 : $foo-- * (eval $fact);',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 41
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => 'defined(wantarray) ? (wantarray ? ($b=\'A\') : ($b=\'S\')) : ($b=\'V\')',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 78
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'recursive subroutine-call inside eval\'\' see its own lexicals',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 169
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'closures created within eval bind correctly',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 182
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'lexical search terminates correctly at subroutine boundary',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 189
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'scalar eval"" pops stack correctly',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 200
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'return from eval {} should clear $@ correctly',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 210
                 }, 'Compiler::Lexer::Token' ),
          bless( {
    ...
    ',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => 'Can\'t "goto" into the middle of a foreach loop',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 228
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'eval catches bad goto calls',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 229
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'Outer eval didn\'t execute the last',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 235
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => '[ID 20020623.002] eval "" doesn\\\'t clear $@',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 251
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => ' my $yyy = 888; my $zzz = 999; fred5(); ',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 348
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => '[perl #9728] used to dump core',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 353
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => '$h{a}=1; foreach my $k (keys %h) {eval qq{\\$k}}',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 384
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'string eval scalar context',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 416
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'sub A::TIEARRAY { L: { eval { last L } } } tie @a, A; warn qq(ok\\n)',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 425
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'eval syntax error, no warnings',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 441
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'no dynamic loading on miniperl, no Devel::Peek',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 473
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'Program completed successfully',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 497
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'originally only 1 reference',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 524
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'execution eval doesn\'t create new references',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 526
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'segfault on syntax errors in block evals',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 555
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'HereDocument',
                   'data' => '# localize the hits hash so the eval ends up with the pad offset of a copy of it in its targ
BEGIN { $^H |= 0x00020000 }
eval q{ eval { + } };
print "ok\\n";
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'assert fail on non-string in Perl_lex_start',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 562
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'string eval leaves readonly lexicals readonly [perl #19135]',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 573
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'eval does not localise %^H at run time',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 592
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'phew! dodged the assertion after a parsing (not lexing) error',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 598
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'our %FIELDS; my main $x; eval q[$x->{foo}]',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 606
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'Errors in finalize_optree do not leak string eval op tree',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 610
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
$foo =;\' ;',
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 28,
            'src' => ' is scalar ( eval \'++\' ) , undef , \'eval syntax error in scalar context\' ;',
            'start_line' => 28,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 29,
            'src' => ' is scalar ( eval \'die\' ) , undef , \'eval run-time error in scalar context\' ;',
            'start_line' => 29,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 30,
            'src' => ' is + ( ) = eval \'++\' , 0 , \'eval syntax error in list context\' ;',
            'start_line' => 30,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 31,
            'src' => ' is + ( ) = eval \'die\' , 0 , \'eval run-time error in list context\' ;',
            'start_line' => 31,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 36,
            'src' => ' $fact = \'if ($foo <= 1) {1;} else {push(@x,$foo--); (eval $fact) * pop(@x);}\' ;',
            'start_line' => 36,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 38,
            'src' => ' is ( $ans , 120 , \'calculate a factorial with recursive evals\' ) ;',
            'start_line' => 38,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 41,
            'src' => ' $fact = \'local($foo)=$foo; $foo <= 1 ? 1 : $foo-- * (eval $fact);\' ;',
            'start_line' => 41,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 48,
            'src' => ' print try \'print "ok $curr_test\\n";\' , "\\n" ;',
            'start_line' => 48,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 94,
            'src' => ' { my @a = qw(a b c d) ; my @b = eval @a ; is ( "@b" , \'4\' ) ; is ( $@ , \'\' ) ; my $a = q[defined(wantarray) ? (wantarray ? ($b=\'A\') : ($b=\'S\')) : ($b=\'V\')] ; my $b ; @a = eval $a ; is ( "@a" , \'A\' ) ; is ( $b , \'A\' ) ; $_ = eval $a ; is ( $b , \'S\' ) ; eval $a ; is ( $b , \'V\' ) ; $b = \'wrong\' ; $x = sub { my $b = "right" ; is ( eval ( \'"$b"\' ) , $b ) ; } ; &$x ( ) ; }',
            'start_line' => 72,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 78,
            'src' => ' my $a = q[defined(wantarray) ? (wantarray ? ($b=\'A\') : ($b=\'S\')) : ($b=\'V\')] ;',
            'start_line' => 78,
            'indent' => 1,
            'block_id' => 3
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 92,
            'src' => ' $x = sub { my $b = "right" ; is ( eval ( \'"$b"\' ) , $b ) ; } ;',
            'start_line' => 89,
            'indent' => 1,
            'block_id' => 3
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 103,
            'src' => ' { my $b = \'wrong\' ; my $X = sub { my $b = "right" ; is ( eval ( \'"$b"\' ) , $b ) ; } ; &$X ( ) ; }',
            'start_line' => 96,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 101,
            'src' => ' my $X = sub { my $b = "right" ; is ( eval ( \'"$b"\' ) , $b ) ; } ;',
            'start_line' => 98,
            'indent' => 1,
            'block_id' => 5
          },
  ...
  sub do_eval3 {
     eval $_[0]; die if $@;
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 149,
            'src' => ' { my $ok = \'not ok\' ; do_eval3 ( \'is($ok, q{ok})\' ) ; do_eval3 ( \'eval q[is($ok, q{ok})]\' ) ; do_eval3 ( \'sub { eval q[is($ok, q{ok})] }->()\' ) ; }',
            'start_line' => 144,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 147,
            'src' => ' do_eval3 ( \'eval q[is($ok, q{ok})]\' ) ;',
            'start_line' => 147,
            'indent' => 1,
            'block_id' => 7
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 148,
            'src' => ' do_eval3 ( \'sub { eval q[is($ok, q{ok})] }->()\' ) ;',
            'start_line' => 148,
            'indent' => 1,
            'block_id' => 7
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 164,
            'src' => ' sub recurse { my $l = shift ; if ( $l < $x ) { ++ $l ; eval \'print "# level $l\\n"; recurse($l);\' ; die if $@ ; } else { $got = "ok $l" ; } }',
            'start_line' => 154,
            'indent' => 1,
            'block_id' => 8
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 160,
            'src' => ' if ( $l < $x ) { ++ $l ; eval \'print "# level $l\\n"; recurse($l);\' ; die if $@ ; }',
            'start_line' => 156,
            'indent' => 2,
            'block_id' => 9
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 169,
            'src' => ' is ( $got , "ok $x" , "recursive subroutine-call inside eval\'\' see its own lexicals" ) ;',
            'start_line' => 168,
            'indent' => 1,
            'block_id' => 8
          },
    ...
    return sub {
       return $self;
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 189,
            'src' => ' is ( do { my $r = "bad" ; eval \'terminal($r)\' ; } , \'good!\' , \'lexical search terminates correctly at subroutine boundary\' ) ;',
            'start_line' => 186,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 189,
            'src' => ' do { my $r = "bad" ; eval \'terminal($r)\' ; }',
            'start_line' => 186,
            'indent' => 0,
            'block_id' => 13
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 196,
            'src' => ' { local $SIG { __DIE__ } = sub { eval { 1 } ; die shift } ; eval { die "wham_eth\\n" } ; is ( $@ , "wham_eth\\n" ) ; }',
            'start_line' => 191,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 193,
            'src' => ' local $SIG { __DIE__ } = sub { eval { 1 } ; die shift } ;',
            'start_line' => 193,
            'indent' => 1,
            'block_id' => 15
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 201,
            'src' => ' { my $c = eval "(1,2)x10" ; is ( $c , \'2222222222\' , \'scalar eval"" pops stack correctly\' ) ; }',
            'start_line' => 198,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 200,
            'src' => ' is ( $c , \'2222222222\' , \'scalar eval"" pops stack correctly\' ) ;',
            'start_line' => 200,
            'indent' => 1,
            'block_id' => 17
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 211,
            'src' => ' { my $status = eval { eval { die } ; print "# eval { return } test\\n" ; return ; } ; is ( $@ , \'\' , \'return from eval {} should clear $@ correctly\' ) ; }',
            'start_line' => 204,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 210,
            'src' => ' is ( $@ , \'\' , \'return from eval {} should clear $@ correctly\' ) ;',
            'start_line' => 210,
            'indent' => 1,
            'block_id' => 18
          },
	...
	return; # removing this changes behavior
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 237,
            'src' => ' { eval { eval { goto foo ; } ; like ( $@ , qr/Can\'t "goto" into the middle of a foreach loop/ , \'eval catches bad goto calls\' ) ; last ; foreach my $i ( 1 ) { foo : fail ( \'jumped into foreach\' ) ; } } ; fail ( "Outer eval didn\'t execute the last" ) ; diag ( $@ ) ; }',
            'start_line' => 225,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 234,
            'src' => ' eval { eval { goto foo ; } ; like ( $@ , qr/Can\'t "goto" into the middle of a foreach loop/ , \'eval catches bad goto calls\' ) ; last ; foreach my $i ( 1 ) { foo : fail ( \'jumped into foreach\' ) ; } } ;',
            'start_line' => 226,
            'indent' => 1,
            'block_id' => 20
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 229,
            'src' => ' like ( $@ , qr/Can\'t "goto" into the middle of a foreach loop/ , \'eval catches bad goto calls\' ) ;',
            'start_line' => 228,
            'indent' => 1,
            'block_id' => 20
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 233,
            'src' => ' foreach my $i ( 1 ) { foo : fail ( \'jumped into foreach\' ) ; }',
            'start_line' => 231,
            'indent' => 1,
            'block_id' => 20
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 232,
            'src' => ' foo : fail ( \'jumped into foreach\' ) ;',
            'start_line' => 232,
            'indent' => 2,
            'block_id' => 21
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 235,
            'src' => ' fail ( "Outer eval didn\'t execute the last" ) ;',
            'start_line' => 235,
            'indent' => 1,
            'block_id' => 20
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 246,
            'src' => ' { foreach ( qw($$x @$x %$x $$$x) ) { eval \'my \' . $_ ; isnt ( $@ , \'\' , "my $_ is forbidden" ) ; } }',
            'start_line' => 241,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 252,
            'src' => ' { $@ = 5 ; eval q{} ; cmp_ok ( length $@ , \'==\' , 0 , \'[ID 20020623.002] eval "" doesn\\\'t clear $@\' ) ; }',
            'start_line' => 248,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 251,
            'src' => ' cmp_ok ( length $@ , \'==\' , 0 , \'[ID 20020623.002] eval "" doesn\\\'t clear $@\' ) ;',
            'start_line' => 251,
            'indent' => 1,
            'block_id' => 24
          },
	...
	is(eval(\'$zzz\'), 1);
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 284,
            'src' => ' sub do_sort { my $zzz = 2 ; my @a = sort { is ( eval ( \'$zzz\' ) , 2 ) ; $a <=> $b } 2 , 1 ; }',
            'start_line' => 279,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 283,
            'src' => ' my @a = sort { is ( eval ( \'$zzz\' ) , 2 ) ; $a <=> $b } 2 , 1 ;',
            'start_line' => 281,
            'indent' => 1,
            'block_id' => 26
          },
    ...
    is($r, 120);
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 321,
            'src' => ' { my $yyy = 4 ; my $zzz = 5 ; my $l = 6 ; $r = eval \'fred3(5)\' } ;',
            'start_line' => 321,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 333,
            'src' => ' sub fred4 { my $zzz = 3 ; is ( $zzz , 3 ) ; is ( eval \'$zzz\' , 3 ) ; is ( eval \'$yyy\' , 2 ) ; }',
            'start_line' => 328,
            'indent' => 0,
            'block_id' => 0
          },
    ...
    fred5();
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 348,
            'src' => ' eval q{ my $yyy = 888; my $zzz = 999; fred5(); } ;',
            'start_line' => 348,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 354,
            'src' => ' { $eval = eval \'sub { eval "sub { %S }" }\' ; $eval-> ( { } ) ; pass ( \'[perl #9728] used to dump core\' ) ; }',
            'start_line' => 350,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 353,
            'src' => ' pass ( \'[perl #9728] used to dump core\' ) ;',
            'start_line' => 353,
            'indent' => 1,
            'block_id' => 30
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 371,
            'src' => ' { my $x = 2 ; sub db1 { $x ; eval \'$x\' } sub DB::db2 { $x ; eval \'$x\' } package DB ; sub db3 { eval \'$x\' } sub DB::db4 { eval \'$x\' } sub db5 { my $x = 4 ; eval \'$x\' } package main ; sub db6 { my $x = 4 ; eval \'$x\' } }',
            'start_line' => 361,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 380,
            'src' => ' { my $x = 3 ; is ( db1 ( ) , 2 ) ; is ( DB::db2 ( ) , 2 ) ; is ( DB::db3 ( ) , 3 ) ; is ( DB::db4 ( ) , 3 ) ; is ( DB::db5 ( ) , 3 ) ; is ( db6 ( ) , 4 ) ; }',
            'start_line' => 372,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 385,
            'src' => ' my $got = runperl ( prog => \'$h{a}=1; foreach my $k (keys %h) {eval qq{\\$k}}\' , stderr => 1 ) ;',
            'start_line' => 384,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 400,
            'src' => ' { my %h ; $h { a } = 1 ; foreach my $k ( keys %h ) { is ( $k , \'a\' ) ; eval "\\$k" ; is ( $k , \'a\' ) ; } }',
            'start_line' => 390,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 399,
            'src' => ' foreach my $k ( keys %h ) { is ( $k , \'a\' ) ; eval "\\$k" ; is ( $k , \'a\' ) ; }',
            'start_line' => 393,
            'indent' => 1,
            'block_id' => 40
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 403,
            'src' => ' pass ( \'#20798 (used to dump core)\' ) ;',
            'start_line' => 403,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 419,
            'src' => ' { my ( @r , $r , $c ) ; sub context { defined ( wantarray ) ? ( wantarray ? ( $c = \'A\' ) : ( $c = \'S\' ) ) : ( $c = \'V\' ) } my $code = q{ context() } ; @r = qw( a b ) ; $r = \'ab\' ; @r = eval $code ; is ( "@r$c" , \'AA\' , \'string eval list context\' ) ; $r = eval $code ; is ( "$r$c" , \'SS\' , \'string eval scalar context\' ) ; eval $code ; is ( "$c" , \'V\' , \'string eval void context\' ) ; }',
            'start_line' => 406,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 408,
            'src' => ' sub context { defined ( wantarray ) ? ( wantarray ? ( $c = \'A\' ) : ( $c = \'S\' ) ) : ( $c = \'V\' ) }',
            'start_line' => 408,
            'indent' => 1,
            'block_id' => 43
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 414,
            'src' => ' is ( "@r$c" , \'AA\' , \'string eval list context\' ) ;',
            'start_line' => 414,
            'indent' => 1,
            'block_id' => 43
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 416,
            'src' => ' is ( "$r$c" , \'SS\' , \'string eval scalar context\' ) ;',
            'start_line' => 416,
            'indent' => 1,
            'block_id' => 43
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 418,
            'src' => ' is ( "$c" , \'V\' , \'string eval void context\' ) ;',
            'start_line' => 418,
            'indent' => 1,
            'block_id' => 43
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 426,
            'src' => ' $got = runperl ( prog => \'sub A::TIEARRAY { L: { eval { last L } } } tie @a, A; warn qq(ok\\n)\' , stderr => 1 ) ;',
            'start_line' => 423,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 436,
            'src' => ' { local $@ = "foo" ; eval undef ; is ( $@ , "" , \'eval undef\' ) ; }',
            'start_line' => 432,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 442,
            'src' => ' { no warnings ; eval "/ /b;" ; like ( $@ , qr/^syntax error/ , \'eval syntax error, no warnings\' ) ; }',
            'start_line' => 438,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 441,
            'src' => ' like ( $@ , qr/^syntax error/ , \'eval syntax error, no warnings\' ) ;',
            'start_line' => 441,
            'indent' => 1,
            'block_id' => 46
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 468,
            'src' => ' cmp_ok ( $@ , \'eq\' , "" , \'length of $@ after eval\' ) ;',
            'start_line' => 468,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 469,
            'src' => ' cmp_ok ( length $@ , \'==\' , 0 , \'length of $@ after eval\' ) ;',
            'start_line' => 469,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 473,
            'src' => ' skip_if_miniperl ( \'no dynamic loading on miniperl, no Devel::Peek\' , 2 ) ;',
            'start_line' => 473,
            'indent' => 1,
            'block_id' => 50
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 479,
            'src' => ' open $prog , ">" , $tempfile or die "Can\'t create test file" ;',
            'start_line' => 479,
            'indent' => 1,
            'block_id' => 50
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 480,
            'src' => ' print $prog q{    use Devel::Peek;
    $! = 0;
    $@ = $!;
    Dump($@);
    print STDERR "******\\n";
    ...
    print STDERR "Done\\n";
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 493,
            'src' => ' close $prog or die "Can\'t close $tempfile: $!" ;',
            'start_line' => 493,
            'indent' => 1,
            'block_id' => 50
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 494,
            'src' => ' my $got = runperl ( progfile => $tempfile , stderr => 1 ) ;',
            'start_line' => 494,
            'indent' => 1,
            'block_id' => 50
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 495,
            'src' => ' my ( $first , $second , $tombstone ) = split (/\\*\\*\\*\\*\\*\\*\\n/ , $got ) ;',
            'start_line' => 495,
            'indent' => 1,
            'block_id' => 50
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 500,
            'src' => ' s/ PV = 0x[0-9a-f]+/ PV = 0x/ foreach $first , $second ;',
            'start_line' => 500,
            'indent' => 1,
            'block_id' => 50
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 501,
            'src' => ' s/ LEN = [0-9]+/ LEN = / foreach $first , $second ;',
            'start_line' => 501,
            'indent' => 1,
            'block_id' => 50
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 506,
            'src' => ' is ( $second , $first , \'eval { 1 } completely resets $@\' ) ;',
            'start_line' => 506,
            'indent' => 1,
            'block_id' => 50
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 518,
            'src' => ' { use feature qw(:5.10) ; my $count_expected = ( $^H & 0x20000 ) ? 2 : 1 ; my $t ; my $s = "a" ; $s =~ s/a/$t = \\%^H;  qq( qq() );/ee ; is ( Internals::SvREFCNT ( %$t ) , $count_expected , \'RT 63110\' ) ; }',
            'start_line' => 511,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 527,
            'src' => ' { my $x ; is ( Internals::SvREFCNT ( $x ) , 1 , "originally only 1 reference" ) ; eval \'$x\' ; is ( Internals::SvREFCNT ( $x ) , 1 , "execution eval doesn\'t create new references" ) ; }',
            'start_line' => 520,
            'indent' => 0,
            'block_id' => 0
          },
...
print "ok\\n";
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 555,
            'src' => ' fresh_perl_is ( q{# localize the hits hash so the eval ends up with the pad offset of a copy of it in its targ
BEGIN { $^H |= 0x00020000 }
eval q{ eval { + } };
print "ok\\n";
} , "ok\\n" , undef , \'segfault on syntax errors in block evals\' ) ;',
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 562,
            'src' => ' fresh_perl_is ( q{use overload \'""\'  => sub { \'1;\' };
my $ov = bless [];
eval $ov;
print "ok\\n";
} , "ok\\n" , undef , \'assert fail on non-string in Perl_lex_start\' ) ;',
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 574,
            'src' => ' for my $k ( ! 0 ) { eval \'my $do_something_with = $k\' ; eval { $k = \'mon\' } ; is "a" =~/a/ , "1" , "string eval leaves readonly lexicals readonly [perl #19135]" ; }',
            'start_line' => 569,
            'indent' => 0,
            'block_id' => 0
          },
  ...
  print "ab" =~ /a b/ ? "ok\\n" : "nokay\\n";
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 593,
            'src' => ' { BEGIN { eval \'require re; import re "/x"\' } ok "ab" =~/a b/ , \'eval does not localise %^H at run time\' ; }',
            'start_line' => 590,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 598,
            'src' => ' pass ( "phew! dodged the assertion after a parsing (not lexing) error" ) ;',
            'start_line' => 598,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 611,
            'src' => ' { local $ENV { PERL_DESTRUCT_LEVEL } = 1 ; unlike runperl ( prog => \'BEGIN { $^H{foo} = bar }\' . \'our %FIELDS; my main $x; eval q[$x->{foo}]\' , stderr => 1 , ) , qr/Unbalanced string table/ , \'Errors in finalize_optree do not leak string eval op tree\' ; }',
            'start_line' => 601,
            'indent' => 0,
            'block_id' => 0
          },
