...
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => 'Parsing \'...\' in "$line" as a range operator',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 40
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 13,
            'src' => ' my $err = "Unimplemented at $0 line " . ( __LINE__ + 2 ) . ".\\n" ;',
            'start_line' => 13,
            'indent' => 0,
            'block_id' => 0
          },
...
print ${\\"D"}  ...  A ;
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 50,
            'src' => ' foreach my $line ( @lines ) { next if $line =~/^\\s*#/ || $line !~/\\S/ ; my $mess = qq{Parsing \'...\' in "$line" as a range operator} ; eval qq{
       {local *STDOUT; no strict "subs"; $line;}
        pass \\$mess;
        1;
    }or do { my $err = $@ ; $err =~ s/\\n//g ; fail "$mess ($err)" ; } }',
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 40,
            'src' => ' my $mess = qq{Parsing \'...\' in "$line" as a range operator} ;',
            'start_line' => 40,
            'indent' => 1,
            'block_id' => 2
          },
