...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => 'Execution of ellipsis statement reported \'Unimplemented\' code',
                   'type' => Compiler::Lexer::TokenType::T_String
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'has_warnings' => 0,
          ...
          bless( {
                   'data' => 'RT #122661: Semicolon before ellipsis statement disambiguates to indicate block rather than hash reference',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          {
            'src' => ' my $err1 = "Unimplemented at $0 line " ;',
            'token_num' => 5,
            'block_id' => 0,
            'start_line' => 14,
            'indent' => 0,
          ...
          },
          {
            ...
            'block_id' => 0,
            'token_num' => 7,
            'src' => ' is $@ , $err , "Execution of ellipsis statement reported \'Unimplemented\' code" ;'
          },
          {
            'end_line' => 20,
            'has_warnings' => 0,
          ...
          },
          {
            ...
            'block_id' => 0,
            'indent' => 0,
            'src' => ' note ( "RT #122661: Semicolon before ellipsis statement disambiguates to indicate block rather than hash reference" ) ;',
            'token_num' => 5,
            'end_line' => 22,
            'has_warnings' => 1
          },
          ...
          {
            'src' => ' eval { @transformed = map { ; ... } @input ; } ;',
            'token_num' => 13,
            'start_line' => 26,
            'indent' => 0,
            'block_id' => 0,
          ...
          },
          {
            ...
            'indent' => 0,
            'token_num' => 7,
            'src' => ' is $@ , $err , "Disambiguation case 1" ;',
            'end_line' => 27,
            'has_warnings' => 1
          },
          {
          ...
          },
          {
            'has_warnings' => 1,
            'end_line' => 32,
            'src' => ' is $@ , $err , "Disambiguation case 2" ;',
            'token_num' => 7,
            'start_line' => 32,
            'indent' => 0,
            'block_id' => 0
          ...
          {
            'src' => ' is $@ , $err , "Disambiguation case 3" ;',
            'token_num' => 7,
            'block_id' => 0,
            'start_line' => 37,
            'indent' => 0,
          ...
          },
          {
            ...
            'block_id' => 0,
            'token_num' => 7,
            'src' => ' is $@ , $err , "Disambiguation case 4" ;'
          },
          {
            'start_line' => 43,
            'indent' => 0,
