...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 31,
            'src' => ' sub not_hash { my ( $err ) = shift ; like ( $err , qr/^Not a HASH reference / ) || printf STDERR "# at %s line %d.\\n" , ( caller ) [ 1 , 2 ] ; }',
            'start_line' => 27,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 30,
            'src' => ' like ( $err , qr/^Not a HASH reference / ) || printf STDERR "# at %s line %d.\\n" , ( caller ) [ 1 , 2 ] ;',
            'start_line' => 29,
            'indent' => 1,
            'block_id' => 7
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 78,
            'src' => ' eval { while ( my ( $k , $v ) = each %$a ) { no_op ; } } ;',
            'start_line' => 74,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 94,
            'src' => ' eval { if ( $a-> { \'abc\' } eq \'ABC\' ) { no_op ( 23 ) } else { no_op ( 42 ) } } ;',
            'start_line' => 92,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 132,
            'src' => ' eval { my $slice = join ( \'\' , \'x\' , @$a { \'abc\' , \'def\' } , \'x\' ) ; } ;',
            'start_line' => 130,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 131,
            'src' => ' my $slice = join ( \'\' , \'x\' , @$a { \'abc\' , \'def\' } , \'x\' ) ;',
            'start_line' => 131,
            'indent' => 0,
            'block_id' => 16
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 165,
            'src' => ' sub f { print "not " unless $_ [ 0 ] eq \'a\' ; $_ [ 0 ] = \'b\' ; print "ok 11\\n" ; }',
            'start_line' => 161,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 176,
            'src' => ' eval { no_op if exists $avhv-> { bar } ; } ;',
            'start_line' => 174,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 186,
            'src' => ' eval { no_op if exists $avhv-> { pants } ; } ;',
            'start_line' => 184,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 185,
            'src' => ' no_op if exists $avhv-> { pants } ;',
            'start_line' => 185,
            'indent' => 0,
            'block_id' => 19
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 201,
            'src' => ' eval { no_op unless exists $avhv-> { bar } and $avhv-> { bar } == 10 ; } ;',
            'start_line' => 199,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 200,
            'src' => ' no_op unless exists $avhv-> { bar } and $avhv-> { bar } == 10 ;',
            'start_line' => 200,
            'indent' => 0,
            'block_id' => 19
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 228,
            'src' => ' eval { @x = delete @{ $avhv } { \'foo\' , \'pants\' } ; } ;',
            'start_line' => 226,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 232,
            'src' => ' eval { no_op unless "$avhv->{bar}" eq "yyy" ; } ;',
            'start_line' => 230,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 231,
            'src' => ' no_op unless "$avhv->{bar}" eq "yyy" ;',
            'start_line' => 231,
            'indent' => 0,
            'block_id' => 19
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 248,
            'src' => ' eval { %$avhv = ( foo => 29 , pants => 2 , bar => 0 ) ; } ;',
            'start_line' => 246,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 255,
            'src' => ' eval { ( $extra , %$avhv ) = ( "moo" , foo => 42 , pants => 53 , bar => "HIKE!" ) ; } ;',
            'start_line' => 253,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 254,
            'src' => ' ( $extra , %$avhv ) = ( "moo" , foo => 42 , pants => 53 , bar => "HIKE!" ) ;',
            'start_line' => 254,
            'indent' => 0,
            'block_id' => 19
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 261,
            'src' => ' eval { %$avhv = ( ) ; ( %$avhv , $extra ) = ( foo => 42 , pants => 53 , bar => "HIKE!" ) ; } ;',
            'start_line' => 258,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 260,
            'src' => ' ( %$avhv , $extra ) = ( foo => 42 , pants => 53 , bar => "HIKE!" ) ;',
            'start_line' => 260,
            'indent' => 0,
            'block_id' => 19
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 267,
            'src' => ' eval { @extra = qw(whatever and stuff) ; %$avhv = ( ) ; } ;',
            'start_line' => 264,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 265,
            'src' => ' @extra = qw(whatever and stuff) ;',
            'start_line' => 265,
            'indent' => 0,
            'block_id' => 19
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 271,
            'src' => ' eval { ( %$avhv , @extra ) = ( foo => 42 , pants => 53 , bar => "HIKE!" ) ; } ;',
            'start_line' => 269,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 276,
            'src' => ' eval { ( @extra , %$avhv ) = ( foo => 42 , pants => 53 , bar => "HIKE!" ) ; } ;',
            'start_line' => 274,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 275,
            'src' => ' ( @extra , %$avhv ) = ( foo => 42 , pants => 53 , bar => "HIKE!" ) ;',
            'start_line' => 275,
            'indent' => 0,
            'block_id' => 19
          },
