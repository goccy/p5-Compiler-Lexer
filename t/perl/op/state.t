...
subtest 'tokenize' => sub {
    ...
    ',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'line' => 411,
                   'data' => 'State variable is correct',
                   'name' => 'String'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'line' => 411,
          ...
          bless( {
                   ...
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'name' => 'String',
                   'data' => 'state variables don\'t surprisingly disappear when accessed'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Symbol,
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'start_line' => 298,
            'indent' => 0,
            'src' => ' foreach my $spam ( @spam ) { no warnings \'experimental::smartmatch\' ; given ( state $spam = $spam ) { when ( $spam [ 0 ] ) { ok 1 , "given" } default { ok 0 , "given" } } }'
          },
          {
            'has_warnings' => 1,
            'end_line' => 299,
	...
	sub h_49522 {
		...
		sub { $t };
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 402,
            'src' => ' { state $f = 1 ; foo ( $f ) if 0 ; ok ( defined $f , \'state init not skipped\' ) ; }',
            'indent' => 0,
            'start_line' => 398
          },
          {
          ...
          },
          {
            ...
            'end_line' => 401,
            'has_warnings' => 1,
            'src' => ' ok ( defined $f , \'state init not skipped\' ) ;',
            'indent' => 1,
            'start_line' => 401
          },
          {
            ...
            'token_num' => 85,
            'indent' => 0,
            'src' => ' { sub thing { my $expect = shift ; my ( $x , $y ) ; state $z ; is ( $z , $expect , "State variable is correct" ) ; $z = 5 ; } thing ( undef ) ; thing ( 5 ) ; sub thing2 { my $expect = shift ; my $x ; my $y ; state $z ; is ( $z , $expect , "State variable is correct" ) ; $z = 6 ; } thing2 ( undef ) ; thing2 ( 6 ) ; }',
            'start_line' => 405
          },
          {
            'end_line' => 414,
            ...
            'token_num' => 32,
            'start_line' => 406,
            'src' => ' sub thing { my $expect = shift ; my ( $x , $y ) ; state $z ; is ( $z , $expect , "State variable is correct" ) ; $z = 5 ; }',
            'indent' => 1
          },
          {
            'start_line' => 407,
          ...
          {
            'start_line' => 411,
            'src' => ' is ( $z , $expect , "State variable is correct" ) ;',
            'indent' => 2,
            'has_warnings' => 1,
            'end_line' => 411,
            'token_num' => 9,
          ...
          },
          {
            ...
            'end_line' => 428,
            'indent' => 1,
            'src' => ' sub thing2 { my $expect = shift ; my $x ; my $y ; state $z ; is ( $z , $expect , "State variable is correct" ) ; $z = 6 ; }',
            'start_line' => 419
          },
          {
            'has_warnings' => 0,
          ...
          },
          {
            'start_line' => 435,
            'indent' => 0,
            'src' => ' sub rt_123029 { state $s ; $s = \'foo\' x500 ; my $c = $s ; return defined $s ; }',
            'token_num' => 21,
            'block_id' => 0,
            'has_warnings' => 1,
            'end_line' => 440
          ...
          },
          {
            ...
            'end_line' => 439,
            'start_line' => 439,
            'src' => ' return defined $s ;',
            'indent' => 1
          },
          {
            'start_line' => 441,
            'src' => ' ok ( rt_123029 ( ) , "state variables don\'t surprisingly disappear when accessed" ) ;',
            'indent' => 0,
            'block_id' => 0,
            'token_num' => 9,
            'end_line' => 441,
