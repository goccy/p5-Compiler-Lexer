...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            'start_line' => 32,
            'indent' => 0,
            'src' => ' sub { eval \'sub MC텟ᵀ::Bࡎᶓ::ᕘ { return $_[1]+2 }\' ; is ( MC텟ᵀ::ድ리ᭉᛞ-> ᕘ ( 0 ) , 2 ) ; }',
            'has_warnings' => 1,
            'end_line' => 32,
            'token_num' => 18,
            'block_id' => 4
          ...
          {
            'start_line' => 33,
            'src' => ' sub { eval \'sub MC텟ᵀ::Bࡎᶓ::ᕘ($) { return $_[1]+3 }\' ; is ( MC텟ᵀ::ድ리ᭉᛞ-> ᕘ ( 0 ) , 3 ) ; }',
            'indent' => 0,
            'has_warnings' => 1,
            'end_line' => 33,
            'token_num' => 18,
          ...
          },
          {
            ...
            'end_line' => 34,
            'indent' => 0,
            'src' => ' sub { eval \'sub MC텟ᵀ::Bࡎᶓ::ᕘ($) { 4 }\' ; is ( MC텟ᵀ::ድ리ᭉᛞ-> ᕘ ( 0 ) , 4 ) ; }',
            'start_line' => 34
          },
          {
            'token_num' => 3,
          ...
          {
            'start_line' => 35,
            'src' => ' sub { *MC텟ᵀ :: Bࡎᶓ::ᕘ = sub { $_ [ 1 ] + 5 } ; is ( MC텟ᵀ::ድ리ᭉᛞ-> ᕘ ( 0 ) , 5 ) ; }',
            'indent' => 0,
            'block_id' => 4,
            'token_num' => 29,
            'end_line' => 35,
          ...
          {
            'indent' => 0,
            'src' => ' sub { local *MC텟ᵀ :: Bࡎᶓ::ᕘ = sub { $_ [ 1 ] + 6 } ; is ( MC텟ᵀ::ድ리ᭉᛞ-> ᕘ ( 0 ) , 6 ) ; }',
            'start_line' => 36,
            'has_warnings' => 1,
            'end_line' => 36,
            'token_num' => 30,
          ...
          {
            'indent' => 0,
            'src' => ' sub { sub FFF { $_ [ 1 ] + 7 } ; local *MC텟ᵀ :: Bࡎᶓ::ᕘ = *FFF ; is ( MC텟ᵀ::ድ리ᭉᛞ-> ᕘ ( 0 ) , 7 ) ; }',
            'start_line' => 38,
            'token_num' => 33,
            'block_id' => 4,
            'end_line' => 38,
          ...
          },
          {
            ...
            'end_line' => 40,
            'has_warnings' => 1,
            'src' => ' sub { sub DḊƋ { $_ [ 1 ] + 8 } ; *MC텟ᵀ :: Bࡎᶓ::ᕘ = *DḊƋ ; is ( MC텟ᵀ::ድ리ᭉᛞ-> ᕘ ( 0 ) , 8 ) ; }',
            'indent' => 0,
            'start_line' => 40
          },
          {
          ...
          {
            'start_line' => 41,
            'src' => ' sub { * ǎᔆɗＦ::앗ｄƑ = sub { $_ [ 1 ] + 9 } ; *MC텟ᵀ :: Bࡎᶓ::ᕘ = \\ & ǎᔆɗＦ::앗ｄƑ ; is ( MC텟ᵀ::ድ리ᭉᛞ-> ᕘ ( 0 ) , 9 ) ; }',
            'indent' => 0,
            'has_warnings' => 1,
            'end_line' => 41,
            'block_id' => 4,
          ...
          {
            'start_line' => 42,
            'src' => ' sub { undef *MC텟ᵀ :: Bࡎᶓ::ᕘ ; eval { MC텟ᵀ::ድ리ᭉᛞ-> ᕘ ( 0 ) } ; like ( $@ , qr/locate object method/ ) ; }',
            'indent' => 0,
            'has_warnings' => 1,
            'end_line' => 42,
            'block_id' => 4,
          ...
          },
          {
            'start_line' => 43,
            'indent' => 0,
            'src' => ' sub { eval "sub MC텟ᵀ::Bࡎᶓ::ᕘ($);" ; *MC텟ᵀ :: Bࡎᶓ::ᕘ = \\ & ǎᔆɗＦ::앗ｄƑ ; is ( MC텟ᵀ::ድ리ᭉᛞ-> ᕘ ( 0 ) , 9 ) ; }',
            'end_line' => 43,
            'has_warnings' => 1,
            'block_id' => 4,
            'token_num' => 26
          ...
          {
            'start_line' => 44,
            'src' => ' sub { *Xƴƶ = sub { $_ [ 1 ] + 10 } ; ${ MC텟ᵀ::Bࡎᶓ:: } { ᕘ } = \\ & Xƴƶ ; is ( MC텟ᵀ::ድ리ᭉᛞ-> ᕘ ( 0 ) , 10 ) ; }',
            'indent' => 0,
            'block_id' => 4,
            'token_num' => 38,
            'end_line' => 44,
          ...
          },
          {
            ...
            'token_num' => 32,
            'start_line' => 45,
            'src' => ' sub { ${ MC텟ᵀ::Bࡎᶓ:: } { ᕘ } = sub { $_ [ 1 ] + 11 } ; is ( MC텟ᵀ::ድ리ᭉᛞ-> ᕘ ( 0 ) , 11 ) ; }',
            'indent' => 0
          },
          {
            'start_line' => 45,
          ...
          },
          {
            ...
            'end_line' => 48,
            'indent' => 0,
            'src' => ' sub { eval \'package MC텟ᵀ::Bࡎᶓ; sub ᕘ { $_[1]+12 }\' ; is ( MC텟ᵀ::ድ리ᭉᛞ-> ᕘ ( 0 ) , 12 ) ; }',
            'start_line' => 48
          },
          {
            'end_line' => 48,
          ...
          {
            'indent' => 0,
            'src' => ' sub { eval \'package ᛎᛎᛎ; sub ᕘ { $_[1]+13 }\' ; *MC텟ᵀ :: Bࡎᶓ::ᕘ = \\ & ᛎᛎᛎ::ᕘ ; is ( MC텟ᵀ::ድ리ᭉᛞ-> ᕘ ( 0 ) , 13 ) ; }',
            'start_line' => 49,
            'has_warnings' => 1,
            'end_line' => 49,
            'token_num' => 26,
          ...
          },
          {
            'start_line' => 50,
            'indent' => 0,
            'src' => ' sub { ${ MC텟ᵀ::Bࡎᶓ:: } { ᕘ } = sub { $_ [ 1 ] + 14 } ; is ( MC텟ᵀ::ድ리ᭉᛞ-> ᕘ ( 0 ) , 14 ) ; }',
            'has_warnings' => 1,
            'end_line' => 50,
            'token_num' => 32,
            'block_id' => 4
          ...
          },
          {
            ...
            'start_line' => 52,
            'indent' => 0,
            'src' => ' sub { undef * { MC텟ᵀ::Bࡎᶓ:: } ; eval { MC텟ᵀ::ድ리ᭉᛞ-> ᕘ ( 0 ) } ; like ( $@ , qr/locate object method/ ) ; }'
          },
          {
            'end_line' => 52,
            'has_warnings' => 1,
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 53,
            'src' => ' sub { eval \'package MC텟ᵀ::Bࡎᶓ; sub ᕘ { $_[1]+15 }\' ; is ( MC텟ᵀ::ድ리ᭉᛞ-> ᕘ ( 0 ) , 15 ) ; }',
            'indent' => 0,
            'start_line' => 53
          },
          {
          ...
          {
            'indent' => 0,
            'src' => ' sub { eval \'package MC텟ᵀ::Bࡎᶓ; sub ᕘ { $_[1]+16 }\' ; is ( MC텟ᵀ::ድ리ᭉᛞ-> ᕘ ( 0 ) , 16 ) ; }',
            'start_line' => 55,
            'block_id' => 4,
            'token_num' => 18,
            'has_warnings' => 1,
          ...
          {
            'indent' => 0,
            'src' => ' sub { %{ MC텟ᵀ::Bࡎᶓ:: } = ( ) ; eval { MC텟ᵀ::ድ리ᭉᛞ-> ᕘ ( 0 ) } ; like ( $@ , qr/locate object method/ ) ; }',
            'start_line' => 56,
            'has_warnings' => 1,
            'end_line' => 56,
            'block_id' => 4,
          ...
          },
          {
            'start_line' => 57,
            'indent' => 0,
            'src' => ' sub { eval \'package MC텟ᵀ::Bࡎᶓ; sub ᕘ { $_[1]+17 }\' ; is ( MC텟ᵀ::ድ리ᭉᛞ-> ᕘ ( 0 ) , 17 ) ; }',
            'block_id' => 4,
            'token_num' => 18,
            'end_line' => 57,
            'has_warnings' => 1
          ...
          },
          {
            ...
            'start_line' => 60,
            'indent' => 0,
            'src' => ' sub { * { MC텟ᵀ::Bࡎᶓ:: } = * { Ƒｏｏ:: } ; eval { MC텟ᵀ::ድ리ᭉᛞ-> ᕘ ( 0 ) } ; like ( $@ , qr/locate object method/ ) ; }'
          },
          {
            'src' => ' * { MC텟ᵀ::Bࡎᶓ:: } = * { Ƒｏｏ:: } ;',
            'indent' => 1,
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'indent' => 0,
            'src' => ' sub { *MC텟ᵀ :: ድ리ᭉᛞ::ᕘ = \\ & MC텟ᵀ::Bࡎᶓ::ᕘ ; eval { MC텟ᵀ::ድ리ᭉᛞ::ᕘ ( 0 , 0 ) } ; ok ( ! $@ ) ; undef *MC텟ᵀ :: ድ리ᭉᛞ::ᕘ }',
            'start_line' => 61
          },
          {
            'indent' => 1,
          ...
          {
            'src' => ' sub { eval \'package MC텟ᵀ::Bࡎᶓ; sub ᕘ { $_[1]+18 }\' ; is ( MC텟ᵀ::ድ리ᭉᛞ-> ᕘ ( 0 ) , 18 ) ; }',
            'indent' => 0,
            'start_line' => 62,
            'has_warnings' => 1,
            'end_line' => 62,
