...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 12,
            'src' => ' ok \'Foogh\'-> isa ( "Baz" ) , \'isa after another stash has claimed the @ISA via glob assignment\' ;',
            'start_line' => 11,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 14,
            'src' => ' ok \'Phoogh\'-> isa ( "Baz" ) , \'isa on the stash that claimed the @ISA via glob assignment\' ;',
            'start_line' => 13,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 16,
            'src' => ' ok ! Foogh-> isa ( "Bar" ) , \'!isa when another stash has claimed the @ISA via glob assignment\' ;',
            'start_line' => 15,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 18,
            'src' => ' ok ! Phoogh-> isa ( "Bar" ) , \'!isa on the stash that claimed the @ISA via glob assignment\' ;',
            'start_line' => 17,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 24,
            'src' => ' ok \'Foogh\'-> isa ( "Baz" ) , \'isa after glob-to-ref assignment when *ISA is shared\' ;',
            'start_line' => 23,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 26,
            'src' => ' ok \'Phoogh\'-> isa ( "Baz" ) , \'isa after glob-to-ref assignment on another stash when *ISA is shared\' ;',
            'start_line' => 25,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 28,
            'src' => ' ok ! Foogh-> isa ( "Bar" ) , \'!isa after glob-to-ref assignment when *ISA is shared\' ;',
            'start_line' => 27,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 30,
            'src' => ' ok ! Phoogh-> isa ( "Bar" ) , \'!isa after glob-to-ref assignment on another stash when *ISA is shared\' ;',
            'start_line' => 29,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 37,
            'src' => ' ok \'Foo\'-> isa ( "Baz" ) , \'isa after another stash has claimed the @ISA via ref-to-glob assignment\' ;',
            'start_line' => 36,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 39,
            'src' => ' ok \'Phoo\'-> isa ( "Baz" ) , \'isa on the stash that claimed the @ISA via ref-to-glob assignment\' ;',
            'start_line' => 38,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 41,
            'src' => ' ok ! Foo-> isa ( "Bar" ) , \'!isa when another stash has claimed the @ISA via ref-to-glob assignment\' ;',
            'start_line' => 40,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 43,
            'src' => ' ok ! Phoo-> isa ( "Bar" ) , \'!isa on the stash that claimed the @ISA via ref-to-glob assignment\' ;',
            'start_line' => 42,
            'indent' => 0,
            'block_id' => 0
          }
