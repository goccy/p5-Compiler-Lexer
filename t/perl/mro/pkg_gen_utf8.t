...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'ᕘ pkg_gen incs for methods',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 29
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 19,
            'src' => ' ok ( ! mro::get_pkg_gen ( \'레알ឭ되s놑Eξsᴛ\' ) , "pkg_gen 0 for non-existent pkg" ) ;',
            'start_line' => 18,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 21,
            'src' => ' my $f_gen = mro::get_pkg_gen ( \'ᕘ\' ) ;',
            'start_line' => 21,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 27,
            'src' => ' { no warnings \'once\' ; * ᕘ::ᕘ_Ƒ운ℭ = sub { 123 } ; }',
            'start_line' => 24,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 28,
            'src' => ' my $new_f_gen = mro::get_pkg_gen ( \'ᕘ\' ) ;',
            'start_line' => 28,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 29,
            'src' => ' ok ( $new_f_gen > $f_gen , \'ᕘ pkg_gen incs for methods\' ) ;',
            'start_line' => 29,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 33,
            'src' => ' $new_f_gen = mro::get_pkg_gen ( \'ᕘ\' ) ;',
            'start_line' => 33,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 34,
            'src' => ' ok ( $new_f_gen > $f_gen , \'ᕘ pkg_gen incs for @ISA\' ) ;',
            'start_line' => 34,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 37,
            'src' => ' undef %ᕘ::; is ( mro::get_pkg_gen ( \'ᕘ\' ) , 1 , "pkg_gen 1 for undef %Pkg::" ) ;',
            'start_line' => 36,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 40,
            'src' => ' is ( mro::get_pkg_gen ( \'ᕘ\' ) , 0 , \'pkg_gen 0 for delete $::{Pkg::}\' ) ;',
            'start_line' => 40,
            'indent' => 0,
            'block_id' => 0
          },
