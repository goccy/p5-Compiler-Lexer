...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => 'Vulcan Intelligent Sentient Humanoid BiPedal LifeForm Object',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 65
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 66,
            'src' => ' ok ( eq_array ( mro::get_linear_isa ( \'Vulcan\' ) , [ qw(Vulcan Intelligent Sentient Humanoid BiPedal LifeForm Object) ] ) , \'... got the right MRO for the Vulcan Dylan Example\' ) ;',
            'start_line' => 63,
            'indent' => 0,
            'block_id' => 0
          }
