...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($$stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 31,
            'src' => ' { package PṞoxᚤ ; our @ISA = qw// ; sub next_prxᔬ { goto & next::method } sub maybe_prxᔬ { goto & maybe::next::method } sub can_prxᔬ { goto & next::can } package Ⱦ밧ᶟ ; our @ISA = qw// ; sub ᕗ { 42 } sub Ƚ { 24 } sub ʠঊₓ { 242 } package ᵗ톺 ; our @ISA = qw/Ⱦ밧ᶟ/ ; sub ᕗ { shift-> PṞoxᚤ::next_prxᔬ ( ) } sub Ƚ { shift-> PṞoxᚤ::maybe_prxᔬ ( ) } sub বẔ { shift-> PṞoxᚤ::maybe_prxᔬ ( ) } sub ʠঊₓ { shift-> PṞoxᚤ::can_prxᔬ ( )-> ( ) } }',
            'start_line' => 11,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 14,
            'src' => ' sub next_prxᔬ { goto & next::method }',
            'start_line' => 14,
            'indent' => 1,
            'block_id' => 1
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 15,
            'src' => ' sub maybe_prxᔬ { goto & maybe::next::method }',
            'start_line' => 15,
            'indent' => 1,
            'block_id' => 1
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 16,
            'src' => ' sub can_prxᔬ { goto & next::can }',
            'start_line' => 16,
            'indent' => 1,
            'block_id' => 1
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 27,
            'src' => ' sub ᕗ { shift-> PṞoxᚤ::next_prxᔬ ( ) }',
            'start_line' => 27,
            'indent' => 1,
            'block_id' => 1
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 28,
            'src' => ' sub Ƚ { shift-> PṞoxᚤ::maybe_prxᔬ ( ) }',
            'start_line' => 28,
            'indent' => 1,
            'block_id' => 1
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 29,
            'src' => ' sub বẔ { shift-> PṞoxᚤ::maybe_prxᔬ ( ) }',
            'start_line' => 29,
            'indent' => 1,
            'block_id' => 1
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 30,
            'src' => ' sub ʠঊₓ { shift-> PṞoxᚤ::can_prxᔬ ( )-> ( ) }',
            'start_line' => 30,
            'indent' => 1,
            'block_id' => 1
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 33,
            'src' => ' is ( ᵗ톺-> ᕗ , 42 , \'proxy next::method via goto\' ) ;',
            'start_line' => 33,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 34,
            'src' => ' is ( ᵗ톺-> Ƚ , 24 , \'proxy maybe::next::method via goto\' ) ;',
            'start_line' => 34,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 35,
            'src' => ' ok ( ! ᵗ톺-> বẔ , \'proxy maybe::next::method via goto with no method\' ) ;',
            'start_line' => 35,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 36,
            'src' => ' is ( ᵗ톺-> ʠঊₓ , 242 , \'proxy next::can via goto\' ) ;',
            'start_line' => 36,
            'indent' => 0,
            'block_id' => 0
          }
