...
subtest 'tokenize' => sub {
    ...
    is_deeply($$tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => '... got the right value from ᕘ->fಓ',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 45
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => '... got the right value from Fᶽ->fಓ',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 46
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => '... got the right value from Bᛆ->fಓ',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 47
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($$stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 26,
            'src' => ' sub fಓ { \'Fᶽ::fಓ => \' . ( shift )-> next::method }',
            'start_line' => 26,
            'indent' => 1,
            'block_id' => 1
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 34,
            'src' => ' sub fಓ { \'Bᛆ::fಓ => \' . ( shift )-> next::method }',
            'start_line' => 34,
            'indent' => 1,
            'block_id' => 1
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 42,
            'src' => ' sub fಓ { \'Baᕃ::fಓ => \' . ( shift )-> NEXT::fಓ }',
            'start_line' => 42,
            'indent' => 1,
            'block_id' => 1
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 45,
            'src' => ' is ( ᕘ-> fಓ , \'ᕘ::fಓ\' , \'... got the right value from ᕘ->fಓ\' ) ;',
            'start_line' => 45,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 46,
            'src' => ' is ( Fᶽ-> fಓ , \'Fᶽ::fಓ => ᕘ::fಓ\' , \'... got the right value from Fᶽ->fಓ\' ) ;',
            'start_line' => 46,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 47,
            'src' => ' is ( Bᛆ-> fಓ , \'Bᛆ::fಓ => ᕘ::fಓ\' , \'... got the right value from Bᛆ->fಓ\' ) ;',
            'start_line' => 47,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 49,
            'src' => ' is ( Baᕃ-> fಓ , \'Baᕃ::fಓ => Bᛆ::fಓ => Fᶽ::fಓ => ᕘ::fಓ\' , \'... got the right value using NEXT in a subclass of a C3 class\' ) ;',
            'start_line' => 49,
            'indent' => 0,
            'block_id' => 0
          }
