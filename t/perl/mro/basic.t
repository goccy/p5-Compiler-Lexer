...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'line' => 342,
                   'data' => '*This_glob_haD_better_not_exist',
                   'name' => 'Mul'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'line' => 342,
          ...
          bless( {
                   'data' => 'obliterating @ISA via glob assignment',
                   'name' => 'RawString',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'has_warnings' => 0,
          ...
          bless( {
                   'name' => 'RawString',
                   'data' => 'autovivifying @ISA via *{@ISA}',
                   'line' => 353,
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
          ...
          bless( {
                   'name' => 'RawString',
                   'data' => 'localising gv-with-cv belonging to detached package',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   ...
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => 'Changes to UNIVERSAL::DESTROY invalidate DESTROY caches',
                   'name' => 'RawString'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'has_warnings' => 0,
          ...
          bless( {
                   'data' => 'no crash when ISA contains nonexistent elements',
                   'name' => 'String',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'don\'t crash when deleting ISA'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'data' => ')',
                   'name' => 'RightParenthesis',
...
'
          ...
          bless( {
                   ...
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'line' => 411,
                   'data' => 'a case with multiple refs to ISA',
                   'name' => 'String'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
...
',
          ...
          bless( {
                   'data' => 'magical *ISA = arrayref elements',
                   'name' => 'String',
                   'line' => 445,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
...
',
          ...
          bless( {
                   ...
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'line' => 458,
                   'data' => 'unmagicalize *ISA elements',
                   'name' => 'String'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'type' => Compiler::Lexer::TokenType::T_RightParenthesis,
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            'start_line' => 338,
            'indent' => 0,
            'src' => ' { @Gwythaint :: ISA = "Fantastic::Creature" ; undef *This_glob_haD_better_not_exist ; *Gwythaint :: ISA = *This_glob_haD_better_not_exist ; ok ! Gwythaint-> isa ( "Fantastic::Creature" ) , \'obliterating @ISA via glob assignment\' ; }',
            'block_id' => 0,
            'token_num' => 28,
            'end_line' => 346,
            'has_warnings' => 1
          },
          {
            'start_line' => 341,
            'indent' => 1,
            'src' => ' @Gwythaint :: ISA = "Fantastic::Creature" ;',
            'end_line' => 341,
            'has_warnings' => 1,
            'block_id' => 44,
            'token_num' => 6
          ...
          {
            'start_line' => 342,
            'src' => ' undef *This_glob_haD_better_not_exist ;',
            'indent' => 1,
            'has_warnings' => 0,
            'end_line' => 342,
            'token_num' => 3,
          ...
          {
            'indent' => 1,
            'src' => ' *Gwythaint :: ISA = *This_glob_haD_better_not_exist ;',
            'start_line' => 343,
            'token_num' => 6,
            'block_id' => 44,
            'end_line' => 343,
          ...
          },
          {
            'start_line' => 344,
            'indent' => 1,
            'src' => ' ok ! Gwythaint-> isa ( "Fantastic::Creature" ) , \'obliterating @ISA via glob assignment\' ;',
            'token_num' => 11,
            'block_id' => 44,
            'has_warnings' => 1,
            'end_line' => 345
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 354,
            'src' => ' { no warnings ; undef *fednu :: ISA ; @{ *fednu :: ISA } = "pyfg" ; ok + fednu-> isa ( "pyfg" ) , \'autovivifying @ISA via *{@ISA}\' ; }',
            'indent' => 0,
            'start_line' => 348
          },
          {
          ...
          {
            'indent' => 1,
            'src' => ' ok + fednu-> isa ( "pyfg" ) , \'autovivifying @ISA via *{@ISA}\' ;',
            'start_line' => 353,
            'end_line' => 353,
            'has_warnings' => 1,
            'block_id' => 45,
          ...
          },
          {
            'start_line' => 356,
            'indent' => 0,
            'src' => ' { sub Detached::method ; my $h = delete $: : { "Detached::" } ; eval { local *Detached :: method } ; is $@ , "" , \'localising gv-with-cv belonging to detached package\' ; }',
            'end_line' => 361,
            'has_warnings' => 1,
            'token_num' => 30,
            'block_id' => 0
          ...
          },
          {
            'start_line' => 359,
            'indent' => 1,
            'src' => ' eval { local *Detached :: method } ;',
            'token_num' => 8,
            'block_id' => 46,
            'has_warnings' => 1,
            'end_line' => 359
          ...
          {
            'src' => ' is $@ , "" , \'localising gv-with-cv belonging to detached package\' ;',
            'indent' => 1,
            'start_line' => 360,
            'has_warnings' => 1,
            'end_line' => 360,
          ...
          {
            'indent' => 0,
            'src' => ' { @il :: ISA = "ilsuper" ; sub ilsuper::can { "puree" } sub il::tomatoes ; { local *il :: ISA ; is + il-> can ( "tomatoes" ) , \\ & il::tomatoes , \'local *ISA\' ; } is "il"-> can ( "tomatoes" ) , "puree" , \'local *ISA unwinding\' ; { local *il :: ISA = [ ] ; is + il-> can ( "tomatoes" ) , \\ & il::tomatoes , \'local *ISA = []\' ; } is "il"-> can ( "tomatoes" ) , "puree" , \'local *ISA=[] unwinding\' ; }',
            'start_line' => 363,
            'has_warnings' => 1,
            'end_line' => 378,
            'block_id' => 0,
          ...
          {
            'start_line' => 368,
            'src' => ' { local *il :: ISA ; is + il-> can ( "tomatoes" ) , \\ & il::tomatoes , \'local *ISA\' ; }',
            'indent' => 1,
            'end_line' => 371,
            'has_warnings' => 1,
            'token_num' => 22,
          ...
          },
          {
            ...
            'block_id' => 50,
            'indent' => 2,
            'src' => ' is + il-> can ( "tomatoes" ) , \\ & il::tomatoes , \'local *ISA\' ;',
            'start_line' => 370
          },
          {
            'src' => ' is "il"-> can ( "tomatoes" ) , "puree" , \'local *ISA unwinding\' ;',
            'indent' => 1,
            'start_line' => 372,
            'block_id' => 48,
            'token_num' => 12,
          ...
          },
          {
            ...
            'start_line' => 387,
            'indent' => 0,
            'src' => ' *UNIVERSAL :: DESTROY = sub { $destroy_output = "new" } ;'
          },
          {
            'start_line' => 387,
            'src' => ' sub { $destroy_output = "new" }',
            'indent' => 0,
            'end_line' => 387,
            'has_warnings' => 1,
            'block_id' => 52,
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'indent' => 0,
            'src' => ' is $destroy_output , "new" , \'Changes to UNIVERSAL::DESTROY invalidate DESTROY caches\' ;',
            'start_line' => 390
          },
          {
            'token_num' => 5,
          ...
          },
          {
            ...
            'end_line' => 398,
            'indent' => 0,
            'src' => ' { no warnings \'uninitialized\' ; $# _119433::ISA ++ ; pass "no crash when ISA contains nonexistent elements" ; }',
            'start_line' => 394
          },
          {
            'start_line' => 395,
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'start_line' => 397,
            'src' => ' pass "no crash when ISA contains nonexistent elements" ;',
            'indent' => 1
          },
          {
            'start_line' => 400,
            'src' => ' { fresh_perl_is ( q{$x = \\@{q(Foo::ISA)};
delete $Foo::{ISA};
@$x = "Bar";
print "ok\\n";
} , "ok" , { } , "don\'t crash when deleting ISA" ) ; fresh_perl_is ( q{@Foo::ISA = qw(Abc Def);
$x = \\@{q(Foo::ISA)};
*Bar::ISA = $x;
delete $Bar::{ISA};
delete $Foo::{ISA};
...
@$x = "Bar";
print "ok\\n";
} , "ok" , { } , "a case with multiple refs to ISA" ) ; fresh_perl_is ( q{$x = \\@{q(Foo::ISA)};
*Bar::ISA = $x;
delete $Foo::{ISA};
delete $Bar::{ISA};
++$y;
@$x = "Bar";
print "ok\\n";
} , "ok" , { } , "a case with multiple refs to ISA" ) ; }',
            'indent' => 0,
            'token_num' => 38,
            'block_id' => 0,
            'end_line' => 435,
...
@$x = "Bar";
print "ok\\n";
} , "ok" , { } , "don\'t crash when deleting ISA" ) ;',
            'start_line' => 401,
            'block_id' => 55,
            'token_num' => 12,
            'end_line' => 401,
          ...
          {
            'src' => ' fresh_perl_is ( q{@Foo::ISA = qw(Abc Def);
$x = \\@{q(Foo::ISA)};
*Bar::ISA = $x;
delete $Bar::{ISA};
delete $Foo::{ISA};
...
print "ok\\n";
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'indent' => 0,
            'src' => ' { fresh_perl_is ( q{*My::Parent::foo = sub { "foo" };
*My::OtherParent::foo = sub { "other" };
my $x = [ "My::Parent" ];
*Fake::ISA = $x;
print Fake->foo, "\\n";
$x->[0] = "My::OtherParent";
print Fake->foo, "\\n";
} , "foo\\nother" , { } , "magical *ISA = arrayref elements" ) ; fresh_perl_is ( q{{
    local *My::Parent::foo = sub { "foo" };
    my $x = [ "My::Parent" ];
    *Fake::ISA = $x;
    print Fake->foo, "\\n";
