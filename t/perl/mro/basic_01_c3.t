...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 45,
            'src' => ' is ( Diamond_D-> hello , \'Diamond_C::hello\' , \'... method resolved itself as expected\' ) ;',
            'start_line' => 45,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 46,
            'src' => ' is ( Diamond_D-> can ( \'hello\' )-> ( ) , \'Diamond_C::hello\' , \'... can(method) resolved itself as expected\' ) ;',
            'start_line' => 46,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 47,
            'src' => ' is ( UNIVERSAL::can ( "Diamond_D" , \'hello\' )-> ( ) , \'Diamond_C::hello\' , \'... can(method) resolved itself as expected\' ) ;',
            'start_line' => 47,
            'indent' => 0,
            'block_id' => 0
          }
