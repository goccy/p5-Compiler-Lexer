...
',
          ...
          bless( {
                   ...
                   'line' => 22,
                   'name' => 'HereDocument',
                   'data' => 'Usage: Internals::SvREADONLY(SCALAR[, ON]) at (eval 1) line 1.
Usage: Internals::SvREFCNT(SCALAR[, REFCOUNT]) at (eval 2) line 1.
Usage: Internals::hv_clear_placeholders(hv) at (eval 3) line 1.
'
                 }, 'Compiler::Lexer::Token' ),
          ...
          bless( {
                   'data' => 'protected values still croak on assignment after SvREADONLY(..., 0)',
                   'name' => 'RawString',
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
          ...
          bless( {
                   ...
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'data' => 'read-only lexical regexps on scope exit [perl #115254]',
                   'name' => 'RawString'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'has_warnings' => 0,
          ...
          bless( {
                   'data' => 'SvREADONLY can make magic vars mutable',
                   'name' => 'RawString',
                   'line' => 75,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            'start_line' => 12,
            'indent' => 0,
            'src' => ' for my $arg ( \'\' , \'q[]\' , qw( 1 undef ) ) { fresh_perl_is ( << ---- , , { } , "Internals::* functions check their argument under func() AND &func() [perl #77776]" ) ; }',
            'token_num' => 27,
            'block_id' => 0,
            'end_line' => 23,
            'has_warnings' => 1
          ...
          {
            'src' => ' fresh_perl_is ( << ---- , , { } , "Internals::* functions check their argument under func() AND &func() [perl #77776]" ) ;',
            'indent' => 1,
            'start_line' => 13,
            'end_line' => 13,
            'has_warnings' => 1,
          ...
          {
            'src' => ' like $@ , qr "^Modification of a read-only value" , \'protected values still croak on assignment after SvREADONLY(..., 0)\' ;',
            'indent' => 0,
            'start_line' => 66,
            'end_line' => 67,
            'has_warnings' => 1,
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 68,
            'src' => ' is ${ \\ 3 } == 3 , "1" , \'attempt to modify failed\' ;',
            'indent' => 0,
            'start_line' => 68
          },
          {
            'start_line' => 70,
            'indent' => 0,
            'src' => ' eval { { my $x = ${ qr // } ; Internals::SvREADONLY $x , 1 ; ( ) } } ;',
            'token_num' => 21,
            'block_id' => 0,
            'end_line' => 70,
            'has_warnings' => 1
          ...
          },
          {
            ...
            'block_id' => 0,
            'token_num' => 7,
            'src' => ' is $@ , "" , \'read-only lexical regexps on scope exit [perl #115254]\' ;',
            'indent' => 0,
            'start_line' => 71
          },
          {
