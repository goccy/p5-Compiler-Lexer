...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'ok 1 - All modules should have tests # TODO Make Schwern Poorer\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 33
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'HereDocument',
                   'data' => '# http://www.xray.mpe.mpg.de/mailing-lists/perl5-porters/2001-04/msg01223.html
# 20010421230349.P2946@blackrider.blackstar.co.uk
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => '# TODO $module needs porting on $^O',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 48
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 26,
            'src' => ' if ( eval { require Socket } ) { if ( ord ( "A" ) != 193 || eval { require Convert::EBCDIC } ) { push @Core_Modules , qw(Net::Cmd Net::POP3) ; } }',
            'start_line' => 21,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 25,
            'src' => ' if ( ord ( "A" ) != 193 || eval { require Convert::EBCDIC } ) { push @Core_Modules , qw(Net::Cmd Net::POP3) ; }',
            'start_line' => 23,
            'indent' => 1,
            'block_id' => 2
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 24,
            'src' => ' push @Core_Modules , qw(Net::Cmd Net::POP3) ;',
            'start_line' => 24,
            'indent' => 2,
            'block_id' => 3
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 28,
            'src' => ' @Core_Modules = sort @Core_Modules ;',
            'start_line' => 28,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 33,
            'src' => ' my $message = "ok 1 - All modules should have tests # TODO Make Schwern Poorer\\n" ;',
            'start_line' => 32,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 36,
            'src' => ' if ( @Core_Modules ) { print "not $message" ; }',
            'start_line' => 34,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 39,
            'src' => ' print q{# http://www.xray.mpe.mpg.de/mailing-lists/perl5-porters/2001-04/msg01223.html
# 20010421230349.P2946@blackrider.blackstar.co.uk
} ;',
            'start_line' => 39,
            'indent' => 0,
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 52,
            'src' => ' foreach my $module ( @Core_Modules ) { my $todo = \'\' ; $todo = "# TODO $module needs porting on $^O" if $module eq \'ByteLoader\' && $^O eq \'VMS\' ; print "# $module compile failed\\nnot " unless compile_module ( $module ) ; print "ok $test_num $todo\\n" ; $test_num ++ ; }',
            'start_line' => 46,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 48,
            'src' => ' $todo = "# TODO $module needs porting on $^O" if $module eq \'ByteLoader\' && $^O eq \'VMS\' ;',
            'start_line' => 48,
            'indent' => 1,
            'block_id' => 6
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 49,
            'src' => ' print "# $module compile failed\\nnot " unless compile_module ( $module ) ;',
            'start_line' => 49,
            'indent' => 1,
            'block_id' => 6
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 65,
            'src' => ' sub compile_module { my ( $module ) = $_ [ 0 ] ; my $compmod = catfile ( curdir ( ) , \'lib\' , \'compmod.pl\' ) ; my $lib = \'-I\' . catdir ( updir ( ) , \'lib\' ) ; my $out = scalar `$^X $lib $compmod $module` ; print "# $out" ; return $out =~/^ok/ ; }',
            'start_line' => 56,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 59,
            'src' => ' my $compmod = catfile ( curdir ( ) , \'lib\' , \'compmod.pl\' ) ;',
            'start_line' => 59,
            'indent' => 1,
            'block_id' => 7
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 62,
            'src' => ' my $out = scalar `$^X $lib $compmod $module` ;',
            'start_line' => 62,
            'indent' => 1,
            'block_id' => 7
          },
