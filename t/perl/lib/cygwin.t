...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'perl pid translates to itself',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'test not run from cygwin process',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 17
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'parent pid translates to itself',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 19
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'posix to absolute win path',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 39
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'win to absolute posix path',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 41
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
my $binmode = $1 =~ /binmode|binary/',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'check cygdrive mount_flags',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 50
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'ExecString',
                   'data' => 'df | grep -i \'^c: \' | cut -d% -f2 | xargs',
                   'type' => Compiler::Lexer::TokenType::T_ExecString,
                   'line' => 56
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 7,
            'src' => ' skip_all ( \'cygwin specific test\' ) unless $^O eq \'cygwin\' ;',
            'start_line' => 7,
            'indent' => 1,
            'block_id' => 1
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 13,
            'src' => ' is ( Cygwin::winpid_to_pid ( Cygwin::pid_to_winpid ( $$ ) ) , $$ , "perl pid translates to itself" ) ;',
            'start_line' => 12,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 17,
            'src' => ' skip "test not run from cygwin process" , 1 if $parent <= 1 ;',
            'start_line' => 17,
            'indent' => 1,
            'block_id' => 2
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 19,
            'src' => ' is ( Cygwin::winpid_to_pid ( Cygwin::pid_to_winpid ( $parent ) ) , $parent , "parent pid translates to itself" ) ;',
            'start_line' => 18,
            'indent' => 1,
            'block_id' => 2
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 22,
            'src' => ' my $catpid = open my $cat , "|cat" or die "Couldn\'t cat: $!" ;',
            'start_line' => 22,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 23,
            'src' => ' open my $ps , "ps|" or die "Couldn\'t do ps: $!" ;',
            'start_line' => 23,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 24,
            'src' => ' my ( $catwinpid ) = map/^.\\s+$catpid\\s+\\d+\\s+\\d+\\s+(\\d+)/ , < $ps > ;',
            'start_line' => 24,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 27,
            'src' => ' is ( Cygwin::winpid_to_pid ( $catwinpid ) , $catpid , "winpid to pid" ) ;',
            'start_line' => 27,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 28,
            'src' => ' is ( Cygwin::pid_to_winpid ( $catpid ) , $catwinpid , "pid to winpid" ) ;',
            'start_line' => 28,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 31,
            'src' => ' is ( Cygwin::win_to_posix_path ( "t\\\\lib" ) , "t/lib" , "win to posix path: t/lib" ) ;',
            'start_line' => 31,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 32,
            'src' => ' is ( Cygwin::posix_to_win_path ( "t/lib" ) , "t\\\\lib" , "posix to win path: t\\\\lib" ) ;',
            'start_line' => 32,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 39,
            'src' => ' is ( Cygwin::posix_to_win_path ( "/" , 1 ) , $winpath , "posix to absolute win path" ) ;',
            'start_line' => 39,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 41,
            'src' => ' is ( Cygwin::win_to_posix_path ( $winpath , 1 ) , "/" , "win to absolute posix path" ) ;',
            'start_line' => 41,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 43,
            'src' => ' my $mount = join \'\' , `/usr/bin/mount` ;',
            'start_line' => 43,
            'indent' => 0,
            'block_id' => 0
          },
...
my $binmode = $1 =~ /binmode|binary/;is ( Cygwin::is_binmount ( "/" ) , $binmode ? 1 : \'\' , "check / for binmount" ) ;',
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 48,
            'src' => ' my $rootmnt = Cygwin::mount_flags ( "/" ) ;',
            'start_line' => 48,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 49,
            'src' => ' ok ( $binmode ? ( $rootmnt =~/,(binmode|binary)/ ) : ( $rootmnt =~/,textmode/ ) , "check / mount_flags" ) ;',
            'start_line' => 49,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 50,
            'src' => ' is ( Cygwin::mount_flags ( "/cygdrive" ) =~/,cygdrive/ , 1 , "check cygdrive mount_flags" ) ;',
            'start_line' => 50,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 53,
            'src' => ' my @flags = split (/,/ , Cygwin::mount_flags ( \'/cygdrive\' ) ) ;',
            'start_line' => 53,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 55,
            'src' => ' ok ( $prefix , "cygdrive mount prefix = " . ( ( $prefix ) ? $prefix : \'<none>\' ) ) ;',
            'start_line' => 55,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 56,
            'src' => ' chomp ( my $prefix2 = `df | grep -i \'^c: \' | cut -d% -f2 | xargs` ) ;',
            'start_line' => 56,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 61,
            'src' => ' is ( $prefix , $prefix2 , \'cygdrive mount prefix\' ) ;',
            'start_line' => 61,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 63,
            'src' => ' my @mnttbl = Cygwin::mount_table ( ) ;',
            'start_line' => 63,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 64,
            'src' => ' ok ( @mnttbl > 0 , "non empty mount_table" ) ;',
            'start_line' => 64,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 70,
            'src' => ' for $i ( @mnttbl ) { if ( $i-> [ 0 ] eq \'/\' ) { is ( $i-> [ 2 ] . "," . $i-> [ 3 ] , $rootmnt , "same root mount flags" ) ; last ; } }',
            'start_line' => 65,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 69,
            'src' => ' if ( $i-> [ 0 ] eq \'/\' ) { is ( $i-> [ 2 ] . "," . $i-> [ 3 ] , $rootmnt , "same root mount flags" ) ; last ; }',
            'start_line' => 66,
            'indent' => 1,
            'block_id' => 4
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 67,
            'src' => ' is ( $i-> [ 2 ] . "," . $i-> [ 3 ] , $rootmnt , "same root mount flags" ) ;',
            'start_line' => 67,
            'indent' => 2,
            'block_id' => 5
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 72,
            'src' => ' ok ( Cwd-> cwd ( ) , "bug#38628 legacy" ) ;',
            'start_line' => 72,
            'indent' => 0,
            'block_id' => 0
          }
