    ...
    is_deeply($stmts, [
          {
            'has_warnings' => 0,
            'end_line' => 3,
            'src' => ' @TODO = qw[ SAVEt_SAVESWITCHSTACK ] ;',
            'token_num' => 7,
            'start_line' => 3,
            'block_id' => 0,
            'indent' => 0
          ...
          },
          {
            ...
            'start_line' => 13,
            'block_id' => 0,
            'src' => ' sub read_cases { my ( $file , $func ) = @_ ; open my $fh , $file or die "$0 cannot open $file: $!" ; while ( readline $fh ) { last if/^Perl_$func/ ; } my %found ; while ( readline $fh ) { last if/^}/ ; $found { $1 } ++ if/case (SAVEt_\\w*):/ ; } close $fh or die "$0 cannot close $file: $!" ; \\ %found ; }',
            'token_num' => 70
          },
          {
            'start_line' => 14,
          ...
          },
          {
            ...
            'indent' => 1,
            'token_num' => 9,
            'src' => ' open my $fh , $file or die "$0 cannot open $file: $!" ;'
          },
          {
            'end_line' => 20,
            'has_warnings' => 1,
            ...
            'block_id' => 3,
            'token_num' => 13,
            'src' => ' while ( readline $fh ) { last if/^Perl_$func/ ; }'
          },
          {
            'token_num' => 6,
            'src' => ' last if/^Perl_$func/ ;',
            'block_id' => 4,
            'start_line' => 19,
            'indent' => 2,
            'has_warnings' => 0,
          ...
          {
            'token_num' => 23,
            'src' => ' while ( readline $fh ) { last if/^}/ ; $found { $1 } ++ if/case (SAVEt_\\w*):/ ; }',
            'start_line' => 22,
            'indent' => 1,
            'block_id' => 3,
            'has_warnings' => 1,
          ...
          },
          {
            ...
            'indent' => 2,
            'token_num' => 10,
            'src' => ' $found { $1 } ++ if/case (SAVEt_\\w*):/ ;',
            'end_line' => 24,
            'has_warnings' => 1
          },
          {
            'token_num' => 6,
            'src' => ' close $fh or die "$0 cannot close $file: $!" ;',
            'start_line' => 26,
            'indent' => 1,
            'block_id' => 3,
            'has_warnings' => 1,
          ...
          },
          {
            ...
            'block_id' => 0,
            'indent' => 0,
            'src' => ' my $leave_scope = read_cases "../scope.c" , "leave_scope" ;',
            'token_num' => 8
          },
          {
            'end_line' => 31,
            ...
            'start_line' => 31,
            'indent' => 0,
            'src' => ' my $ss_dup = read_cases "../sv.c" , "ss_dup" ;',
            'token_num' => 8
          },
          {
            'has_warnings' => 1,
            'end_line' => 33,
            'src' => ' ok scalar %$leave_scope , \'we got some\' ;',
            'token_num' => 6,
            'start_line' => 33,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'block_id' => 0,
            'token_num' => 30,
            'src' => ' for ( sort keys %$leave_scope ) { local $: : TODO = \' \' if exists $TODO { $_ } ; ok exists $$ss_dup { $_ } , "ss_dup handles $_" ; }'
          },
          {
            'indent' => 1,
            'start_line' => 36,
            'block_id' => 6,
            'token_num' => 13,
            'src' => ' local $: : TODO = \' \' if exists $TODO { $_ } ;',
            'end_line' => 36,
            'has_warnings' => 1
          },
          {
