...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => 'show_results process_options finish_tap_output',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 18
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => '1..0 # Skip: home-grown glob doesn\'t handle fancy patterns\\n',
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 18,
            'src' => ' use Maintainers qw(show_results process_options finish_tap_output) ;',
            'start_line' => 18,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 23,
            'src' => ' if ( $^O eq \'VMS\' ) { print "1..0 # Skip: home-grown glob doesn\'t handle fancy patterns\\n" ; exit 0 ; }',
            'start_line' => 20,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 21,
            'src' => ' print "1..0 # Skip: home-grown glob doesn\'t handle fancy patterns\\n" ;',
            'start_line' => 21,
            'indent' => 1,
            'block_id' => 2
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 28,
            'src' => ' { local @ARGV = qw|--checkmani| ; show_results ( process_options ( ) ) ; }',
            'start_line' => 25,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 27,
            'src' => ' show_results ( process_options ( ) ) ;',
            'start_line' => 27,
            'indent' => 1,
            'block_id' => 3
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 33,
            'src' => ' { local @ARGV = qw|--checkmani lib/ ext/| ; show_results ( process_options ( ) ) ; }',
            'start_line' => 30,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 31,
            'src' => ' local @ARGV = qw|--checkmani lib/ ext/| ;',
            'start_line' => 31,
            'indent' => 1,
            'block_id' => 4
          },
...
subtest 'get_used_modules' => sub {
    ...
    is_deeply($modules, [
          ...
          {
            'args' => '  qw ( show_results process_options finish_tap_output )',
            'name' => 'Maintainers'
          }
        ]
