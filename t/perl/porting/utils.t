...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'data' => 'installman installperl regen_perly.pl regen/uconfig_h.pl',
                   'kind' => Compiler::Lexer::Kind::T_Term
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   'name' => 'String',
                   'line' => 86,
                   'data' => 'when executing perl with \'-c $victim\'',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          {
            'token_num' => 10,
            'src' => ' my @victims = ( qw(installman installperl regen_perly.pl regen/uconfig_h.pl) ) ;',
            'indent' => 0,
            'start_line' => 55,
            'block_id' => 0,
            'has_warnings' => 0,
          ...
          },
          {
            ...
            'indent' => 0,
            'token_num' => 18,
            'src' => ' my %excuses = ( \'Porting/git-deltatool\' => \'Git::Wrapper\' , \'Porting/podtidy\' => \'Pod::Tidy\' , \'Porting/leakfinder.pl\' => \'XS::APItest\' , ) ;',
            'end_line' => 60,
            'has_warnings' => 0
          },
          {
            'token_num' => 72,
            'src' => ' foreach ( @maybe ) { if (/\\.p[lm]$/ ) { push @victims , $_ ; } else { open $fh , \'<\' , $_ or die "Can\'t open \'$_\': $!" ; my $line = < $fh > ; if ( $line =~ m{^#!(?:\\S*|/usr/bin/env\\s+)perl} || $^O eq \'VMS\' && $line =~ m{^\\$ perl} ) { push @victims , $_ ; } else { print "# $_ isn\'t a Perl script\\n" ; } } }',
            'block_id' => 0,
            'start_line' => 62,
            'indent' => 0,
            'has_warnings' => 1,
          ...
          },
          {
            ...
            'block_id' => 4,
            'indent' => 1,
            'src' => ' else { open $fh , \'<\' , $_ or die "Can\'t open \'$_\': $!" ; my $line = < $fh > ; if ( $line =~ m{^#!(?:\\S*|/usr/bin/env\\s+)perl} || $^O eq \'VMS\' && $line =~ m{^\\$ perl} ) { push @victims , $_ ; } else { print "# $_ isn\'t a Perl script\\n" ; } }',
            'token_num' => 53,
            'end_line' => 74,
            'has_warnings' => 1
          },
          ...
          },
          {
            ...
            'start_line' => 79,
            'indent' => 0,
            'src' => ' foreach my $victim ( @victims ) { SKIP : { skip ( "$victim uses $excuses{$victim}, so can\'t test with just core modules" ) if $excuses { $victim } ; my $got = runperl ( switches => [ \'-c\' ] , progfile => $victim , stderr => 1 , nolib => 1 ) ; is ( $got , "$victim syntax OK\\n" , "$victim compiles" ) or diag ( "when executing perl with \'-c $victim\'" ) ; } }',
            'token_num' => 60,
            'end_line' => 88,
            'has_warnings' => 1
          },
          ...
          },
          {
            ...
            'end_line' => 84,
            'token_num' => 24,
            'src' => ' my $got = runperl ( switches => [ \'-c\' ] , progfile => $victim , stderr => 1 , nolib => 1 ) ;',
            'start_line' => 84,
            'indent' => 2,
            'block_id' => 10
          },
