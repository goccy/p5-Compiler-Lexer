...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => 'installman installperl regen_perly.pl',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 50
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => '$victim executes code in a BEGIN block which fails for empty \\@ARGV',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 81
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => '$victim uses $excuses{$victim}, so can\'t test with just core modules',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 84
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 36,
            'src' => ' open my $fh , \'<\' , \'MANIFEST\' or die "Can\'t open MANIFEST: $!" ;',
            'start_line' => 36,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 39,
            'src' => ' while ( < $fh > ) { push @maybe , $1 if m!^(Porting/\\S+)! ; }',
            'start_line' => 37,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 38,
            'src' => ' push @maybe , $1 if m!^(Porting/\\S+)! ;',
            'start_line' => 38,
            'indent' => 1,
            'block_id' => 2
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 42,
            'src' => ' open $fh , \'<\' , \'utils.lst\' or die "Can\'t open utils.lst: $!" ;',
            'start_line' => 42,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 47,
            'src' => ' while ( < $fh > ) { die unless m!^(\\S+)! ; push @maybe , $1 ; $maybe [ $#maybe ] .= \'.com\' if $^O eq \'VMS\' ; }',
            'start_line' => 43,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 46,
            'src' => ' $maybe [ $#maybe ] .= \'.com\' if $^O eq \'VMS\' ;',
            'start_line' => 46,
            'indent' => 1,
            'block_id' => 3
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 50,
            'src' => ' my @victims = ( qw(installman installperl regen_perly.pl) ) ;',
            'start_line' => 50,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 54,
            'src' => ' my %excuses = ( \'Porting/git-deltatool\' => \'Git::Wrapper\' , \'Porting/podtidy\' => \'Pod::Tidy\' , ) ;',
            'start_line' => 51,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 73,
            'src' => ' foreach ( @maybe ) { if (/\\.p[lm]$/ ) { push @victims , $_ ; } elsif ( $_ !~ m{^x2p/a2p} ) { open $fh , \'<\' , $_ or die "Can\'t open \'$_\': $!" ; my $line = < $fh > ; if ( $line =~ m{^#!(?:\\S*|/usr/bin/env\\s+)perl} || $^O eq \'VMS\' && $line =~ m{^\\$ perl} ) { push @victims , $_ ; } else { print "# $_ isn\'t a Perl script\\n" ; } } }',
            'start_line' => 56,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 72,
            'src' => ' elsif ( $_ !~ m{^x2p/a2p} ) { open $fh , \'<\' , $_ or die "Can\'t open \'$_\': $!" ; my $line = < $fh > ; if ( $line =~ m{^#!(?:\\S*|/usr/bin/env\\s+)perl} || $^O eq \'VMS\' && $line =~ m{^\\$ perl} ) { push @victims , $_ ; } else { print "# $_ isn\'t a Perl script\\n" ; } }',
            'start_line' => 59,
            'indent' => 1,
            'block_id' => 4
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 64,
            'src' => ' open $fh , \'<\' , $_ or die "Can\'t open \'$_\': $!" ;',
            'start_line' => 64,
            'indent' => 2,
            'block_id' => 6
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 69,
            'src' => ' if ( $line =~ m{^#!(?:\\S*|/usr/bin/env\\s+)perl} || $^O eq \'VMS\' && $line =~ m{^\\$ perl} ) { push @victims , $_ ; }',
            'start_line' => 66,
            'indent' => 2,
            'block_id' => 6
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 71,
            'src' => ' else { print "# $_ isn\'t a Perl script\\n" ; }',
            'start_line' => 69,
            'indent' => 2,
            'block_id' => 6
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 70,
            'src' => ' print "# $_ isn\'t a Perl script\\n" ;',
            'start_line' => 70,
            'indent' => 3,
            'block_id' => 8
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 90,
            'src' => ' foreach my $victim ( @victims ) { SKIP : { skip ( "$victim executes code in a BEGIN block which fails for empty \\@ARGV" ) if $victim =~ m{^utils/cpanp-run-perl} ; skip ( "$victim uses $excuses{$victim}, so can\'t test with just core modules" ) if $excuses { $victim } ; my $got = runperl ( switches => [ \'-c\' ] , progfile => $victim , stderr => 1 ) ; is ( $got , "$victim syntax OK\\n" , "$victim compiles" ) ; } }',
            'start_line' => 77,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 82,
            'src' => ' skip ( "$victim executes code in a BEGIN block which fails for empty \\@ARGV" ) if $victim =~ m{^utils/cpanp-run-perl} ;',
            'start_line' => 81,
            'indent' => 2,
            'block_id' => 10
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 85,
            'src' => ' skip ( "$victim uses $excuses{$victim}, so can\'t test with just core modules" ) if $excuses { $victim } ;',
            'start_line' => 84,
            'indent' => 2,
            'block_id' => 10
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 87,
            'src' => ' my $got = runperl ( switches => [ \'-c\' ] , progfile => $victim , stderr => 1 ) ;',
            'start_line' => 87,
            'indent' => 2,
            'block_id' => 10
          },
