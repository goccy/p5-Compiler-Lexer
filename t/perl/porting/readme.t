...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'name' => 'String',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'data' => 'Can\'t get contents of Porting/ directory.\\n',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value
                 }, 'Compiler::Lexer::Token' ),
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'data' => 'Can\'t open Porting/README.pod: $!',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'kind' => Compiler::Lexer::Kind::T_Term
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'name' => 'String',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => '$file is mentioned in Porting/README.pod',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value
                 }, 'Compiler::Lexer::Token' ),
          ...
          bless( {
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'data' => 'Unicode::Collate not working on EBCDIC',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 56,
                   'name' => 'String'
          ...
          bless( {
                   'name' => 'String',
                   'line' => 57,
                   'data' => 'Files are referenced in order',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value
          ...
          bless( {
                   ...
                   'name' => 'RawString',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'data' => 'Unicode collation did not work.  Not checking order of entries.',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value
                 }, 'Compiler::Lexer::Token' ),
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'block_id' => 0,
            'token_num' => 6,
            'src' => ' close $man or die "Can\'t close MANIFEST: $!" ;',
            'end_line' => 20,
            'has_warnings' => 1
          },
          {
            'src' => ' die "Can\'t get contents of Porting/ directory.\\n" unless @porting_files > 1 ;',
            'token_num' => 7,
            'start_line' => 23,
            'block_id' => 0,
            'indent' => 0,
          ...
          },
          {
            ...
            'block_id' => 0,
            'token_num' => 15,
            'src' => ' open ( my $fh , \'<\' , \'Porting/README.pod\' ) or die ( "Can\'t open Porting/README.pod: $!" ) ;'
          },
          {
            'has_warnings' => 1,
            'end_line' => 27,
            'token_num' => 9,
            'src' => ' my ( @current_order , @sorted_order , %files_in_pod ) ;',
            'start_line' => 27,
            'indent' => 0,
            'block_id' => 0
          },
          {
            'src' => ' while ( < $fh > ) { next unless $_ =~/^=head/ ; my @matches = $_ =~ m/F<([^>]+)>/g ; for my $file ( @matches ) { $files_in_pod { $file } = 1 ; push @current_order , $file ; } }',
            'token_num' => 47,
            'start_line' => 28,
            'indent' => 0,
            'block_id' => 0,
          ...
          {
            'token_num' => 20,
            'src' => ' for my $file ( @matches ) { $files_in_pod { $file } = 1 ; push @current_order , $file ; }',
            'start_line' => 31,
            'block_id' => 3,
            'indent' => 1,
            'has_warnings' => 1,
          ...
          },
          {
            ...
            'indent' => 2,
            'token_num' => 5,
            'src' => ' push @current_order , $file ;'
          },
          {
            'src' => ' for my $file ( @porting_files ) { $file =~ s!^Porting/!! ; next if $file =~/^perl[0-9]+delta\\.pod$/ ; ok ( exists ( $files_in_pod { $file } ) , "$file is mentioned in Porting/README.pod" ) ; delete $files_in_pod { $file } ; }',
            'token_num' => 44,
            'block_id' => 0,
            'start_line' => 37,
            'indent' => 0,
          ...
          },
          {
            ...
            'end_line' => 39,
            'token_num' => 8,
            'src' => ' next if $file =~/^perl[0-9]+delta\\.pod$/ ;',
            'start_line' => 39,
            'indent' => 1,
            'block_id' => 5
          },
          {
            ...
            'start_line' => 40,
            'indent' => 1,
            'src' => ' ok ( exists ( $files_in_pod { $file } ) , "$file is mentioned in Porting/README.pod" ) ;',
            'token_num' => 13,
            'end_line' => 40,
            'has_warnings' => 1
          },
          {
            'src' => ' delete $files_in_pod { $file } ;',
            'token_num' => 6,
            'start_line' => 41,
            'indent' => 1,
            'block_id' => 5,
          ...
          },
          {
            ...
            'block_id' => 0,
            'token_num' => 14,
            'src' => ' for my $file ( keys %files_in_pod ) { fail ( "$file exists in Porting/" ) ; }',
            'end_line' => 45,
            'has_warnings' => 1
          },
          {
            'src' => ' fail ( "$file exists in Porting/" ) ;',
            'token_num' => 5,
            'start_line' => 44,
            'indent' => 1,
            'block_id' => 6,
          ...
          },
          {
            ...
            'end_line' => 52,
            'token_num' => 25,
            'src' => ' eval { require Unicode::Collate ; my $Collator = Unicode::Collate-> new ( ) ; @sorted_order = $Collator-> sort ( @current_order ) ; } ;',
            'indent' => 0,
            'start_line' => 48,
            'block_id' => 0
          },
          ...
          {
            'token_num' => 9,
            'src' => ' my $Collator = Unicode::Collate-> new ( ) ;',
            'start_line' => 50,
            'indent' => 0,
            'block_id' => 6,
            'has_warnings' => 1,
          ...
          },
          {
            ...
            'start_line' => 51,
            'indent' => 0,
            'src' => ' @sorted_order = $Collator-> sort ( @current_order ) ;',
            'token_num' => 9,
            'end_line' => 51,
            'has_warnings' => 1
          },
          {
            'token_num' => 43,
            'src' => ' if ( @sorted_order ) { local $: : TODO ; $: : TODO = "Unicode::Collate not working on EBCDIC" if $: : IS_EBCDIC || $: : IS_EBCDIC ; ok ( eq_array ( \\ @current_order , \\ @sorted_order ) , "Files are referenced in order" ) or print_right_order ( ) ; }',
            'block_id' => 0,
            'start_line' => 54,
            'indent' => 0,
            'has_warnings' => 1,
          ...
          },
          {
            ...
            'indent' => 1,
            'token_num' => 14,
            'src' => ' $: : TODO = "Unicode::Collate not working on EBCDIC" if $: : IS_EBCDIC || $: : IS_EBCDIC ;'
          },
          {
            'src' => ' ok ( eq_array ( \\ @current_order , \\ @sorted_order ) , "Files are referenced in order" ) or print_right_order ( ) ;',
            'token_num' => 18,
            'block_id' => 7,
            'start_line' => 57,
            'indent' => 1,
          ...
          },
          {
            ...
            'block_id' => 0,
            'token_num' => 8,
            'src' => ' else { note ( \'Unicode collation did not work.  Not checking order of entries.\' ) ; }',
            'end_line' => 62,
            'has_warnings' => 1
          },
          {
            'token_num' => 5,
            'src' => ' note ( \'Unicode collation did not work.  Not checking order of entries.\' ) ;',
            'block_id' => 8,
            'start_line' => 61,
            'indent' => 1,
            'has_warnings' => 1,
          ...
          },
          {
            ...
            'block_id' => 0,
            'token_num' => 112,
            'src' => ' sub print_right_order { my $max = 0 ; for ( @current_order ) { my $l = length $_ ; $max = $l if $l > $max ; } $max = 36 if $max > 36 ; note ( sprintf " N   %-${max}s %-${max}s\\n" , "Correct" , "Current" ) ; for ( 0 .. $#current_order ) { my $wrong = $sorted_order [ $_ ] eq $current_order [ $_ ] ? \'\' : \'X\' ; my $line = sprintf "%2d %1s %-${max}s %-${max}s\\n" , $_ , $wrong , $sorted_order [ $_ ] , $current_order [ $_ ] ; $line =~ s{ ((?:  ){2,})}{" " . ". " x (length($1)/2)}e if $_ & 1 ; note ( $line ) ; } }'
          },
          {
            'start_line' => 66,
            'block_id' => 9,
          ...
          },
          {
            ...
            'indent' => 1,
            'token_num' => 20,
            'src' => ' for ( @current_order ) { my $l = length $_ ; $max = $l if $l > $max ; }',
            'end_line' => 70,
            'has_warnings' => 1
          },
          {
          ...
          },
          {
            ...
            'end_line' => 72,
            'token_num' => 10,
            'src' => ' note ( sprintf " N   %-${max}s %-${max}s\\n" , "Correct" , "Current" ) ;',
            'block_id' => 9,
            'start_line' => 72,
            'indent' => 1
          },
          {
            ...
            'block_id' => 9,
            'token_num' => 65,
            'src' => ' for ( 0 .. $#current_order ) { my $wrong = $sorted_order [ $_ ] eq $current_order [ $_ ] ? \'\' : \'X\' ; my $line = sprintf "%2d %1s %-${max}s %-${max}s\\n" , $_ , $wrong , $sorted_order [ $_ ] , $current_order [ $_ ] ; $line =~ s{ ((?:  ){2,})}{" " . ". " x (length($1)/2)}e if $_ & 1 ; note ( $line ) ; }',
            'end_line' => 79,
            'has_warnings' => 1
          },
          {
            'has_warnings' => 1,
            'end_line' => 74,
            'src' => ' my $wrong = $sorted_order [ $_ ] eq $current_order [ $_ ] ? \'\' : \'X\' ;',
            'token_num' => 17,
            'indent' => 2,
            'start_line' => 74,
            'block_id' => 11
          },
          {
            ...
            'end_line' => 76,
            'token_num' => 20,
            'src' => ' my $line = sprintf "%2d %1s %-${max}s %-${max}s\\n" , $_ , $wrong , $sorted_order [ $_ ] , $current_order [ $_ ] ;',
            'block_id' => 11,
            'start_line' => 75,
            'indent' => 2
          },
          {
            ...
            'start_line' => 77,
            'block_id' => 11,
            'src' => ' $line =~ s{ ((?:  ){2,})}{" " . ". " x (length($1)/2)}e if $_ & 1 ;',
            'token_num' => 15
          },
          {
            'has_warnings' => 1,
