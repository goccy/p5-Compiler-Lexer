...
subtest 'tokenize' => sub {
    ...
    is_deeply($$tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => '$file doesn\'t use Test::\\QMore',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 32
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'Nothing in test.pl mentioned $&',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 58
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($$stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 20,
            'src' => ' my %exceptions = ( hints => "require \'./test.pl\'" , parser => \'use DieDieDie\' , proto => \'use strict\' , ) ;',
            'start_line' => 17,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 29,
            'src' => ' open my $t , \'<\' , $file or die "Can\'t open $file: $!" ;',
            'start_line' => 29,
            'indent' => 1,
            'block_id' => 1
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 32,
            'src' => ' unlike ( $contents , qr/use\\s+Test::More/ , "$file doesn\'t use Test::\\QMore" ) ;',
            'start_line' => 32,
            'indent' => 1,
            'block_id' => 1
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 39,
            'src' => ' if ( $file =~ m!comp/(.*)\\.t! && $exceptions { $1 } ) { my $allowed = $exceptions { $1 } ; $contents =~ s/\\Q$allowed//gs ; }',
            'start_line' => 36,
            'indent' => 1,
            'block_id' => 1
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 43,
            'src' => ' unlike ( $contents , qr/^\\s*use\\s+/m , "$file doesn\'t use use" ) unless $file eq \'comp/use.t\' ;',
            'start_line' => 42,
            'indent' => 1,
            'block_id' => 1
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 56,
            'src' => ' isnt ( $INC { \'./test.pl\' } , undef , \'We loaded test.pl\' ) ;',
            'start_line' => 56,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 57,
            'src' => ' ok ( "Perl rules" =~/Perl/ , \'Perl rules\' ) ;',
            'start_line' => 57,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 58,
            'src' => ' is ( eval \'$&\' , undef , \'Nothing in test.pl mentioned $&\' ) ;',
            'start_line' => 58,
            'indent' => 0,
            'block_id' => 0
          },
