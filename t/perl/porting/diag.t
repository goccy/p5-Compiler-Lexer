...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'line' => 35,
                   'name' => 'RegExp',
                   'data' => 'warn|(?<!ov)err|(\\b|_)die|croak'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'line' => 35,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => '\\b(?:(?:Simple_)?v)?FAIL[2-4]?(?:utf8f)?\\b'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'name' => 'SemiColon',
                   'data' => ';',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'line' => 46,
                   'data' => '(?<routine>ckWARN(?:\\\\d+)?reg\\\\w*|vWARN\\\\d+|$regcomp_fail_re)',
                   'name' => 'String'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'line' => 46,
    ...
    $text_re ',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'line' => 62,
                   'data' => '$reading_categorical_exceptions',
                   'name' => 'LocalVar'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
        ...
        ( $category_re (?: , $category_re)* )? \\) ',
          ...
          bless( {
                   'name' => 'RegExp',
                   'data' => '\\A(?:ext|dist|cpan|lib|t|os2/OS2)/',
                   'line' => 203,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   ...
                   'line' => 271,
                   'name' => 'RegExp',
                   'data' => '(?!^)\\b(?:$source_msg_re(?:_nocontext)?|$regcomp_re)\\s*\\('
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_RegDelim,
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => 'win32_croak_not_implemented\\('
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'name' => 'RegDelim',
                   'data' => '/',
          ...
          bless( {
                   ...
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'data' => ' in regex; marked by <-- HERE in m/%s/',
                   'name' => 'String'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'name' => 'SemiColon',
          ...
          bless( {
                   ...
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'name' => 'String',
                   'data' => 'severity is one of $severity for $key'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'data' => ':',
                   'name' => 'Colon',
          ...
          bless( {
                   'data' => 'severity is $severity for $key',
                   'name' => 'String',
                   'line' => 444,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
          ...
          bless( {
                   'name' => 'String',
                   'data' => 'categories are [$categories]',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_String,
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          {
            'src' => ' my $make_exceptions_list = ( $ARGV [ 0 ] || \'\' ) eq \'--make-exceptions-list\' and shift ;',
            'indent' => 0,
            'start_line' => 26,
            'end_line' => 27,
            'has_warnings' => 1,
          ...
          },
          {
            ...
            'token_num' => 3,
            'start_line' => 29,
            'src' => ' require \'regen/embed_lib.pl\' ;',
            'indent' => 0
          },
          {
            'token_num' => 3,
