...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          {
            'indent' => 0,
            'src' => ' my @vars = grep !/^[0123]$/ , grep/^(?:\\d+|[`\'&])$/ , sort keys %::; require \'./test.pl\' ;',
            'start_line' => 29,
            'block_id' => 0,
            'token_num' => 20,
            'end_line' => 36,
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 41,
            'src' => ' is ( scalar @vars , 0 , "extraneous vars" ) or diag ( "extra vars seen: " . join ( ", " , map "*$_" , @vars ) ) ;',
            'indent' => 0,
            'start_line' => 40
          },
          {
