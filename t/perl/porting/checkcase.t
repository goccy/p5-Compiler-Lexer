...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'block_id' => 0,
            'start_line' => 21,
            'src' => ' find ( { no_chdir => 1 , wanted => sub { my $name = $File::Find::name ; $name =~ s/^\\..// ; return if $name =~ m!\\A[Mm]akefile\\z! ; if ( $name eq \'.git\' ) { ++ $File::Find::prune ; return ; } push @{ $files { lc $name } } , $name ; } } , \'.\' ) ;',
            'indent' => 0
          },
          {
            'has_warnings' => 1,
            ...
            'start_line' => 21,
            'indent' => 0,
            'src' => ' sub { my $name = $File::Find::name ; $name =~ s/^\\..// ; return if $name =~ m!\\A[Mm]akefile\\z! ; if ( $name eq \'.git\' ) { ++ $File::Find::prune ; return ; } push @{ $files { lc $name } } , $name ; }'
          },
          {
            'start_line' => 22,
            'indent' => 1,
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 27,
            'src' => ' return if $name =~ m!\\A[Mm]akefile\\z! ;',
            'indent' => 1,
            'start_line' => 27
          },
          {
            'start_line' => 29,
            'indent' => 1,
            'src' => ' if ( $name eq \'.git\' ) { ++ $File::Find::prune ; return ; }',
            'token_num' => 13,
            'block_id' => 2,
            'has_warnings' => 1,
            'end_line' => 38
          ...
          },
          {
            ...
            'end_line' => 46,
            'has_warnings' => 1,
            'src' => ' foreach ( sort values %files ) { is ( @$_ , 1 , join ( ", " , @$_ ) ) or do { note ( $_ ) foreach @$_ ; } ; }',
            'indent' => 0,
            'start_line' => 43
          },
          {
            'src' => ' is ( @$_ , 1 , join ( ", " , @$_ ) ) or do { note ( $_ ) foreach @$_ ; } ;',
            'indent' => 1,
            'start_line' => 44,
            'token_num' => 25,
            'block_id' => 4,
