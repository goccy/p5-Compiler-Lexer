...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'data' => 'compiler not available (cross-compiling)',
                   'kind' => Compiler::Lexer::Kind::T_Term
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'name' => 'RightParenthesis',
...
',
          ...
          bless( {
                   'name' => 'String',
                   'line' => 69,
                   'data' => 'Failing closing code file: $!\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'data' => ' -DPERL_NO_INLINE_FUNCTIONS',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_RawString
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'data' => '$Config{\'cc\'} $out_opt$tmp_exe $ccflags $tmp.c $libs $errornull',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'line' => 104,
                   'name' => 'String'
                 }, 'Compiler::Lexer::Token' ),
          ...
          bless( {
                   ...
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => '$Config{\'cc\'} /include=($COREincdir) $tmp.c',
                   'type' => Compiler::Lexer::TokenType::T_String
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'has_warnings' => 0,
          ...
          bless( {
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => '\\$ SET MESSAGE/NOFACILITY/NOSEVERITY/NOIDENT/NOTEXT\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'name' => 'String',
          ...
          bless( {
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'data' => '\\$ IF \\$SEVERITY .NE. 1 THEN EXIT 44\\n',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 114,
                   'name' => 'String'
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          {
            'token_num' => 8,
            'src' => ' unshift @INC , ".." if -f "../TestInit.pm" ;',
            'block_id' => 1,
            'start_line' => 17,
            'indent' => 1,
            'has_warnings' => 0,
          ...
          {
            'src' => ' if ( $Config { \'usecrosscompile\' } && ! can_run ( $Config { \'cc\' } ) ) { skip_all ( "compiler not available (cross-compiling)" ) ; }',
            'token_num' => 23,
            'indent' => 0,
            'start_line' => 28,
            'block_id' => 0,
          ...
          },
          {
            ...
            'start_line' => 29,
            'indent' => 1,
            'src' => ' skip_all ( "compiler not available (cross-compiling)" ) ;',
            'token_num' => 5
          },
          {
            'end_line' => 32,
          ...
          {
            'src' => ' my $VERBOSE = grep { $_ eq \'-v\' } @ARGV ;',
            'token_num' => 11,
            'indent' => 0,
            'start_line' => 34,
            'block_id' => 0,
          ...
          },
          {
            ...
            'start_line' => 36,
            'block_id' => 0,
            'src' => ' ok ( try_compile_and_link ( q{#include "EXTERN.h"
#include "perl.h"
#include "XSUB.h"
...
int main(int argc, char **argv) {
  return 0;
          ...
          },
          {
            ...
            'indent' => 1,
            'block_id' => 4,
            'src' => ' my $ld_exeext = ( $^O eq \'cygwin\' || $^O eq \'MSWin32\' || $^O eq \'os2\' && $Config { ldflags } =~/-Zexe\\b/ ) ? \'.exe\' : ( ( $^O eq \'vos\' ) ? $Config { exe_ext } : \'\' ) ;',
            'token_num' => 43
          },
          {
            'start_line' => 55,
          ...
          {
            'src' => ' my $obj_ext = $Config { obj_ext } || ".o" ;',
            'token_num' => 10,
            'indent' => 1,
            'start_line' => 62,
            'block_id' => 4,
          ...
          },
          {
            ...
            'block_id' => 4,
            'token_num' => 268,
            'src' => ' if ( open ( my $tmpc , ">$tmp.c" ) ) { print $tmpc $c ; unless ( close ( $tmpc ) ) { chdir ( $cwd ) ; rmtree ( $tempdir ) ; warn "Failing closing code file: $!\\n" if $VERBOSE ; return 0 ; } my $COREincdir = File::Spec-> catdir ( File::Spec-> updir ) ; my $ccflags = $Config { \'ccflags\' } . \' \' . "-I$COREincdir" . \' -DPERL_NO_INLINE_FUNCTIONS\' ; if ( $^O eq "MSWin32" ) { $ccflags .= " -I../win32 -I../win32/include" ; } my $libs = \'\' ; if ( $^O eq "MSWin32" && $Config { cc } =~/\\bcl\\b/i ) { $libs = " /link $Config{\'libs\'}" ; } my $null = File::Spec-> devnull ; my $errornull = $VERBOSE ? \'\' : ">$null 2>$null" ; my $out_opt = "-o " ; if ( $^O eq "MSWin32" && $Config { cc } =~/\\bcl\\b/i ) { $out_opt = "/Fe" ; } my $tmp_exe = "$tmp$ld_exeext" ; my $cccmd = "$Config{\'cc\'} $out_opt$tmp_exe $ccflags $tmp.c $libs $errornull" ; if ( $^O eq \'VMS\' ) { $cccmd = "$Config{\'cc\'} /include=($COREincdir) $tmp.c" ; } if ( $^O eq \'VMS\' ) { open ( my $cmdfile , ">$tmp.com" ) ; print $cmdfile "\\$ SET MESSAGE/NOFACILITY/NOSEVERITY/NOIDENT/NOTEXT\\n" ; print $cmdfile "\\$ $cccmd\\n" ; print $cmdfile "\\$ IF \\$SEVERITY .NE. 1 THEN EXIT 44\\n" ; close $cmdfile ; system ( "\\@ $tmp.com" ) ; $ok = $? == 0 ; chdir ( $cwd ) ; rmtree ( $tempdir ) ; } else { printf "cccmd = $cccmd\\n" if $VERBOSE ; my $res = system ( $cccmd ) ; $ok = defined ( $res ) && $res == 0 && -s $tmp_exe && -x _ ; chdir ( $cwd ) ; rmtree ( $tempdir ) ; } }',
            'end_line' => 130,
            'has_warnings' => 1
          },
          {
          ...
          {
            'src' => ' unless ( close ( $tmpc ) ) { chdir ( $cwd ) ; rmtree ( $tempdir ) ; warn "Failing closing code file: $!\\n" if $VERBOSE ; return 0 ; }',
            'token_num' => 27,
            'block_id' => 5,
            'start_line' => 66,
            'indent' => 2,
          ...
          },
          {
            ...
            'block_id' => 6,
            'token_num' => 5,
            'src' => ' warn "Failing closing code file: $!\\n" if $VERBOSE ;',
            'end_line' => 69,
            'has_warnings' => 1
          },
          {
          ...
          },
          {
            'has_warnings' => 1,
            'end_line' => 73,
            'src' => ' my $COREincdir = File::Spec-> catdir ( File::Spec-> updir ) ;',
            'token_num' => 12,
            'block_id' => 5,
            'start_line' => 73,
            'indent' => 2
          },
          {
            ...
            'indent' => 2,
            'block_id' => 5,
            'src' => ' my $ccflags = $Config { \'ccflags\' } . \' \' . "-I$COREincdir" . \' -DPERL_NO_INLINE_FUNCTIONS\' ;',
            'token_num' => 14
          },
          {
            'indent' => 2,
            ...
            'block_id' => 5,
            'token_num' => 12,
            'src' => ' if ( $^O eq "MSWin32" ) { $ccflags .= " -I../win32 -I../win32/include" ; }',
            'end_line' => 80,
            'has_warnings' => 1
          },
          {
            'has_warnings' => 1,
            'end_line' => 79,
            'src' => ' $ccflags .= " -I../win32 -I../win32/include" ;',
            'token_num' => 4,
            'indent' => 3,
            'start_line' => 79,
            'block_id' => 7
          ...
          },
          {
            ...
            'block_id' => 5,
            'indent' => 2,
            'src' => ' if ( $^O eq "MSWin32" && $Config { cc } =~/\\bcl\\b/i ) { $libs = " /link $Config{\'libs\'}" ; }',
            'token_num' => 22
          },
          {
            'end_line' => 87,
          ...
          },
          {
            ...
            'end_line' => 92,
            'token_num' => 9,
            'src' => ' my $errornull = $VERBOSE ? \'\' : ">$null 2>$null" ;',
            'indent' => 2,
            'start_line' => 92,
            'block_id' => 5
          },
          ...
          {
            'src' => ' if ( $^O eq "MSWin32" && $Config { cc } =~/\\bcl\\b/i ) { $out_opt = "/Fe" ; }',
            'token_num' => 22,
            'indent' => 2,
            'start_line' => 98,
            'block_id' => 5,
          ...
          },
          {
            ...
            'block_id' => 5,
            'token_num' => 5,
            'src' => ' my $tmp_exe = "$tmp$ld_exeext" ;'
          },
          {
            'has_warnings' => 0,
            'end_line' => 104,
            'token_num' => 5,
            'src' => ' my $cccmd = "$Config{\'cc\'} $out_opt$tmp_exe $ccflags $tmp.c $libs $errornull" ;',
            'indent' => 2,
            'start_line' => 104,
            'block_id' => 5
          },
          {
            ...
            'start_line' => 106,
            'indent' => 2,
            'src' => ' if ( $^O eq \'VMS\' ) { $cccmd = "$Config{\'cc\'} /include=($COREincdir) $tmp.c" ; }',
            'token_num' => 12
          },
          {
            'end_line' => 107,
            ...
            'block_id' => 10,
            'indent' => 3,
            'src' => ' $cccmd = "$Config{\'cc\'} /include=($COREincdir) $tmp.c" ;',
            'token_num' => 4
          },
          {
            'end_line' => 120,
            ...
            'block_id' => 5,
            'token_num' => 52,
            'src' => ' if ( $^O eq \'VMS\' ) { open ( my $cmdfile , ">$tmp.com" ) ; print $cmdfile "\\$ SET MESSAGE/NOFACILITY/NOSEVERITY/NOIDENT/NOTEXT\\n" ; print $cmdfile "\\$ $cccmd\\n" ; print $cmdfile "\\$ IF \\$SEVERITY .NE. 1 THEN EXIT 44\\n" ; close $cmdfile ; system ( "\\@ $tmp.com" ) ; $ok = $? == 0 ; chdir ( $cwd ) ; rmtree ( $tempdir ) ; }'
          },
          {
            'end_line' => 111,
            'has_warnings' => 0,
          ...
          },
          {
            ...
            'start_line' => 112,
            'indent' => 3,
            'src' => ' print $cmdfile "\\$ SET MESSAGE/NOFACILITY/NOSEVERITY/NOIDENT/NOTEXT\\n" ;',
            'token_num' => 4,
            'end_line' => 112,
            'has_warnings' => 1
          },
          ...
          {
            'src' => ' print $cmdfile "\\$ IF \\$SEVERITY .NE. 1 THEN EXIT 44\\n" ;',
            'token_num' => 4,
            'indent' => 3,
            'start_line' => 114,
            'block_id' => 11,
          ...
          },
          {
            ...
            'block_id' => 12,
            'indent' => 3,
            'src' => ' my $res = system ( $cccmd ) ;',
            'token_num' => 8
          },
          {
            'src' => ' $ok = defined ( $res ) && $res == 0 && -s $tmp_exe && -x _ ;',
            'token_num' => 17,
            'block_id' => 12,
            'start_line' => 125,
            'indent' => 3,
