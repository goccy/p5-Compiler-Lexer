...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'PERL_STATIC_EXT must be set to the list of static extensions',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 19
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'FindExt just plain broken for static perl.',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 23
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => '"config" dynamic + static + nonxs',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 54
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => '"found" dynamic + static + nonxs',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 56
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'We find the same number of $type',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 62
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'We find the same list of $type',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 63
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 7,
            'src' => ' skip_all ( \'FindExt not portable\' ) if $^O eq \'VMS\' ;',
            'start_line' => 6,
            'indent' => 1,
            'block_id' => 1
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 20,
            'src' => ' if ( $^O eq "MSWin32" && ! defined $ENV { PERL_STATIC_EXT } ) { skip_all "PERL_STATIC_EXT must be set to the list of static extensions" ; }',
            'start_line' => 18,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 19,
            'src' => ' skip_all "PERL_STATIC_EXT must be set to the list of static extensions" ;',
            'start_line' => 19,
            'indent' => 1,
            'block_id' => 2
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 24,
            'src' => ' unless ( defined $Config { usedl } ) { skip_all "FindExt just plain broken for static perl." ; }',
            'start_line' => 22,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 23,
            'src' => ' skip_all "FindExt just plain broken for static perl." ;',
            'start_line' => 23,
            'indent' => 1,
            'block_id' => 3
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 29,
            'src' => ' FindExt::apply_config ( \\ %Config ) ;',
            'start_line' => 29,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 33,
            'src' => ' FindExt::set_static_extensions ( split \' \' , $ENV { PERL_STATIC_EXT } ) if $^O eq "MSWin32" ;',
            'start_line' => 33,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 34,
            'src' => ' FindExt::set_static_extensions ( split \' \' , $Config { static_ext } ) unless $^O eq "MSWin32" ;',
            'start_line' => 34,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 44,
            'src' => ' { foreach my $type ( qw(static dynamic nonxs) ) { push @found_built , eval "FindExt::${type}_ext()" ; push @config_built , split \' \' , $Config { "${type}_ext" } ; } }',
            'start_line' => 39,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 41,
            'src' => ' push @found_built , eval "FindExt::${type}_ext()" ;',
            'start_line' => 41,
            'indent' => 2,
            'block_id' => 5
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 42,
            'src' => ' push @config_built , split \' \' , $Config { "${type}_ext" } ;',
            'start_line' => 42,
            'indent' => 2,
            'block_id' => 5
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 45,
            'src' => ' @config_built = sort @config_built ;',
            'start_line' => 45,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 46,
            'src' => ' @found_built = sort @found_built ;',
            'start_line' => 46,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 64,
            'src' => ' foreach ( [ \'static_ext\' , [ FindExt::static_ext ( ) ] , $Config { static_ext } ] , [ \'nonxs_ext\' , [ FindExt::nonxs_ext ( ) ] , $Config { nonxs_ext } ] , [ \'known_extensions\' , [ FindExt::known_extensions ( ) ] , $Config { known_extensions } ] , [ \'"config" dynamic + static + nonxs\' , \\ @config_built , $Config { extensions } ] , [ \'"found" dynamic + static + nonxs\' , \\ @found_built , join " " , FindExt::extensions ( ) ] , ) { my ( $type , $found , $config ) = @$_ ; my @config = sort split \' \' , $config ; is ( scalar @$found , scalar @config , "We find the same number of $type" ) ; is ( "@$found" , "@config" , "We find the same list of $type" ) ; }',
            'start_line' => 48,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 60,
            'src' => ' my @config = sort split \' \' , $config ;',
            'start_line' => 60,
            'indent' => 1,
            'block_id' => 6
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 62,
            'src' => ' is ( scalar @$found , scalar @config , "We find the same number of $type" ) ;',
            'start_line' => 61,
            'indent' => 1,
            'block_id' => 6
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 63,
            'src' => ' is ( "@$found" , "@config" , "We find the same list of $type" ) ;',
            'start_line' => 63,
            'indent' => 1,
            'block_id' => 6
          }
