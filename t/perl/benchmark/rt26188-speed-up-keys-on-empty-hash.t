...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'Speed difference between $key1 and $key2 is less than 25%',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'Checking the count of hash keys in an empty hash (global)',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 71
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'Checking the list of hash keys in an empty hash (global)',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 73
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'Checking the count of hash keys in an empty hash (lexical)',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 75
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'Checking the list of hash keys in an empty hash (lexical)',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 77
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'Checking the count of hash keys in an empty hash, global vs. lexical',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 79
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'Checking the list of hash keys in an empty hash, global vs. lexical',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 81
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 39,
            'src' => ' delete @h_small { keys %h_small } ;',
            'start_line' => 39,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 41,
            'src' => ' delete @l_small { keys %l_small } ;',
            'start_line' => 41,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 53,
            'src' => ' my $res = timethese shift || -3 , { big => \'1 for keys %h_big\' , small => \'1 for keys %h_small\' , scalar_big => \'$a = keys %h_big\' , scalar_small => \'$a = keys %h_small\' , lex_big => \'1 for keys %l_big\' , lex_small => \'1 for keys %l_small\' , lex_scalar_big => \'$a = keys %l_big\' , lex_scalar_small => \'$a = keys %l_small\' , } , \'none\' ;',
            'start_line' => 43,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 57,
            'src' => ' sub iters_per_second { $_ [ 0 ]-> iters / $_ [ 0 ]-> cpu_p }',
            'start_line' => 55,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 69,
            'src' => ' sub about_as_fast_ok { my ( $res , $key1 , $key2 , $name ) = @_ ; $name ||= "Speed difference between $key1 and $key2 is less than 25%" ; my %iters_per_second = map { $_ => iters_per_second ( $res-> { $_ } ) } ( $key1 , $key2 ) ; my $ratio = abs ( 1 - $iters_per_second { $key1 } / ( $iters_per_second { $key2 } || 1 ) ) ; if ( ! cmp_ok ( $ratio , \'<\' , 0.25 , $name ) ) { diag ( sprintf "%20s: %12.2f/s\\n" , $key1 , $iters_per_second { $key1 } ) ; diag ( sprintf "%20s: %12.2f/s\\n" , $key2 , $iters_per_second { $key2 } ) ; } ; } ;',
            'start_line' => 59,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 61,
            'src' => ' $name ||= "Speed difference between $key1 and $key2 is less than 25%" ;',
            'start_line' => 61,
            'indent' => 1,
            'block_id' => 2
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 62,
            'src' => ' my %iters_per_second = map { $_ => iters_per_second ( $res-> { $_ } ) } ( $key1 , $key2 ) ;',
            'start_line' => 62,
            'indent' => 1,
            'block_id' => 2
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 64,
            'src' => ' my $ratio = abs ( 1 - $iters_per_second { $key1 } / ( $iters_per_second { $key2 } || 1 ) ) ;',
            'start_line' => 64,
            'indent' => 1,
            'block_id' => 2
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 68,
            'src' => ' if ( ! cmp_ok ( $ratio , \'<\' , 0.25 , $name ) ) { diag ( sprintf "%20s: %12.2f/s\\n" , $key1 , $iters_per_second { $key1 } ) ; diag ( sprintf "%20s: %12.2f/s\\n" , $key2 , $iters_per_second { $key2 } ) ; } ;',
            'start_line' => 65,
            'indent' => 1,
            'block_id' => 2
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 71,
            'src' => ' about_as_fast_ok ( $res , \'scalar_big\' , \'scalar_small\' , "Checking the count of hash keys in an empty hash (global)" ) ;',
            'start_line' => 71,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 73,
            'src' => ' about_as_fast_ok ( $res , \'big\' , \'small\' , "Checking the list of hash keys in an empty hash (global)" ) ;',
            'start_line' => 73,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 75,
            'src' => ' about_as_fast_ok ( $res , \'lex_scalar_big\' , \'lex_scalar_small\' , "Checking the count of hash keys in an empty hash (lexical)" ) ;',
            'start_line' => 75,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 77,
            'src' => ' about_as_fast_ok ( $res , \'lex_big\' , \'lex_small\' , "Checking the list of hash keys in an empty hash (lexical)" ) ;',
            'start_line' => 77,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 79,
            'src' => ' about_as_fast_ok ( $res , \'lex_scalar_big\' , \'scalar_big\' , "Checking the count of hash keys in an empty hash, global vs. lexical" ) ;',
            'start_line' => 79,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 81,
            'src' => ' about_as_fast_ok ( $res , \'lex_big\' , \'big\' , "Checking the list of hash keys in an empty hash, global vs. lexical" ) ;',
            'start_line' => 81,
            'indent' => 0,
            'block_id' => 0
          }
