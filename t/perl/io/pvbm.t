...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'untie(PVBM) doesn\\\'t segfault',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 35
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'tied(PVBM) doesn\\\'t segfault',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 36
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'chown() not implemented on Win32',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 70
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 31,
            'src' => ' { my $which ; { package Tie ; sub TIEHANDLE { $which = \'TIEHANDLE\' } sub TIESCALAR { $which = \'TIESCALAR\' } } my $pvbm = PVBM ; tie $pvbm , \'Tie\' ; is ( $which , \'TIESCALAR\' , \'PVBM gets TIESCALAR\' ) ; }',
            'start_line' => 19,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 26,
            'src' => ' { package Tie ; sub TIEHANDLE { $which = \'TIEHANDLE\' } sub TIESCALAR { $which = \'TIESCALAR\' } }',
            'start_line' => 21,
            'indent' => 1,
            'block_id' => 5
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 24,
            'src' => ' sub TIEHANDLE { $which = \'TIEHANDLE\' }',
            'start_line' => 24,
            'indent' => 2,
            'block_id' => 6
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 25,
            'src' => ' sub TIESCALAR { $which = \'TIESCALAR\' }',
            'start_line' => 25,
            'indent' => 2,
            'block_id' => 6
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 30,
            'src' => ' is ( $which , \'TIESCALAR\' , \'PVBM gets TIESCALAR\' ) ;',
            'start_line' => 30,
            'indent' => 1,
            'block_id' => 5
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 37,
            'src' => ' { my $pvbm = PVBM ; ok ( scalar eval { untie $pvbm ; 1 } , \'untie(PVBM) doesn\\\'t segfault\' ) ; ok ( scalar eval { tied $pvbm ; 1 } , \'tied(PVBM) doesn\\\'t segfault\' ) ; }',
            'start_line' => 33,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 35,
            'src' => ' ok ( scalar eval { untie $pvbm ; 1 } , \'untie(PVBM) doesn\\\'t segfault\' ) ;',
            'start_line' => 35,
            'indent' => 1,
            'block_id' => 9
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 36,
            'src' => ' ok ( scalar eval { tied $pvbm ; 1 } , \'tied(PVBM) doesn\\\'t segfault\' ) ;',
            'start_line' => 36,
            'indent' => 1,
            'block_id' => 9
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 42,
            'src' => ' ok ( scalar eval { pipe $pvbm , PIPE ; } , \'pipe(PVBM, ) succeeds\' ) ;',
            'start_line' => 42,
            'indent' => 1,
            'block_id' => 10
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 45,
            'src' => ' ok ( scalar eval { pipe PIPE , $pvbm ; } , \'pipe(, PVBM) succeeds\' ) ;',
            'start_line' => 45,
            'indent' => 1,
            'block_id' => 10
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 48,
            'src' => ' ok ( ! eval { pipe \\ $pvbm , PIPE ; } , \'pipe(PVBM ref, ) fails\' ) ;',
            'start_line' => 48,
            'indent' => 1,
            'block_id' => 10
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 49,
            'src' => ' ok ( ! eval { pipe PIPE , \\ $pvbm ; } , \'pipe(, PVBM ref) fails\' ) ;',
            'start_line' => 49,
            'indent' => 1,
            'block_id' => 10
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 51,
            'src' => ' ok ( ! eval { truncate $pvbm , 0 } , \'truncate(PVBM) fails\' ) ;',
            'start_line' => 51,
            'indent' => 1,
            'block_id' => 10
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 52,
            'src' => ' ok ( ! eval { truncate \\ $pvbm , 0 } , \'truncate(PVBM ref) fails\' ) ;',
            'start_line' => 52,
            'indent' => 1,
            'block_id' => 10
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 54,
            'src' => ' ok ( ! eval { stat $pvbm } , \'stat(PVBM) fails\' ) ;',
            'start_line' => 54,
            'indent' => 1,
            'block_id' => 10
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 55,
            'src' => ' ok ( ! eval { stat \\ $pvbm } , \'stat(PVBM ref) fails\' ) ;',
            'start_line' => 55,
            'indent' => 1,
            'block_id' => 10
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 57,
            'src' => ' ok ( ! eval { lstat $pvbm } , \'lstat(PVBM) fails\' ) ;',
            'start_line' => 57,
            'indent' => 1,
            'block_id' => 10
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 58,
            'src' => ' ok ( ! eval { lstat \\ $pvbm } , \'lstat(PVBM ref) fails\' ) ;',
            'start_line' => 58,
            'indent' => 1,
            'block_id' => 10
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 60,
            'src' => ' ok ( ! eval { chdir $pvbm } , \'chdir(PVBM) fails\' ) ;',
            'start_line' => 60,
            'indent' => 1,
            'block_id' => 10
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 61,
            'src' => ' ok ( ! eval { chdir \\ $pvbm } , \'chdir(pvbm ref) fails\' ) ;',
            'start_line' => 61,
            'indent' => 1,
            'block_id' => 10
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 63,
            'src' => ' ok ( ! eval { close $pvbm } , \'close(PVBM) fails\' ) ;',
            'start_line' => 63,
            'indent' => 1,
            'block_id' => 10
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 64,
            'src' => ' ok ( ! eval { close $pvbm } , \'close(PVBM ref) fails\' ) ;',
            'start_line' => 64,
            'indent' => 1,
            'block_id' => 10
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 66,
            'src' => ' ok ( ! eval { chmod 0600 , $pvbm } , \'chmod(PVBM) fails\' ) ;',
            'start_line' => 66,
            'indent' => 1,
            'block_id' => 10
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 67,
            'src' => ' ok ( ! eval { chmod 0600 , \\ $pvbm } , \'chmod(PVBM ref) fails\' ) ;',
            'start_line' => 67,
            'indent' => 1,
            'block_id' => 10
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 70,
            'src' => ' skip ( \'chown() not implemented on Win32\' , 2 ) if $^O eq \'MSWin32\' ;',
            'start_line' => 70,
            'indent' => 2,
            'block_id' => 11
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 71,
            'src' => ' ok ( ! eval { chown 0 , 0 , $pvbm } , \'chown(PVBM) fails\' ) ;',
            'start_line' => 71,
            'indent' => 2,
            'block_id' => 11
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 72,
            'src' => ' ok ( ! eval { chown 0 , 0 , \\ $pvbm } , \'chown(PVBM ref) fails\' ) ;',
            'start_line' => 72,
            'indent' => 2,
            'block_id' => 11
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 75,
            'src' => ' ok ( ! eval { utime 0 , 0 , $pvbm } , \'utime(PVBM) fails\' ) ;',
            'start_line' => 75,
            'indent' => 1,
            'block_id' => 10
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 76,
            'src' => ' ok ( ! eval { utime 0 , 0 , \\ $pvbm } , \'utime(PVBM ref) fails\' ) ;',
            'start_line' => 76,
            'indent' => 1,
            'block_id' => 10
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 79,
            'src' => ' ok ( ! eval { readline $pvbm } , \'readline(PVBM) fails\' ) ;',
            'start_line' => 79,
            'indent' => 1,
            'block_id' => 10
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 80,
            'src' => ' ok ( ! eval { readline \\ $pvbm } , \'readline(PVBM ref) fails\' ) ;',
            'start_line' => 80,
            'indent' => 1,
            'block_id' => 10
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 82,
            'src' => ' ok ( ! eval { open $pvbm , \'<\' , \'none.such\' } , \'open(PVBM) fails\' ) ;',
            'start_line' => 82,
            'indent' => 1,
            'block_id' => 10
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 83,
            'src' => ' ok ( ! eval { open \\ $pvbm , \'<\' , \'none.such\' , } , \'open(PVBM ref) fails\' ) ;',
            'start_line' => 83,
            'indent' => 1,
            'block_id' => 10
          }
