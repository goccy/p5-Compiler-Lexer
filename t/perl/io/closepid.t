...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'line' => 32,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => 'only matters for waitpid or wait4',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value
                 }, 'Compiler::Lexer::Token' ),
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'end_line' => 14,
            'token_num' => 13,
            'src' => ' watchdog ( 10 , $^O eq \'MSWin32\' ? "alarm" : \'\' ) ;',
            'indent' => 0,
            'start_line' => 14,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'end_line' => 31,
            'token_num' => 15,
            'src' => ' skip ( "Not relevant to $^O" , 3 ) if $^O eq "MSWin32" || $^O eq "VMS" ;',
            'indent' => 1,
            'start_line' => 30,
            'block_id' => 3
          },
          {
            ...
            'start_line' => 32,
            'indent' => 1,
            'src' => ' skip ( "only matters for waitpid or wait4" , 3 ) unless $Config { d_waitpid } || $Config { d_wait4 } ;',
            'token_num' => 17,
            'end_line' => 33,
            'has_warnings' => 1
          },
          {
            'src' => ' open my $savein , "<&" , \\ *STDIN ;',
            'token_num' => 9,
            'indent' => 1,
            'start_line' => 37,
            'block_id' => 3,
          ...
          },
          {
            ...
            'start_line' => 38,
            'block_id' => 3,
            'src' => ' my $pid = open my $fh1 , "-|" , $perl , "-e" , "sleep 50" ;',
            'token_num' => 15
          },
          {
            'token_num' => 7,
            'src' => ' ok ( $pid , "open a pipe" ) ;',
            'start_line' => 39,
            'block_id' => 3,
            'indent' => 1,
            'has_warnings' => 1,
          ...
          },
          {
            ...
            'end_line' => 41,
            'token_num' => 14,
            'src' => ' ok ( open ( STDIN , "<&=" , $fh1 ) , "dup the pipe" ) ;',
            'indent' => 1,
            'start_line' => 41,
            'block_id' => 3
          },
          {
            ...
            'start_line' => 45,
            'indent' => 1,
            'src' => ' ok ( close ( $fh1 ) , "close the original" ) ;',
            'token_num' => 10
          },
          {
            'has_warnings' => 1,
            'end_line' => 46,
            'src' => ' kill $killsig , $pid ;',
            'token_num' => 5,
            'start_line' => 46,
            'indent' => 1,
            'block_id' => 3
