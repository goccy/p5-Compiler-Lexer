...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'stdio not supported for this script',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 39
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'various portability issues',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 56
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'read/close: sig handler close status',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 82
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'print/close: sig handler close status',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 105
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 24,
            'src' => ' eval { pipe my $in , my $out ; $piped = 1 ; } ;',
            'start_line' => 21,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 28,
            'src' => ' if ( ! $piped ) { skip_all ( \'pipe not implemented\' ) ; exit 0 ; }',
            'start_line' => 25,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 26,
            'src' => ' skip_all ( \'pipe not implemented\' ) ;',
            'start_line' => 26,
            'indent' => 1,
            'block_id' => 2
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 32,
            'src' => ' unless ( exists $Config { \'d_alarm\' } ) { skip_all ( \'alarm not implemented\' ) ; exit 0 ; }',
            'start_line' => 29,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 30,
            'src' => ' skip_all ( \'alarm not implemented\' ) ;',
            'start_line' => 30,
            'indent' => 1,
            'block_id' => 3
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 41,
            'src' => ' if ( exists $ENV { PERLIO } && $ENV { PERLIO } =~/stdio/ ) { skip_all ( \'stdio not supported for this script\' ) ; exit 0 ; }',
            'start_line' => 38,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 39,
            'src' => ' skip_all ( \'stdio not supported for this script\' ) ;',
            'start_line' => 39,
            'indent' => 1,
            'block_id' => 4
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 58,
            'src' => ' if ( $^O eq \'VMS\' || $^O eq \'MSWin32\' || $^O eq \'cygwin\' || $^O =~/freebsd/ || ( $^O eq \'solaris\' && $Config { osvers } eq \'2.8\' ) || ( ( int ( $] * 1000 ) & 1 ) == 0 ) ) { skip_all ( \'various portability issues\' ) ; exit 0 ; }',
            'start_line' => 52,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 56,
            'src' => ' skip_all ( \'various portability issues\' ) ;',
            'start_line' => 56,
            'indent' => 1,
            'block_id' => 5
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 71,
            'src' => ' sub fresh_io { undef $in ; undef $out ; pipe $in , $out ; $sigst = "" ; }',
            'start_line' => 67,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 78,
            'src' => ' $SIG { ALRM } = sub { $sigst = close ( $in ) ? "ok" : "nok" } ;',
            'start_line' => 78,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 82,
            'src' => ' is ( $sigst , \'ok\' , \'read/close: sig handler close status\' ) ;',
            'start_line' => 82,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 83,
            'src' => ' ok ( ! $st , \'read/close: read status\' ) ;',
            'start_line' => 83,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 84,
            'src' => ' ok ( ! close ( $in ) , \'read/close: close status\' ) ;',
            'start_line' => 84,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 93,
            'src' => ' ok ( ! $st , \'read/die: read status\' ) ;',
            'start_line' => 93,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 94,
            'src' => ' ok ( close ( $in ) , \'read/die: close status\' ) ;',
            'start_line' => 94,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 99,
            'src' => ' $SIG { ALRM } = sub { $sigst = close ( $out ) ? "ok" : "nok" } ;',
            'start_line' => 99,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 105,
            'src' => ' is ( $sigst , \'nok\' , \'print/close: sig handler close status\' ) ;',
            'start_line' => 105,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 106,
            'src' => ' ok ( ! $st , \'print/close: print status\' ) ;',
            'start_line' => 106,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 107,
            'src' => ' ok ( ! close ( $out ) , \'print/close: close status\' ) ;',
            'start_line' => 107,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 118,
            'src' => ' ok ( ! $st , \'print/die: print status\' ) ;',
            'start_line' => 118,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 121,
            'src' => ' ok ( ! eval { close ( $out ) } , \'print/die: close status\' ) ;',
            'start_line' => 121,
            'indent' => 0,
            'block_id' => 0
          },
