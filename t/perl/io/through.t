...
subtest 'tokenize' => sub {
    ...
    is_deeply($$tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'VMS too picky about line endings for record-oriented pipes',
...
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'length with wrc=$write_c, rdc=$read_c, $how_w, $how_r, $why',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 62
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'content with wrc=$write_c, rdc=$read_c, $how_w, $how_r, $why',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 63
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => '$Perl -we "$set_out;print for grep length, split /(.{1,$write_c})/s, qq($quoted)"',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 72
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => '$Perl -we "$set_out;eval qq(\\\\x24\\\\x7c = 1) or die;print for grep length, split /(.{1,$write_c})/s, qq($quoted)"',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 75
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => '$Perl -we "$set_out;eval qq(sub w {syswrite STDOUT, \\\\x24_} 1) or die; w() for grep length, split /(.{1,$write_c})/s, qq($quoted)"',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 78
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => '$Perl -we "eval qq(\\\\x24\\\\x7c = 1) or die; binmode STDOUT; sleep 1, print for split //, qq(a\\nb\\n\\nc\\n\\n\\n)"',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 115
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => '97 10 98 10 10 99 10 10 10',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 124
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => 'readline_all readline read sysread',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 134
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => 'print print/flush syswrite',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 136
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($$stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 8,
            'src' => ' skip_all ( "VMS too picky about line endings for record-oriented pipes" ) if $^O eq \'VMS\' ;',
            'start_line' => 7,
            'indent' => 1,
            'block_id' => 1
          },
...
z
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 23,
            'src' => ' my $t1 = { data => $data , write_c => [ 1 , 2 , length $data ] , read_c => [ 1 , 2 , 3 , length $data ] } ;',
            'start_line' => 23,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 24,
            'src' => ' my $t2 = { data => $data2 , write_c => [ 1 , 2 , length $data2 ] , read_c => [ 1 , 2 , 3 , length $data2 ] } ;',
            'start_line' => 24,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 28,
            'src' => ' $_-> { write_c } = [ 1 .. length ( $_-> { data } ) ] , $_-> { read_c } = [ 1 .. length ( $_-> { data } ) + 1 , 0xe000 ] for ( ) ;',
            'start_line' => 26,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 31,
            'src' => ' $c += @{ $_-> { write_c } } * ( 1 + 3 * @{ $_-> { read_c } } ) for $t1 , $t2 ;',
            'start_line' => 31,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 40,
            'src' => ' $set_out = "binmode STDOUT, \':crlf\'" if defined $main::use_crlf && $main::use_crlf == 1 ;',
            'start_line' => 39,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 64,
            'src' => ' sub testread ( $$$$$$$ ) { my ( $fh , $str , $read_c , $how_r , $write_c , $how_w , $why ) = @_ ; my $buf = \'\' ; if ( $how_r eq \'readline_all\' ) { $buf .= $_ while < $fh > ; } elsif ( $how_r eq \'readline\' ) { $/ = \\ $read_c ; $buf .= $_ while < $fh > ; } elsif ( $how_r eq \'read\' ) { my ( $in , $c ) ; $buf .= $in while $c = read ( $fh , $in , $read_c ) ; } elsif ( $how_r eq \'sysread\' ) { my ( $in , $c ) ; $buf .= $in while $c = sysread ( $fh , $in , $read_c ) ; } else { die "Unrecognized read: \'$how_r\'" ; } close $fh or die "close: $!" ; $buf =~ s/\\r\\n/\\n/g if $how_r eq \'sysread\' and $how_w =~/print/ ; is ( length $buf , length $str , "length with wrc=$write_c, rdc=$read_c, $how_w, $how_r, $why" ) ; is ( $buf , $str , "content with wrc=$write_c, rdc=$read_c, $how_w, $how_r, $why" ) ; }',
            'start_line' => 42,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 43,
            'src' => ' my ( $fh , $str , $read_c , $how_r , $write_c , $how_w , $why ) = @_ ;',
            'start_line' => 43,
            'indent' => 1,
            'block_id' => 2
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 47,
            'src' => ' if ( $how_r eq \'readline_all\' ) { $buf .= $_ while < $fh > ; }',
            'start_line' => 45,
            'indent' => 1,
            'block_id' => 2
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 50,
            'src' => ' elsif ( $how_r eq \'readline\' ) { $/ = \\ $read_c ; $buf .= $_ while < $fh > ; }',
            'start_line' => 47,
            'indent' => 1,
            'block_id' => 2
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 53,
            'src' => ' elsif ( $how_r eq \'read\' ) { my ( $in , $c ) ; $buf .= $in while $c = read ( $fh , $in , $read_c ) ; }',
            'start_line' => 50,
            'indent' => 1,
            'block_id' => 2
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 52,
            'src' => ' $buf .= $in while $c = read ( $fh , $in , $read_c ) ;',
            'start_line' => 52,
            'indent' => 2,
            'block_id' => 5
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 56,
            'src' => ' elsif ( $how_r eq \'sysread\' ) { my ( $in , $c ) ; $buf .= $in while $c = sysread ( $fh , $in , $read_c ) ; }',
            'start_line' => 53,
            'indent' => 1,
            'block_id' => 2
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 55,
            'src' => ' $buf .= $in while $c = sysread ( $fh , $in , $read_c ) ;',
            'start_line' => 55,
            'indent' => 2,
            'block_id' => 6
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 58,
            'src' => ' else { die "Unrecognized read: \'$how_r\'" ; }',
            'start_line' => 56,
            'indent' => 1,
            'block_id' => 2
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 57,
            'src' => ' die "Unrecognized read: \'$how_r\'" ;',
            'start_line' => 57,
            'indent' => 2,
            'block_id' => 7
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 62,
            'src' => ' is ( length $buf , length $str , "length with wrc=$write_c, rdc=$read_c, $how_w, $how_r, $why" ) ;',
            'start_line' => 62,
            'indent' => 1,
            'block_id' => 2
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 63,
            'src' => ' is ( $buf , $str , "content with wrc=$write_c, rdc=$read_c, $how_w, $how_r, $why" ) ;',
            'start_line' => 63,
            'indent' => 1,
            'block_id' => 2
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 67,
            'src' => ' my ( $str , $write_c , $read_c , $how_w , $how_r , $why ) = @_ ;',
            'start_line' => 67,
            'indent' => 1,
            'block_id' => 8
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 81,
            'src' => ' else { die "Unrecognized write: \'$how_w\'" ; }',
            'start_line' => 79,
            'indent' => 1,
            'block_id' => 8
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 80,
            'src' => ' die "Unrecognized write: \'$how_w\'" ;',
            'start_line' => 80,
            'indent' => 2,
            'block_id' => 12
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 83,
            'src' => ' binmode $fh , \':crlf\' if defined $main::use_crlf && $main::use_crlf == 1 ;',
            'start_line' => 82,
            'indent' => 1,
            'block_id' => 8
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 84,
            'src' => ' testread ( $fh , $str , $read_c , $how_r , $write_c , $how_w , "pipe$why" ) ;',
            'start_line' => 84,
            'indent' => 1,
            'block_id' => 8
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 112,
            'src' => ' sub testfile ( $$$$$$ ) { my ( $str , $write_c , $read_c , $how_w , $how_r , $why ) = @_ ; my @data = grep length , split/(.{1,$write_c})/s , $str ; my $filename = tempfile ( ) ; open my $fh , \'>\' , $filename or die ; select $fh ; binmode $fh , \':crlf\' if defined $main::use_crlf && $main::use_crlf == 1 ; if ( $how_w eq \'print\' ) { $| = 0 ; print $fh $_ for @data ; } elsif ( $how_w eq \'print/flush\' ) { $| = 1 ; print $fh $_ for @data ; } elsif ( $how_w eq \'syswrite\' ) { syswrite $fh , $_ for @data ; } else { die "Unrecognized write: \'$how_w\'" ; } close $fh or die "close: $!" ; open $fh , \'<\' , $filename or die ; binmode $fh , \':crlf\' if defined $main::use_crlf && $main::use_crlf == 1 ; testread ( $fh , $str , $read_c , $how_r , $write_c , $how_w , "file$why" ) ; }',
            'start_line' => 87,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 89,
            'src' => ' my @data = grep length , split/(.{1,$write_c})/s , $str ;',
            'start_line' => 89,
            'indent' => 1,
            'block_id' => 13
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 92,
            'src' => ' open my $fh , \'>\' , $filename or die ;',
            'start_line' => 92,
            'indent' => 1,
            'block_id' => 13
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 99,
            'src' => ' if ( $how_w eq \'print\' ) { $| = 0 ; print $fh $_ for @data ; }',
            'start_line' => 96,
            'indent' => 1,
            'block_id' => 13
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 102,
            'src' => ' elsif ( $how_w eq \'print/flush\' ) { $| = 1 ; print $fh $_ for @data ; }',
            'start_line' => 99,
            'indent' => 1,
            'block_id' => 13
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 104,
            'src' => ' elsif ( $how_w eq \'syswrite\' ) { syswrite $fh , $_ for @data ; }',
            'start_line' => 102,
            'indent' => 1,
            'block_id' => 13
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 111,
            'src' => ' testread ( $fh , $str , $read_c , $how_r , $write_c , $how_w , "file$why" ) ;',
            'start_line' => 111,
            'indent' => 1,
            'block_id' => 13
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 121,
            'src' => ' push @c , ord $c while $c = getc $fh ;',
            'start_line' => 121,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 124,
            'src' => ' is ( "@c" , \'97 10 98 10 10 99 10 10 10\' , \'got expected chars\' ) ;',
            'start_line' => 124,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 142,
            'src' => ' for my $read_c ( @$r ) { for my $write_c ( @$w ) { for my $how_r ( qw(readline_all readline read sysread) ) { next if $how_r eq \'readline_all\' and $read_c != 1 ; for my $how_w ( qw(print print/flush syswrite) ) { testfile ( $str , $write_c , $read_c , $how_w , $how_r , $s ) ; testpipe ( $str , $write_c , $read_c , $how_w , $how_r , $s ) ; } } } }',
            'start_line' => 132,
            'indent' => 1,
            'block_id' => 18
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 141,
            'src' => ' for my $write_c ( @$w ) { for my $how_r ( qw(readline_all readline read sysread) ) { next if $how_r eq \'readline_all\' and $read_c != 1 ; for my $how_w ( qw(print print/flush syswrite) ) { testfile ( $str , $write_c , $read_c , $how_w , $how_r , $s ) ; testpipe ( $str , $write_c , $read_c , $how_w , $how_r , $s ) ; } } }',
            'start_line' => 133,
            'indent' => 2,
            'block_id' => 19
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 140,
            'src' => ' for my $how_r ( qw(readline_all readline read sysread) ) { next if $how_r eq \'readline_all\' and $read_c != 1 ; for my $how_w ( qw(print print/flush syswrite) ) { testfile ( $str , $write_c , $read_c , $how_w , $how_r , $s ) ; testpipe ( $str , $write_c , $read_c , $how_w , $how_r , $s ) ; } }',
            'start_line' => 134,
            'indent' => 3,
            'block_id' => 20
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 135,
            'src' => ' next if $how_r eq \'readline_all\' and $read_c != 1 ;',
            'start_line' => 135,
            'indent' => 4,
            'block_id' => 21
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 139,
            'src' => ' for my $how_w ( qw(print print/flush syswrite) ) { testfile ( $str , $write_c , $read_c , $how_w , $how_r , $s ) ; testpipe ( $str , $write_c , $read_c , $how_w , $how_r , $s ) ; }',
            'start_line' => 136,
            'indent' => 4,
            'block_id' => 21
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 137,
            'src' => ' testfile ( $str , $write_c , $read_c , $how_w , $how_r , $s ) ;',
            'start_line' => 137,
            'indent' => 5,
            'block_id' => 22
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 138,
            'src' => ' testpipe ( $str , $write_c , $read_c , $how_w , $how_r , $s ) ;',
            'start_line' => 138,
            'indent' => 5,
            'block_id' => 22
          },
