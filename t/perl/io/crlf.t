...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'miniperl can\'t rely on loading PerlIO::scalar',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 33
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 23,
            'src' => ' is ( count_chars ( $text , "\\015\\012" ) , 0 ) ;',
            'start_line' => 23,
            'indent' => 1,
            'block_id' => 2
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 29,
            'src' => ' is ( count_chars ( $text , "\\015\\012" ) , 2000 ) ;',
            'start_line' => 29,
            'indent' => 1,
            'block_id' => 2
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 33,
            'src' => ' skip_if_miniperl ( "miniperl can\'t rely on loading PerlIO::scalar" ) ;',
            'start_line' => 33,
            'indent' => 2,
            'block_id' => 5
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 34,
            'src' => ' skip ( "no PerlIO::scalar" ) unless $Config { extensions } =~ m!\\bPerlIO/scalar\\b! ;',
            'start_line' => 34,
            'indent' => 2,
            'block_id' => 5
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 36,
            'src' => ' my $fcontents = join "" , map { "$_\\015\\012" } "a" .. "zzz" ;',
            'start_line' => 36,
            'indent' => 2,
            'block_id' => 5
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 72,
            'src' => ' for my $utf8 ( \'\' , \':utf8\' ) { for my $binmode ( 1 .. 2 ) { open ( FOO , ">$file" ) ; binmode ( FOO , "$utf8:crlf" ) for 1 .. $binmode ; print FOO "Hello\\n" ; close FOO ; open ( FOO , "<$file" ) ; binmode ( FOO ) ; my $foo = scalar < FOO > ; close FOO ; print join ( " " , "#" , map { sprintf ( "%02x" , $_ ) } unpack ( "C*" , $foo ) ) , "\\n" ; like ( $foo , qr/\\x0d\\x0a$/ ) ; unlike ( $foo , qr/\\x0d\\x0d/ ) ; } }',
            'start_line' => 55,
            'indent' => 1,
            'block_id' => 2
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 71,
            'src' => ' for my $binmode ( 1 .. 2 ) { open ( FOO , ">$file" ) ; binmode ( FOO , "$utf8:crlf" ) for 1 .. $binmode ; print FOO "Hello\\n" ; close FOO ; open ( FOO , "<$file" ) ; binmode ( FOO ) ; my $foo = scalar < FOO > ; close FOO ; print join ( " " , "#" , map { sprintf ( "%02x" , $_ ) } unpack ( "C*" , $foo ) ) , "\\n" ; like ( $foo , qr/\\x0d\\x0a$/ ) ; unlike ( $foo , qr/\\x0d\\x0d/ ) ; }',
            'start_line' => 56,
            'indent' => 2,
            'block_id' => 6
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 59,
            'src' => ' binmode ( FOO , "$utf8:crlf" ) for 1 .. $binmode ;',
            'start_line' => 59,
            'indent' => 3,
            'block_id' => 7
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 68,
            'src' => ' print join ( " " , "#" , map { sprintf ( "%02x" , $_ ) } unpack ( "C*" , $foo ) ) , "\\n" ;',
            'start_line' => 67,
            'indent' => 3,
            'block_id' => 7
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 80,
            'src' => ' sub count_chars { my ( $text , $chars ) = @_ ; my $seen = 0 ; $seen ++ while $text =~/$chars/g ; return $seen ; }',
            'start_line' => 75,
            'indent' => 0,
            'block_id' => 0
          },
