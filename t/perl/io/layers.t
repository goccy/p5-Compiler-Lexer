...
subtest 'tokenize' => sub {
    ...
    is_deeply($$tokens, [
          ...
          bless( {
                   ...
                   'stype' => 0,
                   'name' => 'String',
                   'data' => 'PERLIO=\'$ENV{PERLIO}\' unknown',
                   'type' => 163,
                   'line' => 15
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
',
          ...
          bless( {
                   ...
                   'stype' => 0,
                   'name' => 'RegExp',
                   'data' => 'stdio crlf encoding(cp1047) utf8',
                   'type' => 172,
                   'line' => 131
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => 0,
                   'name' => 'RegExp',
                   'data' => 'stdio crlf encoding(cp1047) utf8 crlf utf8',
                   'type' => 172,
                   'line' => 137
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => 0,
                   'name' => 'RawString',
                   'data' => '$@ not clobbered by binmode and :encoding',
                   'type' => 164,
                   'line' => 201
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => 0,
                   'name' => 'RegExp',
                   'data' => 'stdio encoding(cp1252) utf8',
                   'type' => 172,
                   'line' => 217
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => 0,
                   'name' => 'HereDocument',
                   'data' => 'open(UTF, "<:raw:encoding(utf8)", \'$afile\') or die \\$!;
print ref *PerlIO::Layer::NoWarnings{CODE};
',
                   'type' => 169,
                   'line' => 229
          ...
          bless( {
                   ...
                   'stype' => 0,
                   'name' => 'RawString',
                   'data' => '1 fetch on referenced tied glob',
                   'type' => 164,
                   'line' => 245
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => 0,
                   'name' => 'RawString',
                   'data' => 'str/num arguments are treated identically',
                   'type' => 164,
                   'line' => 252
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($$stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 14,
            'src' => ' $ENV { PERLIO } = \'stdio\' if exists $ENV { PERLIO } && $ENV { PERLIO } eq \'\' ;',
            'start_line' => 14,
            'indent' => 1,
            'block_id' => 1
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 16,
            'src' => ' skip_all ( "PERLIO=\'$ENV{PERLIO}\' unknown" ) if exists $ENV { PERLIO } && $ENV { PERLIO } !~/^(stdio|perlio|mmap)$/ ;',
            'start_line' => 15,
            'indent' => 1,
            'block_id' => 1
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 17,
            'src' => ' $PERLIO = exists $ENV { PERLIO } ? $ENV { PERLIO } : "(undef)" ;',
            'start_line' => 17,
            'indent' => 1,
            'block_id' => 1
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 22,
            'src' => ' my $DOSISH = $^O =~/^(?:MSWin32|os2|dos|NetWare)$/ ? 1 : 0 ;',
            'start_line' => 22,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 23,
            'src' => ' $DOSISH = 1 if ! $DOSISH and $^O =~/^uwin/ ;',
            'start_line' => 23,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 24,
            'src' => ' my $NONSTDIO = exists $ENV { PERLIO } && $ENV { PERLIO } ne \'stdio\' ? 1 : 0 ;',
            'start_line' => 24,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 25,
            'src' => ' my $FASTSTDIO = $Config { d_faststdio } && $Config { usefaststdio } ? 1 : 0 ;',
            'start_line' => 25,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 35,
            'src' => ' if ( ${ ^ UNICODE } & 1 ) { if ( ${ ^ UNICODE } & 64 ) { $UTF8_STDIN = ${ ^ UTF8LOCALE } ; } else { $UTF8_STDIN = 1 ; } }',
            'start_line' => 27,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 31,
            'src' => ' if ( ${ ^ UNICODE } & 64 ) { $UTF8_STDIN = ${ ^ UTF8LOCALE } ; }',
            'start_line' => 28,
            'indent' => 1,
            'block_id' => 2
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 39,
            'src' => ' my $NTEST = 60 - ( ( $DOSISH || ! $FASTSTDIO ) ? 7 : 0 ) - ( $DOSISH ? 7 : 0 ) + $UTF8_STDIN ;',
            'start_line' => 38,
            'indent' => 0,
            'block_id' => 0
          },
...
print ref *PerlIO::Layer::NoWarnings{CODE};
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 109,
            'src' => ' sub check { my ( $result , $expected , $id ) = @_ ; if ( $NONSTDIO ) { shift @$result if $result-> [ 0 ] eq "unix" ; if ( $FASTSTDIO ) { $expected-> [ 0 ] = $ENV { PERLIO } ; } else { $expected-> [ 0 ] = $ENV { PERLIO } if $expected-> [ 0 ] eq "stdio" ; } } elsif ( ! $FASTSTDIO && ! $DOSISH ) { splice ( @$result , 0 , 2 , "stdio" ) if @$result >= 2 && $result-> [ 0 ] eq "unix" && $result-> [ 1 ] eq "perlio" ; } elsif ( $DOSISH ) { splice ( @$result , 0 , 2 , "stdio" ) if @$result >= 2 && $result-> [ 0 ] eq "unix" && $result-> [ 1 ] eq "crlf" ; } if ( $DOSISH && grep { $_ eq \'crlf\' } @$expected ) { splice @$expected , 1 , 1 if $expected-> [ 1 ] eq \'crlf\' ; } my $n = scalar @$expected ; is ( scalar @$result , $n , "$id - layers == $n" ) ; for ( my $i = 0 ; $i < $n ; $i ++ ) { my $j = $expected-> [ $i ] ; if ( ref $j eq \'CODE\' ) { ok ( $j-> ( $result-> [ $i ] ) , "$id - $i is ok" ) ; } else { is ( $result-> [ $i ] , $j , sprintf ( "$id - $i is %s" , defined $j ? $j : "undef" ) ) ; } } }',
            'start_line' => 56,
            'indent' => 1,
            'block_id' => 7
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 80,
            'src' => ' if ( $NONSTDIO ) { shift @$result if $result-> [ 0 ] eq "unix" ; if ( $FASTSTDIO ) { $expected-> [ 0 ] = $ENV { PERLIO } ; } else { $expected-> [ 0 ] = $ENV { PERLIO } if $expected-> [ 0 ] eq "stdio" ; } }',
            'start_line' => 71,
            'indent' => 2,
            'block_id' => 8
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 73,
            'src' => ' shift @$result if $result-> [ 0 ] eq "unix" ;',
            'start_line' => 73,
            'indent' => 3,
            'block_id' => 9
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 77,
            'src' => ' if ( $FASTSTDIO ) { $expected-> [ 0 ] = $ENV { PERLIO } ; }',
            'start_line' => 75,
            'indent' => 3,
            'block_id' => 9
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 79,
            'src' => ' else { $expected-> [ 0 ] = $ENV { PERLIO } if $expected-> [ 0 ] eq "stdio" ; }',
            'start_line' => 77,
            'indent' => 3,
            'block_id' => 9
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 78,
            'src' => ' $expected-> [ 0 ] = $ENV { PERLIO } if $expected-> [ 0 ] eq "stdio" ;',
            'start_line' => 78,
            'indent' => 4,
            'block_id' => 11
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 85,
            'src' => ' elsif ( ! $FASTSTDIO && ! $DOSISH ) { splice ( @$result , 0 , 2 , "stdio" ) if @$result >= 2 && $result-> [ 0 ] eq "unix" && $result-> [ 1 ] eq "perlio" ; }',
            'start_line' => 80,
            'indent' => 2,
            'block_id' => 8
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 84,
            'src' => ' splice ( @$result , 0 , 2 , "stdio" ) if @$result >= 2 && $result-> [ 0 ] eq "unix" && $result-> [ 1 ] eq "perlio" ;',
            'start_line' => 81,
            'indent' => 3,
            'block_id' => 12
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 90,
            'src' => ' elsif ( $DOSISH ) { splice ( @$result , 0 , 2 , "stdio" ) if @$result >= 2 && $result-> [ 0 ] eq "unix" && $result-> [ 1 ] eq "crlf" ; }',
            'start_line' => 85,
            'indent' => 2,
            'block_id' => 8
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 89,
            'src' => ' splice ( @$result , 0 , 2 , "stdio" ) if @$result >= 2 && $result-> [ 0 ] eq "unix" && $result-> [ 1 ] eq "crlf" ;',
            'start_line' => 86,
            'indent' => 3,
            'block_id' => 13
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 96,
            'src' => ' if ( $DOSISH && grep { $_ eq \'crlf\' } @$expected ) { splice @$expected , 1 , 1 if $expected-> [ 1 ] eq \'crlf\' ; }',
            'start_line' => 91,
            'indent' => 2,
            'block_id' => 8
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 95,
            'src' => ' splice @$expected , 1 , 1 if $expected-> [ 1 ] eq \'crlf\' ;',
            'start_line' => 95,
            'indent' => 3,
            'block_id' => 14
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 98,
            'src' => ' is ( scalar @$result , $n , "$id - layers == $n" ) ;',
            'start_line' => 98,
            'indent' => 2,
            'block_id' => 8
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 108,
            'src' => ' for ( my $i = 0 ; $i < $n ; $i ++ ) { my $j = $expected-> [ $i ] ; if ( ref $j eq \'CODE\' ) { ok ( $j-> ( $result-> [ $i ] ) , "$id - $i is ok" ) ; } else { is ( $result-> [ $i ] , $j , sprintf ( "$id - $i is %s" , defined $j ? $j : "undef" ) ) ; } }',
            'start_line' => 99,
            'indent' => 2,
            'block_id' => 8
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 103,
            'src' => ' if ( ref $j eq \'CODE\' ) { ok ( $j-> ( $result-> [ $i ] ) , "$id - $i is ok" ) ; }',
            'start_line' => 101,
            'indent' => 3,
            'block_id' => 15
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 107,
            'src' => ' else { is ( $result-> [ $i ] , $j , sprintf ( "$id - $i is %s" , defined $j ? $j : "undef" ) ) ; }',
            'start_line' => 103,
            'indent' => 3,
            'block_id' => 15
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 106,
            'src' => ' is ( $result-> [ $i ] , $j , sprintf ( "$id - $i is %s" , defined $j ? $j : "undef" ) ) ;',
            'start_line' => 104,
            'indent' => 4,
            'block_id' => 17
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 113,
            'src' => ' check ( [ PerlIO::get_layers ( STDIN ) ] , $UTF8_STDIN ? [ "stdio" , "utf8" ] : [ "stdio" ] , "STDIN" ) ;',
            'start_line' => 111,
            'indent' => 1,
            'block_id' => 7
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 120,
            'src' => ' check ( [ PerlIO::get_layers ( F ) ] , [ qw(stdio crlf) ] , "open :crlf" ) ;',
            'start_line' => 118,
            'indent' => 1,
            'block_id' => 7
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 126,
            'src' => ' check ( [ PerlIO::get_layers ( F ) ] , [ qw(stdio crlf) ] , "binmode :crlf" ) ;',
            'start_line' => 124,
            'indent' => 1,
            'block_id' => 7
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 132,
            'src' => ' check ( [ PerlIO::get_layers ( F ) ] , [ qw[stdio crlf encoding(cp1047) utf8] ] , ":encoding(cp1047)" ) ;',
            'start_line' => 130,
            'indent' => 1,
            'block_id' => 7
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 138,
            'src' => ' check ( [ PerlIO::get_layers ( F ) ] , [ qw[stdio crlf encoding(cp1047) utf8 crlf utf8] ] , ":encoding(cp1047):crlf" ) ;',
            'start_line' => 136,
            'indent' => 1,
            'block_id' => 7
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 144,
            'src' => ' check ( [ PerlIO::get_layers ( F ) ] , [ qw(stdio crlf) ] , ":pop" ) ;',
            'start_line' => 142,
            'indent' => 1,
            'block_id' => 7
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 150,
            'src' => ' check ( [ PerlIO::get_layers ( F ) ] , [ "stdio" ] , ":raw" ) ;',
            'start_line' => 148,
            'indent' => 1,
            'block_id' => 7
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 156,
            'src' => ' check ( [ PerlIO::get_layers ( F ) ] , [ qw(stdio utf8) ] , ":utf8" ) ;',
            'start_line' => 154,
            'indent' => 1,
            'block_id' => 7
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 162,
            'src' => ' check ( [ PerlIO::get_layers ( F ) ] , [ "stdio" ] , ":bytes" ) ;',
            'start_line' => 160,
            'indent' => 1,
            'block_id' => 7
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 168,
            'src' => ' check ( [ PerlIO::get_layers ( F ) ] , [ qw[stdio encoding(utf8) utf8] ] , ":encoding(utf8)" ) ;',
            'start_line' => 166,
            'indent' => 1,
            'block_id' => 7
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 174,
            'src' => ' check ( [ PerlIO::get_layers ( F ) ] , [ qw(stdio crlf) ] , ":raw:crlf" ) ;',
            'start_line' => 172,
            'indent' => 1,
            'block_id' => 7
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 176,
            'src' => ' binmode ( F , ":raw :encoding(latin1)" ) ;',
            'start_line' => 176,
            'indent' => 1,
            'block_id' => 7
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 189,
            'src' => ' unless ( $DOSISH || ! $FASTSTDIO ) { my @results = PerlIO::get_layers ( F , details => 1 ) ; splice ( @results , 1 , 2 ) if $NONSTDIO ; check ( [ @results ] , [ "stdio" , undef , sub { $_ [ 0 ] > 0 } , "encoding" , "iso-8859-1" , sub { $_ [ 0 ] & PerlIO::F_UTF8 ( ) } ] , ":raw:encoding(latin1)" ) ; }',
            'start_line' => 179,
            'indent' => 1,
            'block_id' => 7
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 180,
            'src' => ' my @results = PerlIO::get_layers ( F , details => 1 ) ;',
            'start_line' => 180,
            'indent' => 2,
            'block_id' => 18
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 183,
            'src' => ' splice ( @results , 1 , 2 ) if $NONSTDIO ;',
            'start_line' => 183,
            'indent' => 2,
            'block_id' => 18
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 188,
            'src' => ' check ( [ @results ] , [ "stdio" , undef , sub { $_ [ 0 ] > 0 } , "encoding" , "iso-8859-1" , sub { $_ [ 0 ] & PerlIO::F_UTF8 ( ) } ] , ":raw:encoding(latin1)" ) ;',
            'start_line' => 185,
            'indent' => 2,
            'block_id' => 18
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 195,
            'src' => ' check ( [ PerlIO::get_layers ( F ) ] , [ "stdio" ] , "binmode" ) ;',
            'start_line' => 193,
            'indent' => 1,
            'block_id' => 7
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 202,
            'src' => ' { local $@ = "foo" ; binmode ( F , ":encoding(utf8)" ) ; is ( $@ , "foo" , \'$@ not clobbered by binmode and :encoding\' ) ; }',
            'start_line' => 198,
            'indent' => 1,
            'block_id' => 7
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 201,
            'src' => ' is ( $@ , "foo" , \'$@ not clobbered by binmode and :encoding\' ) ;',
            'start_line' => 201,
            'indent' => 2,
            'block_id' => 21
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 222,
            'src' => ' { use open ( IN => ":crlf" , OUT => ":encoding(cp1252)" ) ; open F , \'<\' , $afile ; open G , \'>\' , $afile ; check ( [ PerlIO::get_layers ( F , input => 1 ) ] , [ qw(stdio crlf) ] , "use open IN" ) ; check ( [ PerlIO::get_layers ( G , output => 1 ) ] , [ qw[stdio encoding(cp1252) utf8] ] , "use open OUT" ) ; close F ; close G ; }',
            'start_line' => 206,
            'indent' => 1,
            'block_id' => 7
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 207,
            'src' => ' use open ( IN => ":crlf" , OUT => ":encoding(cp1252)" ) ;',
            'start_line' => 207,
            'indent' => 2,
            'block_id' => 22
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 214,
            'src' => ' check ( [ PerlIO::get_layers ( F , input => 1 ) ] , [ qw(stdio crlf) ] , "use open IN" ) ;',
            'start_line' => 212,
            'indent' => 2,
            'block_id' => 22
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 218,
            'src' => ' check ( [ PerlIO::get_layers ( G , output => 1 ) ] , [ qw[stdio encoding(cp1252) utf8] ] , "use open OUT" ) ;',
            'start_line' => 216,
            'indent' => 2,
            'block_id' => 22
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 226,
            'src' => ' fresh_perl_like ( qq{open(UTF, "<:raw:encoding(utf8)", \'$afile\') or die \\$!;
print ref *PerlIO::Layer::NoWarnings{CODE};
} , qr/^CODE/ ) ;',
            'start_line' => 226,
            'indent' => 1,
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 239,
            'src' => ' is $f , 1 , \'1 fetch on tied glob\' ;',
            'start_line' => 239,
            'indent' => 1,
            'block_id' => 7
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 242,
            'src' => ' is $f , 1 , \'1 fetch on tied globref\' ;',
            'start_line' => 242,
            'indent' => 1,
            'block_id' => 7
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 245,
            'src' => ' is $f , 1 , \'1 fetch on referenced tied glob\' ;',
            'start_line' => 245,
            'indent' => 1,
            'block_id' => 7
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 248,
            'src' => ' is $f , 1 , \'1 fetch on tied string\' ;',
            'start_line' => 248,
            'indent' => 1,
            'block_id' => 7
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 251,
            'src' => ' open "12" , "<:crlf" , "test.pl" or die "$0 cannot open test.pl: $!" ;',
            'start_line' => 251,
            'indent' => 1,
            'block_id' => 7
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 252,
            'src' => ' ok PerlIO::get_layers ( 12 ) , \'str/num arguments are treated identically\' ;',
            'start_line' => 252,
            'indent' => 1,
            'block_id' => 7
          }
...
subtest 'get_used_modules' => sub {
    ...
    is_deeply($modules, [
          ...
          {
            'args' => '  ( IN => ":crlf" , OUT => ":encoding(cp1252)" )',
            'name' => 'open'
          }
        ]
