...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   'data' => 'no SysV semaphores on this platform',
                   'name' => 'RawString',
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'SysV semaphore structures not detected'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'kind' => Compiler::Lexer::Kind::T_Symbol,
          ...
          bless( {
                   'data' => 'erroneous semctl list slice yields undef',
                   'name' => 'String',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   'data' => 'no warnings from erroneous semctl list slice',
                   'name' => 'String',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'has_warnings' => 0,
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'token_num' => 11,
            'indent' => 0,
            'src' => ' skip_all ( \'no SysV semaphores on this platform\' ) if ! $Config { d_sem } ;',
            'start_line' => 12
          },
          {
            'start_line' => 13,
            'indent' => 0,
            'src' => ' skip_all ( \'SysV semaphore structures not detected\' ) if ! $Config { d_semctl_semid_ds } && ! $Config { d_semctl_semun } ;',
            'block_id' => 0,
            'token_num' => 17,
            'end_line' => 14,
            'has_warnings' => 1
          ...
          },
          {
            'start_line' => 17,
            'indent' => 0,
            'src' => ' { local $SIG { __WARN__ } = sub { push @warnings , $_ [ 0 ] } ; local $SIG { SYS } = sub { skip_all ( "SIGSYS caught" ) } if exists $SIG { SYS } ; my $test = ( semctl ( -1 , 0 , 0 , 0 ) ) [ 0 ] ; ok ( ! defined $test , "erroneous semctl list slice yields undef" ) ; }',
            'has_warnings' => 1,
            'end_line' => 22,
            'token_num' => 67,
            'block_id' => 0
          ...
          },
          {
            'start_line' => 19,
            'indent' => 1,
            'src' => ' sub { skip_all ( "SIGSYS caught" ) }',
            'token_num' => 7,
            'block_id' => 3,
            'end_line' => 19,
            'has_warnings' => 1
          ...
          },
          {
            ...
            'start_line' => 21,
            'indent' => 1,
            'src' => ' ok ( ! defined $test , "erroneous semctl list slice yields undef" ) ;'
          },
          {
            'end_line' => 25,
            'has_warnings' => 1,
            ...
            'start_line' => 24,
            'indent' => 0,
            'src' => ' is ( scalar @warnings , 0 , "no warnings from erroneous semctl list slice" ) or diag ( "warnings found: @warnings" ) ;'
          },
          {
            'token_num' => 2,
            'block_id' => 0,
