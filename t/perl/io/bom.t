...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          {
            'token_num' => 17,
            'src' => ' fresh_perl_is ( byte_utf8a_to_utf8n ( "\\xEF\\xBB\\xBF" ) . "print 1;\\nprint 2" , "12" , { } , "script starts with a BOM" ) ;',
            'has_warnings' => 1,
            'start_line' => 14,
            'block_id' => 0,
            'indent' => 0,
          ...
          },
          {
            ...
            'indent' => 0,
            'token_num' => 89,
            'src' => ' for my $end ( 0 , 1 ) { my $encoding = $end ? \'UTF-16LE\' : \'UTF-16BE\' ; my $prog = join \'\' , map chr ( $_ ) , map { $end ? @$_ [ 0 , 1 ] : @$_ [ 1 , 0 ] } ( [ 0xFE , 0xFF ] , map [ 0 , utf8::native_to_unicode ( ord ( $_ ) ) ] , split// , "print 1;\\nprint 2" ) ; fresh_perl_is ( $prog , "12" , { } , "BOM indicates $encoding" ) ; }'
          },
          {
            'start_line' => 18,
            'block_id' => 3,
            ...
            'indent' => 1,
            'end_line' => 18,
            'src' => ' my $encoding = $end ? \'UTF-16LE\' : \'UTF-16BE\' ;',
            'token_num' => 9
          },
          {
            'src' => ' my $prog = join \'\' , map chr ( $_ ) , map { $end ? @$_ [ 0 , 1 ] : @$_ [ 1 , 0 ] } ( [ 0xFE , 0xFF ] , map [ 0 , utf8::native_to_unicode ( ord ( $_ ) ) ] , split// , "print 1;\\nprint 2" ) ;',
            'token_num' => 58,
            'start_line' => 19,
            'block_id' => 3,
            'has_warnings' => 1,
          ...
          {
            'src' => ' fresh_perl_is ( $prog , "12" , { } , "BOM indicates $encoding" ) ;',
            'token_num' => 12,
            'end_line' => 26,
            'indent' => 1,
            'has_warnings' => 1,
