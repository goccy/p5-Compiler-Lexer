...
subtest 'tokenize' => sub {
    ...
    is_deeply($$tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'ok 13 - CORE::say without feature.pm',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 59
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($$stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 37,
            'src' => ' if ( ! exists & Errno::EBADF ) { print "ok 9 # skipped: no EBADF\\n" ; }',
            'start_line' => 35,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 36,
            'src' => ' print "ok 9 # skipped: no EBADF\\n" ;',
            'start_line' => 36,
            'indent' => 1,
            'block_id' => 2
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 43,
            'src' => ' else { $! = 0 ; no warnings \'unopened\' ; say NONEXISTENT "foo" ; print "not " if ( $! != & Errno::EBADF ) ; say "ok 9" ; }',
            'start_line' => 37,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 60,
            'src' => ' { no feature \'say\' ; CORE::say "ok 13 - CORE::say without feature.pm" ; }',
            'start_line' => 57,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 59,
            'src' => ' CORE::say "ok 13 - CORE::say without feature.pm" ;',
            'start_line' => 59,
            'indent' => 1,
            'block_id' => 5
          }
