...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => 'check we read to the correct offset',
                   'name' => 'String'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'name' => 'RightParenthesis',
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          {
            'indent' => 0,
            'src' => ' $ENV { PERL_TEST_MEMORY } >= 3 or skip_all ( "Need ~3Gb for this test" ) ;',
            'start_line' => 11,
            'end_line' => 12,
            'has_warnings' => 1,
            'token_num' => 12,
          ...
          },
          {
            ...
            'start_line' => 21,
            'indent' => 0,
            'src' => ' is ( length $x , 0x80000004 , "check we read to the correct offset" ) ;'
          }
        ]
