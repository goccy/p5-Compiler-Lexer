...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'line' => 22,
                   'data' => 'setting pos on large string',
                   'name' => 'RawString'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'line' => 22,
          ...
          bless( {
                   'name' => 'RawString',
                   'data' => 'reading lvalue pos after setting it > 2**31',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'reading it with pos() in rvalue context'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'data' => ';',
                   'name' => 'SemiColon',
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'token_num' => 8,
            'block_id' => 0,
            'src' => ' is pos $x , 2147483643 , \'setting pos on large string\' ;',
            'indent' => 0,
            'start_line' => 22
          },
          {
          ...
          {
            'indent' => 0,
            'src' => ' is pos $x , 2147483653 , \'reading lvalue pos after setting it > 2**31\' ;',
            'start_line' => 24,
            'end_line' => 24,
            'has_warnings' => 1,
            'token_num' => 8,
          ...
          },
          {
            ...
            'token_num' => 11,
            'start_line' => 25,
            'src' => ' is scalar ( pos $x ) , 2147483653 , \'reading it with pos() in rvalue context\' ;',
            'indent' => 0
          }
        ]
