...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'data' => 'subst on long strings (substcont)',
                   'name' => 'String'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'data' => ';',
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          {
            'start_line' => 10,
            'src' => ' $ENV { PERL_TEST_MEMORY } >= 4 or skip_all ( "Need ~4Gb for this test" ) ;',
            'indent' => 0,
            'block_id' => 0,
            'token_num' => 12,
            'has_warnings' => 1,
          ...
          },
          {
            'start_line' => 20,
            'indent' => 0,
            'src' => ' is eval { $x =~ s/ /_/g } , 2 ** 30 , "subst on long strings" ;',
            'has_warnings' => 1,
            'end_line' => 20,
            'token_num' => 20,
            'block_id' => 0
          ...
          {
            'src' => ' is eval { $x =~ s/_/${\\" "}/g } , 2 ** 30 , "subst on long strings (substcont)" ;',
            'indent' => 0,
            'start_line' => 21,
            'token_num' => 20,
            'block_id' => 0,
