...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   'data' => 'state $y = "foo $bar baz" does not stringify; only concats',
                   'name' => 'RawString',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'start_line' => 170,
            'indent' => 0,
            'src' => ' ok ( ref ( CORE::state $y = "a $o b" ) eq \'o\' , \'state $y = "foo $bar baz" does not stringify; only concats\' ) ;'
          }
        ]
