...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'end_line' => 47,
            'token_num' => 61,
            'src' => ' foreach ( "\\0" , "\\x{1F4A9}" , chr ( 163 ) , \'N\' ) { push @raw , $_ ; my $temp = $_ . chr 256 ; chop $temp ; push @upgraded , $temp ; my $utf8 = $_ ; next if utf8::upgrade ( $utf8 ) == length $_ ; utf8::encode ( $utf8 ) ; push @utf8 , $utf8 ; }',
            'indent' => 0,
            'start_line' => 38,
            'block_id' => 0
          },
