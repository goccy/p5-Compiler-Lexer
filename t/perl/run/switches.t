...
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => '"undef ~~ undef and say q(Hello, world!)"',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 366
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => '"given(undef) {when(undef) { say q(Hello, world!)"}}',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 371
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
1;
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 280,
            'src' => ' { local $TODO = \'\' ; my $v = sprintf "%vd" , $^ V ; my $ver = $Config { PERL_VERSION } ; my $rel = $Config { PERL_SUBVERSION } ; like ( runperl ( switches => [ \'-v\' ] ) , qr/This is perl 5, version \\Q$ver\\E, subversion \\Q$rel\\E \\(v\\Q$v\\E(?:[-*\\w]+| \\([^)]+\\))?\\) built for \\Q$Config{archname}\\E.+Copyright.+Larry Wall.+Artistic License.+GNU General Public License/s , \'-v looks okay\' ) ; }',
            'start_line' => 269,
            'indent' => 0,
            'block_id' => 0
          },
...
king kong foo
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 367,
            'src' => ' $r = runperl ( switches => [ \'-E\' , \'"undef ~~ undef and say q(Hello, world!)"\' ] ) ;',
            'start_line' => 365,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 372,
            'src' => ' $r = runperl ( switches => [ \'-E\' , \'"given(undef) {when(undef) { say q(Hello, world!)"}}\' ] ) ;',
            'start_line' => 370,
            'indent' => 0,
            'block_id' => 0
          },
