...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($$stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 19,
            'src' => ' return unless $f =~/^\\(eval \\d+\\)\\[.*78586\\.t:\\d+\\]/ ;',
            'start_line' => 19,
            'indent' => 1,
            'block_id' => 2
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 29,
            'src' => ' sub trace_lines { my ( $src ) = @_ ; local @lines ; eval $src ; die if $@ ; return join " " , @lines ; }',
            'start_line' => 23,
            'indent' => 0,
            'block_id' => 0
          },
