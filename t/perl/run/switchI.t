...
subtest 'tokenize' => sub {
    ...
    is_deeply($$tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'Double colons not allowed in dir spec',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 16
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'print grep { \\$_ eq \'$lib\' } \\@INC[0..(\\$#INC-1)]',
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($$stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 16,
            'src' => ' skip \'Double colons not allowed in dir spec\' , 1 if $Is_VMS ;',
            'start_line' => 16,
            'indent' => 1,
            'block_id' => 2
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 23,
            'src' => ' fresh_perl_is ( "print grep { \\$_ eq \'$lib\' } \\@INC[0..(\\$#INC-1)]" , $lib , { switches => [ \'-IBla2\' ] , nolib => 1 } , \'-I\' ) ;',
            'start_line' => 22,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 28,
            'src' => ' fresh_perl_is ( "print grep { \\$_ eq \'$lib\' } \\@INC" , $lib , { switches => [ \'-IFoo::Bar2\' ] , nolib => 1 } , \'-I with colons\' ) ;',
            'start_line' => 27,
            'indent' => 1,
            'block_id' => 3
          }
