...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'line' => 19,
                   'name' => 'RawString',
                   'data' => 'Identified entry in @INC with double colons'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'line' => 19,
                   'has_warnings' => 0,
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          {
            'indent' => 0,
            'src' => ' ok do { grep { $_ eq $lib } @INC [ 0 .. ( $#INC - 1 ) ] } , \'Identified entry in @INC\' ;',
            'start_line' => 14,
            'block_id' => 0,
            'token_num' => 23,
            'has_warnings' => 1,
          ...
          },
          {
            ...
            'block_id' => 1,
            'token_num' => 19,
            'src' => ' do { grep { $_ eq $lib } @INC [ 0 .. ( $#INC - 1 ) ] }',
            'indent' => 0,
            'start_line' => 14
          },
          {
          ...
          },
          {
            ...
            'start_line' => 18,
            'indent' => 1,
            'src' => ' ok do { grep { $_ eq $lib } @INC [ 0 .. ( $#INC - 1 ) ] } , \'Identified entry in @INC with double colons\' ;'
          },
          {
            'token_num' => 19,
            'block_id' => 3,
