...
',
          ...
          bless( {
                   'name' => 'RawString',
                   'data' => 'sub DB::DB{} print line=>__LINE__',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
          ...
          bless( {
                   'name' => 'RawString',
                   'data' => '#!perl -d:whatever does not throw line numbers off',
                   'line' => 81,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
          ...
          bless( {
                   'name' => 'String',
                   'data' => 'No crash when *DB::DB exists but not &DB::DB',
                   'line' => 138,
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   ...
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'data' => 'sub DB::DB; BEGIN { $^P = 0x22; } for(0..9){ warn }',
                   'name' => 'RawString'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'data' => ',',
          ...
          bless( {
                   'data' => 'No crash when &DB::DB exists but isn\'t actually defined',
                   'name' => 'String',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'line' => 153,
                   'data' => 'warn; sub DB::DB { print qq-ok\\n-; exit }',
                   'name' => 'RawString'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'line' => 153,
          ...
          bless( {
                   ...
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 157,
                   'data' => 'DB::DB works after \'*DB::DB if 0\'',
                   'name' => 'String'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'line' => 157,
...
',
          ...
          bless( {
                   'data' => 'Recursive DB::DB does not clobber its own pad',
                   'name' => 'String',
                   'line' => 184,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
          ...
          bless( {
                   'data' => 'use Devel::switchd_empty;(?:BEGIN|\\r?\\nprint)',
                   'name' => 'String',
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_String,
          ...
          bless( {
                   ...
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'name' => 'RawString',
                   'data' => 'Copy on write does not mangle ${"_<-e"}[0] [perl #118627]'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
          ...
          bless( {
                   'data' => 'Warning: something\'s wrong.\\n',
                   'name' => 'String',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_String,
          ...
          bless( {
                   'name' => 'String',
                   'data' => 'Warning: something\'s wrong at -e line 1.\\n',
                   'line' => 208,
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_String,
          ...
          bless( {
                   ...
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'data' => 'PERL5DB with embedded newlines',
                   'name' => 'RawString'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'line' => 209,
          ...
          bless( {
                   'data' => 'sub DB::sub {} sub foo : lvalue {} foo();',
                   'name' => 'RawString',
                   'line' => 228,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'has_warnings' => 0,
    ...
    ',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'line' => 253,
                   'data' => 'setting breakpoints without *DB::dbline aliased',
                   'name' => 'String'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'line' => 254,
          ...
          bless( {
                   ...
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'data' => 'sub DB::sub{length($DB::sub); goto &$DB::sub}
     ${^UTF8CACHE}=-1;
     print
       eval qq|sub oo\\x{25f} { 42 }
               sub ooooo\\x{25f} { oo\\x{25f}() }
    ...
    ',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'line' => 275,
                   'data' => 'UTF8 length caches on $DB::sub are flushed',
                   'name' => 'RawString'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'line' => 276,
          ...
          bless( {
                   'data' => 'BEGIN { $^P &= ~0x4 } sort { $$b <=> $$a } (); print qq-42\\n-',
                   'name' => 'RawString',
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => '-d does not conflict with sort optimisations'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'line' => 286,
                   'kind' => Compiler::Lexer::Kind::T_Symbol,
    ...
    ',
          ...
          bless( {
                   ...
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'data' => '\\$DB::single set to overload',
                   'name' => 'String'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'data' => ')',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'line' => 327,
                   'data' => 'putenv does not interfere with PERL5OPT parsing',
                   'name' => 'RawString'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'name' => 'Comma',
...
Foo::foo(3);
          ...
          },
          {
            ...
            'end_line' => 39,
            'indent' => 1,
            'src' => ' like ( $r , qr/^sub<Devel::switchd::import>;import<Devel::switchd>;DB<main,$::tempfile_regexp,9>;sub<Foo::foo>;DB<Foo,$::tempfile_regexp,5>;DB<Foo,$::tempfile_regexp,6>;sub<Bar::bar>;DB<Bar,$::tempfile_regexp,2>;sub<Bar::bar>;DB<Bar,$::tempfile_regexp,2>;sub<Bar::bar>;DB<Bar,$::tempfile_regexp,2>;$/ , \'Got debugging output: 1\' ) ;',
            'start_line' => 37
          },
          {
            'token_num' => 26,
          ...
          },
          {
            ...
            'start_line' => 45,
            'indent' => 1,
            'src' => ' like ( $r , qr/^sub<Devel::switchd::import>;import<Devel::switchd a 42>;DB<main,$::tempfile_regexp,9>;sub<Foo::foo>;DB<Foo,$::tempfile_regexp,5>;DB<Foo,$::tempfile_regexp,6>;sub<Bar::bar>;DB<Bar,$::tempfile_regexp,2>;sub<Bar::bar>;DB<Bar,$::tempfile_regexp,2>;sub<Bar::bar>;DB<Bar,$::tempfile_regexp,2>;$/ , \'Got debugging output: 2\' ) ;'
          },
          {
            'indent' => 1,
            'src' => ' $r = runperl ( switches => [ \'-Ilib\' , \'-f\' , \'-d:-switchd=a,42\' ] , progfile => $filename , args => [ \'4\' ] , ) ;',
          ...
          },
          {
            ...
            'start_line' => 53,
            'indent' => 1,
            'src' => ' like ( $r , qr/^sub<Devel::switchd::unimport>;unimport<Devel::switchd a 42>;DB<main,$::tempfile_regexp,9>;sub<Foo::foo>;DB<Foo,$::tempfile_regexp,5>;DB<Foo,$::tempfile_regexp,6>;sub<Bar::bar>;DB<Bar,$::tempfile_regexp,2>;sub<Bar::bar>;DB<Bar,$::tempfile_regexp,2>;sub<Bar::bar>;DB<Bar,$::tempfile_regexp,2>;$/ , \'Got debugging output: 3\' ) ;'
          },
          {
            'block_id' => 0,
            'token_num' => 29,
          ...
          {
            'indent' => 0,
            'src' => ' like runperl ( switches => [ \'"-Mless ++INC->{q-Devel/_.pm-}"\' ] , progs => [ \'#!perl -d:_\' , \'sub DB::DB{} print line=>__LINE__\' , ] , ) , qr/line2/ , \'#!perl -d:whatever does not throw line numbers off\' ;',
            'start_line' => 73,
            'block_id' => 0,
            'token_num' => 27,
            'has_warnings' => 1,
          ...
          },
          {
            'start_line' => 131,
            'indent' => 0,
            'src' => ' like ( runperl ( switches => [ \'-Ilib\' , \'-d:nodb\' ] , prog => [ \'1\' ] , stderr => 1 , ) , qr/^No DB::DB routine defined/ , "No crash when *DB::DB exists but not &DB::DB" , ) ;',
            'block_id' => 0,
            'token_num' => 33,
            'has_warnings' => 1,
            'end_line' => 139
          ...
          {
            'src' => ' like ( runperl ( switches => [ \'-Ilib\' ] , prog => \'sub DB::DB; BEGIN { $^P = 0x22; } for(0..9){ warn }\' , stderr => 1 , ) , qr/^No DB::DB routine defined/ , "No crash when &DB::DB exists but isn\'t actually defined" , ) ;',
            'indent' => 0,
            'start_line' => 140,
            'token_num' => 29,
            'block_id' => 0,
          ...
          {
            'start_line' => 150,
            'src' => ' is ( runperl ( switches => [ \'-Ilib\' , \'-d:nodb\' ] , prog => \'warn; sub DB::DB { print qq-ok\\n-; exit }\' , stderr => 1 , ) , "ok\\n" , "DB::DB works after \'*DB::DB if 0\'" , ) ;',
            'indent' => 0,
            'has_warnings' => 1,
            'end_line' => 158,
            'token_num' => 28,
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'indent' => 0,
            'src' => ' like ( runperl ( switches => [ \'-Ilib\' ] , progs => [ split "\\n" , q{     BEGIN {
      $^P = 0x22;
     }
     package DB;
     sub DB {
     ...
     chop;
     sub foo { chop; }
} ] , stderr => 1 , ) , qr/42/ , "Recursive DB::DB does not clobber its own pad" , ) ;',
            'start_line' => 161
          },
          {
            'start_line' => 188,
            'indent' => 0,
            'src' => ' like ( runperl ( switches => [ \'-Ilib\' , \'-d:switchd_empty\' ] , prog => \'print @{q|_<-e|}\' , ) , qr "use Devel::switchd_empty;(?:BEGIN|\\r?\\nprint)" , \'Copy on write does not mangle ${"_<-e"}[0] [perl #118627]\' , ) ;',
            'has_warnings' => 1,
            'end_line' => 196,
            'token_num' => 25,
            'block_id' => 0
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'start_line' => 201,
            'src' => ' is ( runperl ( switches => [ \'-Ilib\' , \'-ld\' ] , prog => \'warn\' , stderr => 1 ) , "Warning: something\'s wrong.\\n" . "Warning: something\'s wrong at -e line 1.\\n" , \'PERL5DB with embedded newlines\' , ) ;',
            'indent' => 1
          },
          {
            'has_warnings' => 1,
            ...
            'token_num' => 27,
            'block_id' => 0,
            'src' => ' is ( runperl ( switches => [ \'-Ilib\' , \'-d:switchd_goto\' ] , prog => \'sub baz { print qq|hello;\\n| } sub foo { goto &baz } foo()\' , stderr => 1 , ) , "goto<main::baz>;hello;\\n" , "DB::goto" ) ;',
            'indent' => 0,
            'start_line' => 214
          },
          {
            ...
            'block_id' => 0,
            'indent' => 0,
            'src' => ' is ( runperl ( switches => [ \'-Ilib\' , \'-d:switchd_empty\' ] , progs => [ \'sub DB::sub {} sub foo : lvalue {} foo();\' , \'print qq-ok\\n- unless defined *DB::lsub{HASH}\' ] , ) , "ok\\n" , "%DB::lsub is not vivified" ) ;',
            'start_line' => 225
          },
          {
            'block_id' => 0,
            ...
            'has_warnings' => 1,
            'end_line' => 254,
            'src' => ' is ( runperl ( switches => [ \'-Ilib\' , \'-d:nodb\' ] , progs => [ split "\\n" , \'sub DB::DB {
      $DB::single = 0, return if $DB::single; print qq[ok\\n]; exit
     }
     ${q(_<).__FILE__}{6} = 1; # set a breakpoint
     sub foo {
    ...
    \' ] , stderr => 1 ) , "ok\\n" , "setting breakpoints without *DB::dbline aliased" ) ;',
          ...
          {
            'src' => ' is ( runperl ( switches => [ \'-Ilib\' , \'-d:switchd_empty\' ] , progs => [ split "\\n" , \'sub DB::sub{length($DB::sub); goto &$DB::sub}
     ${^UTF8CACHE}=-1;
     print
       eval qq|sub oo\\x{25f} { 42 }
               sub ooooo\\x{25f} { oo\\x{25f}() }
    ...
    \' ] , stderr => 1 ) , "42\\n" , \'UTF8 length caches on $DB::sub are flushed\' ) ;',
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'indent' => 0,
            'src' => ' is ( runperl ( switches => [ \'-Ilib\' , \'-d:switchd_empty\' ] , prog => \'BEGIN { $^P &= ~0x4 } sort { $$b <=> $$a } (); print qq-42\\n-\' , ) , "42\\n" , \'-d does not conflict with sort optimisations\' ) ;',
            'start_line' => 279
          },
          {
            'end_line' => 289,
            ...
            'token_num' => 7,
            'indent' => 1,
            'src' => ' skip_if_miniperl ( "under miniperl" , 1 ) ;',
            'start_line' => 289
          },
          {
            'has_warnings' => 1,
    ...
    \' ] , stderr => 1 ) , "debugged\\n" , "\\$DB::single set to overload" ) ;',
          ...
          {
            'src' => ' { local $ENV { PERL5OPT } = \'-d:switchd_empty\' ; like ( runperl ( switches => [ \'-Ilib\' ] , prog => \'print q(hi)\' , ) , qr/hi/ , \'putenv does not interfere with PERL5OPT parsing\' , ) ; }',
            'indent' => 0,
            'start_line' => 319,
            'block_id' => 0,
            'token_num' => 35,
          ...
          {
            'indent' => 1,
            'src' => ' local $ENV { PERL5OPT } = \'-d:switchd_empty\' ;',
            'start_line' => 320,
            'has_warnings' => 1,
            'end_line' => 320,
            'block_id' => 5,
          ...
          },
          {
            ...
            'start_line' => 322,
            'indent' => 1,
            'src' => ' like ( runperl ( switches => [ \'-Ilib\' ] , prog => \'print q(hi)\' , ) , qr/hi/ , \'putenv does not interfere with PERL5OPT parsing\' , ) ;'
          }
        ]
