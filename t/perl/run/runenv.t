...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'line' => 102,
                   'data' => 'Global symbol "\\$x" requires explicit package name (did you forget to declare "my \\$x"?) at -e line 1.\\nExecution of -e aborted due to compilation errors.\\n',
                   'name' => 'RegExp'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'data' => '}',
...
',
          ...
          bless( {
                   'data' => 'PERL_PERTURB_KEYS = $mode results in different key order with the same key',
                   'name' => 'String',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_String,
          ...
          bless( {
                   'name' => 'String',
                   'data' => 'PERL_PERTURB_KEYS = $mode allows one to recreate a random hash',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   ...
                   'line' => 274,
                   'name' => 'String',
                   'data' => 'Got the same debug output when we set PERL_HASH_SEED and PERL_PERTURB_KEYS'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'data' => ')',
                   'name' => 'RightParenthesis',
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'end_line' => 69,
            'start_line' => 67,
            'src' => ' for my $k ( sort keys %$env ) { push @envpairs , "$k => $env->{$k}" ; }',
            'indent' => 1
          },
          {
            'has_warnings' => 0,
          ...
          },
          {
            ...
            'end_line' => 70,
            'indent' => 1,
            'src' => ' my $label = join ( \',\' => ( @envpairs , @$args ) ) ;',
            'start_line' => 70
          },
          {
            'start_line' => 71,
            'src' => ' if ( ref $stdout ) { ok ( $actual_stdout =~/$stdout/ , $label . \' stdout\' ) ; }',
            'indent' => 1,
            'end_line' => 73,
            'has_warnings' => 1,
            'block_id' => 7,
          ...
          {
            'src' => ' ok ( $actual_stdout =~/$stdout/ , $label . \' stdout\' ) ;',
            'indent' => 2,
            'start_line' => 72,
            'token_num' => 13,
            'block_id' => 9,
          ...
          },
          {
            ...
            'end_line' => 75,
            'indent' => 1,
            'src' => ' else { is ( $actual_stdout , $stdout , $label . \' stdout\' ) ; }',
            'start_line' => 73
          },
          {
            'block_id' => 10,
            ...
            'end_line' => 74,
            'has_warnings' => 1,
            'src' => ' is ( $actual_stdout , $stdout , $label . \' stdout\' ) ;',
            'indent' => 2,
            'start_line' => 74
          },
          {
            'src' => ' if ( ref $stderr ) { ok ( $actual_stderr =~/$stderr/ , $label . \' stderr\' ) ; }',
            'indent' => 1,
            'start_line' => 76,
            'has_warnings' => 1,
            'end_line' => 78,
          ...
          },
          {
            ...
            'end_line' => 77,
            'indent' => 2,
            'src' => ' ok ( $actual_stderr =~/$stderr/ , $label . \' stderr\' ) ;',
            'start_line' => 77
          },
          {
            'token_num' => 14,
            ...
            'start_line' => 78,
            'indent' => 1,
            'src' => ' else { is ( $actual_stderr , $stderr , $label . \' stderr\' ) ; }'
          },
          {
            'token_num' => 11,
            'block_id' => 12,
            ...
            'end_line' => 79,
            'indent' => 2,
            'src' => ' is ( $actual_stderr , $stderr , $label . \' stderr\' ) ;',
            'start_line' => 79
          },
          {
            'indent' => 0,
          ...
          {
            'indent' => 0,
            'src' => ' try ( { PERL5OPT => \'-Mstrict\' } , [ \'-I../lib\' , \'-e\' , \'print $x\' ] , "" , qq{Global symbol "\\$x" requires explicit package name (did you forget to declare "my \\$x"?) at -e line 1.\\nExecution of -e aborted due to compilation errors.\\n} ) ;',
            'start_line' => 100,
            'end_line' => 102,
            'has_warnings' => 0,
            'block_id' => 0,
          ...
          },
          {
            ...
            'start_line' => 105,
            'indent' => 0,
            'src' => ' try ( { PERL5OPT => \'-Mstrict -w\' } , [ \'-I../lib\' , \'-e\' , \'print $x\' ] , "" , qq{Global symbol "\\$x" requires explicit package name (did you forget to declare "my \\$x"?) at -e line 1.\\nExecution of -e aborted due to compilation errors.\\n} ) ;'
          },
          {
            'start_line' => 110,
...
Use of uninitialized value \\$x in print at -e line 1.
          ...
          },
          {
            ...
            'start_line' => 207,
            'indent' => 0,
            'src' => ' try ( { PERL_HASH_SEED_DEBUG => 1 } , [ \'-e\' , \'1\' ] , \'\' , qr/HASH_FUNCTION =/ ) ;'
          },
          {
            'has_warnings' => 0,
            'end_line' => 215,
            'block_id' => 0,
            'token_num' => 22,
            'src' => ' try ( { PERL_HASH_SEED_DEBUG => 1 } , [ \'-e\' , \'1\' ] , \'\' , qr/HASH_SEED =/ ) ;',
            'indent' => 0,
            'start_line' => 212
          },
          {
            ...
            'has_warnings' => 0,
            'start_line' => 218,
            'src' => ' try ( { PERL_HASH_SEED_DEBUG => 1 , PERL_HASH_SEED => "0" } , [ \'-e\' , \'1\' ] , \'\' , qr/PERTURB_KEYS = 0/ ) ;',
            'indent' => 0
          },
          {
            'block_id' => 0,
            ...
            'has_warnings' => 0,
            'end_line' => 228,
            'src' => ' try ( { PERL_HASH_SEED_DEBUG => 1 , PERL_HASH_SEED => "0x0" } , [ \'-e\' , \'1\' ] , \'\' , qr/PERTURB_KEYS = 2/ ) ;',
            'indent' => 0,
            'start_line' => 225
          },
          {
            'indent' => 0,
            'src' => ' try ( { PERL_HASH_SEED_DEBUG => 1 , PERL_PERTURB_KEYS => "0" } , [ \'-e\' , \'1\' ] , \'\' , qr/PERTURB_KEYS = 0/ ) ;',
            'start_line' => 230,
            'end_line' => 233,
            'has_warnings' => 0,
            'block_id' => 0,
          ...
          {
            'start_line' => 235,
            'src' => ' try ( { PERL_HASH_SEED_DEBUG => 1 , PERL_PERTURB_KEYS => "1" } , [ \'-e\' , \'1\' ] , \'\' , qr/PERTURB_KEYS = 1/ ) ;',
            'indent' => 0,
            'token_num' => 26,
            'block_id' => 0,
            'has_warnings' => 0,
          ...
          },
          {
            ...
            'end_line' => 243,
            'has_warnings' => 0,
            'src' => ' try ( { PERL_HASH_SEED_DEBUG => 1 , PERL_PERTURB_KEYS => "2" } , [ \'-e\' , \'1\' ] , \'\' , qr/PERTURB_KEYS = 2/ ) ;',
            'indent' => 0,
            'start_line' => 240
          },
          {
            ...
            'has_warnings' => 0,
            'start_line' => 245,
            'src' => ' try ( { PERL_HASH_SEED_DEBUG => 1 , PERL_HASH_SEED => "12345678" } , [ \'-e\' , \'1\' ] , \'\' , qr/HASH_SEED = 0x12345678/ ) ;',
            'indent' => 0
          },
          {
            'end_line' => 253,
            ...
            'token_num' => 26,
            'block_id' => 0,
            'src' => ' try ( { PERL_HASH_SEED_DEBUG => 1 , PERL_HASH_SEED => "12" } , [ \'-e\' , \'1\' ] , \'\' , qr/HASH_SEED = 0x12000000/ ) ;',
            'indent' => 0,
            'start_line' => 250
          },
          {
            'start_line' => 255,
            'indent' => 0,
            'src' => ' try ( { PERL_HASH_SEED_DEBUG => 1 , PERL_HASH_SEED => "123456789" } , [ \'-e\' , \'1\' ] , \'\' , qr/HASH_SEED = 0x12345678/ ) ;',
            'has_warnings' => 0,
            'end_line' => 258,
            'block_id' => 0,
            'token_num' => 26
          },
          {
            'start_line' => 262,
            'indent' => 0,
            'src' => ' my @print_keys = ( \'-e\' , \'@_{"A".."Z"}=(); print keys %_\' ) ;',
            'block_id' => 0,
            'token_num' => 9,
            'has_warnings' => 0,
            'end_line' => 262
          },
          {
            ...
            'has_warnings' => 1,
            'start_line' => 263,
            'src' => ' for my $mode ( 0 , 1 , 2 ) { my %base_opts = ( PERL_PERTURB_KEYS => $mode , PERL_HASH_SEED_DEBUG => 1 ) , my ( $out , $err ) = runperl_and_capture ( { %base_opts } , [ @print_keys ] ) ; if ( $err =~/HASH_SEED = (0x[a-f0-9]+)/ ) { my $seed = $1 ; my ( $out2 , $err2 ) = runperl_and_capture ( { %base_opts , PERL_HASH_SEED => $seed } , [ @print_keys ] ) ; if ( $mode == 1 ) { isnt ( $out , $out2 , "PERL_PERTURB_KEYS = $mode results in different key order with the same key" ) ; } else { is ( $out , $out2 , "PERL_PERTURB_KEYS = $mode allows one to recreate a random hash" ) ; } is ( $err , $err2 , "Got the same debug output when we set PERL_HASH_SEED and PERL_PERTURB_KEYS" ) ; } }',
            'indent' => 0
          },
          {
            'token_num' => 31,
            ...
            'has_warnings' => 1,
            'indent' => 1,
            'src' => ' my %base_opts = ( PERL_PERTURB_KEYS => $mode , PERL_HASH_SEED_DEBUG => 1 ) , my ( $out , $err ) = runperl_and_capture ( { %base_opts } , [ @print_keys ] ) ;',
            'start_line' => 264
          },
          {
            'token_num' => 75,
          ...
          },
          {
            ...
            'block_id' => 16,
            'indent' => 2,
            'src' => ' my ( $out2 , $err2 ) = runperl_and_capture ( { %base_opts , PERL_HASH_SEED => $seed } , [ @print_keys ] ) ;',
            'start_line' => 268
          },
          {
            'start_line' => 269,
            'src' => ' if ( $mode == 1 ) { isnt ( $out , $out2 , "PERL_PERTURB_KEYS = $mode results in different key order with the same key" ) ; }',
            'indent' => 2,
            'block_id' => 16,
            'token_num' => 17,
            'has_warnings' => 1,
          ...
          {
            'src' => ' isnt ( $out , $out2 , "PERL_PERTURB_KEYS = $mode results in different key order with the same key" ) ;',
            'indent' => 3,
            'start_line' => 270,
            'has_warnings' => 1,
            'end_line' => 270,
          ...
          {
            'start_line' => 271,
            'src' => ' else { is ( $out , $out2 , "PERL_PERTURB_KEYS = $mode allows one to recreate a random hash" ) ; }',
            'indent' => 2,
            'token_num' => 12,
            'block_id' => 16,
            'has_warnings' => 1,
          ...
          },
          {
            ...
            'block_id' => 19,
            'token_num' => 9,
            'src' => ' is ( $out , $out2 , "PERL_PERTURB_KEYS = $mode allows one to recreate a random hash" ) ;',
            'indent' => 3,
            'start_line' => 272
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 274,
            'src' => ' is ( $err , $err2 , "Got the same debug output when we set PERL_HASH_SEED and PERL_PERTURB_KEYS" ) ;',
            'indent' => 2,
            'start_line' => 274
          },
          {
