...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'ExecString',
                   'data' => '$dtrace -qnBEGIN -c\'$Perl -e 1\' 2>&1',
                   'type' => Compiler::Lexer::TokenType::T_ExecString,
                   'line' => 19
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'Apparently can\'t probe using $dtrace (perhaps you need root?): $result',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 20
                 }, 'Compiler::Lexer::Token' ),
          bless( {
     ...
     package Other;
        ...
        Your::inner();',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'sub-entry { printf("-> %s::%s at %s line %d!\\n", copyinstr(arg3), copyinstr(arg0), copyinstr(arg1), arg2) }
     sub-return { printf("<- %s::%s at %s line %d!\\n", copyinstr(arg3), copyinstr(arg0), copyinstr(arg1), arg2) }',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 46
                 }, 'Compiler::Lexer::Token' ),
...
<- Your::inner at - line 4!',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'traced multiple function calls',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 55
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'phase-change { printf("%s -> %s; ", copyinstr(arg1), copyinstr(arg0)) }',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 60
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'phase changes of a simple script',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 62
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => 'START -> CHECK; CHECK -> INIT; INIT -> RUN; RUN -> END; END -> DESTRUCT;',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 87
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'phase-changes in a script that exercises all of ${^GLOBAL_PHASE}',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 89
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
',
    ...
    ',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => 'foo during INIT; baz during END;',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 115
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'make sure sub-entry and phase-change interact well',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 117
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'Unexpected \'ready!\' result from DTrace: $throwaway',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 139
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'Unexpected error from DTrace: $result',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 152
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 11,
            'src' => ' skip_all_without_config ( "usedtrace" ) ;',
            'start_line' => 11,
            'indent' => 1,
            'block_id' => 1
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 13,
            'src' => ' $dtrace = $Config::Config { dtrace } ;',
            'start_line' => 13,
            'indent' => 1,
            'block_id' => 1
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 17,
            'src' => ' `$dtrace -V` or skip_all ( "$dtrace unavailable" ) ;',
            'start_line' => 17,
            'indent' => 1,
            'block_id' => 1
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 19,
            'src' => ' my $result = `$dtrace -qnBEGIN -c\'$Perl -e 1\' 2>&1` ;',
            'start_line' => 19,
            'indent' => 1,
            'block_id' => 1
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 20,
            'src' => ' $? && skip_all ( "Apparently can\'t probe using $dtrace (perhaps you need root?): $result" ) ;',
            'start_line' => 20,
            'indent' => 1,
            'block_id' => 1
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 34,
            'src' => ' dtrace_like ( \'1\' , \'BEGIN { trace(42+666) }\' , qr/708/ , \'really running DTrace\' , ) ;',
            'start_line' => 29,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 56,
            'src' => ' dtrace_like ( \'package My;
        sub outer { Your::inner() }
     package Your;
        sub inner { }
     package Other;
        My::outer();
        Your::inner();\' , \'sub-entry { printf("-> %s::%s at %s line %d!\\n", copyinstr(arg3), copyinstr(arg0), copyinstr(arg1), arg2) }
     sub-return { printf("<- %s::%s at %s line %d!\\n", copyinstr(arg3), copyinstr(arg0), copyinstr(arg1), arg2) }\' , qr/-> My::outer at - line 2!
-> Your::inner at - line 4!
<- Your::inner at - line 4!
<- My::outer at - line 2!
-> Your::inner at - line 4!
<- Your::inner at - line 4!/ , \'traced multiple function calls\' , ) ;',
            'start_line' => 36,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 63,
            'src' => ' dtrace_like ( \'1\' , \'phase-change { printf("%s -> %s; ", copyinstr(arg1), copyinstr(arg0)) }\' , qr/START -> RUN; RUN -> DESTRUCT;/ , \'phase changes of a simple script\' , ) ;',
            'start_line' => 58,
            'indent' => 0,
            'block_id' => 0
          },
    ...
    END { $x++ }
} , \'phase-change { printf("%s -> %s; ", copyinstr(arg1), copyinstr(arg0)) }\' , qr/START -> CHECK; CHECK -> INIT; INIT -> RUN; RUN -> END; END -> DESTRUCT;/ , \'phase-changes in a script that exercises all of ${^GLOBAL_PHASE}\' , ) ;',
            'start_line' => 69,
            'indent' => 0,
            'block_id' => 0
          },
    ...
    \' , qr/foo during INIT; baz during END;/ , \'make sure sub-entry and phase-change interact well\' , ) ;',
            'start_line' => 92,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 156,
            'src' => ' sub dtrace_like { my $perl = shift ; my $probes = shift ; my $expected = shift ; my $name = shift ; my ( $reader , $writer ) ; my $pid = open2 ( $reader , $writer , $dtrace , \'-q\' , \'-n\' , \'BEGIN { trace("ready!\\n") }\' , \'-n\' , $probes , \'-c\' , $Perl , ) ; chomp ( my $throwaway = < $reader > ) ; $throwaway eq "ready!" or die "Unexpected \'ready!\' result from DTrace: $throwaway" ; print $writer $perl ; close $writer ; local $/ ; my $result = < $reader > ; waitpid ( $pid , 0 ) ; my $child_exit_status = $? >> 8 ; die "Unexpected error from DTrace: $result" if $child_exit_status != 0 ; like ( $result , $expected , $name ) ; }',
            'start_line' => 120,
            'indent' => 0,
            'block_id' => 0
          },
