...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'data' => 'requires compilation with the fork emulation',
                   'name' => 'String'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
...
'
          ...
          bless( {
                   'name' => 'String',
                   'data' => 'ok 2 # $sig signal handler called\\n',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_String,
          ...
          bless( {
                   ...
                   'line' => 71,
                   'name' => 'String',
                   'data' => '# signaled after $count loops\\n'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'name' => 'SemiColon',
                   'data' => ';',
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'end_line' => 19,
            'has_warnings' => 1,
            'src' => ' skip_all ( "requires compilation with the fork emulation" ) unless $Config { \'d_pseudofork\' } ;',
            'indent' => 0,
            'start_line' => 18
          },
          {
          ...
          },
          {
            ...
            'start_line' => 30,
            'indent' => 0,
            'src' => ' my ( $sig ) = grep/^NUM/ , split \' \' , $Config { sig_name } ;'
          },
          {
            'token_num' => 4,
            'block_id' => 0,
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'start_line' => 41,
            'src' => ' unless ( defined $pid ) { print qq{not ok 1 # fork failed: $!
ok 2 # SKIP
ok 3 # SKIP
ok 4 # SKIP
} ; last SKIP ; }',
          ...
          {
            'indent' => 2,
            'src' => ' print qq{not ok 1 # fork failed: $!
ok 2 # SKIP
ok 3 # SKIP
ok 4 # SKIP
} ;',
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'start_line' => 50,
            'src' => ' if ( $pid ) { print "ok 1 # pseudo-forked\\n" ; sleep 2 ; kill $sig , $pid ; waitpid ( $pid , 0 ) ; }',
            'indent' => 1
          },
          {
            'token_num' => 3,
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 76,
            'src' => ' else { my $signalled ; $SIG { $sig } = sub { $! = 1 ; $^E = 1000 ; print "ok 2 # $sig signal handler called\\n" ; ++ $signalled ; } ; $! = 0 ; $^E = 0 ; my $count = 0 ; while ( ! $signalled && ++ $count < 10 ) { sleep 1 ; } print "# signaled after $count loops\\n" ; print $! != 0 ? "not " : "" , "ok 3 # \\$! preserved\\n" ; print $^E != 0 ? "not " : "" , "ok 4 # \\$^E preserved\\n" or print STDERR "# \\$^E = " , 0 + $^E , "\\n" ; exit ; }',
            'indent' => 1,
            'start_line' => 56
          },
          {
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'start_line' => 58,
            'src' => ' $SIG { $sig } = sub { $! = 1 ; $^E = 1000 ; print "ok 2 # $sig signal handler called\\n" ; ++ $signalled ; } ;',
            'indent' => 2
          },
          {
            'token_num' => 17,
            ...
            'end_line' => 63,
            'has_warnings' => 1,
            'src' => ' sub { $! = 1 ; $^E = 1000 ; print "ok 2 # $sig signal handler called\\n" ; ++ $signalled ; }',
            'indent' => 2,
            'start_line' => 58
          },
          {
          ...
          {
            'src' => ' print "ok 2 # $sig signal handler called\\n" ;',
            'indent' => 3,
            'start_line' => 61,
            'end_line' => 61,
            'has_warnings' => 0,
          ...
          },
          {
            ...
            'start_line' => 68,
            'indent' => 2,
            'src' => ' while ( ! $signalled && ++ $count < 10 ) { sleep 1 ; }'
          },
          {
            'token_num' => 3,
            'block_id' => 9,
          ...
          },
          {
            ...
            'start_line' => 71,
            'indent' => 2,
            'src' => ' print "# signaled after $count loops\\n" ;'
          },
          {
            'has_warnings' => 0,
            'end_line' => 72,
            ...
            'token_num' => 11,
            'start_line' => 72,
            'src' => ' print $! != 0 ? "not " : "" , "ok 3 # \\$! preserved\\n" ;',
            'indent' => 2
          },
          {
            'token_num' => 21,
            ...
            'has_warnings' => 0,
            'indent' => 2,
            'src' => ' print $^E != 0 ? "not " : "" , "ok 4 # \\$^E preserved\\n" or print STDERR "# \\$^E = " , 0 + $^E , "\\n" ;',
            'start_line' => 73
          },
          {
            'indent' => 2,
