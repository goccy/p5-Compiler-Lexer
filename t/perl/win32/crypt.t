...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'start_line' => 11,
            'indent' => 0,
            'src' => ' my @bad_salts = ( [ \'\' , \'zero-length\' ] , [ \'a\' , \'length 1\' ] , [ \'!a\' , \'bad first character\' ] , [ \'a!\' , \'bad second character\' ] , [ \'@a\' , \'fencepost before A\' ] , [ \'[a\' , \'fencepost after Z\' ] , [ \'`a\' , \'fencepost before a\' ] , [ \'{a\' , \'fencepost after z\' ] , [ \'-a\' , \'fencepost before .\' ] , [ \':a\' , \'fencepost after 9\' ] , ) ;'
          },
          {
            'indent' => 0,
            'src' => ' my @good_salts = qw(aa zz AA ZZ .. 99) ;',
            'start_line' => 25,
            'token_num' => 8,
            'block_id' => 0,
            'end_line' => 25,
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'indent' => 0,
            'src' => ' plan tests => 2 * @bad_salts + 1 + @good_salts ;',
            'start_line' => 27
          },
          {
            'start_line' => 29,
            'src' => ' for my $bad_salt ( @bad_salts ) { my ( $salt , $what ) = @$bad_salt ; $! = 0 ; is ( crypt ( "abc" , $salt ) , undef , "bad salt ($what)" ) ; is ( 0 + $! , & Errno::EINVAL , "check errno ($what)" ) ; }',
            'indent' => 0,
            'block_id' => 0,
            'token_num' => 47,
            'has_warnings' => 1,
          ...
          },
          {
            ...
            'block_id' => 2,
            'indent' => 1,
            'src' => ' is ( crypt ( "abc" , $salt ) , undef , "bad salt ($what)" ) ;',
            'start_line' => 32
          },
          {
            'block_id' => 2,
            ...
            'start_line' => 33,
            'indent' => 1,
            'src' => ' is ( 0 + $! , & Errno::EINVAL , "check errno ($what)" ) ;'
          },
          {
            'start_line' => 36,
            'src' => ' is ( crypt ( "abcdef" , "ab" ) , "abDMWw5NL.afs" , "sanity check result" ) ;',
            'indent' => 0,
            'block_id' => 0,
            'token_num' => 14,
            'has_warnings' => 1,
          ...
          },
          {
            ...
            'token_num' => 22,
            'indent' => 0,
            'src' => ' for my $good_salt ( @good_salts ) { isnt ( crypt ( "abcdef" , $good_salt ) , undef , "good salt $good_salt" ) ; }',
            'start_line' => 39
          },
          {
            'token_num' => 14,
            ...
            'has_warnings' => 1,
            'indent' => 1,
            'src' => ' isnt ( crypt ( "abcdef" , $good_salt ) , undef , "good salt $good_salt" ) ;',
            'start_line' => 40
          }
        ]
