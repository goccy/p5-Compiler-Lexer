...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'line' => 26,
                   'name' => 'String',
                   'data' => 'requires compilation with PERL_IMPLICIT_SYS'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Stmt,
          ...
          bless( {
                   'data' => 'Could not retrieve STDERR output: $!',
                   'name' => 'String',
                   'line' => 61,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'has_warnings' => 0,
          ...
          bless( {
                   'data' => 'Name "main::x" used only once: possible typo at -e line 1.${NL}Use of uninitialized value \\$x in print at -e line 1.${NL}',
                   'name' => 'RegExp',
                   'line' => 92,
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   'name' => 'RegExp',
                   'data' => 'Global symbol "\\$x" requires explicit package name (did you forget to declare "my \\$x"?',
                   'line' => 99,
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
...
',
          ...
          bless( {
                   ...
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'name' => 'RawString',
                   'data' => 'enough items so PERL5LIB val is longer than 32k'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'line' => 234,
                   'kind' => Compiler::Lexer::Kind::T_Comma,
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          {
            'src' => ' ( $: : os_id , $: : os_major ) = ( Win32::GetOSVersion ( ) ) [ 4 , 1 ] ;',
            'indent' => 1,
            'start_line' => 15,
            'block_id' => 1,
            'token_num' => 21,
          ...
          },
          {
            ...
            'token_num' => 22,
            'indent' => 1,
            'src' => ' if ( $: : os_id == 2 and $: : os_major == 6 ) { $: : tests = 43 ; }',
            'start_line' => 16
          },
          {
            'block_id' => 2,
          ...
          {
            'src' => ' skip_all "requires compilation with PERL_IMPLICIT_SYS" unless $Config { ccflags } =~/(?:\\A|\\s)-DPERL_IMPLICIT_SYS\\b/ ;',
            'indent' => 0,
            'start_line' => 26,
            'block_id' => 0,
            'token_num' => 12,
          ...
          {
            'indent' => 0,
            'src' => ' sub runperl_and_capture { my ( $env , $args ) = @_ ; local %ENV = %ENV ; delete $ENV { PERLLIB } ; delete $ENV { PERL5LIB } ; delete $ENV { PERL5OPT } ; for my $k ( keys %$env ) { $ENV { $k } = $env-> { $k } ; } my $stderr_cache = tmpnam ( ) ; my $stdout = `$PERL @$args 2>$stderr_cache` ; my $stderr = \'\' ; if ( -s $stderr_cache ) { open ( my $stderr_cache_fh , "<" , $stderr_cache ) or die "Could not retrieve STDERR output: $!" ; while ( defined ( my $s_line = < $stderr_cache_fh > ) ) { $stderr .= $s_line ; } close $stderr_cache_fh ; unlink $stderr_cache ; } return ( $stdout , $stderr ) ; }',
            'start_line' => 40,
            'has_warnings' => 1,
            'end_line' => 70,
            'block_id' => 0,
          ...
          },
          {
            ...
            'end_line' => 57,
            'start_line' => 57,
            'src' => ' my $stdout = `$PERL @$args 2>$stderr_cache` ;',
            'indent' => 1
          },
          {
            'has_warnings' => 0,
          ...
          {
            'indent' => 1,
            'src' => ' if ( -s $stderr_cache ) { open ( my $stderr_cache_fh , "<" , $stderr_cache ) or die "Could not retrieve STDERR output: $!" ; while ( defined ( my $s_line = < $stderr_cache_fh > ) ) { $stderr .= $s_line ; } close $stderr_cache_fh ; unlink $stderr_cache ; }',
            'start_line' => 59,
            'block_id' => 4,
            'token_num' => 44,
            'has_warnings' => 1,
          ...
          },
          {
            ...
            'block_id' => 6,
            'token_num' => 13,
            'src' => ' open ( my $stderr_cache_fh , "<" , $stderr_cache ) or die "Could not retrieve STDERR output: $!" ;',
            'indent' => 2,
            'start_line' => 60
          },
          {
            ...
            'block_id' => 6,
            'token_num' => 18,
            'src' => ' while ( defined ( my $s_line = < $stderr_cache_fh > ) ) { $stderr .= $s_line ; }',
            'indent' => 2,
            'start_line' => 62
          },
          {
          ...
          },
          {
            ...
            'start_line' => 69,
            'indent' => 1,
            'src' => ' return ( $stdout , $stderr ) ;'
          },
          {
            'indent' => 0,
            'src' => ' sub try { my ( $env , $args , $stdout , $stderr ) = @_ ; my ( $actual_stdout , $actual_stderr ) = runperl_and_capture ( $env , $args ) ; local $: : Level = $: : Level + 1 ; is $actual_stdout , $stdout ; is $actual_stderr , $stderr ; }',
            'start_line' => 72,
            'has_warnings' => 1,
            'end_line' => 78,
            'token_num' => 52,
          ...
          },
          {
            'start_line' => 90,
            'indent' => 0,
            'src' => ' try ( { PERL5OPT => \'-w\' } , [ \'-e\' , \'"print $::x"\' ] , "" , qq(Name "main::x" used only once: possible typo at -e line 1.${NL}Use of uninitialized value \\$x in print at -e line 1.${NL}) ) ;',
            'end_line' => 92,
            'has_warnings' => 0,
            'token_num' => 22,
            'block_id' => 0
