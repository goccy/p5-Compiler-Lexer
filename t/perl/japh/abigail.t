...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'line' => 99,
                   'data' => 'Your platform quotes differently.',
                   'name' => 'String'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'line' => 107,
                   'data' => '\'-weprint<<EOT;\' -eJust -eanother
                                   -ePerl -eHacker -eEOT',
                   'name' => 'RegExp'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   'data' => ' -eJust -eanother -ePerl -eHacker -eEOT',
                   'name' => 'RegExp',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   'data' => '-_=\'Just another Perl Hacker\'',
                   'name' => 'String',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
...
'
          ...
          bless( {
                   'name' => 'RegExp',
                   'data' => '^(COMMENT|CODE|ARGS|SWITCHES|EXPECT|SKIP|SKIP_OS)
                 (?::\\s+(.*))?$',
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
          ...
          bless( {
                   'data' => 'Your OS uses different quoting.',
                   'name' => 'String',
                   'line' => 196,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'has_warnings' => 0,
...
',
          ...
          bless( {
                   'name' => 'String',
                   'data' => '#!./perl not supported in QNX4',
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_String,
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'end_line' => 46,
            'indent' => 0,
            'src' => ' sub skip { my $why = shift ; my $n = @_ ? shift : 1 ; for ( 1 .. $n ) { my $test = curr_test ; print STDOUT "ok $test # skip: $why\\n" ; next_test ; } }',
            'start_line' => 38
          },
          {
            'indent' => 1,
          ...
          {
            'start_line' => 41,
            'src' => ' for ( 1 .. $n ) { my $test = curr_test ; print STDOUT "ok $test # skip: $why\\n" ; next_test ; }',
            'indent' => 1,
            'token_num' => 19,
            'block_id' => 2,
            'has_warnings' => 1,
          ...
          {
            'src' => ' print STDOUT "ok $test # skip: $why\\n" ;',
            'indent' => 2,
            'start_line' => 43,
            'has_warnings' => 0,
            'end_line' => 43,
          ...
          {
            'src' => ' sub notok { my ( $pass , $name , @mess ) = @_ ; _ok ( ! $pass , _where ( ) , $name , @mess ) ; }',
            'indent' => 0,
            'start_line' => 52,
            'token_num' => 29,
            'block_id' => 0,
          ...
          },
          {
            'start_line' => 57,
            'indent' => 0,
            'src' => ' my $JaPH = "Just another Perl Hacker" ;',
            'token_num' => 5,
            'block_id' => 0,
            'end_line' => 57,
            'has_warnings' => 0
          ...
          {
            'indent' => 0,
            'src' => ' my $JaPH_n = "Just another Perl Hacker\\n" ;',
            'start_line' => 59,
            'end_line' => 59,
            'has_warnings' => 0,
            'block_id' => 0,
          ...
          },
          {
            ...
            'start_line' => 61,
            'indent' => 0,
            'src' => ' my $JaPH_s = "Just another Perl Hacker " ;'
          },
          {
            'start_line' => 62,
            'src' => ' my $JaPh_s = "Just another Perl hacker " ;',
          ...
          {
            'indent' => 0,
            'src' => ' my $JaPH_c = "Just another Perl Hacker," ;',
            'start_line' => 63,
            'block_id' => 0,
            'token_num' => 5,
            'has_warnings' => 0,
          ...
          {
            'indent' => 0,
            'src' => ' { my $out = sprintf "Just another Perl Hacker" ; is ( $out , $JaPH ) ; }',
            'start_line' => 68,
            'end_line' => 71,
            'has_warnings' => 1,
            'token_num' => 15,
          ...
          },
          {
            ...
            'token_num' => 6,
            'indent' => 1,
            'src' => ' my $out = sprintf "Just another Perl Hacker" ;',
            'start_line' => 69
          },
          {
            'start_line' => 70,
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'indent' => 0,
            'src' => ' { my @primes = ( 2 , 3 , 7 , 13 , 53 , 101 , 557 , 1429 ) ; my @composites = ( 4 , 10 , 25 , 32 , 75 , 143 , 1333 , 1728 ) ; my %primeness = ( ( map { $_ => 1 } @primes ) , ( map { $_ => 0 } @composites ) ) ; while ( my ( $num , $is_prime ) = each %primeness ) { my $comment = "$num is " . ( $is_prime ? "prime." : "composite." ) ; my $sub = $is_prime ? "ok" : "notok" ; &$sub ( ( 1  x $num ) !~/^1?$|^(11+?)\\1+$/ , $comment ) ;',
            'start_line' => 74
          },
          {
            'start_line' => 75,
            'indent' => 1,
            'src' => ' my @primes = ( 2 , 3 , 7 , 13 , 53 , 101 , 557 , 1429 ) ;',
            'has_warnings' => 0,
            'end_line' => 75,
            'block_id' => 6,
            'token_num' => 21
          },
          {
            'start_line' => 76,
            'indent' => 1,
            'src' => ' my @composites = ( 4 , 10 , 25 , 32 , 75 , 143 , 1333 , 1728 ) ;',
            'token_num' => 21,
            'block_id' => 6,
            'end_line' => 76,
            'has_warnings' => 0
          ...
          {
            'indent' => 1,
            'src' => ' my %primeness = ( ( map { $_ => 1 } @primes ) , ( map { $_ => 0 } @composites ) ) ;',
            'start_line' => 78,
            'block_id' => 6,
            'token_num' => 25,
            'end_line' => 79,
          ...
          },
          {
            'start_line' => 81,
            'indent' => 1,
            'src' => ' while ( my ( $num , $is_prime ) = each %primeness ) { my $comment = "$num is " . ( $is_prime ? "prime." : "composite." ) ; my $sub = $is_prime ? "ok" : "notok" ; &$sub ( ( 1  x $num )',
            'token_num' => 39,
            'block_id' => 6,
            'has_warnings' => 1,
            'end_line' => 86
          },
          {
            ...
            'start_line' => 82,
            'indent' => 2,
            'src' => ' my $comment = "$num is " . ( $is_prime ? "prime." : "composite." ) ;'
          },
          {
            'start_line' => 84,
            'src' => ' my $sub = $is_prime ? "ok" : "notok" ;',
            'indent' => 2,
            'end_line' => 84,
            'has_warnings' => 1,
            'token_num' => 9,
