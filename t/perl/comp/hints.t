...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    * ;',
          ...
          },
          {
            'start_line' => 123,
            'indent' => 0,
            'src' => ' { my $res ; BEGIN { $^H { 73174 } = "foo" } BEGIN { $res = ( $^H { 73174 } // "" ) } eval \'"" =~ /\\x{100}/i; 1\' or defined & DynaLoader::boot_DynaLoader and die ; BEGIN { $res .= \'-\' . ( $^H { 73174 } // "" ) } $res .= \'-\' . ( $^H { 73174 } // "" ) ; print $res eq "foo-foo-" ? "" : "not " , "ok 23 - \\$^H{foo} correct after /unicode/i (res=$res)\\n" ; }',
            'end_line' => 137,
            'has_warnings' => 1,
            'token_num' => 75,
            'block_id' => 0
