...
krunch.pm krunch.pmc whap.pm whap.pmc',
          ...
          bless( {
                   'data' => '# Sleeping for 20 secs waiting for other process to finish\\n',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
          ...
          bless( {
                   ...
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => ' - require(v5.5.630) with parens [perl #124153]\\n',
                   'type' => Compiler::Lexer::TokenType::T_String
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'has_warnings' => 0,
          ...
          bless( {
                   'name' => 'String',
                   'line' => 80,
                   'data' => ' - require v5 ignores sub named v5\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value
          ...
          bless( {
                   'line' => 107,
                   'name' => 'String',
                   'data' => ' - v5.5.640 eq \\\\x{5}\\\\x{5}\\\\x{280}\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value
          ...
          bless( {
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => ' - v1.20.300.4000.50000.600000 eq ...\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
          ...
          bless( {
                   ...
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => 'print \'ok $i - require bleah.pm\\n\'; 1;\\n',
                   'type' => Compiler::Lexer::TokenType::T_String
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'name' => 'RightParenthesis',
          ...
          bless( {
                   ...
                   'has_warnings' => 0,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'data' => ' - exp $expected_compile; bleah.flg\\n',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'line' => 144,
                   'name' => 'String'
                 }, 'Compiler::Lexer::Token' ),
          ...
          bless( {
                   ...
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => ' - exp $expected_compile; require bleah.pm with flag file\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'name' => 'String',
                   'line' => 147
                 }, 'Compiler::Lexer::Token' ),
          ...
          bless( {
                   ...
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'data' => ' - exp $expected_compile; -e flag_file\\n',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_String
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   'data' => ' - exp $expected_compile; exists \\$INC{\'bleah.pm}\\n',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
...
',
          ...
          bless( {
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'data' => 'ok $i - [perl #24482] require CORE::foo\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'line' => 222,
                   'name' => 'String'
          ...
          bless( {
                   ...
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'data' => 'not ok - [perl #24482] require CORE::foo\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'kind' => Compiler::Lexer::Kind::T_Term
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => '    print "not ok $test - write_file_not_thing $file\\n";
    die "The $thing file should not be loaded";
',
                   'type' => Compiler::Lexer::TokenType::T_HereDocument,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
          ...
          bless( {
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'data' => 'print "ok $simple - urkkk.pm branch A\\n"',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'data' => 'print "ok $pmc_older - krunch.pm branch A\\n"',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'kind' => Compiler::Lexer::Kind::T_Term
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'data' => 'print "ok $pmc_older - krunch.pm branch B\\n";',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
          ...
          bless( {
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'has_warnings' => 0,
                   'data' => 'print "ok $simple - urkkk.pm branch B\\n";',
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'name' => 'RegExp',
                   'line' => 283
          ...
          bless( {
                   ...
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'data' => 'use Errno qw(EACCES); EACCES',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'kind' => Compiler::Lexer::Kind::T_Term
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            'has_warnings' => 0,
            'end_line' => 20,
            'src' => ' my @files_to_delete = qw(bleah.pm bleah.do bleah.flg urkkk.pm urkkk.pmc
krunch.pm krunch.pmc whap.pm whap.pmc) ;',
            'token_num' => 8,
            'start_line' => 19,
            'block_id' => 0,
          ...
          },
          {
            ...
            'block_id' => 0,
            'token_num' => 15,
            'src' => ' if ( grep -e , @files_to_delete ) { print "# Sleeping for 20 secs waiting for other process to finish\\n" ; sleep 20 ; }',
            'end_line' => 32,
            'has_warnings' => 0
          },
          {
            'token_num' => 3,
            'src' => ' print "# Sleeping for 20 secs waiting for other process to finish\\n" ;',
            'start_line' => 30,
            'block_id' => 3,
            'indent' => 1,
            'has_warnings' => 0,
          ...
          {
            'token_num' => 8,
            'src' => ' print "ok " , $i ++ , " - require 5.005 try 1\\n" ;',
            'start_line' => 51,
            'indent' => 0,
            'block_id' => 3,
            'has_warnings' => 1,
          ...
          },
          {
            ...
            'block_id' => 3,
            'token_num' => 8,
            'src' => ' print "ok " , $i ++ , " - require 5.005 try 2\\n" ;'
          },
          {
            'end_line' => 57,
            'has_warnings' => 0,
          ...
          },
          {
            ...
            'start_line' => 59,
            'indent' => 0,
            'src' => ' print "ok " , $i ++ , " - require 5.005 try 3\\n" ;',
            'token_num' => 8,
            'end_line' => 59,
            'has_warnings' => 1
          },
          ...
          },
          {
            ...
            'start_line' => 65,
            'indent' => 0,
            'src' => ' print "ok " , $i ++ , " - require 5.005 try 4\\n" ;',
            'token_num' => 8,
            'end_line' => 65,
            'has_warnings' => 1
          },
          ...
          {
            'src' => ' print "ok " , $i ++ , " - require 5.5.630\\n" ;',
            'token_num' => 8,
            'indent' => 0,
            'start_line' => 71,
            'block_id' => 3,
          ...
          {
            'src' => ' print "ok " , $i ++ , " - require(v5.5.630) with parens [perl #124153]\\n" ;',
            'token_num' => 8,
            'start_line' => 75,
            'block_id' => 3,
            'indent' => 0,
          ...
          {
            'src' => ' print "ok " , $i ++ , " - require v5 ignores sub named v5\\n" ;',
            'token_num' => 8,
            'start_line' => 80,
            'block_id' => 3,
            'indent' => 0,
          ...
          {
            'src' => ' print "ok " , $i ++ , " - require 5.005_63\\n" ;',
            'token_num' => 8,
            'indent' => 0,
            'start_line' => 89,
            'block_id' => 3,
          ...
          },
          {
            ...
            'end_line' => 100,
            'token_num' => 8,
            'src' => ' print "ok " , $i ++ , " - require 10.000_02\\n" ;',
            'start_line' => 100,
            'block_id' => 3,
            'indent' => 0
          },
          ...
          },
          {
            ...
            'block_id' => 7,
            'token_num' => 8,
            'src' => ' print "ok " , $i ++ , " - v5.5.640 eq \\\\x{5}\\\\x{5}\\\\x{280}\\n" ;'
          },
          {
            'end_line' => 109,
            'has_warnings' => 0,
          ...
          },
          {
            ...
            'start_line' => 110,
            'block_id' => 7,
            'src' => ' print "ok " , $i ++ , " - v7.15 eq \\\\x{7}\\\\x{f}\\n" ;',
            'token_num' => 8,
            'end_line' => 110,
            'has_warnings' => 1
          },
          ...
          },
          {
            ...
            'end_line' => 114,
            'token_num' => 8,
            'src' => ' print "ok " , $i ++ , " - v1.20.300.4000.50000.600000 eq ...\\n" ;',
            'start_line' => 114,
            'indent' => 1,
            'block_id' => 7
          },
          ...
          },
          {
            ...
            'start_line' => 124,
            'block_id' => 3,
            'src' => ' print "ok " , $i ++ , "\\ - BEGIN { require 5.11.0}\\n" ;',
            'token_num' => 8
          },
          {
            'token_num' => 7,
            'src' => ' write_file ( \'bleah.pm\' , "print \'ok $i - require bleah.pm\\n\'; 1;\\n" ) ;',
            'indent' => 0,
            'start_line' => 127,
            'block_id' => 3,
            'has_warnings' => 0,
          ...
          {
            'src' => ' print "ok " , $i ++ , " - require returning 0\\n" ;',
            'token_num' => 8,
            'start_line' => 134,
            'block_id' => 3,
            'indent' => 0,
          ...
          },
          {
            ...
            'indent' => 0,
            'token_num' => 8,
            'src' => ' print "ok " , $i ++ , " - %INC not updated\\n" ;',
            'end_line' => 137,
            'has_warnings' => 1
          },
          {
          ...
          },
          {
            ...
            'block_id' => 8,
            'token_num' => 8,
            'src' => ' print "ok " , $i ++ , " - exp $expected_compile; bleah.flg\\n" ;'
          },
          {
            'end_line' => 145,
            'has_warnings' => 0,
          ...
          },
          {
            ...
            'block_id' => 8,
            'token_num' => 8,
            'src' => ' print "ok " , $i ++ , " - exp $expected_compile; require bleah.pm with flag file\\n" ;',
            'end_line' => 147,
            'has_warnings' => 1
          },
          {
          ...
          },
          {
            ...
            'start_line' => 149,
            'block_id' => 8,
            'src' => ' print "ok " , $i ++ , " - exp $expected_compile; -e flag_file\\n" ;',
            'token_num' => 8,
            'end_line' => 149,
            'has_warnings' => 1
          },
          ...
          },
          {
            'has_warnings' => 1,
            'end_line' => 151,
            'src' => ' print "ok " , $i ++ , " - exp $expected_compile; exists \\$INC{\'bleah.pm}\\n" ;',
            'token_num' => 8,
            'start_line' => 151,
            'indent' => 1,
            'block_id' => 8
          ...
          },
          {
            ...
            'indent' => 0,
            'token_num' => 8,
            'src' => ' print "ok " , $i ++ , " - eval { require \'bleah.pm\' }\\n" ;'
          },
          {
            'end_line' => 168,
            'has_warnings' => 0,
          ...
          },
          {
            'has_warnings' => 1,
            'end_line' => 169,
            'src' => ' print "ok " , $i ++ , " - Compilation failed\\n" ;',
            'token_num' => 8,
            'block_id' => 3,
            'start_line' => 169,
            'indent' => 0
          ...
          },
          {
            ...
            'start_line' => 182,
            'block_id' => 3,
            'src' => ' write_file ( "bleah.do" , qq{\\$x = "not ok $i - bleah.do\\\\n";
} ) ;',
            'token_num' => 7
          },
          {
...
1;
          ...
          },
          {
            ...
            'end_line' => 214,
            'token_num' => 13,
            'src' => ' if ( $@ =~/Can\'t locate threads in \\@INC/ ) { print "ok $i - RT #24404\\n" ; }',
            'block_id' => 3,
            'start_line' => 212,
            'indent' => 0
          },
          ...
          },
          {
            ...
            'block_id' => 3,
            'token_num' => 6,
            'src' => ' else { print "not ok - RT #24404$i\\n" ; }'
          },
          {
            'end_line' => 215,
            'has_warnings' => 0,
            ...
            'start_line' => 215,
            'indent' => 1,
            'src' => ' print "not ok - RT #24404$i\\n" ;',
            'token_num' => 3
          },
          {
            'token_num' => 3,
            'src' => ' eval \' require CORE::lc "THREADS" \' ;',
            'block_id' => 3,
            'start_line' => 219,
            'indent' => 0,
            'has_warnings' => 0,
          ...
          },
          {
            'has_warnings' => 0,
            'end_line' => 223,
            'src' => ' if ( $@ =~/Can\'t locate threads in \\@INC/ ) { print "ok $i - [perl #24482] require CORE::foo\\n" ; }',
            'token_num' => 13,
            'block_id' => 3,
            'start_line' => 221,
            'indent' => 0
          },
          {
            'has_warnings' => 0,
            'end_line' => 222,
            'src' => ' print "ok $i - [perl #24482] require CORE::foo\\n" ;',
            'token_num' => 3,
            'indent' => 1,
            'start_line' => 222,
            'block_id' => 12
          ...
          {
            'src' => ' else { print "not ok - [perl #24482] require CORE::foo\\n" ; }',
            'token_num' => 6,
            'start_line' => 223,
            'indent' => 0,
            'block_id' => 3,
          ...
          },
          {
            ...
            'indent' => 1,
            'block_id' => 13,
            'src' => ' print "not ok - [perl #24482] require CORE::foo\\n" ;',
            'token_num' => 3,
            'end_line' => 224,
            'has_warnings' => 0
          },
          ...
          },
          {
            ...
            'block_id' => 3,
            'indent' => 0,
            'src' => ' if ( $@ =~/^This is an expected error/ ) { print "ok $i - expected error\\n" ; }',
            'token_num' => 13
          },
          {
            'has_warnings' => 0,
            'end_line' => 232,
            'src' => ' print "ok $i - expected error\\n" ;',
            'token_num' => 3,
            'start_line' => 232,
            'indent' => 1,
            'block_id' => 14
          },
          {
            ...
            'indent' => 0,
            'token_num' => 6,
            'src' => ' else { print "not ok $i - expected error\\n" ; }',
            'end_line' => 235,
            'has_warnings' => 0
          },
          {
            ...
            'end_line' => 234,
            'token_num' => 3,
            'src' => ' print "not ok $i - expected error\\n" ;',
            'start_line' => 234,
            'block_id' => 15,
            'indent' => 1
          },
          {
            'src' => ' sub write_file_not_thing { my ( $file , $thing , $test ) = @_ ; write_file ( $file , qq{    print "not ok $test - write_file_not_thing $file\\n";
    die "The $thing file should not be loaded";
} ) ; }',
            'token_num' => 22,
            'start_line' => 237,
    ...
    die "The $thing file should not be loaded";
          ...
          {
            'src' => ' foreach ( Config::non_bincompat_options ( ) ) { if ( $_ eq "PERL_DISABLE_PMC" ) { $no_pmc = 1 ; last ; } }',
            'token_num' => 22,
            'indent' => 1,
            'start_line' => 255,
            'block_id' => 17,
          ...
          },
          {
            ...
            'end_line' => 259,
            'token_num' => 14,
            'src' => ' if ( $_ eq "PERL_DISABLE_PMC" ) { $no_pmc = 1 ; last ; }',
            'indent' => 2,
            'start_line' => 256,
            'block_id' => 18
          },
          ...
          {
            'token_num' => 10,
            'src' => ' write_file ( \'urkkk.pm\' , qq(print "ok $simple - urkkk.pm branch A\\n") ) ;',
            'start_line' => 264,
            'indent' => 2,
            'block_id' => 20,
            'has_warnings' => 0,
          ...
          },
          {
            ...
            'end_line' => 270,
            'token_num' => 10,
            'src' => ' write_file ( \'krunch.pm\' , qq(print "ok $pmc_older - krunch.pm branch A\\n") ) ;',
            'start_line' => 270,
            'indent' => 2,
            'block_id' => 20
          },
          ...
          },
          {
            ...
            'start_line' => 275,
            'block_id' => 21,
            'src' => ' write_file ( \'krunch.pmc\' , qq(print "ok $pmc_older - krunch.pm branch B\\n";) ) ;',
            'token_num' => 10,
            'end_line' => 275,
            'has_warnings' => 0
          },
          ...
          },
          {
            ...
            'start_line' => 283,
            'indent' => 2,
            'src' => ' write_file ( \'urkkk.pmc\' , qq(print "ok $simple - urkkk.pm branch B\\n";) ) ;',
            'token_num' => 10
          },
          {
            'block_id' => 21,
          ...
          {
            'token_num' => 13,
            'src' => ' if ( $@ =~/^This is an expected error/ ) { print "ok $pmc_dies - pmc_dies\\n" ; }',
            'block_id' => 17,
            'start_line' => 290,
            'indent' => 1,
            'has_warnings' => 0,
          ...
          },
          {
            ...
            'end_line' => 291,
            'token_num' => 3,
            'src' => ' print "ok $pmc_dies - pmc_dies\\n" ;',
            'block_id' => 22,
            'start_line' => 291,
            'indent' => 2
          },
          {
            'src' => ' else { print "not ok $pmc_dies - pmc_dies\\n" ; }',
            'token_num' => 6,
            'start_line' => 292,
            'block_id' => 17,
            'indent' => 1,
          ...
          },
          {
            ...
            'block_id' => 23,
            'token_num' => 3,
            'src' => ' print "not ok $pmc_dies - pmc_dies\\n" ;'
          },
          {
            'block_id' => 3,
            'start_line' => 298,
            'indent' => 0,
            'token_num' => 30,
            'src' => ' { $! = eval \'use Errno qw(EACCES); EACCES\' || 0 ; eval q{require \'op\'} ; $i ++ ; print "not " if $@ =~/Permission denied/ ; print "ok $i - require op\\n" ; }',
            'end_line' => 310,
            'has_warnings' => 1
          },
          {
            ...
            'indent' => 1,
            'token_num' => 7,
            'src' => ' $! = eval \'use Errno qw(EACCES); EACCES\' || 0 ;',
            'end_line' => 305,
            'has_warnings' => 0
          },
          {
          ...
          },
          {
            ...
            'end_line' => 308,
            'token_num' => 9,
            'src' => ' print "not " if $@ =~/Permission denied/ ;',
            'start_line' => 308,
            'block_id' => 24,
            'indent' => 1
          },
          ...
          },
          {
            ...
            'indent' => 0,
            'token_num' => 49,
            'src' => ' if ( defined & DynaLoader::boot_DynaLoader ) { require Cwd ; require File::Spec::Functions ; eval { CORE::require ( File::Spec::Functions::catfile ( Cwd::getcwd ( ) , "bleah.pm" ) ) ; } ; if ( $@ =~/^This is an expected error/ ) { print "ok $i - require(func())\\n" ; } else { print "not ok $i - require(func())\\n" ; } }',
            'end_line' => 325,
            'has_warnings' => 1
          },
          {
          ...
          },
          {
            ...
            'indent' => 1,
            'block_id' => 25,
            'src' => ' if ( $@ =~/^This is an expected error/ ) { print "ok $i - require(func())\\n" ; }',
            'token_num' => 13
          },
          {
            'has_warnings' => 0,
            'end_line' => 321,
            'src' => ' print "ok $i - require(func())\\n" ;',
            'token_num' => 3,
            'indent' => 2,
            'start_line' => 321,
            'block_id' => 26
          },
          {
            'has_warnings' => 0,
            'end_line' => 324,
            'src' => ' else { print "not ok $i - require(func())\\n" ; }',
            'token_num' => 6,
            'block_id' => 25,
            'start_line' => 322,
            'indent' => 1
          },
          {
            'has_warnings' => 0,
            'end_line' => 323,
            'src' => ' print "not ok $i - require(func())\\n" ;',
            'token_num' => 3,
            'start_line' => 323,
            'block_id' => 27,
            'indent' => 2
          ...
          },
          {
            ...
            'block_id' => 37,
            'token_num' => 13,
            'src' => ' foreach my $file ( @files_to_delete ) { 1 while unlink $file ; }'
          },
          {
            'has_warnings' => 1,
            'end_line' => 379,
