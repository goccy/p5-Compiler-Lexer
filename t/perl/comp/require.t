...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => 'bleah.pm bleah.do bleah.flg urkkk.pm urkkk.pmc
krunch.pm krunch.pmc whap.pm whap.pmc',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => '\\x{1}\\x{14}\\x{12c}\\x{fa0}\\x{c350}\\x{927c0}',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 92
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'BEGIN {require 5.11.0} ${"foo"} = "bar";',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 101
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'unlink \'$flag_file\' or die; \\$a=0; \\$b=1/\\$a; 1;\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 124
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'HereDocument',
                   'data' => 'print "not " if !defined wantarray || wantarray ne \'\';
print "ok $i - require() context\\n";
1;
',
                   'type' => Compiler::Lexer::TokenType::T_HereDocument,
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => 'Can\'t locate threads in \\@INC',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 191
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => 'die "This is an expected error";\\n',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 198
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => '^This is an expected error',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 201
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'Failed to load Config for some reason',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 218
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'Failed to get ccflags for some reason',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 221
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => '# .pmc files are ignored, so test that\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 227
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => 'die "This is not an expected error"',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 230
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => '# Sleeping for 2 seconds before creating some more files\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 232
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => '# .pmc files should be loaded, so test that\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 239
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'ok $i # SKIP Cwd may not be available in miniperl\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 276
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => '${not}ok $i - require ignores I/O layers\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 286
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => '${not}ok $i - require does not localise %^H at run time\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 295
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => '^(Unsupported script encoding \\Q$_\\E)',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 322
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 14,
            'src' => ' sub do_require { %INC = ( ) ; write_file ( \'bleah.pm\' , @_ ) ; eval { require "bleah.pm" } ; my @a ; }',
            'start_line' => 9,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 20,
            'src' => ' my @fjles_to_delete = qw(bleah.pm bleah.do bleah.flg urkkk.pm urkkk.pmc
krunch.pm krunch.pmc whap.pm whap.pmc) ;',
            'start_line' => 19,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 23,
            'src' => ' my $Is_EBCDIC = ( ord ( \'A\' ) == 193 ) ? 1 : 0 ;',
            'start_line' => 23,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 26,
            'src' => ' if ( $Is_EBCDIC || $Is_UTF8 ) { $total_tests -= 3 ; }',
            'start_line' => 26,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 35,
            'src' => ' sub write_file { my $f = shift ; open ( REQ , ">$f" ) or die "Can\'t write \'$f\': $!" ; binmode REQ ; print REQ @_ ; close REQ or die "Could not close $f: $!" ; }',
            'start_line' => 29,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 31,
            'src' => ' open ( REQ , ">$f" ) or die "Can\'t write \'$f\': $!" ;',
            'start_line' => 31,
            'indent' => 1,
            'block_id' => 4
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 34,
            'src' => ' close REQ or die "Could not close $f: $!" ;',
            'start_line' => 34,
            'indent' => 1,
            'block_id' => 4
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 98,
            'src' => ' eval \'require 5.11.0; ${"foo"} = "bar";\' ;',
            'start_line' => 98,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 101,
            'src' => ' eval \'BEGIN {require 5.11.0} ${"foo"} = "bar";\' ;',
            'start_line' => 101,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 106,
            'src' => ' write_file ( \'bleah.pm\' , "print \'ok $i\\n\'; 1;\\n" ) ;',
            'start_line' => 106,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 115,
            'src' => ' print "not " if exists $INC { \'bleah.pm\' } ;',
            'start_line' => 115,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 122,
            'src' => ' print "not " unless -e $flag_file ;',
            'start_line' => 122,
            'indent' => 1,
            'block_id' => 6
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 124,
            'src' => ' write_file ( \'bleah.pm\' , "unlink \'$flag_file\' or die; \\$a=0; \\$b=1/\\$a; 1;\\n" ) ;',
            'start_line' => 124,
            'indent' => 1,
            'block_id' => 6
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 127,
            'src' => ' print "not " unless -e $flag_file xor $expected_compile ;',
            'start_line' => 127,
            'indent' => 1,
            'block_id' => 6
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 129,
            'src' => ' print "not " unless exists $INC { \'bleah.pm\' } ;',
            'start_line' => 129,
            'indent' => 1,
            'block_id' => 6
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 144,
            'src' => ' write_file ( \'bleah.pm\' , "unlink \'$flag_file\'; 1" ) ;',
            'start_line' => 144,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 166,
            'src' => ' sub dofile { do "bleah.do" or die $@ ; } ;',
            'start_line' => 166,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 176,
            'src' => ' write_file ( \'bleah.pm\' , q{print "not " if !defined wantarray || wantarray ne \'\';
print "ok $i - require() context\\n";
1;
} ) ;',
            'start_line' => 171,
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 181,
            'src' => ' eval q{$_=$_+2;require bleah} ;',
            'start_line' => 181,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 182,
            'src' => ' eval q{return require bleah} ;',
            'start_line' => 182,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 193,
            'src' => ' if ( $@ =~/Can\'t locate threads in \\@INC/ ) { print "ok $i\\n" ; }',
            'start_line' => 191,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 198,
            'src' => ' write_file ( \'bleah.pm\' , qq(die "This is an expected error";\\n) ) ;',
            'start_line' => 198,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 213,
            'src' => ' sub write_file_not_thing { my ( $file , $thing , $test ) = @_ ; write_file ( $file , qq{    print "not ok $test\\n";
    die "The $thing file should not be loaded";
} ) ; }',
            'start_line' => 207,
            'indent' => 0,
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 209,
            'src' => ' write_file ( $file , qq{    print "not ok $test\\n";
    die "The $thing file should not be loaded";
} ) ;',
            'start_line' => 209,
            'indent' => 1,
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 219,
            'src' => ' die "Failed to load Config for some reason" unless $Config::Config { version } ;',
            'start_line' => 218,
            'indent' => 1,
            'block_id' => 13
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 220,
            'src' => ' my $ccflags = $Config::Config { ccflags } ;',
            'start_line' => 220,
            'indent' => 1,
            'block_id' => 13
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 221,
            'src' => ' die "Failed to get ccflags for some reason" unless defined $ccflags ;',
            'start_line' => 221,
            'indent' => 1,
            'block_id' => 13
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 238,
            'src' => ' if ( $ccflags =~/(?:^|\\s)-DPERL_DISABLE_PMC\\b/ ) { print "# .pmc files are ignored, so test that\\n" ; write_file_not_thing ( \'krunch.pmc\' , \'.pmc\' , $pmc_older ) ; write_file ( \'urkkk.pm\' , qq(print "ok $simple\\n") ) ; write_file ( \'whap.pmc\' , qq(die "This is not an expected error") ) ; print "# Sleeping for 2 seconds before creating some more files\\n" ; sleep 2 ; write_file ( \'krunch.pm\' , qq(print "ok $pmc_older\\n") ) ; write_file_not_thing ( \'urkkk.pmc\' , \'.pmc\' , $simple ) ; write_file ( \'whap.pm\' , qq(die "This is an expected error") ) ; }',
            'start_line' => 226,
            'indent' => 1,
            'block_id' => 13
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 250,
            'src' => ' else { print "# .pmc files should be loaded, so test that\\n" ; write_file ( \'krunch.pmc\' , qq(print "ok $pmc_older\\n";) ) ; write_file_not_thing ( \'urkkk.pm\' , \'.pm\' , $simple ) ; write_file ( \'whap.pmc\' , qq(die "This is an expected error") ) ; print "# Sleeping for 2 seconds before creating some more files\\n" ; sleep 2 ; write_file_not_thing ( \'krunch.pm\' , \'.pm\' , $pmc_older ) ; write_file ( \'urkkk.pmc\' , qq(print "ok $simple\\n";) ) ; write_file_not_thing ( \'whap.pm\' , \'.pm\' , $pmc_dies ) ; }',
            'start_line' => 238,
            'indent' => 1,
            'block_id' => 13
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 253,
            'src' => ' eval { CORE::require whap ; 1 } and die ;',
            'start_line' => 253,
            'indent' => 1,
            'block_id' => 13
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 257,
            'src' => ' if ( $@ =~/^This is an expected error/ ) { print "ok $pmc_dies\\n" ; }',
            'start_line' => 255,
            'indent' => 1,
            'block_id' => 13
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 259,
            'src' => ' else { print "not ok $pmc_dies\\n" ; }',
            'start_line' => 257,
            'indent' => 1,
            'block_id' => 13
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 275,
            'src' => ' if ( defined & DynaLoader::boot_DynaLoader ) { require Cwd ; require File::Spec::Functions ; eval { CORE::require ( File::Spec::Functions::catfile ( Cwd::getcwd ( ) , "bleah.pm" ) ) ; } ; if ( $@ =~/^This is an expected error/ ) { print "ok $i\\n" ; } else { print "not ok $i\\n" ; } }',
            'start_line' => 264,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 277,
            'src' => ' else { print "ok $i # SKIP Cwd may not be available in miniperl\\n" ; }',
            'start_line' => 275,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 311,
            'src' => ' my %templates = ( \'UTF-8\' => \'C0U\' , \'UTF-16BE\' => \'n\' , \'UTF-16LE\' => \'v\' , ) ;',
            'start_line' => 307,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 318,
            'src' => ' sub bytes_to_utf { my ( $enc , $content , $do_bom ) = @_ ; my $template = $templates { $enc } ; die "Unsupported encoding $enc" unless $template ; return pack "$template*" , ( $do_bom ? 0xFEFF : ( ) ) , unpack "C*" , $content ; }',
            'start_line' => 313,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 325,
            'src' => ' foreach ( sort keys %templates ) { $i ++ ; do_require ( bytes_to_utf ( $_ , qq(print "ok $i # $_\\\\n"; 1;\\n) , 1 ) ) ; if ( $@ =~/^(Unsupported script encoding \\Q$_\\E)/ ) { print "ok $i # skip $1\\n" ; } }',
            'start_line' => 320,
            'indent' => 0,
            'block_id' => 0
          },
