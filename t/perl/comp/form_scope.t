...
',
          ...
          bless( {
                   'name' => 'String',
                   'data' => 'ok 5 - closure var not available when outer sub is inactive\\n',
                   'line' => 75,
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
...
',
          ...
          bless( {
                   'name' => 'RegExp',
                   'data' => '^Variable "\\$z" is not available at',
                   'line' => 117,
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'line' => 118,
                   'data' => 'ok 9 - closure var not available when outer sub is undefined\\n',
                   'name' => 'String'
                 }, 'Compiler::Lexer::Token' ),
          bless( {
                   'name' => 'SemiColon',
...
',
          ...
          bless( {
                   ...
                   'has_warnings' => 0,
                   'kind' => Compiler::Lexer::Kind::T_Term,
                   'data' => '@* - formats closing over redefined subs (got @*)
ref \\$x eq \'SCALAR\' ? "ok 13" : "not ok 13", ref \\$x;
',
                   'name' => 'Format'
                 }, 'Compiler::Lexer::Token' ),
...
$test
 . }',
          ...
          },
          {
            ...
            'token_num' => 844,
            'start_line' => 20,
            'src' => ' sub foo { sub bar { { my ( $a , $b , $c , $d , $e , $f , $g , $h , $i , $j , $k , $l , $m , $n , $o , $p , $q , $r , $s , $t , $u ) } { my ( $a , $b , $c , $d , $e , $f , $g , $h , $i , $j , $k , $l , $m , $n , $o , $p , $q , $r , $s , $t , $u ) } { my ( $a , $b , $c , $d , $e , $f , $g , $h , $i , $j , $k , $l , $m , $n , $o , $p , $q , $r , $s , $t , $u ) } { my ( $a , $b , $c , $d , $e , $f , $g , $h , $i , $j , $k , $l , $m , $n , $o , $p , $q , $r , $s , $t , $u ) } { my ( $a , $b , $c , $d , $e , $f , $g , $h , $i , $j , $k , $l , $m , $n , $o , $p , $q , $r , $s , $t , $u ) } { my ( $a , $b , $c , $d , $e , $f , $g , $h , $i , $j , $k , $l , $m , $n , $o , $p , $q , $r , $s , $t , $u ) } { my ( $a , $b , $c , $d , $e , $f , $g , $h , $i , $j , $k , $l , $m , $n , $o , $p , $q , $r , $s , $t , $u ) } { my ( $a , $b , $c , $d , $e , $f , $g , $h , $i , $j , $k , $l , $m , $n , $o , $p , $q , $r , $s , $t , $u ) } { my ( $a , $b , $c , $d , $e , $f , $g , $h , $i , $j , $k , $l , $m , $n , $o , $p , $q , $r , $s , $t , $u ) } { my ( $a , $b , $c , $d , $e , $f , $g , $h , $i , $j , $k , $l , $m , $n , $o , $p , $q , $r , $s , $t , $u ) } { my ( $a , $b , $c , $d , $e , $f , $g , $h , $i , $j , $k , $l , $m , $n , $o , $p , $q , $r , $s , $t , $u ) } { my ( $a , $b , $c , $d , $e , $f , $g , $h , $i , $j , $k , $l , $m , $n , $o , $p , $q , $r , $s , $t , $u ) } { my ( $a , $b , $c , $d , $e , $f , $g , $h , $i , $j , $k , $l , $m , $n , $o , $p , $q , $r , $s , $t , $u ) } { my ( $a , $b , $c , $d , $e , $f , $g , $h , $i , $j , $k , $l , $m , $n , $o , $p , $q , $r , $s , $t , $u ) } { my ( $a , $b , $c , $d , $e , $f , $g , $h , $i , $j , $k , $l , $m , $n , $o , $p , $q , $r , $s , $t , $u ) } { my ( $a , $b , $c , $d , $e , $f , $g , $h , $i , $j , $k , $l , $m , $n , $o , $p , $q , $r , $s , $t , $u ) } { my ( $a , $b , $c , $d , $e , $f , $g , $h , $i , $j , $k , $l , $m , $n , $o , $p , $q , $r , $s , $t , $u ) } { my ( $a , $b , $c , $d , $e , $f , $g , $h , $i , $j , $k , $l , $m , $n , $o , $p , $q , $r , $s , $t , $u ) } my $x ; format STDOUT2 = @<<<<<<
"ok 3".$x # $x is not available, but this should not crash
 . } }',
            'indent' => 0
          },
...
"ok 3".$x # $x is not available, but this should not crash
 . }',
          ...
          {
            'indent' => 2,
            'src' => ' { my ( $a , $b , $c , $d , $e , $f , $g , $h , $i , $j , $k , $l , $m , $n , $o , $p , $q , $r , $s , $t , $u ) }',
            'start_line' => 25,
            'block_id' => 3,
            'token_num' => 46,
            'end_line' => 25,
          ...
          },
          {
            ...
            'start_line' => 56,
            'indent' => 0,
            'src' => ' sub baz { my $a ; sub { $a ; { my ( $a , $b , $c , $d , $e , $f , $g , $h , $i , $j , $k , $l , $m , $n , $o , $p , $q , $r , $s , $t ) } my $x ; format STDOUT3 = @<<<<<<<<<<<<<<<<<<<<<<<<<
defined $x ? "not ok 4 - $x" : "ok 4"
 . } }'
          },
          {
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'indent' => 1,
            'src' => ' sub { $a ; { my ( $a , $b , $c , $d , $e , $f , $g , $h , $i , $j , $k , $l , $m , $n , $o , $p , $q , $r , $s , $t ) } my $x ; format STDOUT3 = @<<<<<<<<<<<<<<<<<<<<<<<<<
defined $x ? "not ok 4 - $x" : "ok 4"
 . }',
            'start_line' => 58
          },
          ...
          },
          {
            ...
            'block_id' => 23,
            'start_line' => 60,
            'src' => ' { my ( $a , $b , $c , $d , $e , $f , $g , $h , $i , $j , $k , $l , $m , $n , $o , $p , $q , $r , $s , $t ) }',
            'indent' => 2
          },
          {
            'has_warnings' => 0,
          ...
          },
          {
            ...
            'start_line' => 69,
            'indent' => 0,
            'src' => ' { local $^W = 1 ; my $w ; local $SIG { __WARN__ } = sub { $w = shift } ; write ; print "not " unless $w =~/^Variable "\\$x" is not available at/ ; print "ok 5 - closure var not available when outer sub is inactive\\n" ; }'
          },
          {
            'end_line' => 70,
            'has_warnings' => 0,
          ...
          {
            'start_line' => 74,
            'src' => ' print "not " unless $w =~/^Variable "\\$x" is not available at/ ;',
            'indent' => 1,
            'token_num' => 9,
            'block_id' => 25,
            'end_line' => 74,
          ...
          },
          {
            ...
            'block_id' => 25,
            'indent' => 1,
            'src' => ' print "ok 5 - closure var not available when outer sub is inactive\\n" ;',
            'start_line' => 75
          },
          {
            'start_line' => 81,
            'indent' => 0,
            'src' => ' sub make_closure { my $arg = shift ; sub { shift == 0 and &$next ( 1 ) , return ; my $x = "ok $arg" ; format STDOUT4 = @<<<<<<<
$x
 . sub { write }-> ( ) ; } }',
            'block_id' => 0,
            'token_num' => 41,
          ...
          {
            'indent' => 1,
            'src' => ' sub { shift == 0 and &$next ( 1 ) , return ; my $x = "ok $arg" ; format STDOUT4 = @<<<<<<<
$x
 . sub { write }-> ( ) ; }',
            'start_line' => 83,
            'block_id' => 27,
...
$x
 . sub { write }-> ( ) ;',
          ...
          },
          {
            ...
            'block_id' => 0,
            'start_line' => 102,
            'src' => ' sub x { { my ( $a , $b , $c , $d , $e , $f , $g , $h , $i , $j , $k , $l , $m , $n , $o , $p , $q , $r , $s , $t , $u ) } my $z ; format STDOUT6 = @<<<<<<<<<<<<<<<<<<<<<<<<<
defined $z ? "not ok 8 - $z" : "ok 8"
 . }',
            'indent' => 0
          },
          ...
          },
          {
            ...
            'block_id' => 0,
            'start_line' => 111,
            'src' => ' *STDOUT = *STDOUT6 { FORMAT } ;',
            'indent' => 0
          },
          {
            'indent' => 0,
            'src' => ' { local $^W = 1 ; my $w ; local $SIG { __WARN__ } = sub { $w = shift } ; write ; print "not " unless $w =~/^Variable "\\$z" is not available at/ ; print "ok 9 - closure var not available when outer sub is undefined\\n" ; }',
            'start_line' => 112,
            'token_num' => 37,
            'block_id' => 0,
            'end_line' => 119,
          ...
          },
          {
            ...
            'start_line' => 117,
            'indent' => 1,
            'src' => ' print "not " unless $w =~/^Variable "\\$z" is not available at/ ;'
          },
          {
            'has_warnings' => 0,
            'end_line' => 118,
            ...
            'block_id' => 32,
            'start_line' => 118,
            'src' => ' print "ok 9 - closure var not available when outer sub is undefined\\n" ;',
            'indent' => 1
          },
          {
            'has_warnings' => 1,
...
do { my $x = "ok 10 - closure inside format"; sub { $x }->() }
 . *STDOUT = *STDOUT7 { FORMAT } ;',
          ...
          {
            'src' => ' format STDOUT8 = @<<<< - recursive formats
do { my $t = "ok " . $testn--; write if $t =~ 12; $t}
 . *STDOUT = *STDOUT8 { FORMAT } ;',
            'indent' => 0,
            'start_line' => 129,
          ...
          },
          {
            ...
            'start_line' => 136,
            'indent' => 0,
            'src' => ' sub _13 { my $x ; format STDOUT13 = @* - formats closing over redefined subs (got @*)
ref \\$x eq \'SCALAR\' ? "ok 13" : "not ok 13", ref \\$x;
 . }'
          },
          {
