...
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'ok 7 - closure var not available when outer sub is undefined\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 91
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
defined $z ? "not ok 6 - $z" : "ok 6"
 . }',
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 92,
            'src' => ' { local $^W = 1 ; my $w ; local $SIG { __WARN__ } = sub { $w = shift } ; write ; print "not " unless $w =~/^Variable "\\$z" is not available at/ ; print "ok 7 - closure var not available when outer sub is undefined\\n" ; }',
            'start_line' => 85,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 91,
            'src' => ' print "ok 7 - closure var not available when outer sub is undefined\\n" ;',
            'start_line' => 91,
            'indent' => 1,
            'block_id' => 29
          }
