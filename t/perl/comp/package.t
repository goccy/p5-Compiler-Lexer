...
print $main',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'package main; print $blurfl == 123 ? "ok 6\\n" : "not ok 6\\n";',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 40
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 18,
            'src' => ' { package ABC ; $blurfl = 5 ; \'$maina = $\' b ; }',
            'start_line' => 14,
            'indent' => 0,
            'block_id' => 0
          },
...
print $main\' blurfl == 123 ? "ok 3\\n" : "not ok 3\\n" ;',
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 40,
            'src' => ' eval \'package main; print $blurfl == 123 ? "ok 6\\n" : "not ok 6\\n";\' ;',
            'start_line' => 40,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 53,
            'src' => ' sub foo { my $s = shift ; if ( $s ) { package PQR ; main::c ( ) ; } }',
            'start_line' => 47,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 59,
            'src' => ' undef %xyz::; eval { $a = * xyz::new { PACKAGE } ; } ;',
            'start_line' => 58,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 64,
            'src' => ' print $@ =~/^Can\'t use anonymous symbol table for method lookup/ ? "ok 10\\n" : "not ok 10 # \'$@\'\\n" ;',
            'start_line' => 63,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 68,
            'src' => ' print ref $Q eq "__ANON__" ? "ok 12\\n" : "not ok 12 # \'$Q\'\\n" ;',
            'start_line' => 68,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 72,
            'src' => ' print __PACKAGE__ eq \'bug32562\' ? "ok 13\\n" : "not ok 13\\n" ;',
            'start_line' => 72,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 73,
            'src' => ' print eval \'__PACKAGE__\' eq \'bug32562\' ? "ok 14\\n" : "not ok 14\\n" ;',
            'start_line' => 73,
            'indent' => 0,
            'block_id' => 0
          }
