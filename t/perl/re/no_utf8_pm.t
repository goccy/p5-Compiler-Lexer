...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'has_warnings' => 0,
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'data' => 'case insensitive matching of any Latin1 chars does not load utf8.pm',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'kind' => Compiler::Lexer::Kind::T_Term
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          {
            'src' => ' ok ( ! exists $INC { "utf8.pm" } , \'case insensitive matching of any Latin1 chars does not load utf8.pm\' ) ;',
            'token_num' => 12,
            'block_id' => 0,
            'start_line' => 17,
            'indent' => 0,
