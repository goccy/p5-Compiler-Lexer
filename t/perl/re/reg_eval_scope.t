...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => '(?{}) has its own lexical scope',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 20
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => '1a82a93a104a85a96a101a 1b82b93b104b85b96b101b 1c82c93c104c85c96c101c ',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 43
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'multiple (?{})s in loop with lexicals',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 45
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'run-time re-eval has its own scope',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 49
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'multiple (?{})s in "foo" =~ /$string/x',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 89
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => 'b${\\do { package baz; qr|(?{ $::pack = __PACKAGE__ })a| }}',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 111
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => '/text$qr/ inherits pragmata',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 114
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => '/$text/ containing (?{}) inherits package',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 122
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => '/$text/ containing (?{}) inherits pragmata',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 127
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'HereDocument',
                   'data' => ' eval { my $a=4; my $b=5; "a" =~ /(?{die})a/ }; print $a,$b"
',
                   'type' => Compiler::Lexer::TokenType::T_HereDocument,
                   'line' => 133
                 }, 'Compiler::Lexer::Token' ),
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'Don\'t run crashing TODO test on release build',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 141
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'HereDocument',
                   'data' => '     {  my $a=4; my $b=5; "a" =~ /(?{last})a/ }; print $a,$b
',
                   'type' => Compiler::Lexer::TokenType::T_HereDocument,
                   'line' => 146
                 }, 'Compiler::Lexer::Token' ),
...
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'HereDocument',
                   'data' => '     print sub {  my $a=4; my $b=5; "a" =~ /(?{return $a.$b})a/ }->();
',
                   'type' => Compiler::Lexer::TokenType::T_HereDocument,
                   'line' => 152
                 }, 'Compiler::Lexer::Token' ),
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'HereDocument',
                   'data' => '  my $a=4; my $b=5; "a" =~ /(?{goto _})a/; die; _: print $a,$b
',
                   'type' => Compiler::Lexer::TokenType::T_HereDocument,
                   'line' => 157
                 }, 'Compiler::Lexer::Token' ),
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'undef *_ in a re-eval does not cause a double free',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 163
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 16,
            'src' => ' sub on { $: : TODO = "(?{}) implementation is screwy" }',
            'start_line' => 16,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 45,
            'src' => ' , \'multiple (?{})s in loop with lexicals\' ;',
            'start_line' => 44,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 49,
            'src' => ' , \'run-time re-eval has its own scope\' ;',
            'start_line' => 49,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 89,
            'src' => ' , \'multiple (?{})s in "foo" =~ /$string/x\' ;',
            'start_line' => 74,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 104,
            'src' => ' "a" =~ do { package foo ; qr/(?{ $::pack = __PACKAGE__ })a/ } ;',
            'start_line' => 104,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 104,
            'src' => ' do { package foo ; qr/(?{ $::pack = __PACKAGE__ })a/ }',
            'start_line' => 104,
            'indent' => 0,
            'block_id' => 9
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 105,
            'src' => ' is $pack , \'foo\' , \'qr// inherits package\' ;',
            'start_line' => 105,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 107,
            'src' => ' is $re , \'(?^x:)\' , \'qr// inherits pragmata\' ;',
            'start_line' => 107,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 111,
            'src' => ' "ba" =~/b${\\do { package baz; qr|(?{ $::pack = __PACKAGE__ })a| }}/ ;',
            'start_line' => 111,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 112,
            'src' => ' is $pack , \'baz\' , \'/text$qr/ inherits package\' ;',
            'start_line' => 112,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 113,
            'src' => ' "ba" =~ m+b${\\do { use re "/i"; qr|(?{ $::re = qr-- })a| }}+ ;',
            'start_line' => 113,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 114,
            'src' => ' is $re , \'(?^i:)\' , \'/text$qr/ inherits pragmata\' ;',
            'start_line' => 114,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 121,
            'src' => ' { use re \'eval\' ; package bar ; "ba" =~/${\\\'(?{ $::pack = __PACKAGE__ })a\'}/ ; }',
            'start_line' => 117,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 122,
            'src' => ' is $pack , \'bar\' , \'/$text/ containing (?{}) inherits package\' ;',
            'start_line' => 122,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 127,
            'src' => ' is $re , \'(?^m:)\' , \'/$text/ containing (?{}) inherits pragmata\' ;',
            'start_line' => 127,
            'indent' => 0,
            'block_id' => 0
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 131,
            'src' => ' fresh_perl_is q{ eval { my $a=4; my $b=5; "a" =~ /(?{die})a/ }; print $a,$b"
} , \'45\' , { stderr => 1 } , \'(?{die})\' ;',
            'start_line' => 131,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 142,
            'src' => ' skip "Don\'t run crashing TODO test on release build" , 3 if $: : TODO && ( int ( $] * 1000 ) & 1 ) == 0 ;',
            'start_line' => 141,
            'indent' => 1,
            'block_id' => 14
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 144,
            'src' => ' fresh_perl_is q{     {  my $a=4; my $b=5; "a" =~ /(?{last})a/ }; print $a,$b
} , \'45\' , { stderr => 1 } , \'(?{last})\' ;',
            'start_line' => 144,
            'indent' => 1,
            'block_id' => 14
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 150,
            'src' => ' fresh_perl_is q{     print sub {  my $a=4; my $b=5; "a" =~ /(?{return $a.$b})a/ }->();
} , \'45\' , { stderr => 1 } , \'(?{return})\' ;',
            'start_line' => 150,
            'indent' => 1,
            'block_id' => 14
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 155,
            'src' => ' fresh_perl_is q{  my $a=4; my $b=5; "a" =~ /(?{goto _})a/; die; _: print $a,$b
} , \'45\' , { stderr => 1 } , \'(?{goto})\' ;',
            'start_line' => 155,
            'indent' => 0,
            'block_id' => 0
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 163,
            'src' => ' pass "undef *_ in a re-eval does not cause a double free" ;',
            'start_line' => 163,
            'indent' => 0,
            'block_id' => 0
          }
