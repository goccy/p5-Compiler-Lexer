...
subtest 'tokenize' => sub {
    ...
    is_deeply($tokens, [
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RegExp',
                   'data' => '$qr $skip_amp $qr_embed $qr_embed_thr',
                   'type' => Compiler::Lexer::TokenType::T_RegExp,
                   'line' => 70
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'ok $test # (Blank line or comment)\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 94
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'RawString',
                   'data' => 'utf8::upgrade($subject); study $subject',
                   'type' => Compiler::Lexer::TokenType::T_RawString,
                   'line' => 119
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'HereDocument',
                   'data' => '		# Can\'t run the match in a subthread, but can do this and
	 	# clone the pattern the other way.
                my \\$RE = threads->new(sub {qr$pat})->join();
                $study;
                \\$match = (\\$subject =~ /(?:)\\$RE(?:)/) while \\$c--;
...
',
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'not ok $test$todo (compile) $input => \'$err\'\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 170
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'not ok $test$todo $input => error \'$err\'\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 182
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'not ok $test$todo ($study) $input => false positive\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 185
                 }, 'Compiler::Lexer::Token' ),
          bless( {
          ...
          bless( {
                   ...
                   'stype' => Compiler::Lexer::SyntaxType::T_Value,
                   'name' => 'String',
                   'data' => 'not ok $test$todo ($study) $input => \'$got\', match=$match\\n',
                   'type' => Compiler::Lexer::TokenType::T_String,
                   'line' => 195
                 }, 'Compiler::Lexer::Token' ),
          bless( {
...
subtest 'get_groups_by_syntax_level' => sub {
    ...
    is_deeply($stmts, [
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 55,
            'src' => ' if ( defined $file ) { open TESTS , $file or die "Can\'t open $file" ; }',
            'start_line' => 53,
            'indent' => 1,
            'block_id' => 1
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 54,
            'src' => ' open TESTS , $file or die "Can\'t open $file" ;',
            'start_line' => 54,
            'indent' => 2,
            'block_id' => 2
          },
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 69,
            'src' => ' use vars qw($bang $ffff $nulnul) ;',
            'start_line' => 69,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 70,
            'src' => ' use vars qw($qr $skip_amp $qr_embed $qr_embed_thr) ;',
            'start_line' => 70,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 75,
            'src' => ' if ( ! defined $file ) { open TESTS , \'re/re_tests\' or die "Can\'t open re/re_tests: $!" ; }',
            'start_line' => 73,
            'indent' => 0,
            'block_id' => 0
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 74,
            'src' => ' open TESTS , \'re/re_tests\' or die "Can\'t open re/re_tests: $!" ;',
            'start_line' => 74,
            'indent' => 1,
            'block_id' => 4
          },
	 	...
	 	# clone the pattern the other way.
          ...
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 97,
            'src' => ' if ( !/\\S/ ||/^\\s*#/ ||/^__END__$/ ) { print "ok $test # (Blank line or comment)\\n" ; if (/#/ ) { print $_ } ; next ; }',
            'start_line' => 93,
            'indent' => 1,
            'block_id' => 5
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 94,
            'src' => ' print "ok $test # (Blank line or comment)\\n" ;',
            'start_line' => 94,
            'indent' => 2,
            'block_id' => 6
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 100,
            'src' => ' my ( $pat , $subject , $result , $repl , $expect , $reason ) = split (/\\t/ , $_ , 6 ) ;',
            'start_line' => 100,
            'indent' => 1,
            'block_id' => 5
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 101,
            'src' => ' $reason = \'\' unless defined $reason ;',
            'start_line' => 101,
            'indent' => 1,
            'block_id' => 5
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 102,
            'src' => ' my $input = join ( \':\' , $pat , $subject , $result , $repl , $expect ) ;',
            'start_line' => 102,
            'indent' => 1,
            'block_id' => 5
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 109,
            'src' => ' $expect = $repl = \'-\' if $skip_amp and $input =~/\\$[&\\`\\\']/ ;',
            'start_line' => 109,
            'indent' => 1,
            'block_id' => 5
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 110,
            'src' => ' my $todo_qr = $qr_embed_thr && ( $result =~ s/t// ) ;',
            'start_line' => 110,
            'indent' => 1,
            'block_id' => 5
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 111,
            'src' => ' my $skip = ( $skip_amp ? ( $result =~ s/B//i ) : ( $result =~ s/B// ) ) ;',
            'start_line' => 111,
            'indent' => 1,
            'block_id' => 5
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 112,
            'src' => ' ++ $skip if $result =~ s/M// && ! defined & DynaLoader::boot_DynaLoader ;',
            'start_line' => 112,
            'indent' => 1,
            'block_id' => 5
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 113,
            'src' => ' $reason = \'skipping $&\' if $reason eq \'\' && $skip_amp ;',
            'start_line' => 113,
            'indent' => 1,
            'block_id' => 5
          },
	 	...
	 	# clone the pattern the other way.
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 167,
            'src' => ' { no warnings qw(uninitialized regexp) ; eval $code ; }',
            'start_line' => 161,
            'indent' => 2,
            'block_id' => 8
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 165,
            'src' => ' no warnings qw(uninitialized regexp) ;',
            'start_line' => 165,
            'indent' => 3,
            'block_id' => 13
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 172,
            'src' => ' if ( $result eq \'c\' ) { if ( $err !~ m!^\\Q$expect! ) { print "not ok $test$todo (compile) $input => \'$err\'\\n" ; next TEST } last ; }',
            'start_line' => 169,
            'indent' => 2,
            'block_id' => 8
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 170,
            'src' => ' if ( $err !~ m!^\\Q$expect! ) { print "not ok $test$todo (compile) $input => \'$err\'\\n" ; next TEST }',
            'start_line' => 170,
            'indent' => 3,
            'block_id' => 14
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 170,
            'src' => ' print "not ok $test$todo (compile) $input => \'$err\'\\n" ;',
            'start_line' => 170,
            'indent' => 4,
            'block_id' => 15
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 176,
            'src' => ' elsif ( $skip ) { print "ok $test # skipped" , length ( $reason ) ? " $reason" : \'\' , "\\n" ; next TEST ; }',
            'start_line' => 173,
            'indent' => 2,
            'block_id' => 8
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 174,
            'src' => ' print "ok $test # skipped" , length ( $reason ) ? " $reason" : \'\' , "\\n" ;',
            'start_line' => 174,
            'indent' => 3,
            'block_id' => 16
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 180,
            'src' => ' elsif ( $todo_qr ) { print "not ok $test # TODO" , length ( $reason ) ? " - $reason" : \'\' , "\\n" ; next TEST ; }',
            'start_line' => 177,
            'indent' => 2,
            'block_id' => 8
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 178,
            'src' => ' print "not ok $test # TODO" , length ( $reason ) ? " - $reason" : \'\' , "\\n" ;',
            'start_line' => 178,
            'indent' => 3,
            'block_id' => 17
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 183,
            'src' => ' elsif ( $@ ) { print "not ok $test$todo $input => error \'$err\'\\n" , _comment ( "$code\\n$@\\n" ) ; next TEST ; }',
            'start_line' => 181,
            'indent' => 2,
            'block_id' => 8
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 182,
            'src' => ' print "not ok $test$todo $input => error \'$err\'\\n" , _comment ( "$code\\n$@\\n" ) ;',
            'start_line' => 182,
            'indent' => 3,
            'block_id' => 18
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 186,
            'src' => ' elsif ( $result =~/^n/ ) { if ( $match ) { print "not ok $test$todo ($study) $input => false positive\\n" ; next TEST } }',
            'start_line' => 184,
            'indent' => 2,
            'block_id' => 8
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 185,
            'src' => ' if ( $match ) { print "not ok $test$todo ($study) $input => false positive\\n" ; next TEST }',
            'start_line' => 185,
            'indent' => 3,
            'block_id' => 19
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 185,
            'src' => ' print "not ok $test$todo ($study) $input => false positive\\n" ;',
            'start_line' => 185,
            'indent' => 4,
            'block_id' => 20
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 204,
            'src' => ' else { if ( ! $match || $got ne $expect ) { eval { require Data::Dumper } ; if ( $@ || ! defined & DynaLoader::boot_DynaLoader ) { print "not ok $test$todo ($study) $input => \'$got\', match=$match\\n" , _comment ( "$code\\n" ) ; } else { my $s = Data::Dumper-> new ( [ $subject ] , [ \'subject\' ] )-> Useqq ( 1 )-> Dump ; my $g = Data::Dumper-> new ( [ $got ] , [ \'got\' ] )-> Useqq ( 1 )-> Dump ; print "not ok $test$todo ($study) $input => \'$got\', match=$match\\n" , _comment ( "$s\\n$g\\n$code\\n" ) ; } next TEST ; } }',
            'start_line' => 187,
            'indent' => 2,
            'block_id' => 8
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 203,
            'src' => ' if ( ! $match || $got ne $expect ) { eval { require Data::Dumper } ; if ( $@ || ! defined & DynaLoader::boot_DynaLoader ) { print "not ok $test$todo ($study) $input => \'$got\', match=$match\\n" , _comment ( "$code\\n" ) ; } else { my $s = Data::Dumper-> new ( [ $subject ] , [ \'subject\' ] )-> Useqq ( 1 )-> Dump ; my $g = Data::Dumper-> new ( [ $got ] , [ \'got\' ] )-> Useqq ( 1 )-> Dump ; print "not ok $test$todo ($study) $input => \'$got\', match=$match\\n" , _comment ( "$s\\n$g\\n$code\\n" ) ; } next TEST ; }',
            'start_line' => 188,
            'indent' => 3,
            'block_id' => 21
          },
          ...
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 196,
            'src' => ' if ( $@ || ! defined & DynaLoader::boot_DynaLoader ) { print "not ok $test$todo ($study) $input => \'$got\', match=$match\\n" , _comment ( "$code\\n" ) ; }',
            'start_line' => 190,
            'indent' => 4,
            'block_id' => 22
          },
          {
            ...
            'has_warnings' => 0,
            'end_line' => 195,
            'src' => ' print "not ok $test$todo ($study) $input => \'$got\', match=$match\\n" , _comment ( "$code\\n" ) ;',
            'start_line' => 195,
            'indent' => 5,
            'block_id' => 23
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 201,
            'src' => ' else { my $s = Data::Dumper-> new ( [ $subject ] , [ \'subject\' ] )-> Useqq ( 1 )-> Dump ; my $g = Data::Dumper-> new ( [ $got ] , [ \'got\' ] )-> Useqq ( 1 )-> Dump ; print "not ok $test$todo ($study) $input => \'$got\', match=$match\\n" , _comment ( "$s\\n$g\\n$code\\n" ) ; }',
            'start_line' => 197,
            'indent' => 4,
            'block_id' => 22
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 198,
            'src' => ' my $s = Data::Dumper-> new ( [ $subject ] , [ \'subject\' ] )-> Useqq ( 1 )-> Dump ;',
            'start_line' => 198,
            'indent' => 5,
            'block_id' => 24
          },
          {
            ...
            'has_warnings' => 1,
            'end_line' => 199,
            'src' => ' my $g = Data::Dumper-> new ( [ $got ] , [ \'got\' ] )-> Useqq ( 1 )-> Dump ;',
            'start_line' => 199,
            'indent' => 5,
            'block_id' => 24
          },
