...
use constant {
    ...
    T_RegMatch => 143,
    T_RegDelim => 144,
    T_RegMiddleDelim => 145,
    T_RegAllReplace => 146,
    T_RegReplace => 147,
    T_RegReplaceFrom => 148,
    T_RegReplaceTo => 149,
    T_FieldDecl => 150,
    T_TypeRef => 151,
    T_LabelRef => 152,
    T_LocalVarDecl => 153,
    T_GlobalVarDecl => 154,
    T_MultiLocalVarDecl => 155,
    T_MultiGlobalVarDecl => 156,
    T_Prototype => 157,
    T_Var => 158,
    T_CodeVar => 159,
    T_ArrayVar => 160,
    ...
    T_ExecString => 166,
    T_VersionString => 167,
    T_HereDocumentTag => 168,
    T_HereDocumentRawTag => 169,
    T_HereDocumentExecTag => 170,
    T_RawHereDocument => 171,
    T_HereDocument => 172,
    T_HereDocumentEnd => 173,
    T_FormatDecl => 174,
    T_Format => 175,
    T_FormatEnd => 176,
    T_Object => 177,
